...
public class TParameterImpl extends TAnnotatableImpl implements TParameter {
	...
	public EList<TAbstractFlowElement> getIncomingFlows() {
		if (incomingFlows == null) {
			incomingFlows = new EObjectResolvingEList<TAbstractFlowElement>(TAbstractFlowElement.class, this, BasicPackage.TPARAMETER__INCOMING_FLOWS);
		}
	...
	public EList<TAbstractFlowElement> getOutgoingFlows() {
		if (outgoingFlows == null) {
			outgoingFlows = new EObjectResolvingEList<TAbstractFlowElement>(TAbstractFlowElement.class, this, BasicPackage.TPARAMETER__OUTGOING_FLOWS);
		}
