...
public class TMethodSignatureImpl extends TAnnotatableImpl implements TMethodSignature {
	...
	public EList<TAbstractFlowElement> getIncomingFlows() {
		if (incomingFlows == null) {
			incomingFlows = new EObjectResolvingEList<TAbstractFlowElement>(TAbstractFlowElement.class, this, BasicPackage.TMETHOD_SIGNATURE__INCOMING_FLOWS);
		}
	...
	public EList<TAbstractFlowElement> getOutgoingFlows() {
		if (outgoingFlows == null) {
			outgoingFlows = new EObjectResolvingEList<TAbstractFlowElement>(TAbstractFlowElement.class, this, BasicPackage.TMETHOD_SIGNATURE__OUTGOING_FLOWS);
		}
