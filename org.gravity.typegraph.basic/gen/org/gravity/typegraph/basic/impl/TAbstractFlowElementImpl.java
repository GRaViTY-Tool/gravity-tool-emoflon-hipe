...
public abstract class TAbstractFlowElementImpl extends MinimalEObjectImpl.Container implements TAbstractFlowElement {
	...
	public EList<TAbstractFlowElement> getIncomingFlows() {
		if (incomingFlows == null) {
			incomingFlows = new EObjectResolvingEList<TAbstractFlowElement>(TAbstractFlowElement.class, this, BasicPackage.TABSTRACT_FLOW_ELEMENT__INCOMING_FLOWS);
		}
	...
	public EList<TAbstractFlowElement> getOutgoingFlows() {
		if (outgoingFlows == null) {
			outgoingFlows = new EObjectResolvingEList<TAbstractFlowElement>(TAbstractFlowElement.class, this, BasicPackage.TABSTRACT_FLOW_ELEMENT__OUTGOING_FLOWS);
		}
