...
public abstract class TMemberImpl extends TAnnotatableImpl implements TMember {
	...
	public EList<TAbstractFlowElement> getIncomingFlows() {
		if (incomingFlows == null) {
			incomingFlows = new EObjectResolvingEList<TAbstractFlowElement>(TAbstractFlowElement.class, this, BasicPackage.TMEMBER__INCOMING_FLOWS);
		}
	...
	public EList<TAbstractFlowElement> getOutgoingFlows() {
		if (outgoingFlows == null) {
			outgoingFlows = new EObjectResolvingEList<TAbstractFlowElement>(TAbstractFlowElement.class, this, BasicPackage.TMEMBER__OUTGOING_FLOWS);
		}
