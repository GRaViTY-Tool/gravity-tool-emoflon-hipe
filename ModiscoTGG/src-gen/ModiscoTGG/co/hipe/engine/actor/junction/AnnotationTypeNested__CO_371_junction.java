...
public class AnnotationTypeNested__CO_371_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, AbstractJunctionNode node) {
		...
		ports.add(new PortJunctionLeft(getSelf(), name2actor.get("AnnotationTypeNested__CO_2703_nacjunction"), this::check_constraint_16));
	}
