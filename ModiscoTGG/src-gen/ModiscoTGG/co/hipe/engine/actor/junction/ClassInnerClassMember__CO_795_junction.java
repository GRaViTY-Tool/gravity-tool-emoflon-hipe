...
public class ClassInnerClassMember__CO_795_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		...
		ports.add(new PortJunctionLeft(getSelf(), name2actor.get("ClassInnerClassMember__CO_788_junction"), this::check_constraint_53));
	}
