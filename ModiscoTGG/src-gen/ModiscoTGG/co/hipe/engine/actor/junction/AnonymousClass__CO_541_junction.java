...
public class AnonymousClass__CO_541_junction extends GenericJunctionActor{
	...
	public boolean check_constraint_32(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.AddSuffix csp_14 = new org.emoflon.ibex.tgg.operational.csp.constraints.AddSuffix();
		...
		csp_14.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "$1", "java.lang.String"));
		csp_14.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tNewPackage.getTName(), "java.lang.String"));
		csp_14.solve();
