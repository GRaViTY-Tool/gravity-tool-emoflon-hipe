...
public class Interface__CO_1437_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		...
		ports.add(new PortJunctionLeft(getSelf(), name2actor.get("Interface__CO_1431_junction"), this::check_constraint_108));
	}
