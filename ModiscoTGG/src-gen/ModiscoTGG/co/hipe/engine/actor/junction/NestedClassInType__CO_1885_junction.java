...
public class NestedClassInType__CO_1885_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		...
		ports.add(new PortJunctionRight(getSelf(), name2actor.get("NestedClassInType__CO_1880_junction"), this::check_constraint_127));
	}
	...
	public boolean check_constraint_127(HMatch match) {
		...
		csp_43.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, eNestedType.isProxy(), "boolean"));
		csp_43.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tNestedType.isTLib(), "boolean"));
		csp_43.solve();
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_44 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_44.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, eNestedType.getName(), "java.lang.String"));
		csp_44.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tNestedType.getTName(), "java.lang.String"));
		csp_44.solve();
		
		boolean predicate = csp_43.isSatisfied() && csp_44.isSatisfied();
