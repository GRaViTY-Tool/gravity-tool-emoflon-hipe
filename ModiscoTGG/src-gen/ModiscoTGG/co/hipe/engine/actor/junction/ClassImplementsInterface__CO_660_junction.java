...
public class ClassImplementsInterface__CO_660_junction extends GenericJunctionActor{
	
	@Override
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		ports = new LinkedList<>();
		ports.add(new PortJunctionRight(getSelf(), name2actor.get("ClassImplementsInterface__CO_656_junction"), this::check_constraint_40));
	}
