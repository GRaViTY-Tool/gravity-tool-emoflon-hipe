...
public class PackageToPGPackage__CO_2053_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		...
		ports.add(new PortJunctionRight(getSelf(), name2actor.get("PackageToPGPackage__CO_2051_junction"), this::check_constraint_144));
	}
	...
	public boolean check_constraint_144(HMatch match) {
		org.gravity.typegraph.basic.TPackage tPackage = (org.gravity.typegraph.basic.TPackage) match.getNodes()[3];
		...
		csp_51.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mPackage.getName(), "java.lang.String"));
		csp_51.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tPackage.getTName(), "java.lang.String"));
		csp_51.solve();
