...
public class ClassInnerAnonClassMember_tInnerClass_classes_incoming_TRG__FILTER_NAC_770_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, AbstractJunctionNode node) {
		...
		ports.add(new PortJunction(getSelf(), name2actor.get("ClassInnerAnonClassMember_tInnerClass_classes_incoming_TRG__FILTER_NAC_production"), this::check_constraint_50));
	}
