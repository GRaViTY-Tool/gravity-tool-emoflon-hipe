...
public class Class__CO_879_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, AbstractJunctionNode node) {
		...
		ports.add(new PortJunctionLeft(getSelf(), name2actor.get("Class__CO_873_junction"), this::check_constraint_61));
	}
