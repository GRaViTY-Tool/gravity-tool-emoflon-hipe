...
public class TypesOrphaned__CO_2604_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, AbstractJunctionNode node) {
		...
		ports.add(new PortJunctionLeft(getSelf(), name2actor.get("TypesOrphaned__CO_2601_junction"), this::check_constraint_206));
	}
	...
	public boolean check_constraint_206(HMatch match) {
		...
		csp_54.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mType.isProxy(), "boolean"));
		csp_54.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tType.isTLib(), "boolean"));
		csp_54.solve();
