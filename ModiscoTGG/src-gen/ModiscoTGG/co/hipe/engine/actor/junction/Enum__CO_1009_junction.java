...
public class Enum__CO_1009_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		...
		ports.add(new PortJunctionLeft(getSelf(), name2actor.get("Enum__CO_1007_junction"), this::check_constraint_70));
	}
