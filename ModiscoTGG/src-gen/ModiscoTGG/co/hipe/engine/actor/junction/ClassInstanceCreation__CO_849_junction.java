...
public class ClassInstanceCreation__CO_849_junction extends GenericJunctionActor{
	
	@Override
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		ports = new LinkedList<>();
		ports.add(new PortJunctionRight(getSelf(), name2actor.get("ClassInstanceCreation__CO_841_junction"), this::check_constraint_58));
	}
