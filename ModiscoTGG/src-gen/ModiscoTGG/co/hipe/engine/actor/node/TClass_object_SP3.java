...
public class TClass_object_SP3 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("TClass_pg_7_reference"), this::check_constraint_160));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("TypeGraph_classes_8_reference"), this::check_constraint_177));
	}
	...
	public boolean check_constraint_160(org.gravity.typegraph.basic.TClass tPrimitiveClass) {
		return String.valueOf(tPrimitiveClass.getTName()).equals("char") && tPrimitiveClass.isTLib()==true;
	}
	
	public boolean check_constraint_177(org.gravity.typegraph.basic.TClass tPrimitiveClass) {
