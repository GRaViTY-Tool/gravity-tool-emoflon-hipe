...
public class AbstractTypeDeclaration_object_SP0 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.AbstractTypeDeclaration>(getSelf(), name2actor.get("AbstractTypeDeclaration_bodyDeclarations_10_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.AbstractTypeDeclaration>(getSelf(), name2actor.get("AbstractTypeDeclaration_bodyDeclarations_4_reference"), this::returnTrue));
