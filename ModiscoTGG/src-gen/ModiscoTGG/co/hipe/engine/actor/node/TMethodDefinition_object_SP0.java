...
public class TMethodDefinition_object_SP0 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TMethodDefinition>(getSelf(), name2actor.get("MDefinitionToTMember_target_1_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TMethodDefinition>(getSelf(), name2actor.get("TCall_tTarget_4_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TMethodDefinition>(getSelf(), name2actor.get("TMethodDefinition_returnType_0_reference"), this::returnTrue));
