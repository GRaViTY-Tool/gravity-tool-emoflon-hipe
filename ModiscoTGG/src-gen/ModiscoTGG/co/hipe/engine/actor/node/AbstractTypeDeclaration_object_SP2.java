...
public class AbstractTypeDeclaration_object_SP2 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.AbstractTypeDeclaration>(getSelf(), name2actor.get("AbstractTypeDeclaration_bodyDeclarations_2_reference"), this::returnTrue));
