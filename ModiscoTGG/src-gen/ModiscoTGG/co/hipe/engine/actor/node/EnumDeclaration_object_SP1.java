...
public class EnumDeclaration_object_SP1 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.EnumDeclaration>> ports;		
		
	public EnumDeclaration_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.eclipse.modisco.java.EnumDeclaration>(getSelf(), name2actor.get("AbstractTypeDeclaration_bodyDeclarations_9_reference"), this::returnTrue));
		...
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.EnumDeclaration>(getSelf(), name2actor.get("EnumDeclaration_package_2_reference"), this::returnTrue));
	}
