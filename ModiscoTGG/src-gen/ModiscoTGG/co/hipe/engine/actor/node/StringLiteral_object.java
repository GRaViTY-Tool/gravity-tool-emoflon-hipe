...
public class StringLiteral_object extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.StringLiteral>> ports;		
		
	public StringLiteral_object() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.eclipse.modisco.java.StringLiteral>(getSelf(), name2actor.get("AnnotationMemberValuePair_value_5_reference"), this::returnTrue));
		...
		ports.add(new PortNodeRight<org.eclipse.modisco.java.StringLiteral>(getSelf(), name2actor.get("StringLiteralToTTextNode_source_0_reference"), this::returnTrue));
	}
