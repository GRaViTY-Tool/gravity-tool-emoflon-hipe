...
public class MFieldName_object extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MFieldName>> ports;		
		
	public MFieldName_object() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.modisco.MFieldName>(getSelf(), name2actor.get("MFieldNameToTField_source_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.modisco.MFieldName>(getSelf(), name2actor.get("MFieldName_mSignatures_0_reference"), this::returnTrue));
