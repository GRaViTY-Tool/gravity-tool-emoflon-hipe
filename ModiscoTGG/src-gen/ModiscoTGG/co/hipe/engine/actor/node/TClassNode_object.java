...
public class TClassNode_object extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.annotations.TClassNode>> ports;		
		
	public TClassNode_object() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.annotations.TClassNode>(getSelf(), name2actor.get("TClassNode_tClass_0_reference"), this::returnTrue));
	}
