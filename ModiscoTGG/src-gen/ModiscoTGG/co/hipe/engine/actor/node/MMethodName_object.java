...
public class MMethodName_object extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MMethodName>> ports;		
		
	public MMethodName_object() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.modisco.MMethodName>(getSelf(), name2actor.get("MMethodNameToTMethod_source_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.modisco.MMethodName>(getSelf(), name2actor.get("MMethodName_mSignatures_1_reference"), this::returnTrue));
	}
