...
public class TypeGraph_object_SP3 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TypeGraph>(getSelf(), name2actor.get("TClass_pg_13_reference"), this::returnTrue));
		...
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TypeGraph>(getSelf(), name2actor.get("TypeGraph_interfaces_0_reference"), this::returnTrue));
	}
