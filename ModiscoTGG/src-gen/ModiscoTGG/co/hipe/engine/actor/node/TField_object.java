...
public class TField_object extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TField>> ports;		
		
	public TField_object() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TField>(getSelf(), name2actor.get("MFieldNameToTField_target_0_reference"), this::returnTrue));
		...
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TField>(getSelf(), name2actor.get("TField_signatures_0_reference"), this::returnTrue));
	}
