...
public class TFieldDefinition_object_SP1 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TFieldDefinition>(getSelf(), name2actor.get("ASTNodeToTAnnotatable_target_4_reference"), this::returnTrue));
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TFieldDefinition>(getSelf(), name2actor.get("TWrite_tTarget_3_reference"), this::returnTrue));
	}
