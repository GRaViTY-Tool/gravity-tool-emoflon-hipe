...
public class TClass_object_SP10 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TClass>> ports;		
		
	public TClass_object_SP10() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("PrimitiveTypeToTClass_target_4_reference"), this::check_constraint_167));
		...
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("TClass_pg_13_reference"), this::check_constraint_184));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("TypeGraph_classes_1_reference"), this::check_constraint_28));
	}
	...
	public boolean check_constraint_167(org.gravity.typegraph.basic.TClass tPrimitiveClass) {
		return String.valueOf(tPrimitiveClass.getTName()).equals("float") && tPrimitiveClass.isTLib()==true;
	}
	
	public boolean check_constraint_184(org.gravity.typegraph.basic.TClass tPrimitiveClass) {
		return String.valueOf(tPrimitiveClass.getTName()).equals("void") && tPrimitiveClass.isTLib()==true;
	}
	
	public boolean check_constraint_28(org.gravity.typegraph.basic.TClass tAnonymous) {
