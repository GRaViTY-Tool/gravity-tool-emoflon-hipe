...
public class MMethodInvocation_object_SP0 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.modisco.MMethodInvocation>(getSelf(), name2actor.get("MAbstractMethodDefinition_usages_3_reference"), this::returnTrue));
		...
		ports.add(new PortNodeLeft<org.gravity.modisco.MMethodInvocation>(getSelf(), name2actor.get("MMethodInvocation_mStaticType_0_reference"), this::returnTrue));
	}
