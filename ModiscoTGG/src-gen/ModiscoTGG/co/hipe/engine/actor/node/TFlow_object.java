...
public class TFlow_object extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TFlow>(getSelf(), name2actor.get("MFlowToTFlow_target_0_reference"), this::returnTrue));
		...
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TFlow>(getSelf(), name2actor.get("TFlow_incomingFlows_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TFlow>(getSelf(), name2actor.get("TFlow_outgoingFlows_0_reference"), this::returnTrue));
	}
