...
public class NumberLiteral_object extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.NumberLiteral>> ports;		
		
	public NumberLiteral_object() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.eclipse.modisco.java.NumberLiteral>(getSelf(), name2actor.get("AnnotationMemberValuePair_value_4_reference"), this::returnTrue));
		...
		ports.add(new PortNodeRight<org.eclipse.modisco.java.NumberLiteral>(getSelf(), name2actor.get("NumberLiteralToTNumberNode_source_0_reference"), this::returnTrue));
	}
