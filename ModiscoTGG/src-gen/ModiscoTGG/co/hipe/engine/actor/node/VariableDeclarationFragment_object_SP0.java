...
public class VariableDeclarationFragment_object_SP0 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.VariableDeclarationFragment>> ports;		
		
	public VariableDeclarationFragment_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.eclipse.modisco.java.VariableDeclarationFragment>(getSelf(), name2actor.get("MSingleVariableAccess_variable_1_reference"), this::returnTrue));
