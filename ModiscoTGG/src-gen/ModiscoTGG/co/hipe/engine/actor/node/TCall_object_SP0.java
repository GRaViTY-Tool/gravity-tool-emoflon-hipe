...
public class TCall_object_SP0 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TCall>(getSelf(), name2actor.get("AbstractMethodInvocationToTAccess_target_0_reference"), this::returnTrue));
		...
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TCall>(getSelf(), name2actor.get("TCall_tSource_4_reference"), this::returnTrue));
	}
