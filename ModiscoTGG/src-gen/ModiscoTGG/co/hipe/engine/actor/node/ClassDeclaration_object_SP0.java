...
public class ClassDeclaration_object_SP0 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.ClassDeclaration>(getSelf(), name2actor.get("ClassDeclaration_bodyDeclarations_6_reference"), this::returnTrue));
		...
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.ClassDeclaration>(getSelf(), name2actor.get("ClassDeclaration_usagesInTypeAccess_3_reference"), this::returnTrue));
