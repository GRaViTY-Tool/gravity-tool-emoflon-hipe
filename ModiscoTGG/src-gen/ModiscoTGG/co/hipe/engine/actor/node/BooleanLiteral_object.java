...
public class BooleanLiteral_object extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.BooleanLiteral>> ports;		
		
	public BooleanLiteral_object() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.eclipse.modisco.java.BooleanLiteral>(getSelf(), name2actor.get("AnnotationMemberValuePair_value_2_reference"), this::returnTrue));
		...
		ports.add(new PortNodeRight<org.eclipse.modisco.java.BooleanLiteral>(getSelf(), name2actor.get("BooleanLiteralToTBoolNode_source_0_reference"), this::returnTrue));
	}
