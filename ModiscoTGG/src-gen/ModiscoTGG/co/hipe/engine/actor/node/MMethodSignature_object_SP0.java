...
public class MMethodSignature_object_SP0 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.modisco.MMethodSignature>(getSelf(), name2actor.get("MAbstractFlowElementToTAbstractFlowElement_source_12_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MMethodSignature>(getSelf(), name2actor.get("MMethodDefinition_mSignature_3_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.modisco.MMethodSignature>(getSelf(), name2actor.get("MMethodSignature_mEntrys_0_reference"), this::returnTrue));
