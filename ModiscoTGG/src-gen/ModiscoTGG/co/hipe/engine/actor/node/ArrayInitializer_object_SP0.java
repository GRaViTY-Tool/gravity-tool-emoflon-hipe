...
public class ArrayInitializer_object_SP0 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.ArrayInitializer>(getSelf(), name2actor.get("ArrayInitializer_expressions_1_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.ArrayInitializer>(getSelf(), name2actor.get("ArrayInitializer_expressions_3_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.ArrayInitializer>(getSelf(), name2actor.get("ArrayInitializer_expressions_5_reference"), this::returnTrue));
	}
