...
public class MMethodDefinition_object_SP0 extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MMethodDefinition>> ports;		
		
	public MMethodDefinition_object_SP0() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeLeft<org.gravity.modisco.MMethodDefinition>(getSelf(), name2actor.get("MMethodDefinition_redefinitions_0_reference"), this::returnTrue));
