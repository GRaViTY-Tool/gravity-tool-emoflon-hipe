...
public class MFlow_object extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.modisco.MFlow>(getSelf(), name2actor.get("MAbstractFlowElement_incomingFlows_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MFlow>(getSelf(), name2actor.get("MAbstractFlowElement_outgoingFlows_0_reference"), this::returnTrue));
		...
		ports.add(new PortNodeRight<org.gravity.modisco.MFlow>(getSelf(), name2actor.get("MFlowToTFlow_source_0_reference"), this::returnTrue));
	}
