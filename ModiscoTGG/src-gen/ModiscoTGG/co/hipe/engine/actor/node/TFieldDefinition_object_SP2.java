...
public class TFieldDefinition_object_SP2 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TFieldDefinition>> ports;		
		
	public TFieldDefinition_object_SP2() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TFieldDefinition>(getSelf(), name2actor.get("TReadWrite_tTarget_1_reference"), this::returnTrue));
