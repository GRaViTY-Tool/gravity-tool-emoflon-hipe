...
public class TMethod_object extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TMethod>> ports;		
		
	public TMethod_object() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TMethod>(getSelf(), name2actor.get("MMethodNameToTMethod_target_0_reference"), this::returnTrue));
		...
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TMethod>(getSelf(), name2actor.get("TMethod_signatures_0_reference"), this::returnTrue));
	}
