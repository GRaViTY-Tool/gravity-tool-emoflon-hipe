...
public class MDefinition_object_SP0 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.modisco.MDefinition>(getSelf(), name2actor.get("MAnonymous_bodyDeclarations_5_reference"), this::returnTrue));
		...
		ports.add(new PortNodeLeft<org.gravity.modisco.MDefinition>(getSelf(), name2actor.get("MDefinition_mAbstractFieldAccess_2_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.modisco.MDefinition>(getSelf(), name2actor.get("MDefinition_mMethodInvocations_3_reference"), this::returnTrue));
	}
