...
public class Package_object_SP0 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Package>(getSelf(), name2actor.get("InterfaceDeclaration_package_3_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Package>(getSelf(), name2actor.get("MClass_package_1_reference"), this::returnTrue));
