...
public class TParameter_previous_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodParameterLink__CO_1773_junction"), this::check_constraint_124));
	}	
	...
	public boolean check_constraint_124(EdgeMatch edge) {
