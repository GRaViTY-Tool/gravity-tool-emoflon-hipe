...
public class BooleanLiteralToTBoolNode_source_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueBooleanArray__CO_73_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationMemberValueBoolean__CO_93_junction"), this::returnTrue));
	}	
