...
public class TypeToTAbstractType_source_5_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassInnerClassMember__CO_791_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MemberInClassVisibility__CO_1569_junction"), this::returnTrue));
	}	
