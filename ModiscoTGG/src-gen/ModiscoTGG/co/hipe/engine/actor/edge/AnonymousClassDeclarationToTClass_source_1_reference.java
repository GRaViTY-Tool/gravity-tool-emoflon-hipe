...
public class AnonymousClassDeclarationToTClass_source_1_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnonymousClassTypeClass__CO_443_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnonymousClassTypeInterface__CO_487_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnonymousClass__CO_530_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("LinkDefinitionToAnonymous__CO_1469_junction"), this::returnTrue));
	}	
