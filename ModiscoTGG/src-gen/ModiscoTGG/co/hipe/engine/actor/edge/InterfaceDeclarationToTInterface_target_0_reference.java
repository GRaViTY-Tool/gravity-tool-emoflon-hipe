...
public class InterfaceDeclarationToTInterface_target_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("InterfaceExtendsInterface__CO_1324_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("InterfaceExtendsInterface__CO_1325_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("InterfaceInAnonymous__CO_1368_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("Interface__CO_1438_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("NestedInterfaceInType__CO_1992_junction"), this::returnTrue));
	}	
