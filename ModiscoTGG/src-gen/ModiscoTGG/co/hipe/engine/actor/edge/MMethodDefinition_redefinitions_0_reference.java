...
public class MMethodDefinition_redefinitions_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodOverriding__CO_1738_junction"), this::check_constraint_120));
	}	
	...
	public boolean check_constraint_120(EdgeMatch edge) {
