...
public class TPackage_interfaces_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("InterfaceInAnonymous__CO_2775_nacjunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("InterfaceInAnonymous__CO_2776_nacjunction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("Interface__CO_triangle_1_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("Interface_tType_interfaces_incoming_TRG__FILTER_NAC_1460_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("Interface_tType_interfaces_incoming_TRG__FILTER_NAC_1460_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("NestedInterfaceInType__CO_triangle_1_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("NestedInterfaceInType_tNestedType_interfaces_incoming_TRG__FILTER_NAC_2028_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("NestedInterfaceInType_tNestedType_interfaces_incoming_TRG__FILTER_NAC_2028_junction"), this::returnTrue));
	}	
