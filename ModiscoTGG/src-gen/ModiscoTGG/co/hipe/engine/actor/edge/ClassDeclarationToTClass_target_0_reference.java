...
public class ClassDeclarationToTClass_target_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassExtendsClass__CO_620_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassExtendsClass__CO_621_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassImplementsInterface__CO_658_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassInAnonymous__CO_702_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassInnerAnonClassMember__CO_737_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassInnerClassMember__CO_790_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("Class__CO_880_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("NestedClassInType__CO_1888_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("SyntethicMethod__CO_2529_junction"), this::returnTrue));
	}	
