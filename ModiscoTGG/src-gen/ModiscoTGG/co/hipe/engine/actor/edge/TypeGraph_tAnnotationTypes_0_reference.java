...
public class TypeGraph_tAnnotationTypes_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationTypeNested__CO_triangle_2_triangleJunction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationType__CO_triangle_0_triangleJunction"), this::returnTrue));
	}	
