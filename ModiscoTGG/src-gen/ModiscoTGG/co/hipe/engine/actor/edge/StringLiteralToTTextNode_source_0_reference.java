...
public class StringLiteralToTTextNode_source_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueStringArray__CO_254_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationMemberValueString__CO_274_junction"), this::returnTrue));
	}	
