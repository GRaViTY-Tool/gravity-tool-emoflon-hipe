...
public class AnnotationTypeDeclaration_usagesInTypeAccess_1_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationTypeAccess__CO_308_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationTypeAccess_mAccess_usagesInTypeAccess_incoming_SRC__FILTER_NAC_337_junction"), this::returnTrue));
	}	
