...
public class TypeGraph_interfaces_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdge(getSelf(), name2actor.get("InterfaceInAnonymous__CO_triangle_1_triangleJunction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("Interface__CO_triangle_1_triangleJunction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("NestedInterfaceInType__CO_triangle_2_triangleJunction"), this::returnTrue));
	}	
