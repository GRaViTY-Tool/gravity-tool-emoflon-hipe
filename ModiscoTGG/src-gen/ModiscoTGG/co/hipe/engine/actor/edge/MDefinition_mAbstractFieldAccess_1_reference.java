...
public class MDefinition_mAbstractFieldAccess_1_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessReadWrite_mAccess_mAbstractFieldAccess_incoming_SRC__FILTER_NAC_1091_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("FieldAccessReadWrite_mAccess_mAbstractFieldAccess_incoming_SRC__FILTER_NAC_1091_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessRead_mAccess_mAbstractFieldAccess_incoming_SRC__FILTER_NAC_1144_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("FieldAccessRead_mAccess_mAbstractFieldAccess_incoming_SRC__FILTER_NAC_1144_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessWrite_mAccess_mAbstractFieldAccess_incoming_SRC__FILTER_NAC_1197_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("FieldAccessWrite_mAccess_mAbstractFieldAccess_incoming_SRC__FILTER_NAC_1197_junction"), this::returnTrue));
	}	
