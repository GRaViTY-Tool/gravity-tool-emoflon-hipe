...
public class TAbstractType_tModifier_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("InterfaceMember__CO_2777_nacjunction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MemberInAnnotationVisibility__CO_2780_nacjunction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MemberInClassVisibility__CO_2781_nacjunction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MemberInEnumVisibility__CO_2782_nacjunction"), this::returnTrue));
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("TypesVisibility__CO_2626_junction"), this::returnTrue));
	}	
