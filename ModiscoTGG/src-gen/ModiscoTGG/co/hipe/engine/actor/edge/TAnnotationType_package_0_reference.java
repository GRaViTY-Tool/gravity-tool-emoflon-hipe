...
public class TAnnotationType_package_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationTypeNested__CO_triangle_1_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationType__CO_triangle_0_triangleJunction"), this::returnTrue));
	}	
