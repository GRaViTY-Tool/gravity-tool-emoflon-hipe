...
public class TClass_tAnnotation_2_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("EnumInAnonymous__CO_976_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("Enum__CO_1011_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("NestedEnum__CO_1941_junction"), this::returnTrue));
	}	
