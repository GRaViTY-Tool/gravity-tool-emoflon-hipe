...
public class MSignatureToTSignature_target_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ConstructorDefinition__CO_921_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodDefinition__CO_1630_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodParameterLinkFirst__CO_1760_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodParameterType__CO_1800_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodParameter__CO_1835_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodSignature__CO_1855_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("SignatureReturnType__CO_2410_junction"), this::returnTrue));
	}	
