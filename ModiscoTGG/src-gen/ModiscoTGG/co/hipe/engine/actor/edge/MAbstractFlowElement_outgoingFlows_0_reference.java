...
public class MAbstractFlowElement_outgoingFlows_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("IncomingFlow__CO_1304_junction"), this::check_constraint_97));
	}	
	...
	public boolean check_constraint_97(EdgeMatch edge) {
