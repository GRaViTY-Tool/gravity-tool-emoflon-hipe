...
public class TPackage_pg_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationTypeNested__CO_2703_nacjunction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnonymousClass__CO_2722_nacjunction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassInnerAnonClassMember__CO_2752_nacjunction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassInnerClassMember__CO_2756_nacjunction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("NestedClassInType__CO_2785_nacjunction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("NestedEnum__CO_2788_nacjunction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("NestedInterfaceInType__CO_2791_nacjunction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("PackageToPGPackage__CO_2057_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("SubPackageToPGPackage__CO_2831_nacjunction"), this::returnTrue));
