...
public class MAbstractFlowElementToTAbstractFlowElement_target_1_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ConstructorDefinition__CO_912_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodDefinition__CO_1622_junction"), this::returnTrue));
	}	
