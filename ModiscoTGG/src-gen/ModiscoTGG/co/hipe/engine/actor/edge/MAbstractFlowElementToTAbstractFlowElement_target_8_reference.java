...
public class MAbstractFlowElementToTAbstractFlowElement_target_8_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodParameterType__CO_1791_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodParameter__CO_1826_junction"), this::returnTrue));
	}	
