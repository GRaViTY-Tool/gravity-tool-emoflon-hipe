...
public class TInterface_parentInterfaces_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("InterfaceExtendsInterface__CO_1321_junction"), this::check_constraint_99));
	}	
	...
	public boolean check_constraint_99(EdgeMatch edge) {
