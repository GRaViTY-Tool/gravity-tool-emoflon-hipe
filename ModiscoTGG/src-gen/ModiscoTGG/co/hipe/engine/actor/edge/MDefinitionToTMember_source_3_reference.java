...
public class MDefinitionToTMember_source_3_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessReadWrite__CO_1051_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessRead__CO_1104_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessWrite__CO_1157_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldDefinition__CO_1207_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("VariableDeclarationFragment__CO_2667_junction"), this::returnTrue));
	}	
