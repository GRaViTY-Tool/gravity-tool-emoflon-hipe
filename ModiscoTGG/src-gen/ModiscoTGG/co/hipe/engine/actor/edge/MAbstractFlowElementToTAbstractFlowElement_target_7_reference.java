...
public class MAbstractFlowElementToTAbstractFlowElement_target_7_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("Flow__CO_1290_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("IncomingFlow__CO_1309_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("OutgoingFlow__CO_2040_junction"), this::returnTrue));
	}	
