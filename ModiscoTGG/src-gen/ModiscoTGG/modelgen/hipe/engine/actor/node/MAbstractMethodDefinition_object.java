...
public class MAbstractMethodDefinition_object extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MAbstractMethodDefinition>> ports;		
		
	public MAbstractMethodDefinition_object() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.modisco.MAbstractMethodDefinition>(getSelf(), name2actor.get("AnonymousClassDeclaration_bodyDeclarations_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MAbstractMethodDefinition>(getSelf(), name2actor.get("ClassDeclaration_bodyDeclarations_0_reference"), this::returnTrue));
