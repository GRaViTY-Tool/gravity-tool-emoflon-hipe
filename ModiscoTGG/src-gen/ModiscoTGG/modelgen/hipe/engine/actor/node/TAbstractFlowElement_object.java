...
public class TAbstractFlowElement_object extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TAbstractFlowElement>(getSelf(), name2actor.get("MAbstractFlowElementToTAbstractFlowElement_target_0_reference"), this::returnTrue));
	}
