...
public class TAbstractType_object extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TAbstractType>> ports;		
		
	public TAbstractType_object() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TAbstractType>(getSelf(), name2actor.get("TAbstractType_package_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TAbstractType>(getSelf(), name2actor.get("TAbstractType_pg_1_reference"), this::returnTrue));
