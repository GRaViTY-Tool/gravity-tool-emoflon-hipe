...
public class MMethodInvocation_object extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MMethodInvocation>> ports;		
		
	public MMethodInvocation_object() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.modisco.MMethodInvocation>(getSelf(), name2actor.get("AbstractMethodInvocationToTAccess_source_0_reference"), this::returnTrue));
	}
