...
public class TPackage_object extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TPackage>> ports;		
		
	public TPackage_object() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TPackage>(getSelf(), name2actor.get("TAbstractType_package_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TPackage>(getSelf(), name2actor.get("TClass_package_1_reference"), this::returnTrue));
