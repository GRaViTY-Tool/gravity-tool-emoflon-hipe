...
public class EnumDeclaration_object extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.EnumDeclaration>> ports;		
		
	public EnumDeclaration_object() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.EnumDeclaration>(getSelf(), name2actor.get("EnumDeclaration_bodyDeclarations_5_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.EnumDeclaration>(getSelf(), name2actor.get("TypeToTAbstractType_source_5_reference"), this::returnTrue));
	}
