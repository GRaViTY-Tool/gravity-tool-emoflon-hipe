...
public class TMethodDefinition_object extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TMethodDefinition>> ports;		
		
	public TMethodDefinition_object() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TMethodDefinition>(getSelf(), name2actor.get("MDefinitionToTMember_target_2_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TMethodDefinition>(getSelf(), name2actor.get("TMethodDefinition_signature_1_reference"), this::returnTrue));
	}
