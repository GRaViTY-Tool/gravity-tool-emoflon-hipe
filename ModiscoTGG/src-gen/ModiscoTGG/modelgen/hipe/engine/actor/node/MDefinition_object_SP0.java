...
public class MDefinition_object_SP0 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.modisco.MDefinition>(getSelf(), name2actor.get("ClassDeclaration_bodyDeclarations_4_reference"), this::returnTrue));
		...
		ports.add(new PortNodeLeft<org.gravity.modisco.MDefinition>(getSelf(), name2actor.get("MDefinition_mSignature_0_reference"), this::returnTrue));
	}
