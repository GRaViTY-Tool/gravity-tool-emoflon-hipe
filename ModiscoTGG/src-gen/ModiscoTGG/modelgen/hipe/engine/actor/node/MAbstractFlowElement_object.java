...
public class MAbstractFlowElement_object extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.modisco.MAbstractFlowElement>(getSelf(), name2actor.get("MAbstractFlowElementToTAbstractFlowElement_source_0_reference"), this::returnTrue));
	}
