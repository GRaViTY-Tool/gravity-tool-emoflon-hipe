...
public class TAnnotationType_object extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.annotations.TAnnotationType>> ports;		
		
	public TAnnotationType_object() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.annotations.TAnnotationType>(getSelf(), name2actor.get("TAnnotationType_defines_2_reference"), this::returnTrue));
