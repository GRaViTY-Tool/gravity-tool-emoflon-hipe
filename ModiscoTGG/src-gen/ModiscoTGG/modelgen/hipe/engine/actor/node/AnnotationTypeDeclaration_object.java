...
public class AnnotationTypeDeclaration_object extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.AnnotationTypeDeclaration>> ports;		
		
	public AnnotationTypeDeclaration_object() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.AnnotationTypeDeclaration>(getSelf(), name2actor.get("AnnotationTypeDeclaration_bodyDeclarations_3_reference"), this::returnTrue));
