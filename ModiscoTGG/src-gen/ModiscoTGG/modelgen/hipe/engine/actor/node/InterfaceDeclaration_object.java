...
public class InterfaceDeclaration_object extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.InterfaceDeclaration>> ports;		
		
	public InterfaceDeclaration_object() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.InterfaceDeclaration>(getSelf(), name2actor.get("InterfaceDeclaration_bodyDeclarations_2_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.InterfaceDeclaration>(getSelf(), name2actor.get("TypeToTAbstractType_source_4_reference"), this::returnTrue));
	}
