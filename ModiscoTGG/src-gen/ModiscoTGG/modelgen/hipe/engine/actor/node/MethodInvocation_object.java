...
public class MethodInvocation_object extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeMatchRight<org.eclipse.modisco.java.MethodInvocation>(getSelf(), name2actor.get("ArrayInitializerIgnoreExpressionsEdge__GEN_171_junction"), this::returnTrue));
	}
