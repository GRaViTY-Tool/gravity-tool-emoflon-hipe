...
public class MMethodDefinition_object extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MMethodDefinition>> ports;		
		
	public MMethodDefinition_object() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.modisco.MMethodDefinition>(getSelf(), name2actor.get("MDefinitionToTMember_source_3_reference"), this::returnTrue));
	}
