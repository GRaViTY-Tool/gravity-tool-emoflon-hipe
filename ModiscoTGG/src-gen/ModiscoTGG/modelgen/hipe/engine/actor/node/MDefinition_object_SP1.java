...
public class MDefinition_object_SP1 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.modisco.MDefinition>(getSelf(), name2actor.get("AnnotationTypeDeclaration_bodyDeclarations_3_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MDefinition>(getSelf(), name2actor.get("EnumDeclaration_bodyDeclarations_5_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MDefinition>(getSelf(), name2actor.get("InterfaceDeclaration_bodyDeclarations_2_reference"), this::returnTrue));
	}
