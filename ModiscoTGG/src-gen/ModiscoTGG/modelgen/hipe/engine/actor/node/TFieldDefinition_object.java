...
public class TFieldDefinition_object extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TFieldDefinition>> ports;		
		
	public TFieldDefinition_object() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TFieldDefinition>(getSelf(), name2actor.get("MDefinitionToTMember_target_1_reference"), this::returnTrue));
