...
public class ArrayInitializer_object extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.ArrayInitializer>> ports;		
		
	public ArrayInitializer_object() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeMatchLeft<org.eclipse.modisco.java.ArrayInitializer>(getSelf(), name2actor.get("ArrayInitializerIgnoreExpressionsEdge__GEN_171_junction"), this::returnTrue));
	}
