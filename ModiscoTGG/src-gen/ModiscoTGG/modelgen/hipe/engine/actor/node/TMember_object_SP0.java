...
public class TMember_object_SP0 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TMember>(getSelf(), name2actor.get("TClass_defines_3_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TMember>(getSelf(), name2actor.get("TMember_signature_0_reference"), this::returnTrue));
	}
