...
public class ClassDeclaration_object extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.ClassDeclaration>> ports;		
		
	public ClassDeclaration_object() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.ClassDeclaration>(getSelf(), name2actor.get("ClassDeclaration_bodyDeclarations_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.ClassDeclaration>(getSelf(), name2actor.get("ClassDeclaration_bodyDeclarations_4_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.ClassDeclaration>(getSelf(), name2actor.get("TypeToTAbstractType_source_3_reference"), this::returnTrue));
	}
