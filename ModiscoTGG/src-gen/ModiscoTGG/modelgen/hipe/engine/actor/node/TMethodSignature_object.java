...
public class TMethodSignature_object extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TMethodSignature>> ports;		
		
	public TMethodSignature_object() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TMethodSignature>(getSelf(), name2actor.get("TMethodDefinition_signature_1_reference"), this::returnTrue));
	}
