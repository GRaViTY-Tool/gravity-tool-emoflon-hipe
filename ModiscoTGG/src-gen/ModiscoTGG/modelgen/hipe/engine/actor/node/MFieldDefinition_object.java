...
public class MFieldDefinition_object extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MFieldDefinition>> ports;		
		
	public MFieldDefinition_object() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.modisco.MFieldDefinition>(getSelf(), name2actor.get("AbstractTypeDeclaration_bodyDeclarations_1_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MFieldDefinition>(getSelf(), name2actor.get("MDefinitionToTMember_source_2_reference"), this::returnTrue));
