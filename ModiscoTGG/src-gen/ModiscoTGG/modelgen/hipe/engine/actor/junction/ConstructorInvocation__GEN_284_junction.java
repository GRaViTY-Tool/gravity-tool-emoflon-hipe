...
public class ConstructorInvocation__GEN_284_junction extends GenericJunctionActor{
	
	@Override
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		ports = new LinkedList<>();
		ports.add(new PortJunction(getSelf(), name2actor.get("ConstructorInvocation__GEN_production"), this::check_constraint_6));
	}
