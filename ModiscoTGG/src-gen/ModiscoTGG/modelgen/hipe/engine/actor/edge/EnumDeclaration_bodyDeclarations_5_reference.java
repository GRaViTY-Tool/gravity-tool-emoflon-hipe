...
public class EnumDeclaration_bodyDeclarations_5_reference extends AbstractActor {
	...
	public EnumDeclaration_bodyDeclarations_5_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MemberInEnumVisibility__GEN_586_junction"), this::returnTrue));
	}	
