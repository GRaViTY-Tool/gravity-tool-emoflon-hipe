...
public class AnonymousClassDeclarationToTClass_target_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationTypeInAnonymous__GEN_101_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassInAnonymous__GEN_216_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassInnerAnonClassMember__GEN_232_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("EnumInAnonymous__GEN_298_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("InterfaceInAnonymous__GEN_462_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("LinkDefinitionToAnonymous__GEN_499_junction"), this::returnTrue));
	}	
