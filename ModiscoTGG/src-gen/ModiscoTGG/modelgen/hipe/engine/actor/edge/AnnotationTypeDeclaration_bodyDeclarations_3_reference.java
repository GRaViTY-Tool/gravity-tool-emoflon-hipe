...
public class AnnotationTypeDeclaration_bodyDeclarations_3_reference extends AbstractActor {
	...
	public AnnotationTypeDeclaration_bodyDeclarations_3_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MemberInAnnotationVisibility__GEN_551_junction"), this::returnTrue));
	}	
