...
public class AnonymousClassDeclarationToTClass_source_1_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnonymousClassTypeClass__GEN_134_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnonymousClassTypeInterface__GEN_147_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("LinkDefinitionToAnonymous__GEN_499_junction"), this::returnTrue));
	}	
