...
public class AbstractTypeDeclaration_bodyDeclarations_1_reference extends AbstractActor {
	...
	public AbstractTypeDeclaration_bodyDeclarations_1_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessReadWrite__GEN_330_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessRead__GEN_357_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessWrite__GEN_384_junction"), this::returnTrue));
	}	
