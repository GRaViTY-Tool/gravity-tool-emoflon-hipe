...
public class MSignatureToTSignature_target_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ConstructorDefinition__GEN_278_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodDefinition__GEN_597_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodParameterLinkFirst__GEN_656_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodParameterType__GEN_681_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodParameter__GEN_693_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("SignatureReturnType__GEN_846_junction"), this::returnTrue));
	}	
