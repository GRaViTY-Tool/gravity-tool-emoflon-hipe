...
public class ClassDeclaration_bodyDeclarations_0_reference extends AbstractActor {
	...
	public ClassDeclaration_bodyDeclarations_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassInnerClassMember__GEN_243_junction"), this::returnTrue));
	}	
