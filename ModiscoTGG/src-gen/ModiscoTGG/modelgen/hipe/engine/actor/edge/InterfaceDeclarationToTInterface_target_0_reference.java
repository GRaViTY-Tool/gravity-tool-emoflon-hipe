...
public class InterfaceDeclarationToTInterface_target_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("InterfaceExtendsInterface__GEN_449_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("InterfaceExtendsInterface__GEN_450_junction"), this::returnTrue));
	}	
