...
public class TypeToTAbstractType_source_3_reference extends AbstractActor {
	...
	public TypeToTAbstractType_source_3_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassInnerClassMember__GEN_247_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MemberInClassVisibility__GEN_569_junction"), this::returnTrue));
	}	
