...
public class AbstractMethodInvocationToTAccess_source_0_reference extends AbstractActor {
	...
	public AbstractMethodInvocationToTAccess_source_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodInvocationStaticType__GEN_610_junction"), this::returnTrue));
	}	
