...
public class AnnotationToTAnnotation_source_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberKey__GEN_1_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationTypeAccess__GEN_88_junction"), this::returnTrue));
	}	
