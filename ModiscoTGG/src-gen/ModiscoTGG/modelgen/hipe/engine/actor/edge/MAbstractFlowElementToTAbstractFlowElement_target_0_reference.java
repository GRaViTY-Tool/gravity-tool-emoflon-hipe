...
public class MAbstractFlowElementToTAbstractFlowElement_target_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("Flow__GEN_429_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("IncomingFlow__GEN_437_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("OutgoingFlow__GEN_746_junction"), this::returnTrue));
	}	
