...
public class TClass_defines_3_reference extends AbstractActor {
	...
	public TClass_defines_3_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MemberInClassVisibility__GEN_564_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MemberInEnumVisibility__GEN_581_junction"), this::returnTrue));
	}	
