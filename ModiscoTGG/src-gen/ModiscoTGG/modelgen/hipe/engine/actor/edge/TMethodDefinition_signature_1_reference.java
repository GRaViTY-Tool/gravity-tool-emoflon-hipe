...
public class TMethodDefinition_signature_1_reference extends AbstractActor {
	...
	public TMethodDefinition_signature_1_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("SyntethicMethod__GEN_895_junction"), this::returnTrue));
	}	
