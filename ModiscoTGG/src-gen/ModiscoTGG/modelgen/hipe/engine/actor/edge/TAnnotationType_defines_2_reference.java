...
public class TAnnotationType_defines_2_reference extends AbstractActor {
	...
	public TAnnotationType_defines_2_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MemberInAnnotationVisibility__GEN_552_junction"), this::returnTrue));
	}	
