...
public class InterfaceDeclaration_bodyDeclarations_2_reference extends AbstractActor {
	...
	public InterfaceDeclaration_bodyDeclarations_2_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("InterfaceMember__GEN_478_junction"), this::returnTrue));
	}	
