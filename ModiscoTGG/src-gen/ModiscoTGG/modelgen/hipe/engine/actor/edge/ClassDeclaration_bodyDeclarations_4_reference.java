...
public class ClassDeclaration_bodyDeclarations_4_reference extends AbstractActor {
	...
	public ClassDeclaration_bodyDeclarations_4_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MemberInClassVisibility__GEN_569_junction"), this::returnTrue));
	}	
