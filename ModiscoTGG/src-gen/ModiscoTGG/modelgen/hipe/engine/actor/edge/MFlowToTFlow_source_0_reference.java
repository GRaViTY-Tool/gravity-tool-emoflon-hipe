...
public class MFlowToTFlow_source_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("IncomingFlow__GEN_436_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("OutgoingFlow__GEN_745_junction"), this::returnTrue));
	}	
