...
public class AnonymousClassDeclarationToTClass_target_1_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnonymousClassTypeClass__GEN_134_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnonymousClassTypeInterface__GEN_147_junction"), this::returnTrue));
	}	
