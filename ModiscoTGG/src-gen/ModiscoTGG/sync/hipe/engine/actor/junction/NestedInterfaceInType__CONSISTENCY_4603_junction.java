...
public class NestedInterfaceInType__CONSISTENCY_4603_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, AbstractJunctionNode node) {
		...
		ports.add(new PortJunctionLeft(getSelf(), name2actor.get("NestedInterfaceInType__CONSISTENCY_6336_nacjunction"), this::check_constraint_208));
	}
	...
	public boolean check_constraint_208(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.AddSuffix csp_55 = new org.emoflon.ibex.tgg.operational.csp.constraints.AddSuffix();
		csp_55.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, eOuterType.getName(), "java.lang.String"));
		csp_55.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "$", "java.lang.String"));
		csp_55.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tNestedPackage.getTName(), "java.lang.String"));
		csp_55.solve();
