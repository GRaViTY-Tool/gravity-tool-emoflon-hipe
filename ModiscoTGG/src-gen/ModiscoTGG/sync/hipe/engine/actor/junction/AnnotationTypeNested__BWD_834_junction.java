...
public class AnnotationTypeNested__BWD_834_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		...
		ports.add(new PortJunctionLeft(getSelf(), name2actor.get("AnnotationTypeNested__BWD_6157_nacjunction"), this::check_constraint_18));
	}
	...
	public boolean check_constraint_18(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.AddSuffix csp_9 = new org.emoflon.ibex.tgg.operational.csp.constraints.AddSuffix();
		csp_9.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, eOuterType.getName(), "java.lang.String"));
		...
		csp_9.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tNestedPackage.getTName(), "java.lang.String"));
		csp_9.solve();
