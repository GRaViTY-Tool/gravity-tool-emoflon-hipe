...
public class NestedEnum__BWD_4470_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		...
		ports.add(new PortJunctionRight(getSelf(), name2actor.get("NestedEnum__BWD_4468_junction"), this::check_constraint_196));
	}
	...
	public boolean check_constraint_196(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.AddSuffix csp_50 = new org.emoflon.ibex.tgg.operational.csp.constraints.AddSuffix();
		csp_50.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, eOuterType.getName(), "java.lang.String"));
		csp_50.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "$", "java.lang.String"));
		csp_50.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tNestedPackage.getTName(), "java.lang.String"));
		csp_50.solve();
		
		boolean predicate = csp_50.isSatisfied();
