...
public class SuperConstructorInvocation__BWD_5576_junction extends GenericJunctionActor{
	
	@Override
	protected void initializePorts(Map<String, ActorRef> name2actor, AbstractJunctionNode node) {
		ports = new LinkedList<>();
		ports.add(new PortJunction(getSelf(), name2actor.get("SuperConstructorInvocation__BWD_production"), this::check_constraint_279));
	}
