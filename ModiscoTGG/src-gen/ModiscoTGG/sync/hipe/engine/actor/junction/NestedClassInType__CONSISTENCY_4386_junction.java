...
public class NestedClassInType__CONSISTENCY_4386_junction extends GenericJunctionActor{
	...
	public boolean check_constraint_192(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.AddSuffix csp_47 = new org.emoflon.ibex.tgg.operational.csp.constraints.AddSuffix();
		csp_47.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, eOuterType.getName(), "java.lang.String"));
		csp_47.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "$", "java.lang.String"));
		csp_47.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tNestedPackage.getTName(), "java.lang.String"));
		csp_47.solve();
		
		boolean predicate = csp_47.isSatisfied();
