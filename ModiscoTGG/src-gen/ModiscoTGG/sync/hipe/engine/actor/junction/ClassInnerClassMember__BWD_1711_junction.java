...
public class ClassInnerClassMember__BWD_1711_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, AbstractJunctionNode node) {
		...
		ports.add(new PortJunctionLeft(getSelf(), name2actor.get("ClassInnerClassMember__BWD_1704_junction"), this::check_constraint_72));
	}
	...
	public boolean check_constraint_72(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.AddSuffix csp_22 = new org.emoflon.ibex.tgg.operational.csp.constraints.AddSuffix();
		csp_22.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tOuterClass.getTName(), "java.lang.String"));
		csp_22.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "$1", "java.lang.String"));
		csp_22.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tInnerPackage.getTName(), "java.lang.String"));
		csp_22.solve();
