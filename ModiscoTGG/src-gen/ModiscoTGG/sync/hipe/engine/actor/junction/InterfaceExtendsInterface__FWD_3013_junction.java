...
public class InterfaceExtendsInterface__FWD_3013_junction extends GenericJunctionActor{
	
	@Override
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		ports = new LinkedList<>();
		ports.add(new PortJunctionRight(getSelf(), name2actor.get("InterfaceExtendsInterface__FWD_3009_junction"), this::check_constraint_152));
	}
