...
public class TAnnotationValue_tValue_3_reference extends AbstractActor {
	...
	public TAnnotationValue_tValue_3_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueNumberArray__BWD_455_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueNumberArray__CONSISTENCY_464_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueNumber__BWD_505_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueNumber__CONSISTENCY_514_junction"), this::returnTrue));
	}	
