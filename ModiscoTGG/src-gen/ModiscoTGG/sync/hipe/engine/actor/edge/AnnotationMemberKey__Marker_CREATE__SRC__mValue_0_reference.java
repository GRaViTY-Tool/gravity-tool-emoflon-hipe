...
public class AnnotationMemberKey__Marker_CREATE__SRC__mValue_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.AnnotationMemberValuePair, Set<ModiscoTGG.AnnotationMemberKey__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberKey__Marker_CREATE__SRC__mValue_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationMemberKey__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberKey__Marker source, org.eclipse.modisco.java.AnnotationMemberValuePair target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationMemberKey__Marker> message) {
		...
		org.eclipse.modisco.java.AnnotationMemberValuePair target = (org.eclipse.modisco.java.AnnotationMemberValuePair) message.input.getCREATE__SRC__mValue();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberKey__Marker, org.eclipse.modisco.java.AnnotationMemberValuePair> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberKey__Marker, org.eclipse.modisco.java.AnnotationMemberValuePair> message) {
