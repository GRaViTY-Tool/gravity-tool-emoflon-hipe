...
public class InterfaceDeclaration_bodyDeclarations_3_reference extends AbstractActor {
	...
	public InterfaceDeclaration_bodyDeclarations_3_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("InterfaceMember__BWD_3125_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("InterfaceMember__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("InterfaceMember__FWD_3183_junction"), this::returnTrue));
	}	
