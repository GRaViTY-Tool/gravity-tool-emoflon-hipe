...
public class InterfaceMember__Marker_CREATE__TRG__tModifier_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TModifier, Set<ModiscoTGG.InterfaceMember__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public InterfaceMember__Marker_CREATE__TRG__tModifier_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("InterfaceMember__CONSISTENCY_triangle_6_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.InterfaceMember__Marker source, org.gravity.typegraph.basic.TModifier target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.InterfaceMember__Marker, org.gravity.typegraph.basic.TModifier> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.InterfaceMember__Marker, org.gravity.typegraph.basic.TModifier> message) {
