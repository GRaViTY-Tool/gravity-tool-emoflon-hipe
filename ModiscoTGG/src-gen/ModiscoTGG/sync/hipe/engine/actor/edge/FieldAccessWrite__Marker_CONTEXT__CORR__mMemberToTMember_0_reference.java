...
public class FieldAccessWrite__Marker_CONTEXT__CORR__mMemberToTMember_0_reference extends AbstractActor {
	...
	public FieldAccessWrite__Marker_CONTEXT__CORR__mMemberToTMember_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("FieldAccessWrite__CONSISTENCY_triangle_10_triangleJunction"), this::returnTrue));
	}	
