...
public class MAbstractMethodDefinition_usages_3_reference extends AbstractActor {
	...
	public MAbstractMethodDefinition_usages_3_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodInvocation__CONSISTENCY_3898_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodInvocation__FWD_3943_junction"), this::returnTrue));
	}	
