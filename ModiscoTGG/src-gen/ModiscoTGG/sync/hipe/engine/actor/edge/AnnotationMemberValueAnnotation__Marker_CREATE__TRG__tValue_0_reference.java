...
public class AnnotationMemberValueAnnotation__Marker_CREATE__TRG__tValue_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.annotations.TAnnotation, Set<ModiscoTGG.AnnotationMemberValueAnnotation__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueAnnotation__Marker_CREATE__TRG__tValue_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationMemberValueAnnotation__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueAnnotation__Marker source, org.gravity.typegraph.basic.annotations.TAnnotation target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueAnnotation__Marker, org.gravity.typegraph.basic.annotations.TAnnotation> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueAnnotation__Marker, org.gravity.typegraph.basic.annotations.TAnnotation> message) {
