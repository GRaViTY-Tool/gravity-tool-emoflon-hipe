...
public class ClassDeclaration_bodyDeclarations_1_reference extends AbstractActor {
	...
	public ClassDeclaration_bodyDeclarations_1_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassInnerClassMember__BWD_1703_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassInnerClassMember__CONSISTENCY_triangle_8_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassInnerClassMember__FWD_1784_junction"), this::returnTrue));
	}	
