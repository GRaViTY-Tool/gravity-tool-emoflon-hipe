...
public class TInterface_outerType_4_reference extends AbstractActor {
	...
	public TInterface_outerType_4_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("InterfaceInAnonymous__BWD_triangle_1_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("InterfaceInAnonymous__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
