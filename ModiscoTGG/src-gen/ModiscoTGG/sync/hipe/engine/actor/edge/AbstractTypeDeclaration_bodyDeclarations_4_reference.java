...
public class AbstractTypeDeclaration_bodyDeclarations_4_reference extends AbstractActor {
	...
	public AbstractTypeDeclaration_bodyDeclarations_4_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("LinkDefinitionToType__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("LinkDefinitionToType__FWD_3445_junction"), this::returnTrue));
	}	
