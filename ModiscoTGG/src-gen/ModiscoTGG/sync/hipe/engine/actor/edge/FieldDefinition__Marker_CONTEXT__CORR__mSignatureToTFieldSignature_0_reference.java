...
public class FieldDefinition__Marker_CONTEXT__CORR__mSignatureToTFieldSignature_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.MSignatureToTSignature, Set<ModiscoTGG.FieldDefinition__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public FieldDefinition__Marker_CONTEXT__CORR__mSignatureToTFieldSignature_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("FieldDefinition__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.FieldDefinition__Marker source, ModiscoTGG.MSignatureToTSignature target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.FieldDefinition__Marker> message) {
		...
		ModiscoTGG.MSignatureToTSignature target = (ModiscoTGG.MSignatureToTSignature) message.input.getCONTEXT__CORR__mSignatureToTFieldSignature();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.FieldDefinition__Marker, ModiscoTGG.MSignatureToTSignature> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.FieldDefinition__Marker, ModiscoTGG.MSignatureToTSignature> message) {
