...
public class MAbstractMethodDefinition_usages_0_reference extends AbstractActor {
	...
	public MAbstractMethodDefinition_usages_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassInstanceCreation__CONSISTENCY_1832_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassInstanceCreation__FWD_1877_junction"), this::returnTrue));
	}	
