...
public class BooleanLiteralToTBoolNode_source_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.BooleanLiteral, Set<ModiscoTGG.BooleanLiteralToTBoolNode>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public BooleanLiteralToTBoolNode_source_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueBooleanArray__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueBoolean__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.BooleanLiteralToTBoolNode source, org.eclipse.modisco.java.BooleanLiteral target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.BooleanLiteralToTBoolNode> message) {
		...
		org.eclipse.modisco.java.BooleanLiteral target = (org.eclipse.modisco.java.BooleanLiteral) message.input.getSource();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.BooleanLiteralToTBoolNode, org.eclipse.modisco.java.BooleanLiteral> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.BooleanLiteralToTBoolNode, org.eclipse.modisco.java.BooleanLiteral> message) {
