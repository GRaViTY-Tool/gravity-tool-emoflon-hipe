...
public class AnonymousClassDeclaration_bodyDeclarations_3_reference extends AbstractActor {
	...
	public AnonymousClassDeclaration_bodyDeclarations_3_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("EnumInAnonymous__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("EnumInAnonymous__FWD_2173_junction"), this::returnTrue));
	}	
