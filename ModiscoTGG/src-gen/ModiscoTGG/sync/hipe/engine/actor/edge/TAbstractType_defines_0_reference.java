...
public class TAbstractType_defines_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TMember, Set<org.gravity.typegraph.basic.TAbstractType>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public TAbstractType_defines_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessReadWrite__BWD_2282_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessReadWrite__CONSISTENCY_2302_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessReadWrite__FWD_2367_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessRead__BWD_2414_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessRead__CONSISTENCY_2434_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessRead__FWD_2499_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessWrite__BWD_2546_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessWrite__CONSISTENCY_2566_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessWrite__FWD_2631_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, org.gravity.typegraph.basic.TAbstractType source, org.gravity.typegraph.basic.TMember target) {
	...
	private void leftAdded(NodeAddedLeft<org.gravity.typegraph.basic.TAbstractType> message) {
		...
		for(org.gravity.typegraph.basic.TMember target : message.input.getDefines()) {
	...
	private void addReference(ReferenceAdded<org.gravity.typegraph.basic.TAbstractType, org.gravity.typegraph.basic.TMember> message) {
	...
	private void removeReference(ReferenceDeleted<org.gravity.typegraph.basic.TAbstractType, org.gravity.typegraph.basic.TMember> message) {
