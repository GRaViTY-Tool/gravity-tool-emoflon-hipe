...
public class FieldSignature__Marker_CREATE__TRG__tSignature_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TFieldSignature, Set<ModiscoTGG.FieldSignature__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public FieldSignature__Marker_CREATE__TRG__tSignature_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("FieldSignature__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.FieldSignature__Marker source, org.gravity.typegraph.basic.TFieldSignature target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.FieldSignature__Marker> message) {
		...
		org.gravity.typegraph.basic.TFieldSignature target = (org.gravity.typegraph.basic.TFieldSignature) message.input.getCREATE__TRG__tSignature();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.FieldSignature__Marker, org.gravity.typegraph.basic.TFieldSignature> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.FieldSignature__Marker, org.gravity.typegraph.basic.TFieldSignature> message) {
