...
public class AbstractTypeDeclaration_bodyDeclarations_8_reference extends AbstractActor {
	...
	public AbstractTypeDeclaration_bodyDeclarations_8_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("NestedClassInType__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("NestedClassInType__FWD_4445_junction"), this::returnTrue));
	}	
