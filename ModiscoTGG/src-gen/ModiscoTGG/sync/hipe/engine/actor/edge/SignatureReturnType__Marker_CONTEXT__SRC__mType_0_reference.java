...
public class SignatureReturnType__Marker_CONTEXT__SRC__mType_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.Type, Set<ModiscoTGG.SignatureReturnType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public SignatureReturnType__Marker_CONTEXT__SRC__mType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("SignatureReturnType__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.SignatureReturnType__Marker source, org.eclipse.modisco.java.Type target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.SignatureReturnType__Marker, org.eclipse.modisco.java.Type> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.SignatureReturnType__Marker, org.eclipse.modisco.java.Type> message) {
