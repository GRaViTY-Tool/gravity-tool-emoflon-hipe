...
public class AnonymousClassDeclaration_bodyDeclarations_0_reference extends AbstractActor {
	...
	public AnonymousClassDeclaration_bodyDeclarations_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationTypeInAnonymous__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationTypeInAnonymous__FWD_822_junction"), this::returnTrue));
	}	
