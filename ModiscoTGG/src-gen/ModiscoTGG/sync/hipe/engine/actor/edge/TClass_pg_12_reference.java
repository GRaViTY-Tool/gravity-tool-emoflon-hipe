...
public class TClass_pg_12_reference extends AbstractActor {
	...
	public TClass_pg_12_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PrimitiveTypeIsShort__BWD_5270_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("PrimitiveTypeIsShort__CONSISTENCY_5280_junction"), this::returnTrue));
	}	
