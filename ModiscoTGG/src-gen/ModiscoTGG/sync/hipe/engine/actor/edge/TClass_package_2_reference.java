...
public class TClass_package_2_reference extends AbstractActor {
	...
	public TClass_package_2_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnonymousClass__BWD_1177_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnonymousClass__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
