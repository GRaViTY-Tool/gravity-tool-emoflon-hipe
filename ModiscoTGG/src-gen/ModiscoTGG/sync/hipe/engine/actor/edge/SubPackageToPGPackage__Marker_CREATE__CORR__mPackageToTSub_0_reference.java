...
public class SubPackageToPGPackage__Marker_CREATE__CORR__mPackageToTSub_0_reference extends AbstractActor {
	...
	public SubPackageToPGPackage__Marker_CREATE__CORR__mPackageToTSub_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("SubPackageToPGPackage__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.SubPackageToPGPackage__Marker> message) {
		...
		ModiscoTGG.PackageToTPackage target = (ModiscoTGG.PackageToTPackage) message.input.getCREATE__CORR__mPackageToTSub();
