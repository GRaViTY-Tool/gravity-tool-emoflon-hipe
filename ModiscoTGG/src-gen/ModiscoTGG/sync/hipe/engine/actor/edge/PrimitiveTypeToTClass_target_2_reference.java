...
public class PrimitiveTypeToTClass_target_2_reference extends AbstractActor {
	...
	public PrimitiveTypeToTClass_target_2_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PrimitiveTypeIsChar__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
