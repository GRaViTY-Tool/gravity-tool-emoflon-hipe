...
public class LinkDefinitionToAnonymous__Marker_CONTEXT__CORR__mTypeToTType_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.AnonymousClassDeclarationToTClass, Set<ModiscoTGG.LinkDefinitionToAnonymous__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public LinkDefinitionToAnonymous__Marker_CONTEXT__CORR__mTypeToTType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("LinkDefinitionToAnonymous__CONSISTENCY_triangle_8_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.LinkDefinitionToAnonymous__Marker source, ModiscoTGG.AnonymousClassDeclarationToTClass target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.LinkDefinitionToAnonymous__Marker> message) {
		...
		ModiscoTGG.AnonymousClassDeclarationToTClass target = (ModiscoTGG.AnonymousClassDeclarationToTClass) message.input.getCONTEXT__CORR__mTypeToTType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.LinkDefinitionToAnonymous__Marker, ModiscoTGG.AnonymousClassDeclarationToTClass> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.LinkDefinitionToAnonymous__Marker, ModiscoTGG.AnonymousClassDeclarationToTClass> message) {
