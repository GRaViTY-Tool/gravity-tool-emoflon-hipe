...
public class ClassImplementsInterface__Marker_CONTEXT__CORR__eSuperInterfaceToTSuperInterface_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.TypeToTAbstractType, Set<ModiscoTGG.ClassImplementsInterface__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ClassImplementsInterface__Marker_CONTEXT__CORR__eSuperInterfaceToTSuperInterface_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassImplementsInterface__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ClassImplementsInterface__Marker source, ModiscoTGG.TypeToTAbstractType target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ClassImplementsInterface__Marker> message) {
		...
		ModiscoTGG.TypeToTAbstractType target = (ModiscoTGG.TypeToTAbstractType) message.input.getCONTEXT__CORR__eSuperInterfaceToTSuperInterface();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ClassImplementsInterface__Marker, ModiscoTGG.TypeToTAbstractType> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ClassImplementsInterface__Marker, ModiscoTGG.TypeToTAbstractType> message) {
