...
public class AnnotationMemberValueAnnotation__Marker_CREATE__CORR__mTypeToTType_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.AnnotationToTAnnotation, Set<ModiscoTGG.AnnotationMemberValueAnnotation__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueAnnotation__Marker_CREATE__CORR__mTypeToTType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationMemberValueAnnotation__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueAnnotation__Marker source, ModiscoTGG.AnnotationToTAnnotation target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueAnnotation__Marker, ModiscoTGG.AnnotationToTAnnotation> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueAnnotation__Marker, ModiscoTGG.AnnotationToTAnnotation> message) {
