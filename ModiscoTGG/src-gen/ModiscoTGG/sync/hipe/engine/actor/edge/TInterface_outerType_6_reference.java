...
public class TInterface_outerType_6_reference extends AbstractActor {
	...
	public TInterface_outerType_6_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("NestedInterfaceInType__BWD_triangle_2_triangleJunction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("NestedInterfaceInType__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
