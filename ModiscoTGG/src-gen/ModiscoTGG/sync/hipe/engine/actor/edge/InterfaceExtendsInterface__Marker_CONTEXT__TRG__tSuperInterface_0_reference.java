...
public class InterfaceExtendsInterface__Marker_CONTEXT__TRG__tSuperInterface_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TInterface, Set<ModiscoTGG.InterfaceExtendsInterface__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public InterfaceExtendsInterface__Marker_CONTEXT__TRG__tSuperInterface_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("InterfaceExtendsInterface__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.InterfaceExtendsInterface__Marker source, org.gravity.typegraph.basic.TInterface target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.InterfaceExtendsInterface__Marker> message) {
		...
		org.gravity.typegraph.basic.TInterface target = (org.gravity.typegraph.basic.TInterface) message.input.getCONTEXT__TRG__tSuperInterface();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.InterfaceExtendsInterface__Marker, org.gravity.typegraph.basic.TInterface> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.InterfaceExtendsInterface__Marker, org.gravity.typegraph.basic.TInterface> message) {
