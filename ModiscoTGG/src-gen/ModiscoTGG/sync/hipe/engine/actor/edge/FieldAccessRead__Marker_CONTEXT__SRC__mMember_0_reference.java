...
public class FieldAccessRead__Marker_CONTEXT__SRC__mMember_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MDefinition, Set<ModiscoTGG.FieldAccessRead__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public FieldAccessRead__Marker_CONTEXT__SRC__mMember_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("FieldAccessRead__CONSISTENCY_triangle_10_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.FieldAccessRead__Marker source, org.gravity.modisco.MDefinition target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.FieldAccessRead__Marker, org.gravity.modisco.MDefinition> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.FieldAccessRead__Marker, org.gravity.modisco.MDefinition> message) {
