...
public class AbstractTypeDeclaration_bodyDeclarations_10_reference extends AbstractActor {
	...
	public AbstractTypeDeclaration_bodyDeclarations_10_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("NestedInterfaceInType__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("NestedInterfaceInType__FWD_4662_junction"), this::returnTrue));
	}	
