...
public class TypeToTAbstractType_source_19_reference extends AbstractActor {
	...
	public TypeToTAbstractType_source_19_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("UnresolvedTypeDeclaration__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
