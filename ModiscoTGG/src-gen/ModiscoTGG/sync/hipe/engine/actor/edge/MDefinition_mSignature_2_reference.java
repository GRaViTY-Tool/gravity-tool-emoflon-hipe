...
public class MDefinition_mSignature_2_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MSignature, Set<org.gravity.modisco.MDefinition>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MDefinition_mSignature_2_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("LinkDefinitionToAnonymous__BWD_3283_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("LinkDefinitionToAnonymous__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("LinkDefinitionToAnonymous__FWD_3349_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("LinkDefinitionToType__BWD_3376_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("LinkDefinitionToType__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("LinkDefinitionToType__FWD_3442_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, org.gravity.modisco.MDefinition source, org.gravity.modisco.MSignature target) {
	...
	private void leftAdded(NodeAddedLeft<org.gravity.modisco.MDefinition> message) {
		...
		org.gravity.modisco.MSignature target = (org.gravity.modisco.MSignature) message.input.getMSignature();
	...
	private void addReference(ReferenceAdded<org.gravity.modisco.MDefinition, org.gravity.modisco.MSignature> message) {
	...
	private void removeReference(ReferenceDeleted<org.gravity.modisco.MDefinition, org.gravity.modisco.MSignature> message) {
