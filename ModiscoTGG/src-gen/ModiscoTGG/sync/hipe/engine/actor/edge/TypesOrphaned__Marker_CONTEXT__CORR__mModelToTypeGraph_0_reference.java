...
public class TypesOrphaned__Marker_CONTEXT__CORR__mModelToTypeGraph_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.ModelToTypeGraph, Set<ModiscoTGG.TypesOrphaned__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public TypesOrphaned__Marker_CONTEXT__CORR__mModelToTypeGraph_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("TypesOrphaned__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.TypesOrphaned__Marker source, ModiscoTGG.ModelToTypeGraph target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.TypesOrphaned__Marker, ModiscoTGG.ModelToTypeGraph> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.TypesOrphaned__Marker, ModiscoTGG.ModelToTypeGraph> message) {
