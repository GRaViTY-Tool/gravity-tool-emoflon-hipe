...
public class InterfaceInAnonymous__Marker_CREATE__CORR__mInterfaceDeclarationtoTInterface_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.InterfaceDeclarationToTInterface, Set<ModiscoTGG.InterfaceInAnonymous__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public InterfaceInAnonymous__Marker_CREATE__CORR__mInterfaceDeclarationtoTInterface_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("InterfaceInAnonymous__CONSISTENCY_triangle_10_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.InterfaceInAnonymous__Marker source, ModiscoTGG.InterfaceDeclarationToTInterface target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.InterfaceInAnonymous__Marker, ModiscoTGG.InterfaceDeclarationToTInterface> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.InterfaceInAnonymous__Marker, ModiscoTGG.InterfaceDeclarationToTInterface> message) {
