...
public class MMethodDefinition_returnType_1_reference extends AbstractActor {
	...
	public MMethodDefinition_returnType_1_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ReturnType__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ReturnType__FWD_5430_junction"), this::returnTrue));
	}	
