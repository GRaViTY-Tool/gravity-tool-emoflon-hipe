...
public class ClassExtendsClass__Marker_CREATE__SRC__eTypeAccess_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.TypeAccess, Set<ModiscoTGG.ClassExtendsClass__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ClassExtendsClass__Marker_CREATE__SRC__eTypeAccess_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ClassExtendsClass__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ClassExtendsClass__Marker source, org.eclipse.modisco.java.TypeAccess target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ClassExtendsClass__Marker, org.eclipse.modisco.java.TypeAccess> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ClassExtendsClass__Marker, org.eclipse.modisco.java.TypeAccess> message) {
