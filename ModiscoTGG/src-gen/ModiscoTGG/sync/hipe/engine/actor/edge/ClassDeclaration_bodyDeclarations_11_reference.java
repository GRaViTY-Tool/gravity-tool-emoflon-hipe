...
public class ClassDeclaration_bodyDeclarations_11_reference extends AbstractActor {
	...
	public ClassDeclaration_bodyDeclarations_11_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("SyntethicMethod__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("SyntethicMethod__FWD_5810_junction"), this::returnTrue));
	}	
