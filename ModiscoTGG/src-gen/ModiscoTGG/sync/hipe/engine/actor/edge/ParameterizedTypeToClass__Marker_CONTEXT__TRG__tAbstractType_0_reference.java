...
public class ParameterizedTypeToClass__Marker_CONTEXT__TRG__tAbstractType_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TAbstractType, Set<ModiscoTGG.ParameterizedTypeToClass__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ParameterizedTypeToClass__Marker_CONTEXT__TRG__tAbstractType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ParameterizedTypeToClass__CONSISTENCY_triangle_6_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ParameterizedTypeToClass__Marker source, org.gravity.typegraph.basic.TAbstractType target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ParameterizedTypeToClass__Marker> message) {
		...
		org.gravity.typegraph.basic.TAbstractType target = (org.gravity.typegraph.basic.TAbstractType) message.input.getCONTEXT__TRG__tAbstractType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ParameterizedTypeToClass__Marker, org.gravity.typegraph.basic.TAbstractType> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ParameterizedTypeToClass__Marker, org.gravity.typegraph.basic.TAbstractType> message) {
