...
public class AnnotationMemberValueBoolean__Marker_CREATE__CORR__mValueToTValue_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.BooleanLiteralToTBoolNode, Set<ModiscoTGG.AnnotationMemberValueBoolean__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueBoolean__Marker_CREATE__CORR__mValueToTValue_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationMemberValueBoolean__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueBoolean__Marker source, ModiscoTGG.BooleanLiteralToTBoolNode target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueBoolean__Marker, ModiscoTGG.BooleanLiteralToTBoolNode> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueBoolean__Marker, ModiscoTGG.BooleanLiteralToTBoolNode> message) {
