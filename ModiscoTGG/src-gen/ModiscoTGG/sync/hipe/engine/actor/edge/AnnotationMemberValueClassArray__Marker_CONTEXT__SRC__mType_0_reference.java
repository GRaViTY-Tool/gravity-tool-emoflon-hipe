...
public class AnnotationMemberValueClassArray__Marker_CONTEXT__SRC__mType_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.Type, Set<ModiscoTGG.AnnotationMemberValueClassArray__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueClassArray__Marker_CONTEXT__SRC__mType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationMemberValueClassArray__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueClassArray__Marker source, org.eclipse.modisco.java.Type target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueClassArray__Marker, org.eclipse.modisco.java.Type> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueClassArray__Marker, org.eclipse.modisco.java.Type> message) {
