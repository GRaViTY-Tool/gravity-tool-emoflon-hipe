...
public class Interface__Marker_CONTEXT__CORR__mPackageToTPackage_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.PackageToTPackage, Set<ModiscoTGG.Interface__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public Interface__Marker_CONTEXT__CORR__mPackageToTPackage_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("Interface__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.Interface__Marker source, ModiscoTGG.PackageToTPackage target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.Interface__Marker, ModiscoTGG.PackageToTPackage> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.Interface__Marker, ModiscoTGG.PackageToTPackage> message) {
