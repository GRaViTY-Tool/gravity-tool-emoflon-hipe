...
public class ASTNodeToTAnnotatable_source_1_reference extends AbstractActor {
	...
	public ASTNodeToTAnnotatable_source_1_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationTypeInAnonymous__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationTypeNested__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationType__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
	}	
