...
public class ClassInnerClassMember__Marker_CONTEXT__CORR__eOuterClassToTOuterClass_0_reference extends AbstractActor {
	...
	public ClassInnerClassMember__Marker_CONTEXT__CORR__eOuterClassToTOuterClass_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassInnerClassMember__CONSISTENCY_triangle_12_triangleJunction"), this::returnTrue));
	}	
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ClassInnerClassMember__Marker> message) {
		...
		ModiscoTGG.TypeToTAbstractType target = (ModiscoTGG.TypeToTAbstractType) message.input.getCONTEXT__CORR__eOuterClassToTOuterClass();
