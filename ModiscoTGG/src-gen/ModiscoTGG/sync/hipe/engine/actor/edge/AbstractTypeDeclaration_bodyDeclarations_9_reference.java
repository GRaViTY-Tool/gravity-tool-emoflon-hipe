...
public class AbstractTypeDeclaration_bodyDeclarations_9_reference extends AbstractActor {
	...
	public AbstractTypeDeclaration_bodyDeclarations_9_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("NestedEnum__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("NestedEnum__FWD_4554_junction"), this::returnTrue));
	}	
