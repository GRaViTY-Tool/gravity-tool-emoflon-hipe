...
public class TReadWrite_tSource_1_reference extends AbstractActor {
	...
	public TReadWrite_tSource_1_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessReadWrite__BWD_2273_junction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("FieldAccessReadWrite__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
