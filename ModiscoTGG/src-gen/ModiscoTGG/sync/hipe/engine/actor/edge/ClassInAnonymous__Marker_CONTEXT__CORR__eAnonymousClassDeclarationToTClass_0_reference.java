...
public class ClassInAnonymous__Marker_CONTEXT__CORR__eAnonymousClassDeclarationToTClass_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.AnonymousClassDeclarationToTClass, Set<ModiscoTGG.ClassInAnonymous__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ClassInAnonymous__Marker_CONTEXT__CORR__eAnonymousClassDeclarationToTClass_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassInAnonymous__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ClassInAnonymous__Marker source, ModiscoTGG.AnonymousClassDeclarationToTClass target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ClassInAnonymous__Marker, ModiscoTGG.AnonymousClassDeclarationToTClass> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ClassInAnonymous__Marker, ModiscoTGG.AnonymousClassDeclarationToTClass> message) {
