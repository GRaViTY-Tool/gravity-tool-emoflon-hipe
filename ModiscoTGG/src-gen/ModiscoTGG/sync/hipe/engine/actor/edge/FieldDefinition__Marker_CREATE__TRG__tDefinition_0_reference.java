...
public class FieldDefinition__Marker_CREATE__TRG__tDefinition_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TFieldDefinition, Set<ModiscoTGG.FieldDefinition__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public FieldDefinition__Marker_CREATE__TRG__tDefinition_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("FieldDefinition__CONSISTENCY_triangle_6_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.FieldDefinition__Marker source, org.gravity.typegraph.basic.TFieldDefinition target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.FieldDefinition__Marker> message) {
		...
		org.gravity.typegraph.basic.TFieldDefinition target = (org.gravity.typegraph.basic.TFieldDefinition) message.input.getCREATE__TRG__tDefinition();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.FieldDefinition__Marker, org.gravity.typegraph.basic.TFieldDefinition> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.FieldDefinition__Marker, org.gravity.typegraph.basic.TFieldDefinition> message) {
