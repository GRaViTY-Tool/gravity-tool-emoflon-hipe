...
public class TClass_signature_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TSignature, Set<org.gravity.typegraph.basic.TAbstractType>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public TClass_signature_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("LinkDefinitionToAnonymous__BWD_triangle_0_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("LinkDefinitionToAnonymous__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, org.gravity.typegraph.basic.TAbstractType source, org.gravity.typegraph.basic.TSignature target) {
	...
	private void leftAdded(NodeAddedLeft<org.gravity.typegraph.basic.TAbstractType> message) {
		...
		for(org.gravity.typegraph.basic.TSignature target : message.input.getSignature()) {
	...
	private void addReference(ReferenceAdded<org.gravity.typegraph.basic.TAbstractType, org.gravity.typegraph.basic.TSignature> message) {
	...
	private void removeReference(ReferenceDeleted<org.gravity.typegraph.basic.TAbstractType, org.gravity.typegraph.basic.TSignature> message) {
