...
public class MethodInvocation__Marker_CREATE__SRC__invocation_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MMethodInvocation, Set<ModiscoTGG.MethodInvocation__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodInvocation__Marker_CREATE__SRC__invocation_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodInvocation__CONSISTENCY_triangle_8_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodInvocation__Marker source, org.gravity.modisco.MMethodInvocation target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodInvocation__Marker, org.gravity.modisco.MMethodInvocation> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodInvocation__Marker, org.gravity.modisco.MMethodInvocation> message) {
