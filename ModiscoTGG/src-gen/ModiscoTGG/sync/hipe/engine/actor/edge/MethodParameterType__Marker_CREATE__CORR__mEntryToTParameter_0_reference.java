...
public class MethodParameterType__Marker_CREATE__CORR__mEntryToTParameter_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.MEntryToTParameter, Set<ModiscoTGG.MethodParameterType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodParameterType__Marker_CREATE__CORR__mEntryToTParameter_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodParameterType__CONSISTENCY_triangle_9_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodParameterType__Marker source, ModiscoTGG.MEntryToTParameter target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MethodParameterType__Marker> message) {
		...
		ModiscoTGG.MEntryToTParameter target = (ModiscoTGG.MEntryToTParameter) message.input.getCREATE__CORR__mEntryToTParameter();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodParameterType__Marker, ModiscoTGG.MEntryToTParameter> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodParameterType__Marker, ModiscoTGG.MEntryToTParameter> message) {
