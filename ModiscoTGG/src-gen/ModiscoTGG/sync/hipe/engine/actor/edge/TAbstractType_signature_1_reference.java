...
public class TAbstractType_signature_1_reference extends AbstractActor {
	...
	public TAbstractType_signature_1_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("LinkDefinitionToType__BWD_triangle_0_triangleJunction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("LinkDefinitionToType__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
	}	
