...
public class TAnnotation_tValues_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.annotations.TAnnotationValue, Set<org.gravity.typegraph.basic.annotations.TAnnotation>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public TAnnotation_tValues_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberKey__BWD_1_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberKey__CONSISTENCY_10_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, org.gravity.typegraph.basic.annotations.TAnnotation source, org.gravity.typegraph.basic.annotations.TAnnotationValue target) {
	...
	private void leftAdded(NodeAddedLeft<org.gravity.typegraph.basic.annotations.TAnnotation> message) {
		...
		for(org.gravity.typegraph.basic.annotations.TAnnotationValue target : message.input.getTValues()) {
	...
	private void addReference(ReferenceAdded<org.gravity.typegraph.basic.annotations.TAnnotation, org.gravity.typegraph.basic.annotations.TAnnotationValue> message) {
	...
	private void removeReference(ReferenceDeleted<org.gravity.typegraph.basic.annotations.TAnnotation, org.gravity.typegraph.basic.annotations.TAnnotationValue> message) {
