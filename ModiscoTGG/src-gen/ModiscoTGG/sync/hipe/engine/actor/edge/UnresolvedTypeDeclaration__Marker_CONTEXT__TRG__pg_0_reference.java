...
public class UnresolvedTypeDeclaration__Marker_CONTEXT__TRG__pg_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TypeGraph, Set<ModiscoTGG.UnresolvedTypeDeclaration__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public UnresolvedTypeDeclaration__Marker_CONTEXT__TRG__pg_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("UnresolvedTypeDeclaration__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.UnresolvedTypeDeclaration__Marker source, org.gravity.typegraph.basic.TypeGraph target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.UnresolvedTypeDeclaration__Marker> message) {
		...
		org.gravity.typegraph.basic.TypeGraph target = (org.gravity.typegraph.basic.TypeGraph) message.input.getCONTEXT__TRG__pg();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.UnresolvedTypeDeclaration__Marker, org.gravity.typegraph.basic.TypeGraph> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.UnresolvedTypeDeclaration__Marker, org.gravity.typegraph.basic.TypeGraph> message) {
