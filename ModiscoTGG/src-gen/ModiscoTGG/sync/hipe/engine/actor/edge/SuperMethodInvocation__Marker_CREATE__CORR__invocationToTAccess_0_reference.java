...
public class SuperMethodInvocation__Marker_CREATE__CORR__invocationToTAccess_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.AbstractMethodInvocationToTAccess, Set<ModiscoTGG.SuperMethodInvocation__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public SuperMethodInvocation__Marker_CREATE__CORR__invocationToTAccess_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("SuperMethodInvocation__CONSISTENCY_triangle_8_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.SuperMethodInvocation__Marker source, ModiscoTGG.AbstractMethodInvocationToTAccess target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.SuperMethodInvocation__Marker, ModiscoTGG.AbstractMethodInvocationToTAccess> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.SuperMethodInvocation__Marker, ModiscoTGG.AbstractMethodInvocationToTAccess> message) {
