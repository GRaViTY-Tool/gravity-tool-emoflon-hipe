...
public class PackageToPGPackage__Marker_CONTEXT__CORR__mModelToTypeGraph_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.ModelToTypeGraph, Set<ModiscoTGG.PackageToPGPackage__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public PackageToPGPackage__Marker_CONTEXT__CORR__mModelToTypeGraph_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("PackageToPGPackage__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.PackageToPGPackage__Marker source, ModiscoTGG.ModelToTypeGraph target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.PackageToPGPackage__Marker> message) {
		...
		ModiscoTGG.ModelToTypeGraph target = (ModiscoTGG.ModelToTypeGraph) message.input.getCONTEXT__CORR__mModelToTypeGraph();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.PackageToPGPackage__Marker, ModiscoTGG.ModelToTypeGraph> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.PackageToPGPackage__Marker, ModiscoTGG.ModelToTypeGraph> message) {
