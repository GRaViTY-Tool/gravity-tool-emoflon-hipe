...
public class TAnnotatable_tAnnotation_0_reference extends AbstractActor {

	private List<Port<EdgeMatch>> ports;

	private Map<org.gravity.typegraph.basic.annotations.TAnnotatable, Set<EdgeMatch>> sourceElements = new HashMap<org.gravity.typegraph.basic.annotations.TAnnotatable, Set<EdgeMatch>>();
	private Map<org.gravity.typegraph.basic.annotations.TAnnotation, Set<EdgeMatch>> targetElements = new HashMap<org.gravity.typegraph.basic.annotations.TAnnotation, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.gravity.typegraph.basic.annotations.TAnnotation, Set<org.gravity.typegraph.basic.annotations.TAnnotatable>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public TAnnotatable_tAnnotation_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationMemberValueAnnotationArray__BWD_6101_nacjunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationMemberValueAnnotationArray__CONSISTENCY_6103_nacjunction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationMemberValueAnnotationArray_tValue_tAnnotation_incoming_TRG__FILTER_NAC_production"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationMemberValueAnnotation__BWD_6105_nacjunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationMemberValueAnnotation__CONSISTENCY_6107_nacjunction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationMemberValueAnnotation_tValue_tAnnotation_incoming_TRG__FILTER_NAC_production"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationOnBodyDeclaration__BWD_641_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationOnBodyDeclaration__CONSISTENCY_650_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, org.gravity.typegraph.basic.annotations.TAnnotatable source, org.gravity.typegraph.basic.annotations.TAnnotation target) {
	...
	private void addPendingMatch(Object source, Object target) {
		Set<org.gravity.typegraph.basic.annotations.TAnnotatable> sourcePending = pending.get(target);
		if(sourcePending == null) {
			sourcePending = new HashSet<org.gravity.typegraph.basic.annotations.TAnnotatable>();
			pending.put((org.gravity.typegraph.basic.annotations.TAnnotation) target, sourcePending);
		}
		sourcePending.add((org.gravity.typegraph.basic.annotations.TAnnotatable) source);
	}
	
	private void leftAdded(NodeAddedLeft<org.gravity.typegraph.basic.annotations.TAnnotatable> message) {
		...
		for(org.gravity.typegraph.basic.annotations.TAnnotation target : message.input.getTAnnotation()) {
	...
	private void rightAdded(NodeAddedRight<org.gravity.typegraph.basic.annotations.TAnnotation> message) {
		...
		if(pending.containsKey(message.input)) {
			Set<org.gravity.typegraph.basic.annotations.TAnnotatable> pendingsSources = pending.get(message.input);
			for(org.gravity.typegraph.basic.annotations.TAnnotatable source : pendingsSources) {
	...
	private void leftRemoved(NodeDeletedLeft<org.gravity.typegraph.basic.annotations.TAnnotatable> message) {
		...
		for(EdgeMatch match : sourceMatches) {
			...
			Set<org.gravity.typegraph.basic.annotations.TAnnotatable> sourcePending = pending.get(match.target());
	...
	private void rightRemoved(NodeDeletedRight<org.gravity.typegraph.basic.annotations.TAnnotation> message) {
	...
	private void addReference(ReferenceAdded<org.gravity.typegraph.basic.annotations.TAnnotatable, org.gravity.typegraph.basic.annotations.TAnnotation> message) {
	...
	private void removeReference(ReferenceDeleted<org.gravity.typegraph.basic.annotations.TAnnotatable, org.gravity.typegraph.basic.annotations.TAnnotation> message) {
		Set<org.gravity.typegraph.basic.annotations.TAnnotatable> pendingSources = pending.get(message.target);
	...
	private void changeAttribute(AttributeChanged<?> message) {
		...
		if(message.node instanceof org.gravity.typegraph.basic.annotations.TAnnotatable) {
			leftChanged(message);
		}
		else {
