...
public class AnnotationTypeAccess__Marker_CONTEXT__CORR__AnnotationTypeToTAnnotationType_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.TypeToTAbstractType, Set<ModiscoTGG.AnnotationTypeAccess__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationTypeAccess__Marker_CONTEXT__CORR__AnnotationTypeToTAnnotationType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationTypeAccess__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationTypeAccess__Marker source, ModiscoTGG.TypeToTAbstractType target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationTypeAccess__Marker> message) {
		...
		ModiscoTGG.TypeToTAbstractType target = (ModiscoTGG.TypeToTAbstractType) message.input.getCONTEXT__CORR__AnnotationTypeToTAnnotationType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationTypeAccess__Marker, ModiscoTGG.TypeToTAbstractType> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationTypeAccess__Marker, ModiscoTGG.TypeToTAbstractType> message) {
