...
public class TClass_pg_9_reference extends AbstractActor {
	...
	public TClass_pg_9_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PrimitiveTypeIsFloat__BWD_5102_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("PrimitiveTypeIsFloat__CONSISTENCY_5112_junction"), this::returnTrue));
	}	
