...
public class MDefinition_mAbstractFieldAccess_0_reference extends AbstractActor {
	...
	public MDefinition_mAbstractFieldAccess_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessReadWrite__CONSISTENCY_triangle_6_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("FieldAccessReadWrite__FWD_2366_junction"), this::returnTrue));
	}	
