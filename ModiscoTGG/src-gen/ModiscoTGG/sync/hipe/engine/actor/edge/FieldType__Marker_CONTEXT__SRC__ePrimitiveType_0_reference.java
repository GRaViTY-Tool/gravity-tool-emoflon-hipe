...
public class FieldType__Marker_CONTEXT__SRC__ePrimitiveType_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.Type, Set<ModiscoTGG.FieldType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public FieldType__Marker_CONTEXT__SRC__ePrimitiveType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("FieldType__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.FieldType__Marker source, org.eclipse.modisco.java.Type target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.FieldType__Marker> message) {
		...
		org.eclipse.modisco.java.Type target = (org.eclipse.modisco.java.Type) message.input.getCONTEXT__SRC__ePrimitiveType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.FieldType__Marker, org.eclipse.modisco.java.Type> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.FieldType__Marker, org.eclipse.modisco.java.Type> message) {
