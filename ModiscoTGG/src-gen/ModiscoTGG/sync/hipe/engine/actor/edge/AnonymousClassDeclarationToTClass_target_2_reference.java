...
public class AnonymousClassDeclarationToTClass_target_2_reference extends AbstractActor {
	...
	public AnonymousClassDeclarationToTClass_target_2_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnonymousClass__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
