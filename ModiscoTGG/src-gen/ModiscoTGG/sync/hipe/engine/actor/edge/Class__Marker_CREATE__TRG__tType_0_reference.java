...
public class Class__Marker_CREATE__TRG__tType_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TClass, Set<ModiscoTGG.Class__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public Class__Marker_CREATE__TRG__tType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("Class__CONSISTENCY_triangle_9_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.Class__Marker source, org.gravity.typegraph.basic.TClass target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.Class__Marker, org.gravity.typegraph.basic.TClass> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.Class__Marker, org.gravity.typegraph.basic.TClass> message) {
