...
public class SubPackageToPGPackage__Marker_CONTEXT__SRC__mParentPackage_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.Package, Set<ModiscoTGG.SubPackageToPGPackage__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public SubPackageToPGPackage__Marker_CONTEXT__SRC__mParentPackage_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("SubPackageToPGPackage__CONSISTENCY_triangle_6_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.SubPackageToPGPackage__Marker source, org.eclipse.modisco.java.Package target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.SubPackageToPGPackage__Marker> message) {
		...
		org.eclipse.modisco.java.Package target = (org.eclipse.modisco.java.Package) message.input.getCONTEXT__SRC__mParentPackage();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.SubPackageToPGPackage__Marker, org.eclipse.modisco.java.Package> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.SubPackageToPGPackage__Marker, org.eclipse.modisco.java.Package> message) {
