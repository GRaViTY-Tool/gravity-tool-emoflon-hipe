...
public class TParameter_previous_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TParameter, Set<org.gravity.typegraph.basic.TParameter>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public TParameter_previous_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodParameterLink__BWD_4110_junction"), this::check_constraint_180));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodParameterLink__CONSISTENCY_4123_junction"), this::check_constraint_183));
	}	
	...
	private void addMatch(InputMessage message, org.gravity.typegraph.basic.TParameter source, org.gravity.typegraph.basic.TParameter target) {
	...
	private void leftAdded(NodeAddedLeft<org.gravity.typegraph.basic.TParameter> message) {
		...
		org.gravity.typegraph.basic.TParameter target = (org.gravity.typegraph.basic.TParameter) message.input.getPrevious();
	...
	private void addReference(ReferenceAdded<org.gravity.typegraph.basic.TParameter, org.gravity.typegraph.basic.TParameter> message) {
	...
	private void removeReference(ReferenceDeleted<org.gravity.typegraph.basic.TParameter, org.gravity.typegraph.basic.TParameter> message) {
