...
public class TypesVisibility__Marker_CONTEXT__TRG__tType_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TAbstractType, Set<ModiscoTGG.TypesVisibility__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public TypesVisibility__Marker_CONTEXT__TRG__tType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("TypesVisibility__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.TypesVisibility__Marker source, org.gravity.typegraph.basic.TAbstractType target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.TypesVisibility__Marker, org.gravity.typegraph.basic.TAbstractType> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.TypesVisibility__Marker, org.gravity.typegraph.basic.TAbstractType> message) {
