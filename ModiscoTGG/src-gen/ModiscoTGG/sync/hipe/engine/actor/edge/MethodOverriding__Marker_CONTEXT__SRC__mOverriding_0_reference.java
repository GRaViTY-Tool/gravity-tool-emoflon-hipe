...
public class MethodOverriding__Marker_CONTEXT__SRC__mOverriding_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MMethodDefinition, Set<ModiscoTGG.MethodOverriding__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodOverriding__Marker_CONTEXT__SRC__mOverriding_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodOverriding__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodOverriding__Marker source, org.gravity.modisco.MMethodDefinition target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MethodOverriding__Marker> message) {
		...
		org.gravity.modisco.MMethodDefinition target = (org.gravity.modisco.MMethodDefinition) message.input.getCONTEXT__SRC__mOverriding();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodOverriding__Marker, org.gravity.modisco.MMethodDefinition> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodOverriding__Marker, org.gravity.modisco.MMethodDefinition> message) {
