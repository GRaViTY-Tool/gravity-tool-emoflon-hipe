...
public class NestedEnum__Marker_CREATE__TRG__tNestedPackage_0_reference extends AbstractActor {
	...
	public NestedEnum__Marker_CREATE__TRG__tNestedPackage_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("NestedEnum__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
