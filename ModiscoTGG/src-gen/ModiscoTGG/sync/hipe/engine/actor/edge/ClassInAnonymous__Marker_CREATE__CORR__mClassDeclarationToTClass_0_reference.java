...
public class ClassInAnonymous__Marker_CREATE__CORR__mClassDeclarationToTClass_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.ClassDeclarationToTClass, Set<ModiscoTGG.ClassInAnonymous__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ClassInAnonymous__Marker_CREATE__CORR__mClassDeclarationToTClass_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassInAnonymous__CONSISTENCY_triangle_10_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ClassInAnonymous__Marker source, ModiscoTGG.ClassDeclarationToTClass target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ClassInAnonymous__Marker> message) {
		...
		ModiscoTGG.ClassDeclarationToTClass target = (ModiscoTGG.ClassDeclarationToTClass) message.input.getCREATE__CORR__mClassDeclarationToTClass();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ClassInAnonymous__Marker, ModiscoTGG.ClassDeclarationToTClass> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ClassInAnonymous__Marker, ModiscoTGG.ClassDeclarationToTClass> message) {
