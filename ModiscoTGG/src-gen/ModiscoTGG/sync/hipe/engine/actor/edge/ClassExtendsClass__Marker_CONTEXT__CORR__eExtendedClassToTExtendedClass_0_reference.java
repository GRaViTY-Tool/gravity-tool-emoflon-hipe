...
public class ClassExtendsClass__Marker_CONTEXT__CORR__eExtendedClassToTExtendedClass_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.ClassDeclarationToTClass, Set<ModiscoTGG.ClassExtendsClass__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ClassExtendsClass__Marker_CONTEXT__CORR__eExtendedClassToTExtendedClass_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassExtendsClass__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ClassExtendsClass__Marker source, ModiscoTGG.ClassDeclarationToTClass target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ClassExtendsClass__Marker> message) {
		...
		ModiscoTGG.ClassDeclarationToTClass target = (ModiscoTGG.ClassDeclarationToTClass) message.input.getCONTEXT__CORR__eExtendedClassToTExtendedClass();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ClassExtendsClass__Marker, ModiscoTGG.ClassDeclarationToTClass> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ClassExtendsClass__Marker, ModiscoTGG.ClassDeclarationToTClass> message) {
