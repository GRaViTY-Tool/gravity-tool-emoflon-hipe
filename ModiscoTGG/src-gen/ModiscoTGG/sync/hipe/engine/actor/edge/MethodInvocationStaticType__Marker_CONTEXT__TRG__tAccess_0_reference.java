...
public class MethodInvocationStaticType__Marker_CONTEXT__TRG__tAccess_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TCall, Set<EdgeMatch>> targetElements = new HashMap<org.gravity.typegraph.basic.TCall, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.gravity.typegraph.basic.TCall, Set<ModiscoTGG.MethodInvocationStaticType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodInvocationStaticType__Marker_CONTEXT__TRG__tAccess_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodInvocationStaticType__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodInvocationStaticType__Marker source, org.gravity.typegraph.basic.TCall target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.gravity.typegraph.basic.TCall) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MethodInvocationStaticType__Marker> message) {
		...
		org.gravity.typegraph.basic.TCall target = (org.gravity.typegraph.basic.TCall) message.input.getCONTEXT__TRG__tAccess();
	...
	private void rightAdded(NodeAddedRight<org.gravity.typegraph.basic.TCall> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.gravity.typegraph.basic.TCall> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodInvocationStaticType__Marker, org.gravity.typegraph.basic.TCall> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodInvocationStaticType__Marker, org.gravity.typegraph.basic.TCall> message) {
