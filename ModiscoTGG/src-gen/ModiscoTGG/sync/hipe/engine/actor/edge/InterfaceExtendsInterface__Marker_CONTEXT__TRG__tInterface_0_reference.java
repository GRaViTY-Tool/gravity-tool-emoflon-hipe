...
public class InterfaceExtendsInterface__Marker_CONTEXT__TRG__tInterface_0_reference extends AbstractActor {
	...
	public InterfaceExtendsInterface__Marker_CONTEXT__TRG__tInterface_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("InterfaceExtendsInterface__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.InterfaceExtendsInterface__Marker> message) {
		...
		org.gravity.typegraph.basic.TInterface target = (org.gravity.typegraph.basic.TInterface) message.input.getCONTEXT__TRG__tInterface();
