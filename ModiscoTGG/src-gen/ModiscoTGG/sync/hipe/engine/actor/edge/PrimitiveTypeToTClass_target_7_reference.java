...
public class PrimitiveTypeToTClass_target_7_reference extends AbstractActor {
	...
	public PrimitiveTypeToTClass_target_7_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PrimitiveTypeIsShort__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
