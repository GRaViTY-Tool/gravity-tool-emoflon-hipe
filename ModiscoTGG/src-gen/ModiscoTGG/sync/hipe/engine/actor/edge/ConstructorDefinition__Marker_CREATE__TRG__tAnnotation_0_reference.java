...
public class ConstructorDefinition__Marker_CREATE__TRG__tAnnotation_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TConstructor, Set<EdgeMatch>> targetElements = new HashMap<org.gravity.typegraph.basic.TConstructor, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.gravity.typegraph.basic.TConstructor, Set<ModiscoTGG.ConstructorDefinition__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ConstructorDefinition__Marker_CREATE__TRG__tAnnotation_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ConstructorDefinition__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ConstructorDefinition__Marker source, org.gravity.typegraph.basic.TConstructor target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.gravity.typegraph.basic.TConstructor) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ConstructorDefinition__Marker> message) {
		...
		org.gravity.typegraph.basic.TConstructor target = (org.gravity.typegraph.basic.TConstructor) message.input.getCREATE__TRG__tAnnotation();
	...
	private void rightAdded(NodeAddedRight<org.gravity.typegraph.basic.TConstructor> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.gravity.typegraph.basic.TConstructor> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ConstructorDefinition__Marker, org.gravity.typegraph.basic.TConstructor> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ConstructorDefinition__Marker, org.gravity.typegraph.basic.TConstructor> message) {
