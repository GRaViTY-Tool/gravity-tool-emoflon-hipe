...
public class MethodInvocationRecursive__Marker_CREATE__SRC__invocation_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MMethodInvocation, Set<ModiscoTGG.MethodInvocationRecursive__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodInvocationRecursive__Marker_CREATE__SRC__invocation_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodInvocationRecursive__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodInvocationRecursive__Marker source, org.gravity.modisco.MMethodInvocation target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MethodInvocationRecursive__Marker> message) {
		...
		org.gravity.modisco.MMethodInvocation target = (org.gravity.modisco.MMethodInvocation) message.input.getCREATE__SRC__invocation();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodInvocationRecursive__Marker, org.gravity.modisco.MMethodInvocation> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodInvocationRecursive__Marker, org.gravity.modisco.MMethodInvocation> message) {
