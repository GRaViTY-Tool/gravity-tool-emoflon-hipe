...
public class MethodParameterLink__Marker_CONTEXT__SRC__mEntry_0_reference extends AbstractActor {
	...
	public MethodParameterLink__Marker_CONTEXT__SRC__mEntry_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodParameterLink__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
