...
public class MAbstractFlowElement_ownedFlows_0_reference extends AbstractActor {
	...
	public MAbstractFlowElement_ownedFlows_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("Flow__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("Flow__FWD_2899_junction"), this::returnTrue));
	}	
	...
	private void leftAdded(NodeAddedLeft<org.gravity.modisco.MAbstractFlowElement> message) {
		...
		for(org.gravity.modisco.MFlow target : message.input.getOwnedFlows()) {
