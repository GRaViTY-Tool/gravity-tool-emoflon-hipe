...
public class FieldAccessReadWrite__Marker_CREATE__TRG__tAccess_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TReadWrite, Set<EdgeMatch>> targetElements = new HashMap<org.gravity.typegraph.basic.TReadWrite, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.gravity.typegraph.basic.TReadWrite, Set<ModiscoTGG.FieldAccessReadWrite__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public FieldAccessReadWrite__Marker_CREATE__TRG__tAccess_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("FieldAccessReadWrite__CONSISTENCY_triangle_12_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.FieldAccessReadWrite__Marker source, org.gravity.typegraph.basic.TReadWrite target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.gravity.typegraph.basic.TReadWrite) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.FieldAccessReadWrite__Marker> message) {
		...
		org.gravity.typegraph.basic.TReadWrite target = (org.gravity.typegraph.basic.TReadWrite) message.input.getCREATE__TRG__tAccess();
	...
	private void rightAdded(NodeAddedRight<org.gravity.typegraph.basic.TReadWrite> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.gravity.typegraph.basic.TReadWrite> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.FieldAccessReadWrite__Marker, org.gravity.typegraph.basic.TReadWrite> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.FieldAccessReadWrite__Marker, org.gravity.typegraph.basic.TReadWrite> message) {
