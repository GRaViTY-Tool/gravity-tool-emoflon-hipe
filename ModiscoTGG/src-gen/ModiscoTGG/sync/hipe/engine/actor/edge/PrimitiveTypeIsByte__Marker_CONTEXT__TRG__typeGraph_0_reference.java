...
public class PrimitiveTypeIsByte__Marker_CONTEXT__TRG__typeGraph_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TypeGraph, Set<ModiscoTGG.PrimitiveTypeIsByte__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public PrimitiveTypeIsByte__Marker_CONTEXT__TRG__typeGraph_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("PrimitiveTypeIsByte__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.PrimitiveTypeIsByte__Marker source, org.gravity.typegraph.basic.TypeGraph target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.PrimitiveTypeIsByte__Marker, org.gravity.typegraph.basic.TypeGraph> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.PrimitiveTypeIsByte__Marker, org.gravity.typegraph.basic.TypeGraph> message) {
