...
public class ClassExtendsClass__Marker_CONTEXT__SRC__eExtendedClass_0_reference extends AbstractActor {
	...
	public ClassExtendsClass__Marker_CONTEXT__SRC__eExtendedClass_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ClassExtendsClass__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ClassExtendsClass__Marker> message) {
		...
		org.eclipse.modisco.java.ClassDeclaration target = (org.eclipse.modisco.java.ClassDeclaration) message.input.getCONTEXT__SRC__eExtendedClass();
