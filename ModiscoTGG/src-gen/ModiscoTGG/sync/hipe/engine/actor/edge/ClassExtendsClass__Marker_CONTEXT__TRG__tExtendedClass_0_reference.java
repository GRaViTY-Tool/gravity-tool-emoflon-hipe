...
public class ClassExtendsClass__Marker_CONTEXT__TRG__tExtendedClass_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TClass, Set<ModiscoTGG.ClassExtendsClass__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ClassExtendsClass__Marker_CONTEXT__TRG__tExtendedClass_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ClassExtendsClass__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ClassExtendsClass__Marker source, org.gravity.typegraph.basic.TClass target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ClassExtendsClass__Marker> message) {
		...
		org.gravity.typegraph.basic.TClass target = (org.gravity.typegraph.basic.TClass) message.input.getCONTEXT__TRG__tExtendedClass();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ClassExtendsClass__Marker, org.gravity.typegraph.basic.TClass> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ClassExtendsClass__Marker, org.gravity.typegraph.basic.TClass> message) {
