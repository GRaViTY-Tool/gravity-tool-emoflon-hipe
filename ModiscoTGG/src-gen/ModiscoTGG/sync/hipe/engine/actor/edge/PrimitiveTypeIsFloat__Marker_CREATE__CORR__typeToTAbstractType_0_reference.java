...
public class PrimitiveTypeIsFloat__Marker_CREATE__CORR__typeToTAbstractType_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.TypeToTAbstractType, Set<ModiscoTGG.PrimitiveTypeIsFloat__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public PrimitiveTypeIsFloat__Marker_CREATE__CORR__typeToTAbstractType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PrimitiveTypeIsFloat__CONSISTENCY_5113_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.PrimitiveTypeIsFloat__Marker source, ModiscoTGG.TypeToTAbstractType target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.PrimitiveTypeIsFloat__Marker, ModiscoTGG.TypeToTAbstractType> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.PrimitiveTypeIsFloat__Marker, ModiscoTGG.TypeToTAbstractType> message) {
