...
public class VariableDeclarationFragment__Marker_CREATE__SRC__varDeclFragment_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.VariableDeclarationFragment, Set<ModiscoTGG.VariableDeclarationFragment__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public VariableDeclarationFragment__Marker_CREATE__SRC__varDeclFragment_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("VariableDeclarationFragment__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.VariableDeclarationFragment__Marker source, org.eclipse.modisco.java.VariableDeclarationFragment target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.VariableDeclarationFragment__Marker> message) {
		...
		org.eclipse.modisco.java.VariableDeclarationFragment target = (org.eclipse.modisco.java.VariableDeclarationFragment) message.input.getCREATE__SRC__varDeclFragment();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.VariableDeclarationFragment__Marker, org.eclipse.modisco.java.VariableDeclarationFragment> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.VariableDeclarationFragment__Marker, org.eclipse.modisco.java.VariableDeclarationFragment> message) {
