...
public class ASTNodeToTAnnotatable_source_0_reference extends AbstractActor {
	...
	public ASTNodeToTAnnotatable_source_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationOnBodyDeclaration__BWD_643_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationOnBodyDeclaration__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationOnBodyDeclaration__FWD_677_junction"), this::returnTrue));
	}	
