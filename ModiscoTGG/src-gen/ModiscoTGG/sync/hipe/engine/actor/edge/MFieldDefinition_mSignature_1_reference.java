...
public class MFieldDefinition_mSignature_1_reference extends AbstractActor {
	...
	public MFieldDefinition_mSignature_1_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldDefinition__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldDefinition__FWD_2709_junction"), this::returnTrue));
	}	
