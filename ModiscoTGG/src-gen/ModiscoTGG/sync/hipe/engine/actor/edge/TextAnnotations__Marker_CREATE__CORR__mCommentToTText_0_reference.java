...
public class TextAnnotations__Marker_CREATE__CORR__mCommentToTText_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.LineCommentToTTextAnnotation, Set<EdgeMatch>> targetElements = new HashMap<ModiscoTGG.LineCommentToTTextAnnotation, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<ModiscoTGG.LineCommentToTTextAnnotation, Set<ModiscoTGG.TextAnnotations__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public TextAnnotations__Marker_CREATE__CORR__mCommentToTText_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("TextAnnotations__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.TextAnnotations__Marker source, ModiscoTGG.LineCommentToTTextAnnotation target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((ModiscoTGG.LineCommentToTTextAnnotation) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.TextAnnotations__Marker> message) {
		...
		ModiscoTGG.LineCommentToTTextAnnotation target = (ModiscoTGG.LineCommentToTTextAnnotation) message.input.getCREATE__CORR__mCommentToTText();
	...
	private void rightAdded(NodeAddedRight<ModiscoTGG.LineCommentToTTextAnnotation> message) {
	...
	private void rightRemoved(NodeDeletedRight<ModiscoTGG.LineCommentToTTextAnnotation> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.TextAnnotations__Marker, ModiscoTGG.LineCommentToTTextAnnotation> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.TextAnnotations__Marker, ModiscoTGG.LineCommentToTTextAnnotation> message) {
