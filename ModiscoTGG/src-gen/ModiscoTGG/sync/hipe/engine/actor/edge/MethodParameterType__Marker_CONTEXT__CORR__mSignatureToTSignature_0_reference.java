...
public class MethodParameterType__Marker_CONTEXT__CORR__mSignatureToTSignature_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.MSignatureToTSignature, Set<ModiscoTGG.MethodParameterType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodParameterType__Marker_CONTEXT__CORR__mSignatureToTSignature_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodParameterType__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodParameterType__Marker source, ModiscoTGG.MSignatureToTSignature target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodParameterType__Marker, ModiscoTGG.MSignatureToTSignature> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodParameterType__Marker, ModiscoTGG.MSignatureToTSignature> message) {
