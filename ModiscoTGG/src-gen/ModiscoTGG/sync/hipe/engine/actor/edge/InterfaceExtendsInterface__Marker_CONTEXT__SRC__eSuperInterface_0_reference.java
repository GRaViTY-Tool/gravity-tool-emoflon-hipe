...
public class InterfaceExtendsInterface__Marker_CONTEXT__SRC__eSuperInterface_0_reference extends AbstractActor {
	...
	public InterfaceExtendsInterface__Marker_CONTEXT__SRC__eSuperInterface_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("InterfaceExtendsInterface__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.InterfaceExtendsInterface__Marker> message) {
		...
		org.eclipse.modisco.java.InterfaceDeclaration target = (org.eclipse.modisco.java.InterfaceDeclaration) message.input.getCONTEXT__SRC__eSuperInterface();
