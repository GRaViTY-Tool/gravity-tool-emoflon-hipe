...
public class SyntethicMethod__Marker_CONTEXT__TRG__tDef_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TMethodDefinition, Set<ModiscoTGG.SyntethicMethod__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public SyntethicMethod__Marker_CONTEXT__TRG__tDef_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("SyntethicMethod__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.SyntethicMethod__Marker source, org.gravity.typegraph.basic.TMethodDefinition target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.SyntethicMethod__Marker> message) {
		...
		org.gravity.typegraph.basic.TMethodDefinition target = (org.gravity.typegraph.basic.TMethodDefinition) message.input.getCONTEXT__TRG__tDef();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.SyntethicMethod__Marker, org.gravity.typegraph.basic.TMethodDefinition> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.SyntethicMethod__Marker, org.gravity.typegraph.basic.TMethodDefinition> message) {
