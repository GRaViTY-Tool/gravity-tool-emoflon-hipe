...
public class ReturnType__Marker_CONTEXT__SRC__eReturnType_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.Type, Set<ModiscoTGG.ReturnType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ReturnType__Marker_CONTEXT__SRC__eReturnType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ReturnType__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ReturnType__Marker source, org.eclipse.modisco.java.Type target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ReturnType__Marker> message) {
		...
		org.eclipse.modisco.java.Type target = (org.eclipse.modisco.java.Type) message.input.getCONTEXT__SRC__eReturnType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ReturnType__Marker, org.eclipse.modisco.java.Type> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ReturnType__Marker, org.eclipse.modisco.java.Type> message) {
