...
public class MMethodDefinition_usages_2_reference extends AbstractActor {
	...
	public MMethodDefinition_usages_2_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodInvocationRecursive__CONSISTENCY_3779_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodInvocationRecursive__FWD_3810_junction"), this::returnTrue));
	}	
