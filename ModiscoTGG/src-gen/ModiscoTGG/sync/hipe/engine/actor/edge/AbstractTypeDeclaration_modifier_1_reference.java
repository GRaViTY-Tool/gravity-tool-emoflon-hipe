...
public class AbstractTypeDeclaration_modifier_1_reference extends AbstractActor {
	...
	public AbstractTypeDeclaration_modifier_1_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("TypesVisibility__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("TypesVisibility__FWD_6016_junction"), this::returnTrue));
	}	
