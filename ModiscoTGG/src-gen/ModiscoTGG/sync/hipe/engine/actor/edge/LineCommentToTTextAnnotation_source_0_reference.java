...
public class LineCommentToTTextAnnotation_source_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.LineComment, Set<EdgeMatch>> targetElements = new HashMap<org.eclipse.modisco.java.LineComment, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.eclipse.modisco.java.LineComment, Set<ModiscoTGG.LineCommentToTTextAnnotation>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public LineCommentToTTextAnnotation_source_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("TextAnnotations__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.LineCommentToTTextAnnotation source, org.eclipse.modisco.java.LineComment target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.eclipse.modisco.java.LineComment) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.LineCommentToTTextAnnotation> message) {
		...
		org.eclipse.modisco.java.LineComment target = (org.eclipse.modisco.java.LineComment) message.input.getSource();
	...
	private void rightAdded(NodeAddedRight<org.eclipse.modisco.java.LineComment> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.eclipse.modisco.java.LineComment> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.LineCommentToTTextAnnotation, org.eclipse.modisco.java.LineComment> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.LineCommentToTTextAnnotation, org.eclipse.modisco.java.LineComment> message) {
