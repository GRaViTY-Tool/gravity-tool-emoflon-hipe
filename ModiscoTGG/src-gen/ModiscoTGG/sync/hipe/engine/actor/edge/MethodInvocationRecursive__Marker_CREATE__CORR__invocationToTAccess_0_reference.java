...
public class MethodInvocationRecursive__Marker_CREATE__CORR__invocationToTAccess_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.AbstractMethodInvocationToTAccess, Set<ModiscoTGG.MethodInvocationRecursive__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodInvocationRecursive__Marker_CREATE__CORR__invocationToTAccess_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodInvocationRecursive__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodInvocationRecursive__Marker source, ModiscoTGG.AbstractMethodInvocationToTAccess target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodInvocationRecursive__Marker, ModiscoTGG.AbstractMethodInvocationToTAccess> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodInvocationRecursive__Marker, ModiscoTGG.AbstractMethodInvocationToTAccess> message) {
