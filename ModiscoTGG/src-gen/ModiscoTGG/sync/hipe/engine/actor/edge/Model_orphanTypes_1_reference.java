...
public class Model_orphanTypes_1_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.Type, Set<org.eclipse.modisco.java.Model>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public Model_orphanTypes_1_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ParameterizedTypeToClass__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ParameterizedTypeToClass__FWD_4837_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, org.eclipse.modisco.java.Model source, org.eclipse.modisco.java.Type target) {
	...
	private void leftAdded(NodeAddedLeft<org.eclipse.modisco.java.Model> message) {
		...
		for(org.eclipse.modisco.java.Type target : message.input.getOrphanTypes()) {
	...
	private void addReference(ReferenceAdded<org.eclipse.modisco.java.Model, org.eclipse.modisco.java.Type> message) {
	...
	private void removeReference(ReferenceDeleted<org.eclipse.modisco.java.Model, org.eclipse.modisco.java.Type> message) {
