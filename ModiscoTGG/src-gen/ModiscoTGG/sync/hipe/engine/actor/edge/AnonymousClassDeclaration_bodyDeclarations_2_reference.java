...
public class AnonymousClassDeclaration_bodyDeclarations_2_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.BodyDeclaration, Set<EdgeMatch>> targetElements = new HashMap<org.eclipse.modisco.java.BodyDeclaration, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.eclipse.modisco.java.BodyDeclaration, Set<org.eclipse.modisco.java.AnonymousClassDeclaration>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnonymousClassDeclaration_bodyDeclarations_2_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassInnerAnonClassMember__BWD_1593_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassInnerAnonClassMember__CONSISTENCY_triangle_8_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassInnerAnonClassMember__FWD_1674_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, org.eclipse.modisco.java.AnonymousClassDeclaration source, org.eclipse.modisco.java.BodyDeclaration target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.eclipse.modisco.java.BodyDeclaration) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<org.eclipse.modisco.java.AnonymousClassDeclaration> message) {
		...
		for(org.eclipse.modisco.java.BodyDeclaration target : message.input.getBodyDeclarations()) {
	...
	private void rightAdded(NodeAddedRight<org.eclipse.modisco.java.BodyDeclaration> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.eclipse.modisco.java.BodyDeclaration> message) {
	...
	private void addReference(ReferenceAdded<org.eclipse.modisco.java.AnonymousClassDeclaration, org.eclipse.modisco.java.BodyDeclaration> message) {
	...
	private void removeReference(ReferenceDeleted<org.eclipse.modisco.java.AnonymousClassDeclaration, org.eclipse.modisco.java.BodyDeclaration> message) {
