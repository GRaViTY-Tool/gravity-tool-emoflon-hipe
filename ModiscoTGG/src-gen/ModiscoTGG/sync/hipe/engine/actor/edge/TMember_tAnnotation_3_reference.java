...
public class TMember_tAnnotation_3_reference extends AbstractActor {
	...
	public TMember_tAnnotation_3_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("TextAnnotations__BWD_5837_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("TextAnnotations__CONSISTENCY_5846_junction"), this::returnTrue));
	}	
