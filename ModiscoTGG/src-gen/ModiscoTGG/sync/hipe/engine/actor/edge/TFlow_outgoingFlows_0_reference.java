...
public class TFlow_outgoingFlows_0_reference extends AbstractActor {
	...
	public TFlow_outgoingFlows_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("OutgoingFlow__BWD_4687_junction"), this::check_constraint_212));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("OutgoingFlow__CONSISTENCY_triangle_0_triangleJunction"), this::check_constraint_214));
	}	
	...
	private void leftAdded(NodeAddedLeft<org.gravity.typegraph.basic.TAbstractFlowElement> message) {
		...
		for(org.gravity.typegraph.basic.TAbstractFlowElement target : message.input.getOutgoingFlows()) {
	...
	public boolean check_constraint_212(EdgeMatch edge) {
	...
	public boolean check_constraint_214(EdgeMatch edge) {
		org.gravity.typegraph.basic.TAbstractFlowElement tFlow = (org.gravity.typegraph.basic.TAbstractFlowElement) edge.source();
		org.gravity.typegraph.basic.TAbstractFlowElement tTarget = (org.gravity.typegraph.basic.TAbstractFlowElement) edge.target();
		boolean predicate = !tFlow.equals(tTarget);
		edge.setConstraintSatisfied(predicate);
