...
public class AnonymousClassDeclaration_bodyDeclarations_1_reference extends AbstractActor {
	...
	public AnonymousClassDeclaration_bodyDeclarations_1_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassInAnonymous__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassInAnonymous__FWD_1573_junction"), this::returnTrue));
	}	
