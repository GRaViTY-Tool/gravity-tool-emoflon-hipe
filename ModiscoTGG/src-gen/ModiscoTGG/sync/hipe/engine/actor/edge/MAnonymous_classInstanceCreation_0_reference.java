...
public class MAnonymous_classInstanceCreation_0_reference extends AbstractActor {

	private List<Port<EdgeMatch>> ports;

	private Map<org.eclipse.modisco.java.AnonymousClassDeclaration, Set<EdgeMatch>> sourceElements = new HashMap<org.eclipse.modisco.java.AnonymousClassDeclaration, Set<EdgeMatch>>();
	private Map<org.eclipse.modisco.java.ClassInstanceCreation, Set<EdgeMatch>> targetElements = new HashMap<org.eclipse.modisco.java.ClassInstanceCreation, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.eclipse.modisco.java.ClassInstanceCreation, Set<org.eclipse.modisco.java.AnonymousClassDeclaration>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MAnonymous_classInstanceCreation_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnonymousClassTypeClass__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnonymousClassTypeClass__FWD_1046_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnonymousClassTypeInterface__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnonymousClassTypeInterface__FWD_1136_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, org.eclipse.modisco.java.AnonymousClassDeclaration source, org.eclipse.modisco.java.ClassInstanceCreation target) {
	...
	private void addPendingMatch(Object source, Object target) {
		Set<org.eclipse.modisco.java.AnonymousClassDeclaration> sourcePending = pending.get(target);
		if(sourcePending == null) {
			sourcePending = new HashSet<org.eclipse.modisco.java.AnonymousClassDeclaration>();
			pending.put((org.eclipse.modisco.java.ClassInstanceCreation) target, sourcePending);
		}
		sourcePending.add((org.eclipse.modisco.java.AnonymousClassDeclaration) source);
	}
	
	private void leftAdded(NodeAddedLeft<org.eclipse.modisco.java.AnonymousClassDeclaration> message) {
		...
		org.eclipse.modisco.java.ClassInstanceCreation target = (org.eclipse.modisco.java.ClassInstanceCreation) message.input.getClassInstanceCreation();
	...
	private void rightAdded(NodeAddedRight<org.eclipse.modisco.java.ClassInstanceCreation> message) {
		...
		if(pending.containsKey(message.input)) {
			Set<org.eclipse.modisco.java.AnonymousClassDeclaration> pendingsSources = pending.get(message.input);
			for(org.eclipse.modisco.java.AnonymousClassDeclaration source : pendingsSources) {
	...
	private void leftRemoved(NodeDeletedLeft<org.eclipse.modisco.java.AnonymousClassDeclaration> message) {
		...
		for(EdgeMatch match : sourceMatches) {
			...
			Set<org.eclipse.modisco.java.AnonymousClassDeclaration> sourcePending = pending.get(match.target());
	...
	private void rightRemoved(NodeDeletedRight<org.eclipse.modisco.java.ClassInstanceCreation> message) {
	...
	private void addReference(ReferenceAdded<org.eclipse.modisco.java.AnonymousClassDeclaration, org.eclipse.modisco.java.ClassInstanceCreation> message) {
	...
	private void removeReference(ReferenceDeleted<org.eclipse.modisco.java.AnonymousClassDeclaration, org.eclipse.modisco.java.ClassInstanceCreation> message) {
		Set<org.eclipse.modisco.java.AnonymousClassDeclaration> pendingSources = pending.get(message.target);
	...
	private void changeAttribute(AttributeChanged<?> message) {
		...
		if(message.node instanceof org.eclipse.modisco.java.AnonymousClassDeclaration) {
			leftChanged(message);
		}
		else {
