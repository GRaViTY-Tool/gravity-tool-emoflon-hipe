...
public class MDefinition_mAbstractFieldAccess_2_reference extends AbstractActor {
	...
	public MDefinition_mAbstractFieldAccess_2_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessRead__CONSISTENCY_triangle_6_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("FieldAccessRead__FWD_2498_junction"), this::returnTrue));
	}	
