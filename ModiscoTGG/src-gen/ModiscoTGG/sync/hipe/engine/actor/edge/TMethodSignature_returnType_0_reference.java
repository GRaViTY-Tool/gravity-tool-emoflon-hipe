...
public class TMethodSignature_returnType_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TAbstractType, Set<org.gravity.typegraph.basic.TMethodSignature>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public TMethodSignature_returnType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("SignatureReturnType__BWD_5462_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("SignatureReturnType__CONSISTENCY_5475_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, org.gravity.typegraph.basic.TMethodSignature source, org.gravity.typegraph.basic.TAbstractType target) {
	...
	private void addReference(ReferenceAdded<org.gravity.typegraph.basic.TMethodSignature, org.gravity.typegraph.basic.TAbstractType> message) {
	...
	private void removeReference(ReferenceDeleted<org.gravity.typegraph.basic.TMethodSignature, org.gravity.typegraph.basic.TAbstractType> message) {
