...
public class AnnotationMemberValueBoolean__Marker_CREATE__SRC__mValue_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.BooleanLiteral, Set<ModiscoTGG.AnnotationMemberValueBoolean__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueBoolean__Marker_CREATE__SRC__mValue_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationMemberValueBoolean__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueBoolean__Marker source, org.eclipse.modisco.java.BooleanLiteral target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueBoolean__Marker, org.eclipse.modisco.java.BooleanLiteral> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueBoolean__Marker, org.eclipse.modisco.java.BooleanLiteral> message) {
