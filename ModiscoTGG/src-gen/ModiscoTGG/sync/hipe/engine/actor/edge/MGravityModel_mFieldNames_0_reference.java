...
public class MGravityModel_mFieldNames_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MFieldName, Set<org.gravity.modisco.MGravityModel>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MGravityModel_mFieldNames_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldName__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldName__FWD_2752_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, org.gravity.modisco.MGravityModel source, org.gravity.modisco.MFieldName target) {
	...
	private void leftAdded(NodeAddedLeft<org.gravity.modisco.MGravityModel> message) {
		...
		for(org.gravity.modisco.MFieldName target : message.input.getMFieldNames()) {
	...
	private void addReference(ReferenceAdded<org.gravity.modisco.MGravityModel, org.gravity.modisco.MFieldName> message) {
	...
	private void removeReference(ReferenceDeleted<org.gravity.modisco.MGravityModel, org.gravity.modisco.MFieldName> message) {
