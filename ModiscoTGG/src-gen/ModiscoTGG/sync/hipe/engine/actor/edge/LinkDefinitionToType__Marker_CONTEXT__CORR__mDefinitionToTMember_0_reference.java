...
public class LinkDefinitionToType__Marker_CONTEXT__CORR__mDefinitionToTMember_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.MDefinitionToTMember, Set<ModiscoTGG.LinkDefinitionToType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public LinkDefinitionToType__Marker_CONTEXT__CORR__mDefinitionToTMember_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("LinkDefinitionToType__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.LinkDefinitionToType__Marker source, ModiscoTGG.MDefinitionToTMember target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.LinkDefinitionToType__Marker> message) {
		...
		ModiscoTGG.MDefinitionToTMember target = (ModiscoTGG.MDefinitionToTMember) message.input.getCONTEXT__CORR__mDefinitionToTMember();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.LinkDefinitionToType__Marker, ModiscoTGG.MDefinitionToTMember> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.LinkDefinitionToType__Marker, ModiscoTGG.MDefinitionToTMember> message) {
