...
public class TypesOrphaned__Marker_CREATE__TRG__tType_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TClass, Set<ModiscoTGG.TypesOrphaned__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public TypesOrphaned__Marker_CREATE__TRG__tType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("TypesOrphaned__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.TypesOrphaned__Marker source, org.gravity.typegraph.basic.TClass target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.TypesOrphaned__Marker> message) {
		...
		org.gravity.typegraph.basic.TClass target = (org.gravity.typegraph.basic.TClass) message.input.getCREATE__TRG__tType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.TypesOrphaned__Marker, org.gravity.typegraph.basic.TClass> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.TypesOrphaned__Marker, org.gravity.typegraph.basic.TClass> message) {
