...
public class FieldAccessWrite__Marker_CONTEXT__TRG__tField_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TFieldDefinition, Set<ModiscoTGG.FieldAccessWrite__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public FieldAccessWrite__Marker_CONTEXT__TRG__tField_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("FieldAccessWrite__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.FieldAccessWrite__Marker source, org.gravity.typegraph.basic.TFieldDefinition target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.FieldAccessWrite__Marker, org.gravity.typegraph.basic.TFieldDefinition> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.FieldAccessWrite__Marker, org.gravity.typegraph.basic.TFieldDefinition> message) {
