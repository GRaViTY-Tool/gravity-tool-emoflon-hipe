...
public class MemberInAnnotationVisibility__Marker_CONTEXT__CORR__defToMember_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.MDefinitionToTMember, Set<ModiscoTGG.MemberInAnnotationVisibility__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MemberInAnnotationVisibility__Marker_CONTEXT__CORR__defToMember_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MemberInAnnotationVisibility__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MemberInAnnotationVisibility__Marker source, ModiscoTGG.MDefinitionToTMember target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MemberInAnnotationVisibility__Marker> message) {
		...
		ModiscoTGG.MDefinitionToTMember target = (ModiscoTGG.MDefinitionToTMember) message.input.getCONTEXT__CORR__defToMember();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MemberInAnnotationVisibility__Marker, ModiscoTGG.MDefinitionToTMember> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MemberInAnnotationVisibility__Marker, ModiscoTGG.MDefinitionToTMember> message) {
