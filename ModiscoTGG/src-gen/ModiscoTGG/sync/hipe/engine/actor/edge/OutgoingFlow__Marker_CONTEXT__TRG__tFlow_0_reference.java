...
public class OutgoingFlow__Marker_CONTEXT__TRG__tFlow_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TFlow, Set<ModiscoTGG.OutgoingFlow__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public OutgoingFlow__Marker_CONTEXT__TRG__tFlow_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("OutgoingFlow__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.OutgoingFlow__Marker source, org.gravity.typegraph.basic.TFlow target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.OutgoingFlow__Marker> message) {
		...
		org.gravity.typegraph.basic.TFlow target = (org.gravity.typegraph.basic.TFlow) message.input.getCONTEXT__TRG__tFlow();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.OutgoingFlow__Marker, org.gravity.typegraph.basic.TFlow> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.OutgoingFlow__Marker, org.gravity.typegraph.basic.TFlow> message) {
