...
public class AnnotationMemberValueNumberArray__Marker_CREATE__SRC__mValue_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.NumberLiteral, Set<EdgeMatch>> targetElements = new HashMap<org.eclipse.modisco.java.NumberLiteral, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.eclipse.modisco.java.NumberLiteral, Set<ModiscoTGG.AnnotationMemberValueNumberArray__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueNumberArray__Marker_CREATE__SRC__mValue_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationMemberValueNumberArray__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueNumberArray__Marker source, org.eclipse.modisco.java.NumberLiteral target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.eclipse.modisco.java.NumberLiteral) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationMemberValueNumberArray__Marker> message) {
		...
		org.eclipse.modisco.java.NumberLiteral target = (org.eclipse.modisco.java.NumberLiteral) message.input.getCREATE__SRC__mValue();
	...
	private void rightAdded(NodeAddedRight<org.eclipse.modisco.java.NumberLiteral> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.eclipse.modisco.java.NumberLiteral> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueNumberArray__Marker, org.eclipse.modisco.java.NumberLiteral> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueNumberArray__Marker, org.eclipse.modisco.java.NumberLiteral> message) {
