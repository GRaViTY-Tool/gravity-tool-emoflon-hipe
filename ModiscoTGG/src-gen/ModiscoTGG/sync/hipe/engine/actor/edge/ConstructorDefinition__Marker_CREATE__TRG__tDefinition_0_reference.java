...
public class ConstructorDefinition__Marker_CREATE__TRG__tDefinition_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TMethodDefinition, Set<ModiscoTGG.ConstructorDefinition__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ConstructorDefinition__Marker_CREATE__TRG__tDefinition_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ConstructorDefinition__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ConstructorDefinition__Marker source, org.gravity.typegraph.basic.TMethodDefinition target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ConstructorDefinition__Marker> message) {
		...
		org.gravity.typegraph.basic.TMethodDefinition target = (org.gravity.typegraph.basic.TMethodDefinition) message.input.getCREATE__TRG__tDefinition();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ConstructorDefinition__Marker, org.gravity.typegraph.basic.TMethodDefinition> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ConstructorDefinition__Marker, org.gravity.typegraph.basic.TMethodDefinition> message) {
