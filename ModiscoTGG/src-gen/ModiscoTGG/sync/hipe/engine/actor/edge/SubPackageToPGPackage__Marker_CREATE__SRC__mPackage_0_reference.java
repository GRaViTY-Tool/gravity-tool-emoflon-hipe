...
public class SubPackageToPGPackage__Marker_CREATE__SRC__mPackage_0_reference extends AbstractActor {
	...
	public SubPackageToPGPackage__Marker_CREATE__SRC__mPackage_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("SubPackageToPGPackage__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.SubPackageToPGPackage__Marker> message) {
		...
		org.eclipse.modisco.java.Package target = (org.eclipse.modisco.java.Package) message.input.getCREATE__SRC__mPackage();
