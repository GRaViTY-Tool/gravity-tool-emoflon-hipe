...
public class AnnotationOnBodyDeclaration__Marker_CREATE__TRG__tAnnotation_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.annotations.TAnnotation, Set<ModiscoTGG.AnnotationOnBodyDeclaration__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationOnBodyDeclaration__Marker_CREATE__TRG__tAnnotation_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationOnBodyDeclaration__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationOnBodyDeclaration__Marker source, org.gravity.typegraph.basic.annotations.TAnnotation target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationOnBodyDeclaration__Marker> message) {
		...
		org.gravity.typegraph.basic.annotations.TAnnotation target = (org.gravity.typegraph.basic.annotations.TAnnotation) message.input.getCREATE__TRG__tAnnotation();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationOnBodyDeclaration__Marker, org.gravity.typegraph.basic.annotations.TAnnotation> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationOnBodyDeclaration__Marker, org.gravity.typegraph.basic.annotations.TAnnotation> message) {
