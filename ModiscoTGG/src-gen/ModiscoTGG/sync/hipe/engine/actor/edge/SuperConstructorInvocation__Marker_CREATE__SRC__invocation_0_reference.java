...
public class SuperConstructorInvocation__Marker_CREATE__SRC__invocation_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MAbstractMethodInvocation, Set<EdgeMatch>> targetElements = new HashMap<org.gravity.modisco.MAbstractMethodInvocation, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.gravity.modisco.MAbstractMethodInvocation, Set<ModiscoTGG.SuperConstructorInvocation__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public SuperConstructorInvocation__Marker_CREATE__SRC__invocation_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("SuperConstructorInvocation__CONSISTENCY_triangle_8_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.SuperConstructorInvocation__Marker source, org.gravity.modisco.MAbstractMethodInvocation target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.gravity.modisco.MAbstractMethodInvocation) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.SuperConstructorInvocation__Marker> message) {
		...
		org.gravity.modisco.MAbstractMethodInvocation target = (org.gravity.modisco.MAbstractMethodInvocation) message.input.getCREATE__SRC__invocation();
	...
	private void rightAdded(NodeAddedRight<org.gravity.modisco.MAbstractMethodInvocation> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.gravity.modisco.MAbstractMethodInvocation> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.SuperConstructorInvocation__Marker, org.gravity.modisco.MAbstractMethodInvocation> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.SuperConstructorInvocation__Marker, org.gravity.modisco.MAbstractMethodInvocation> message) {
