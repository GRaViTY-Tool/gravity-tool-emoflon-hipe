...
public class EnumInAnonymous__Marker_CREATE__SRC__mNestedType_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.EnumDeclaration, Set<ModiscoTGG.EnumInAnonymous__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public EnumInAnonymous__Marker_CREATE__SRC__mNestedType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("EnumInAnonymous__CONSISTENCY_triangle_9_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.EnumInAnonymous__Marker source, org.eclipse.modisco.java.EnumDeclaration target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.EnumInAnonymous__Marker> message) {
		...
		org.eclipse.modisco.java.EnumDeclaration target = (org.eclipse.modisco.java.EnumDeclaration) message.input.getCREATE__SRC__mNestedType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.EnumInAnonymous__Marker, org.eclipse.modisco.java.EnumDeclaration> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.EnumInAnonymous__Marker, org.eclipse.modisco.java.EnumDeclaration> message) {
