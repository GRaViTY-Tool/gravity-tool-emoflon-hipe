...
public class TClass_pg_13_reference extends AbstractActor {
	...
	public TClass_pg_13_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PrimitiveTypesIsVoid__BWD_5326_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("PrimitiveTypesIsVoid__CONSISTENCY_5336_junction"), this::returnTrue));
	}	
