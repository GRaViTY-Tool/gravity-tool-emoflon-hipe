...
public class PackageToPGPackage__Marker_CONTEXT__SRC__mModel_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.Model, Set<ModiscoTGG.PackageToPGPackage__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public PackageToPGPackage__Marker_CONTEXT__SRC__mModel_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("PackageToPGPackage__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.PackageToPGPackage__Marker source, org.eclipse.modisco.java.Model target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.PackageToPGPackage__Marker> message) {
		...
		org.eclipse.modisco.java.Model target = (org.eclipse.modisco.java.Model) message.input.getCONTEXT__SRC__mModel();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.PackageToPGPackage__Marker, org.eclipse.modisco.java.Model> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.PackageToPGPackage__Marker, org.eclipse.modisco.java.Model> message) {
