...
public class TUnresolvedType_pg_15_reference extends AbstractActor {
	...
	public TUnresolvedType_pg_15_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("UnresolvedTypeDeclaration__BWD_6028_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("UnresolvedTypeDeclaration__CONSISTENCY_6037_junction"), this::returnTrue));
	}	
