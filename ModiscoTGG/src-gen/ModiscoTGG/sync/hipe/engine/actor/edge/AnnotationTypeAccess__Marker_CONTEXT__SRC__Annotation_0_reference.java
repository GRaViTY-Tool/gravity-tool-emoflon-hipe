...
public class AnnotationTypeAccess__Marker_CONTEXT__SRC__Annotation_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.Annotation, Set<ModiscoTGG.AnnotationTypeAccess__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationTypeAccess__Marker_CONTEXT__SRC__Annotation_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationTypeAccess__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationTypeAccess__Marker source, org.eclipse.modisco.java.Annotation target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationTypeAccess__Marker> message) {
		...
		org.eclipse.modisco.java.Annotation target = (org.eclipse.modisco.java.Annotation) message.input.getCONTEXT__SRC__Annotation();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationTypeAccess__Marker, org.eclipse.modisco.java.Annotation> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationTypeAccess__Marker, org.eclipse.modisco.java.Annotation> message) {
