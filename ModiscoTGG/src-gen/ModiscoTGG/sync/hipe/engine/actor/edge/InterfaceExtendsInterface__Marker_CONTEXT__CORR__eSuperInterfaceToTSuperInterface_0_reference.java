...
public class InterfaceExtendsInterface__Marker_CONTEXT__CORR__eSuperInterfaceToTSuperInterface_0_reference extends AbstractActor {
	...
	public InterfaceExtendsInterface__Marker_CONTEXT__CORR__eSuperInterfaceToTSuperInterface_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("InterfaceExtendsInterface__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.InterfaceExtendsInterface__Marker> message) {
		...
		ModiscoTGG.InterfaceDeclarationToTInterface target = (ModiscoTGG.InterfaceDeclarationToTInterface) message.input.getCONTEXT__CORR__eSuperInterfaceToTSuperInterface();
