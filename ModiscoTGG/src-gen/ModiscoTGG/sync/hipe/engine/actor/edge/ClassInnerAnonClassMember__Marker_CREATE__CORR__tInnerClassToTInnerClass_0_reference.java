...
public class ClassInnerAnonClassMember__Marker_CREATE__CORR__tInnerClassToTInnerClass_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.ClassDeclarationToTClass, Set<EdgeMatch>> targetElements = new HashMap<ModiscoTGG.ClassDeclarationToTClass, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<ModiscoTGG.ClassDeclarationToTClass, Set<ModiscoTGG.ClassInnerAnonClassMember__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ClassInnerAnonClassMember__Marker_CREATE__CORR__tInnerClassToTInnerClass_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassInnerAnonClassMember__CONSISTENCY_triangle_11_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ClassInnerAnonClassMember__Marker source, ModiscoTGG.ClassDeclarationToTClass target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((ModiscoTGG.ClassDeclarationToTClass) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ClassInnerAnonClassMember__Marker> message) {
		...
		ModiscoTGG.ClassDeclarationToTClass target = (ModiscoTGG.ClassDeclarationToTClass) message.input.getCREATE__CORR__tInnerClassToTInnerClass();
	...
	private void rightAdded(NodeAddedRight<ModiscoTGG.ClassDeclarationToTClass> message) {
	...
	private void rightRemoved(NodeDeletedRight<ModiscoTGG.ClassDeclarationToTClass> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ClassInnerAnonClassMember__Marker, ModiscoTGG.ClassDeclarationToTClass> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ClassInnerAnonClassMember__Marker, ModiscoTGG.ClassDeclarationToTClass> message) {
