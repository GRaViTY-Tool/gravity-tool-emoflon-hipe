...
public class TCall_tSource_4_reference extends AbstractActor {
	...
	public TCall_tSource_4_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodInvocationRecursive__BWD_3764_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodInvocationRecursive__CONSISTENCY_3774_junction"), this::returnTrue));
	}	
