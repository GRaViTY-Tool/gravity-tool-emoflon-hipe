...
public class ClassInnerClassMember__Marker_CONTEXT__SRC__eOuterClass_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.ClassDeclaration, Set<ModiscoTGG.ClassInnerClassMember__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ClassInnerClassMember__Marker_CONTEXT__SRC__eOuterClass_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ClassInnerClassMember__CONSISTENCY_triangle_12_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ClassInnerClassMember__Marker source, org.eclipse.modisco.java.ClassDeclaration target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ClassInnerClassMember__Marker> message) {
		...
		org.eclipse.modisco.java.ClassDeclaration target = (org.eclipse.modisco.java.ClassDeclaration) message.input.getCONTEXT__SRC__eOuterClass();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ClassInnerClassMember__Marker, org.eclipse.modisco.java.ClassDeclaration> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ClassInnerClassMember__Marker, org.eclipse.modisco.java.ClassDeclaration> message) {
