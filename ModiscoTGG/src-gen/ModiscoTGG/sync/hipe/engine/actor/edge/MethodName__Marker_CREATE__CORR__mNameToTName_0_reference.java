...
public class MethodName__Marker_CREATE__CORR__mNameToTName_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.MMethodNameToTMethod, Set<ModiscoTGG.MethodName__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodName__Marker_CREATE__CORR__mNameToTName_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodName__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodName__Marker source, ModiscoTGG.MMethodNameToTMethod target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MethodName__Marker> message) {
		...
		ModiscoTGG.MMethodNameToTMethod target = (ModiscoTGG.MMethodNameToTMethod) message.input.getCREATE__CORR__mNameToTName();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodName__Marker, ModiscoTGG.MMethodNameToTMethod> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodName__Marker, ModiscoTGG.MMethodNameToTMethod> message) {
