...
public class ASTNodeToTAnnotatable_target_5_reference extends AbstractActor {
	...
	public ASTNodeToTAnnotatable_target_5_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("InterfaceInAnonymous__CONSISTENCY_triangle_6_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("Interface__CONSISTENCY_triangle_9_triangleJunction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("NestedInterfaceInType__CONSISTENCY_triangle_11_triangleJunction"), this::returnTrue));
	}	
