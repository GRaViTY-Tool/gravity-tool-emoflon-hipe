...
public class InterfaceDeclaration_package_3_reference extends AbstractActor {
	...
	public InterfaceDeclaration_package_3_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("Interface__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("Interface__FWD_3261_junction"), this::returnTrue));
	}	
