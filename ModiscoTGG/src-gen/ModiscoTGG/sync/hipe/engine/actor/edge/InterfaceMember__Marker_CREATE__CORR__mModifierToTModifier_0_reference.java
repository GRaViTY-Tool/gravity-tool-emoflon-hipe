...
public class InterfaceMember__Marker_CREATE__CORR__mModifierToTModifier_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.MModifierToTModifier, Set<ModiscoTGG.InterfaceMember__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public InterfaceMember__Marker_CREATE__CORR__mModifierToTModifier_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("InterfaceMember__CONSISTENCY_triangle_8_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.InterfaceMember__Marker source, ModiscoTGG.MModifierToTModifier target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.InterfaceMember__Marker, ModiscoTGG.MModifierToTModifier> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.InterfaceMember__Marker, ModiscoTGG.MModifierToTModifier> message) {
