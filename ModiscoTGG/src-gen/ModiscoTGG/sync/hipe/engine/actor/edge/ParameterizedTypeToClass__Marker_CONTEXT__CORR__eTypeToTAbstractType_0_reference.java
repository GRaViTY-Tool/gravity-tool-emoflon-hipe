...
public class ParameterizedTypeToClass__Marker_CONTEXT__CORR__eTypeToTAbstractType_0_reference extends AbstractActor {
	...
	public ParameterizedTypeToClass__Marker_CONTEXT__CORR__eTypeToTAbstractType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ParameterizedTypeToClass__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ParameterizedTypeToClass__Marker> message) {
		...
		ModiscoTGG.TypeToTAbstractType target = (ModiscoTGG.TypeToTAbstractType) message.input.getCONTEXT__CORR__eTypeToTAbstractType();
