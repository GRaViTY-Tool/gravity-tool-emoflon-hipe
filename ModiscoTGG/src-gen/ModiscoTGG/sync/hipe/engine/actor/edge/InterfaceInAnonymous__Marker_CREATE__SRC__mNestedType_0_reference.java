...
public class InterfaceInAnonymous__Marker_CREATE__SRC__mNestedType_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.InterfaceDeclaration, Set<ModiscoTGG.InterfaceInAnonymous__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public InterfaceInAnonymous__Marker_CREATE__SRC__mNestedType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("InterfaceInAnonymous__CONSISTENCY_triangle_10_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.InterfaceInAnonymous__Marker source, org.eclipse.modisco.java.InterfaceDeclaration target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.InterfaceInAnonymous__Marker> message) {
		...
		org.eclipse.modisco.java.InterfaceDeclaration target = (org.eclipse.modisco.java.InterfaceDeclaration) message.input.getCREATE__SRC__mNestedType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.InterfaceInAnonymous__Marker, org.eclipse.modisco.java.InterfaceDeclaration> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.InterfaceInAnonymous__Marker, org.eclipse.modisco.java.InterfaceDeclaration> message) {
