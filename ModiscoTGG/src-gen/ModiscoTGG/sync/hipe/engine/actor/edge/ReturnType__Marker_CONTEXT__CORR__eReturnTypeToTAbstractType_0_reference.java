...
public class ReturnType__Marker_CONTEXT__CORR__eReturnTypeToTAbstractType_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.TypeToTAbstractType, Set<ModiscoTGG.ReturnType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ReturnType__Marker_CONTEXT__CORR__eReturnTypeToTAbstractType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ReturnType__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ReturnType__Marker source, ModiscoTGG.TypeToTAbstractType target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ReturnType__Marker> message) {
		...
		ModiscoTGG.TypeToTAbstractType target = (ModiscoTGG.TypeToTAbstractType) message.input.getCONTEXT__CORR__eReturnTypeToTAbstractType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ReturnType__Marker, ModiscoTGG.TypeToTAbstractType> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ReturnType__Marker, ModiscoTGG.TypeToTAbstractType> message) {
