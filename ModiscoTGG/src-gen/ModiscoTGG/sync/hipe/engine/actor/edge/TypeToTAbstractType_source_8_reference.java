...
public class TypeToTAbstractType_source_8_reference extends AbstractActor {
	...
	public TypeToTAbstractType_source_8_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ParameterizedTypeToClass__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
	}	
