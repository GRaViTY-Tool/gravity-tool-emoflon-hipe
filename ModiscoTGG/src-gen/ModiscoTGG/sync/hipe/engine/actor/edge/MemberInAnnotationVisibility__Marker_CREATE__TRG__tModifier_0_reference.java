...
public class MemberInAnnotationVisibility__Marker_CREATE__TRG__tModifier_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TModifier, Set<ModiscoTGG.MemberInAnnotationVisibility__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MemberInAnnotationVisibility__Marker_CREATE__TRG__tModifier_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MemberInAnnotationVisibility__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MemberInAnnotationVisibility__Marker source, org.gravity.typegraph.basic.TModifier target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MemberInAnnotationVisibility__Marker> message) {
		...
		org.gravity.typegraph.basic.TModifier target = (org.gravity.typegraph.basic.TModifier) message.input.getCREATE__TRG__tModifier();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MemberInAnnotationVisibility__Marker, org.gravity.typegraph.basic.TModifier> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MemberInAnnotationVisibility__Marker, org.gravity.typegraph.basic.TModifier> message) {
