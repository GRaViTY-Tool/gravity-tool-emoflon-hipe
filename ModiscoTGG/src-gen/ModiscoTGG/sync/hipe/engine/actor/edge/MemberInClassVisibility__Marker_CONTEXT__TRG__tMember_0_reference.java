...
public class MemberInClassVisibility__Marker_CONTEXT__TRG__tMember_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TMember, Set<ModiscoTGG.MemberInClassVisibility__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MemberInClassVisibility__Marker_CONTEXT__TRG__tMember_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MemberInClassVisibility__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MemberInClassVisibility__Marker source, org.gravity.typegraph.basic.TMember target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MemberInClassVisibility__Marker, org.gravity.typegraph.basic.TMember> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MemberInClassVisibility__Marker, org.gravity.typegraph.basic.TMember> message) {
