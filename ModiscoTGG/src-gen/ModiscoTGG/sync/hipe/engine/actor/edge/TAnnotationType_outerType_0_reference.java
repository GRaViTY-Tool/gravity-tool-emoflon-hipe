...
public class TAnnotationType_outerType_0_reference extends AbstractActor {
	...
	public TAnnotationType_outerType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationTypeInAnonymous__BWD_triangle_0_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationTypeInAnonymous__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
	}	
