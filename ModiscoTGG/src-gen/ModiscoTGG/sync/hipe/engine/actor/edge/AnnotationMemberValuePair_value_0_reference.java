...
public class AnnotationMemberValuePair_value_0_reference extends AbstractActor {

	private List<Port<EdgeMatch>> ports;

	private Map<org.eclipse.modisco.java.AnnotationMemberValuePair, Set<EdgeMatch>> sourceElements = new HashMap<org.eclipse.modisco.java.AnnotationMemberValuePair, Set<EdgeMatch>>();
	private Map<org.eclipse.modisco.java.Expression, Set<EdgeMatch>> targetElements = new HashMap<org.eclipse.modisco.java.Expression, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.eclipse.modisco.java.Expression, Set<org.eclipse.modisco.java.AnnotationMemberValuePair>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValuePair_value_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueAnnotationArray__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueAnnotationArray__FWD_84_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueBooleanArray__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueBooleanArray__FWD_189_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueClassArray__CONSISTENCY_triangle_6_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueClassArray__FWD_311_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueNumberArray__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueNumberArray__FWD_495_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueStringArray__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueStringArray__FWD_588_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, org.eclipse.modisco.java.AnnotationMemberValuePair source, org.eclipse.modisco.java.Expression target) {
	...
	private void addPendingMatch(Object source, Object target) {
		Set<org.eclipse.modisco.java.AnnotationMemberValuePair> sourcePending = pending.get(target);
		if(sourcePending == null) {
			sourcePending = new HashSet<org.eclipse.modisco.java.AnnotationMemberValuePair>();
			pending.put((org.eclipse.modisco.java.Expression) target, sourcePending);
		}
		sourcePending.add((org.eclipse.modisco.java.AnnotationMemberValuePair) source);
	}
	
	private void leftAdded(NodeAddedLeft<org.eclipse.modisco.java.AnnotationMemberValuePair> message) {
		...
		org.eclipse.modisco.java.Expression target = (org.eclipse.modisco.java.Expression) message.input.getValue();
	...
	private void rightAdded(NodeAddedRight<org.eclipse.modisco.java.Expression> message) {
		...
		if(pending.containsKey(message.input)) {
			Set<org.eclipse.modisco.java.AnnotationMemberValuePair> pendingsSources = pending.get(message.input);
			for(org.eclipse.modisco.java.AnnotationMemberValuePair source : pendingsSources) {
	...
	private void leftRemoved(NodeDeletedLeft<org.eclipse.modisco.java.AnnotationMemberValuePair> message) {
		...
		for(EdgeMatch match : sourceMatches) {
			...
			Set<org.eclipse.modisco.java.AnnotationMemberValuePair> sourcePending = pending.get(match.target());
	...
	private void rightRemoved(NodeDeletedRight<org.eclipse.modisco.java.Expression> message) {
	...
	private void addReference(ReferenceAdded<org.eclipse.modisco.java.AnnotationMemberValuePair, org.eclipse.modisco.java.Expression> message) {
	...
	private void removeReference(ReferenceDeleted<org.eclipse.modisco.java.AnnotationMemberValuePair, org.eclipse.modisco.java.Expression> message) {
		Set<org.eclipse.modisco.java.AnnotationMemberValuePair> pendingSources = pending.get(message.target);
	...
	private void changeAttribute(AttributeChanged<?> message) {
		...
		if(message.node instanceof org.eclipse.modisco.java.AnnotationMemberValuePair) {
			leftChanged(message);
		}
		else {
