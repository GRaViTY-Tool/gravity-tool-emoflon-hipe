...
public class ClassDeclaration_superInterfaces_1_reference extends AbstractActor {
	...
	public ClassDeclaration_superInterfaces_1_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassImplementsInterface__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassImplementsInterface__FWD_1481_junction"), this::returnTrue));
	}	
