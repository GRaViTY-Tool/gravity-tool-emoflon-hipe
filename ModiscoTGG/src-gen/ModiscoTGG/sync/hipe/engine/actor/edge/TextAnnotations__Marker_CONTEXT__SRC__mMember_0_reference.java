...
public class TextAnnotations__Marker_CONTEXT__SRC__mMember_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MDefinition, Set<ModiscoTGG.TextAnnotations__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public TextAnnotations__Marker_CONTEXT__SRC__mMember_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("TextAnnotations__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.TextAnnotations__Marker source, org.gravity.modisco.MDefinition target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.TextAnnotations__Marker, org.gravity.modisco.MDefinition> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.TextAnnotations__Marker, org.gravity.modisco.MDefinition> message) {
