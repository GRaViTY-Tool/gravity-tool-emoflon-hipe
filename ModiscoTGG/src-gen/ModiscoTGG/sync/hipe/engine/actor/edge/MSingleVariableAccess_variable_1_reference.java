...
public class MSingleVariableAccess_variable_1_reference extends AbstractActor {
	...
	public MSingleVariableAccess_variable_1_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessRead__CONSISTENCY_triangle_9_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessRead__FWD_2498_junction"), this::returnTrue));
	}	
