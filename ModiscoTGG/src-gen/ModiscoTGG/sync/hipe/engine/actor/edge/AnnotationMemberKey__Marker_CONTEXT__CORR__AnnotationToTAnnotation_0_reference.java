...
public class AnnotationMemberKey__Marker_CONTEXT__CORR__AnnotationToTAnnotation_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.AnnotationToTAnnotation, Set<ModiscoTGG.AnnotationMemberKey__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberKey__Marker_CONTEXT__CORR__AnnotationToTAnnotation_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationMemberKey__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberKey__Marker source, ModiscoTGG.AnnotationToTAnnotation target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberKey__Marker, ModiscoTGG.AnnotationToTAnnotation> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberKey__Marker, ModiscoTGG.AnnotationToTAnnotation> message) {
