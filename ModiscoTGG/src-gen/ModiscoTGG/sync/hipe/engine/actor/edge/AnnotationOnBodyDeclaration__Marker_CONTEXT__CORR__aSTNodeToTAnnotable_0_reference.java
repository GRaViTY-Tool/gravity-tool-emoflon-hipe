...
public class AnnotationOnBodyDeclaration__Marker_CONTEXT__CORR__aSTNodeToTAnnotable_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.ASTNodeToTAnnotatable, Set<EdgeMatch>> targetElements = new HashMap<ModiscoTGG.ASTNodeToTAnnotatable, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<ModiscoTGG.ASTNodeToTAnnotatable, Set<ModiscoTGG.AnnotationOnBodyDeclaration__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationOnBodyDeclaration__Marker_CONTEXT__CORR__aSTNodeToTAnnotable_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationOnBodyDeclaration__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationOnBodyDeclaration__Marker source, ModiscoTGG.ASTNodeToTAnnotatable target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((ModiscoTGG.ASTNodeToTAnnotatable) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationOnBodyDeclaration__Marker> message) {
		...
		ModiscoTGG.ASTNodeToTAnnotatable target = (ModiscoTGG.ASTNodeToTAnnotatable) message.input.getCONTEXT__CORR__aSTNodeToTAnnotable();
	...
	private void rightAdded(NodeAddedRight<ModiscoTGG.ASTNodeToTAnnotatable> message) {
	...
	private void rightRemoved(NodeDeletedRight<ModiscoTGG.ASTNodeToTAnnotatable> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationOnBodyDeclaration__Marker, ModiscoTGG.ASTNodeToTAnnotatable> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationOnBodyDeclaration__Marker, ModiscoTGG.ASTNodeToTAnnotatable> message) {
