...
public class Enum__Marker_CREATE__TRG__tType_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TClass, Set<ModiscoTGG.Enum__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public Enum__Marker_CREATE__TRG__tType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("Enum__CONSISTENCY_triangle_8_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.Enum__Marker source, org.gravity.typegraph.basic.TClass target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.Enum__Marker, org.gravity.typegraph.basic.TClass> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.Enum__Marker, org.gravity.typegraph.basic.TClass> message) {
