...
public class MGravityModel_unresolvedItems_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.UnresolvedItem, Set<EdgeMatch>> targetElements = new HashMap<org.eclipse.modisco.java.UnresolvedItem, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.eclipse.modisco.java.UnresolvedItem, Set<org.eclipse.modisco.java.Model>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MGravityModel_unresolvedItems_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("UnresolvedTypeDeclaration__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("UnresolvedTypeDeclaration__FWD_6062_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, org.eclipse.modisco.java.Model source, org.eclipse.modisco.java.UnresolvedItem target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.eclipse.modisco.java.UnresolvedItem) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<org.eclipse.modisco.java.Model> message) {
		...
		for(org.eclipse.modisco.java.UnresolvedItem target : message.input.getUnresolvedItems()) {
	...
	private void rightAdded(NodeAddedRight<org.eclipse.modisco.java.UnresolvedItem> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.eclipse.modisco.java.UnresolvedItem> message) {
	...
	private void addReference(ReferenceAdded<org.eclipse.modisco.java.Model, org.eclipse.modisco.java.UnresolvedItem> message) {
	...
	private void removeReference(ReferenceDeleted<org.eclipse.modisco.java.Model, org.eclipse.modisco.java.UnresolvedItem> message) {
