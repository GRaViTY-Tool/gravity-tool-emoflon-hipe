...
public class FieldAccessReadWrite__Marker_CONTEXT__SRC__varDeclFrag_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.VariableDeclarationFragment, Set<ModiscoTGG.FieldAccessReadWrite__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public FieldAccessReadWrite__Marker_CONTEXT__SRC__varDeclFrag_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("FieldAccessReadWrite__CONSISTENCY_triangle_9_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.FieldAccessReadWrite__Marker source, org.eclipse.modisco.java.VariableDeclarationFragment target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.FieldAccessReadWrite__Marker> message) {
		...
		org.eclipse.modisco.java.VariableDeclarationFragment target = (org.eclipse.modisco.java.VariableDeclarationFragment) message.input.getCONTEXT__SRC__varDeclFrag();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.FieldAccessReadWrite__Marker, org.eclipse.modisco.java.VariableDeclarationFragment> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.FieldAccessReadWrite__Marker, org.eclipse.modisco.java.VariableDeclarationFragment> message) {
