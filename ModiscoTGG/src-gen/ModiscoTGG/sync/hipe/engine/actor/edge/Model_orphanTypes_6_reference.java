...
public class Model_orphanTypes_6_reference extends AbstractActor {
	...
	public Model_orphanTypes_6_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PrimitiveTypeIsFloat__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PrimitiveTypeIsFloat__FWD_5144_junction"), this::returnTrue));
	}	
