...
public class ClassDeclarationToTClass_source_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.ClassDeclaration, Set<EdgeMatch>> targetElements = new HashMap<org.eclipse.modisco.java.ClassDeclaration, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.eclipse.modisco.java.ClassDeclaration, Set<ModiscoTGG.ClassDeclarationToTClass>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ClassDeclarationToTClass_source_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassExtendsClass__BWD_1352_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassExtendsClass__BWD_1357_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassExtendsClass__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassExtendsClass__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassExtendsClass__FWD_1396_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassExtendsClass__FWD_1400_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassImplementsInterface__BWD_1437_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassImplementsInterface__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassImplementsInterface__FWD_1480_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("SyntethicMethod__BWD_5742_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("SyntethicMethod__CONSISTENCY_triangle_8_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("SyntethicMethod__FWD_5809_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ClassDeclarationToTClass source, org.eclipse.modisco.java.ClassDeclaration target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.eclipse.modisco.java.ClassDeclaration) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ClassDeclarationToTClass> message) {
		...
		org.eclipse.modisco.java.ClassDeclaration target = (org.eclipse.modisco.java.ClassDeclaration) message.input.getSource();
	...
	private void rightAdded(NodeAddedRight<org.eclipse.modisco.java.ClassDeclaration> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.eclipse.modisco.java.ClassDeclaration> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ClassDeclarationToTClass, org.eclipse.modisco.java.ClassDeclaration> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ClassDeclarationToTClass, org.eclipse.modisco.java.ClassDeclaration> message) {
