...
public class AnnotationMemberValueClassArray__Marker_CONTEXT__TRG__tAnnotationValue_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.annotations.TAnnotationValue, Set<ModiscoTGG.AnnotationMemberValueClassArray__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueClassArray__Marker_CONTEXT__TRG__tAnnotationValue_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationMemberValueClassArray__CONSISTENCY_triangle_8_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueClassArray__Marker source, org.gravity.typegraph.basic.annotations.TAnnotationValue target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueClassArray__Marker, org.gravity.typegraph.basic.annotations.TAnnotationValue> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueClassArray__Marker, org.gravity.typegraph.basic.annotations.TAnnotationValue> message) {
