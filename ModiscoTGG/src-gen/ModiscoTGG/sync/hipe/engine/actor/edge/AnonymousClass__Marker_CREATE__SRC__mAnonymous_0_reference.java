...
public class AnonymousClass__Marker_CREATE__SRC__mAnonymous_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MAnonymous, Set<ModiscoTGG.AnonymousClass__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnonymousClass__Marker_CREATE__SRC__mAnonymous_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnonymousClass__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnonymousClass__Marker source, org.gravity.modisco.MAnonymous target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnonymousClass__Marker> message) {
		...
		org.gravity.modisco.MAnonymous target = (org.gravity.modisco.MAnonymous) message.input.getCREATE__SRC__mAnonymous();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnonymousClass__Marker, org.gravity.modisco.MAnonymous> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnonymousClass__Marker, org.gravity.modisco.MAnonymous> message) {
