...
public class TClass_implements_1_reference extends AbstractActor {
	...
	public TClass_implements_1_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassImplementsInterface__BWD_1433_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassImplementsInterface__CONSISTENCY_1446_junction"), this::returnTrue));
	}	
