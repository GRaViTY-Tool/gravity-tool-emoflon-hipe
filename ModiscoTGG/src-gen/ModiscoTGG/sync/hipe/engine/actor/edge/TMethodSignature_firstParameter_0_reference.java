...
public class TMethodSignature_firstParameter_0_reference extends AbstractActor {
	...
	public TMethodSignature_firstParameter_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodParameterLinkFirst__BWD_4055_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodParameterLinkFirst__CONSISTENCY_4068_junction"), this::returnTrue));
	}	
	...
	private void leftAdded(NodeAddedLeft<org.gravity.typegraph.basic.TMethodSignature> message) {
		...
		org.gravity.typegraph.basic.TParameter target = (org.gravity.typegraph.basic.TParameter) message.input.getFirstParameter();
