...
public class Class__Marker_CONTEXT__CORR__mPackageToTPackage_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.PackageToTPackage, Set<ModiscoTGG.Class__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public Class__Marker_CONTEXT__CORR__mPackageToTPackage_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("Class__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.Class__Marker source, ModiscoTGG.PackageToTPackage target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.Class__Marker, ModiscoTGG.PackageToTPackage> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.Class__Marker, ModiscoTGG.PackageToTPackage> message) {
