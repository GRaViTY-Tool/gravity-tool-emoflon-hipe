...
public class MethodParameter__Marker_CONTEXT__SRC__mSignature_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MMethodSignature, Set<ModiscoTGG.MethodParameter__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodParameter__Marker_CONTEXT__SRC__mSignature_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodParameter__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodParameter__Marker source, org.gravity.modisco.MMethodSignature target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodParameter__Marker, org.gravity.modisco.MMethodSignature> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodParameter__Marker, org.gravity.modisco.MMethodSignature> message) {
