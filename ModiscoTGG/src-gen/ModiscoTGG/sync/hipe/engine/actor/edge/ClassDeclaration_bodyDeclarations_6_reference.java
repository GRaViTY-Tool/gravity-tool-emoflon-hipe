...
public class ClassDeclaration_bodyDeclarations_6_reference extends AbstractActor {
	...
	public ClassDeclaration_bodyDeclarations_6_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MemberInClassVisibility__BWD_3551_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MemberInClassVisibility__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MemberInClassVisibility__FWD_3609_junction"), this::returnTrue));
	}	
