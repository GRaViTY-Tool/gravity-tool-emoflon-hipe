...
public class AnnotationMemberValueAnnotationArray__Marker_CREATE__SRC__mArray_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.ArrayInitializer, Set<ModiscoTGG.AnnotationMemberValueAnnotationArray__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueAnnotationArray__Marker_CREATE__SRC__mArray_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationMemberValueAnnotationArray__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueAnnotationArray__Marker source, org.eclipse.modisco.java.ArrayInitializer target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationMemberValueAnnotationArray__Marker> message) {
		...
		org.eclipse.modisco.java.ArrayInitializer target = (org.eclipse.modisco.java.ArrayInitializer) message.input.getCREATE__SRC__mArray();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueAnnotationArray__Marker, org.eclipse.modisco.java.ArrayInitializer> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueAnnotationArray__Marker, org.eclipse.modisco.java.ArrayInitializer> message) {
