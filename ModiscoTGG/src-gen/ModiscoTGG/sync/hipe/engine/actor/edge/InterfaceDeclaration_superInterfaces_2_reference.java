...
public class InterfaceDeclaration_superInterfaces_2_reference extends AbstractActor {
	...
	public InterfaceDeclaration_superInterfaces_2_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("InterfaceExtendsInterface__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("InterfaceExtendsInterface__FWD_3013_junction"), this::returnTrue));
	}	
