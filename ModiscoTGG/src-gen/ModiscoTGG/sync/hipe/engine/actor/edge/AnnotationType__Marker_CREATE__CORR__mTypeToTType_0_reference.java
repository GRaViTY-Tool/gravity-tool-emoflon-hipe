...
public class AnnotationType__Marker_CREATE__CORR__mTypeToTType_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.TypeToTAbstractType, Set<ModiscoTGG.AnnotationType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationType__Marker_CREATE__CORR__mTypeToTType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationType__CONSISTENCY_944_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationType__Marker source, ModiscoTGG.TypeToTAbstractType target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationType__Marker> message) {
		...
		ModiscoTGG.TypeToTAbstractType target = (ModiscoTGG.TypeToTAbstractType) message.input.getCREATE__CORR__mTypeToTType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationType__Marker, ModiscoTGG.TypeToTAbstractType> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationType__Marker, ModiscoTGG.TypeToTAbstractType> message) {
