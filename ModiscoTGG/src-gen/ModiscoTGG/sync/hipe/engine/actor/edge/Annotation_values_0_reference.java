...
public class Annotation_values_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.AnnotationMemberValuePair, Set<org.eclipse.modisco.java.Annotation>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public Annotation_values_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberKey__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberKey__FWD_35_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, org.eclipse.modisco.java.Annotation source, org.eclipse.modisco.java.AnnotationMemberValuePair target) {
	...
	private void leftAdded(NodeAddedLeft<org.eclipse.modisco.java.Annotation> message) {
		...
		for(org.eclipse.modisco.java.AnnotationMemberValuePair target : message.input.getValues()) {
	...
	private void addReference(ReferenceAdded<org.eclipse.modisco.java.Annotation, org.eclipse.modisco.java.AnnotationMemberValuePair> message) {
	...
	private void removeReference(ReferenceDeleted<org.eclipse.modisco.java.Annotation, org.eclipse.modisco.java.AnnotationMemberValuePair> message) {
