...
public class SuperMethodInvocation__Marker_CONTEXT__SRC__mMethod_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MAbstractMethodDefinition, Set<ModiscoTGG.SuperMethodInvocation__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public SuperMethodInvocation__Marker_CONTEXT__SRC__mMethod_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("SuperMethodInvocation__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.SuperMethodInvocation__Marker source, org.gravity.modisco.MAbstractMethodDefinition target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.SuperMethodInvocation__Marker, org.gravity.modisco.MAbstractMethodDefinition> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.SuperMethodInvocation__Marker, org.gravity.modisco.MAbstractMethodDefinition> message) {
