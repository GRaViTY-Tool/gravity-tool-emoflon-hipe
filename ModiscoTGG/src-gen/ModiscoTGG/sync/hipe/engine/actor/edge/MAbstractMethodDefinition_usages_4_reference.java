...
public class MAbstractMethodDefinition_usages_4_reference extends AbstractActor {
	...
	public MAbstractMethodDefinition_usages_4_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("SuperMethodInvocation__CONSISTENCY_5681_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("SuperMethodInvocation__FWD_5726_junction"), this::returnTrue));
	}	
