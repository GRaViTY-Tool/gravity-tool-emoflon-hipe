...
public class ArrayInitializer_expressions_5_reference extends AbstractActor {
	...
	public ArrayInitializer_expressions_5_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ArrayInitializerIgnoreExpressionsEdge__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("ArrayInitializerIgnoreExpressionsEdge__FWD_production"), this::returnTrue));
	}	
