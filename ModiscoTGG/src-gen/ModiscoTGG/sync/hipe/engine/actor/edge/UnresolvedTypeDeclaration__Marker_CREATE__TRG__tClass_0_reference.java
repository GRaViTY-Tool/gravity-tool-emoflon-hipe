...
public class UnresolvedTypeDeclaration__Marker_CREATE__TRG__tClass_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TUnresolvedType, Set<EdgeMatch>> targetElements = new HashMap<org.gravity.typegraph.basic.TUnresolvedType, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.gravity.typegraph.basic.TUnresolvedType, Set<ModiscoTGG.UnresolvedTypeDeclaration__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public UnresolvedTypeDeclaration__Marker_CREATE__TRG__tClass_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("UnresolvedTypeDeclaration__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.UnresolvedTypeDeclaration__Marker source, org.gravity.typegraph.basic.TUnresolvedType target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.gravity.typegraph.basic.TUnresolvedType) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.UnresolvedTypeDeclaration__Marker> message) {
		...
		org.gravity.typegraph.basic.TUnresolvedType target = (org.gravity.typegraph.basic.TUnresolvedType) message.input.getCREATE__TRG__tClass();
	...
	private void rightAdded(NodeAddedRight<org.gravity.typegraph.basic.TUnresolvedType> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.gravity.typegraph.basic.TUnresolvedType> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.UnresolvedTypeDeclaration__Marker, org.gravity.typegraph.basic.TUnresolvedType> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.UnresolvedTypeDeclaration__Marker, org.gravity.typegraph.basic.TUnresolvedType> message) {
