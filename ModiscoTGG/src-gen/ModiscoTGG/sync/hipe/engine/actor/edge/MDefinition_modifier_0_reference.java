...
public class MDefinition_modifier_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.Modifier, Set<EdgeMatch>> targetElements = new HashMap<org.eclipse.modisco.java.Modifier, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.eclipse.modisco.java.Modifier, Set<org.eclipse.modisco.java.BodyDeclaration>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MDefinition_modifier_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("InterfaceMember__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("InterfaceMember__FWD_3179_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MemberInAnnotationVisibility__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MemberInAnnotationVisibility__FWD_3524_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MemberInClassVisibility__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MemberInClassVisibility__FWD_3605_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MemberInEnumVisibility__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MemberInEnumVisibility__FWD_3686_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, org.eclipse.modisco.java.BodyDeclaration source, org.eclipse.modisco.java.Modifier target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.eclipse.modisco.java.Modifier) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<org.eclipse.modisco.java.BodyDeclaration> message) {
		...
		org.eclipse.modisco.java.Modifier target = (org.eclipse.modisco.java.Modifier) message.input.getModifier();
	...
	private void rightAdded(NodeAddedRight<org.eclipse.modisco.java.Modifier> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.eclipse.modisco.java.Modifier> message) {
	...
	private void addReference(ReferenceAdded<org.eclipse.modisco.java.BodyDeclaration, org.eclipse.modisco.java.Modifier> message) {
	...
	private void removeReference(ReferenceDeleted<org.eclipse.modisco.java.BodyDeclaration, org.eclipse.modisco.java.Modifier> message) {
