...
public class MMethodSignature_mFirstEntry_0_reference extends AbstractActor {
	...
	public MMethodSignature_mFirstEntry_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodParameterLinkFirst__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodParameterLinkFirst__FWD_4095_junction"), this::returnTrue));
	}	
	...
	private void leftAdded(NodeAddedLeft<org.gravity.modisco.MParameterList> message) {
		...
		org.gravity.modisco.MEntry target = (org.gravity.modisco.MEntry) message.input.getMFirstEntry();
