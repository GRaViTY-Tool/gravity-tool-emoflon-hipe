...
public class FieldType__Marker_CONTEXT__CORR__mSignatureToTFieldSignature_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.MSignatureToTSignature, Set<ModiscoTGG.FieldType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public FieldType__Marker_CONTEXT__CORR__mSignatureToTFieldSignature_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("FieldType__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.FieldType__Marker source, ModiscoTGG.MSignatureToTSignature target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.FieldType__Marker, ModiscoTGG.MSignatureToTSignature> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.FieldType__Marker, ModiscoTGG.MSignatureToTSignature> message) {
