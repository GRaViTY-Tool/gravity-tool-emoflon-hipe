...
public class TMethodDefinition_tAnnotation_1_reference extends AbstractActor {
	...
	public TMethodDefinition_tAnnotation_1_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ConstructorDefinition__BWD_1969_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ConstructorDefinition__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
