...
public class ClassDeclaration_usagesInTypeAccess_3_reference extends AbstractActor {
	...
	public ClassDeclaration_usagesInTypeAccess_3_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassExtendsClass__CONSISTENCY_1366_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassExtendsClass__FWD_1401_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassExtendsClass_eTypeAccess_usagesInTypeAccess_incoming_SRC__FILTER_NAC_1425_junction"), this::returnTrue));
	}	
