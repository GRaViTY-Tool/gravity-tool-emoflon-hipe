...
public class AnnotationType__Marker_CONTEXT__CORR__mPackageToTPackage_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.PackageToTPackage, Set<ModiscoTGG.AnnotationType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationType__Marker_CONTEXT__CORR__mPackageToTPackage_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationType__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationType__Marker source, ModiscoTGG.PackageToTPackage target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationType__Marker> message) {
		...
		ModiscoTGG.PackageToTPackage target = (ModiscoTGG.PackageToTPackage) message.input.getCONTEXT__CORR__mPackageToTPackage();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationType__Marker, ModiscoTGG.PackageToTPackage> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationType__Marker, ModiscoTGG.PackageToTPackage> message) {
