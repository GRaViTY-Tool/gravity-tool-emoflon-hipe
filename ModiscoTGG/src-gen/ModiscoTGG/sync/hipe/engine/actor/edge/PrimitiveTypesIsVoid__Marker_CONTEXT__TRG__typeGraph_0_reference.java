...
public class PrimitiveTypesIsVoid__Marker_CONTEXT__TRG__typeGraph_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TypeGraph, Set<ModiscoTGG.PrimitiveTypesIsVoid__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public PrimitiveTypesIsVoid__Marker_CONTEXT__TRG__typeGraph_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("PrimitiveTypesIsVoid__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.PrimitiveTypesIsVoid__Marker source, org.gravity.typegraph.basic.TypeGraph target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.PrimitiveTypesIsVoid__Marker, org.gravity.typegraph.basic.TypeGraph> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.PrimitiveTypesIsVoid__Marker, org.gravity.typegraph.basic.TypeGraph> message) {
