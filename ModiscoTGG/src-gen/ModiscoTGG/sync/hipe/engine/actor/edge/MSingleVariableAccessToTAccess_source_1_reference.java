...
public class MSingleVariableAccessToTAccess_source_1_reference extends AbstractActor {
	...
	public MSingleVariableAccessToTAccess_source_1_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessRead__CONSISTENCY_triangle_13_triangleJunction"), this::returnTrue));
	}	
