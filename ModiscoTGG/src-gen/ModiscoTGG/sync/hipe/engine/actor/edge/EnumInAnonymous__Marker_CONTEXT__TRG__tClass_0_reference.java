...
public class EnumInAnonymous__Marker_CONTEXT__TRG__tClass_0_reference extends AbstractActor {
	...
	public EnumInAnonymous__Marker_CONTEXT__TRG__tClass_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("EnumInAnonymous__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
