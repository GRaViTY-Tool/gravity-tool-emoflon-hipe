...
public class ArrayTypeToClass__Marker_CONTEXT__SRC__eType_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.Type, Set<ModiscoTGG.ArrayTypeToClass__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ArrayTypeToClass__Marker_CONTEXT__SRC__eType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ArrayTypeToClass__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ArrayTypeToClass__Marker source, org.eclipse.modisco.java.Type target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ArrayTypeToClass__Marker, org.eclipse.modisco.java.Type> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ArrayTypeToClass__Marker, org.eclipse.modisco.java.Type> message) {
