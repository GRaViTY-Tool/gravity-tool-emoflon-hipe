...
public class TClass_pg_14_reference extends AbstractActor {
	...
	public TClass_pg_14_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("TypeParameter__BWD_5882_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("TypeParameter__CONSISTENCY_5892_junction"), this::returnTrue));
	}	
