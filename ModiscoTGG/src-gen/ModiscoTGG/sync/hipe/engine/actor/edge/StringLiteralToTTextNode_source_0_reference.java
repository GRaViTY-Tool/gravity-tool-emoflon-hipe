...
public class StringLiteralToTTextNode_source_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.StringLiteral, Set<ModiscoTGG.StringLiteralToTTextNode>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public StringLiteralToTTextNode_source_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueStringArray__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueString__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.StringLiteralToTTextNode source, org.eclipse.modisco.java.StringLiteral target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.StringLiteralToTTextNode> message) {
		...
		org.eclipse.modisco.java.StringLiteral target = (org.eclipse.modisco.java.StringLiteral) message.input.getSource();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.StringLiteralToTTextNode, org.eclipse.modisco.java.StringLiteral> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.StringLiteralToTTextNode, org.eclipse.modisco.java.StringLiteral> message) {
