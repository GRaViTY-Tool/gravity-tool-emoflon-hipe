...
public class FieldDefinition__Marker_CONTEXT__TRG__tFieldSignature_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TFieldSignature, Set<EdgeMatch>> targetElements = new HashMap<org.gravity.typegraph.basic.TFieldSignature, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.gravity.typegraph.basic.TFieldSignature, Set<ModiscoTGG.FieldDefinition__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public FieldDefinition__Marker_CONTEXT__TRG__tFieldSignature_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("FieldDefinition__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.FieldDefinition__Marker source, org.gravity.typegraph.basic.TFieldSignature target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.gravity.typegraph.basic.TFieldSignature) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.FieldDefinition__Marker> message) {
		...
		org.gravity.typegraph.basic.TFieldSignature target = (org.gravity.typegraph.basic.TFieldSignature) message.input.getCONTEXT__TRG__tFieldSignature();
	...
	private void rightAdded(NodeAddedRight<org.gravity.typegraph.basic.TFieldSignature> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.gravity.typegraph.basic.TFieldSignature> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.FieldDefinition__Marker, org.gravity.typegraph.basic.TFieldSignature> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.FieldDefinition__Marker, org.gravity.typegraph.basic.TFieldSignature> message) {
