...
public class TClass_outerType_2_reference extends AbstractActor {
	...
	public TClass_outerType_2_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnonymousClass__BWD_triangle_0_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnonymousClass__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
	}	
