...
public class AnnotationMemberValuePair_value_5_reference extends AbstractActor {
	...
	public AnnotationMemberValuePair_value_5_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueString__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueString__FWD_632_junction"), this::returnTrue));
	}	
