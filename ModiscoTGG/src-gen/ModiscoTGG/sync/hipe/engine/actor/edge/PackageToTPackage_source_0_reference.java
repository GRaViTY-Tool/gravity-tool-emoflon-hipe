...
public class PackageToTPackage_source_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.Package, Set<EdgeMatch>> targetElements = new HashMap<org.eclipse.modisco.java.Package, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.eclipse.modisco.java.Package, Set<ModiscoTGG.PackageToTPackage>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public PackageToTPackage_source_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationType__BWD_928_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationType__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationType__FWD_986_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("Class__BWD_1890_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("Class__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("Class__FWD_1955_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("Enum__BWD_2189_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("Enum__CONSISTENCY_triangle_6_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("Enum__FWD_2256_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("Interface__BWD_3202_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("Interface__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("Interface__FWD_3267_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PackageToPGPackage__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("SubPackageToPGPackage__BWD_5516_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("SubPackageToPGPackage__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("SubPackageToPGPackage__CONSISTENCY_triangle_6_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("SubPackageToPGPackage__FWD_5564_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.PackageToTPackage source, org.eclipse.modisco.java.Package target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.eclipse.modisco.java.Package) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.PackageToTPackage> message) {
		...
		org.eclipse.modisco.java.Package target = (org.eclipse.modisco.java.Package) message.input.getSource();
	...
	private void rightAdded(NodeAddedRight<org.eclipse.modisco.java.Package> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.eclipse.modisco.java.Package> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.PackageToTPackage, org.eclipse.modisco.java.Package> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.PackageToTPackage, org.eclipse.modisco.java.Package> message) {
