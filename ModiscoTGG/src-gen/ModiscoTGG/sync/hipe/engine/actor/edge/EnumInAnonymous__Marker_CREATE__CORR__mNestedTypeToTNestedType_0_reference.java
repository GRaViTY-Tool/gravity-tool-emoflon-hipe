...
public class EnumInAnonymous__Marker_CREATE__CORR__mNestedTypeToTNestedType_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.TypeToTAbstractType, Set<ModiscoTGG.EnumInAnonymous__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public EnumInAnonymous__Marker_CREATE__CORR__mNestedTypeToTNestedType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("EnumInAnonymous__CONSISTENCY_triangle_9_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.EnumInAnonymous__Marker source, ModiscoTGG.TypeToTAbstractType target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.EnumInAnonymous__Marker, ModiscoTGG.TypeToTAbstractType> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.EnumInAnonymous__Marker, ModiscoTGG.TypeToTAbstractType> message) {
