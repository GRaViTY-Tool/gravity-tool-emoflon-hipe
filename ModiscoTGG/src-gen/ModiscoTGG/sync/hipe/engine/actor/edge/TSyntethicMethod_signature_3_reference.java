...
public class TSyntethicMethod_signature_3_reference extends AbstractActor {
	...
	public TSyntethicMethod_signature_3_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("SyntethicMethod__BWD_triangle_0_triangleJunction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("SyntethicMethod__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
	}	
