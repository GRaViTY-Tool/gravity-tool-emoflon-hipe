...
public class ClassInstanceCreation_type_0_reference extends AbstractActor {

	private List<Port<EdgeMatch>> ports;

	private Map<org.eclipse.modisco.java.ClassInstanceCreation, Set<EdgeMatch>> sourceElements = new HashMap<org.eclipse.modisco.java.ClassInstanceCreation, Set<EdgeMatch>>();
	...
	private Map<org.eclipse.modisco.java.TypeAccess, Set<org.eclipse.modisco.java.ClassInstanceCreation>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ClassInstanceCreation_type_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationTypeAccess__CONSISTENCY_6143_nacjunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationTypeAccess__CONSISTENCY_6146_nacjunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationTypeAccess__CONSISTENCY_6148_nacjunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationTypeAccess__FWD_6151_nacjunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationTypeAccess__FWD_6154_nacjunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationTypeAccess__FWD_6156_nacjunction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationTypeAccess_mAccess_type_incoming_SRC__FILTER_NAC_production"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnonymousClassTypeClass__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnonymousClassTypeClass__FWD_1046_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnonymousClassTypeInterface__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnonymousClassTypeInterface__FWD_1136_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, org.eclipse.modisco.java.ClassInstanceCreation source, org.eclipse.modisco.java.TypeAccess target) {
	...
	private void addPendingMatch(Object source, Object target) {
		Set<org.eclipse.modisco.java.ClassInstanceCreation> sourcePending = pending.get(target);
		if(sourcePending == null) {
			sourcePending = new HashSet<org.eclipse.modisco.java.ClassInstanceCreation>();
			pending.put((org.eclipse.modisco.java.TypeAccess) target, sourcePending);
		}
		sourcePending.add((org.eclipse.modisco.java.ClassInstanceCreation) source);
	}
	
	private void leftAdded(NodeAddedLeft<org.eclipse.modisco.java.ClassInstanceCreation> message) {
	...
	private void rightAdded(NodeAddedRight<org.eclipse.modisco.java.TypeAccess> message) {
		...
		if(pending.containsKey(message.input)) {
			Set<org.eclipse.modisco.java.ClassInstanceCreation> pendingsSources = pending.get(message.input);
			for(org.eclipse.modisco.java.ClassInstanceCreation source : pendingsSources) {
	...
	private void leftRemoved(NodeDeletedLeft<org.eclipse.modisco.java.ClassInstanceCreation> message) {
		...
		for(EdgeMatch match : sourceMatches) {
			...
			Set<org.eclipse.modisco.java.ClassInstanceCreation> sourcePending = pending.get(match.target());
	...
	private void addReference(ReferenceAdded<org.eclipse.modisco.java.ClassInstanceCreation, org.eclipse.modisco.java.TypeAccess> message) {
	...
	private void removeReference(ReferenceDeleted<org.eclipse.modisco.java.ClassInstanceCreation, org.eclipse.modisco.java.TypeAccess> message) {
		Set<org.eclipse.modisco.java.ClassInstanceCreation> pendingSources = pending.get(message.target);
	...
	private void changeAttribute(AttributeChanged<?> message) {
		...
		if(message.node instanceof org.eclipse.modisco.java.ClassInstanceCreation) {
			leftChanged(message);
		}
		else {
