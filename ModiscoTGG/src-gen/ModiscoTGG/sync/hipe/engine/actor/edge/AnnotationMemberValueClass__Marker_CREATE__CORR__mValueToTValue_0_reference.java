...
public class AnnotationMemberValueClass__Marker_CREATE__CORR__mValueToTValue_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.ClassLiteralToClassNode, Set<EdgeMatch>> targetElements = new HashMap<ModiscoTGG.ClassLiteralToClassNode, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<ModiscoTGG.ClassLiteralToClassNode, Set<ModiscoTGG.AnnotationMemberValueClass__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueClass__Marker_CREATE__CORR__mValueToTValue_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationMemberValueClass__CONSISTENCY_triangle_8_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueClass__Marker source, ModiscoTGG.ClassLiteralToClassNode target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((ModiscoTGG.ClassLiteralToClassNode) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationMemberValueClass__Marker> message) {
		...
		ModiscoTGG.ClassLiteralToClassNode target = (ModiscoTGG.ClassLiteralToClassNode) message.input.getCREATE__CORR__mValueToTValue();
	...
	private void rightAdded(NodeAddedRight<ModiscoTGG.ClassLiteralToClassNode> message) {
	...
	private void rightRemoved(NodeDeletedRight<ModiscoTGG.ClassLiteralToClassNode> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueClass__Marker, ModiscoTGG.ClassLiteralToClassNode> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueClass__Marker, ModiscoTGG.ClassLiteralToClassNode> message) {
