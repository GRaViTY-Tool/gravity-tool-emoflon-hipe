...
public class ConstructorInvocation__Marker_CREATE__TRG__tAccess_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TCall, Set<ModiscoTGG.ConstructorInvocation__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ConstructorInvocation__Marker_CREATE__TRG__tAccess_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ConstructorInvocation__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ConstructorInvocation__Marker source, org.gravity.typegraph.basic.TCall target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ConstructorInvocation__Marker, org.gravity.typegraph.basic.TCall> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ConstructorInvocation__Marker, org.gravity.typegraph.basic.TCall> message) {
