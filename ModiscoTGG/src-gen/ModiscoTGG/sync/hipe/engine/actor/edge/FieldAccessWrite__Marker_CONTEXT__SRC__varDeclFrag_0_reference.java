...
public class FieldAccessWrite__Marker_CONTEXT__SRC__varDeclFrag_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.VariableDeclarationFragment, Set<ModiscoTGG.FieldAccessWrite__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public FieldAccessWrite__Marker_CONTEXT__SRC__varDeclFrag_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("FieldAccessWrite__CONSISTENCY_triangle_9_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.FieldAccessWrite__Marker source, org.eclipse.modisco.java.VariableDeclarationFragment target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.FieldAccessWrite__Marker, org.eclipse.modisco.java.VariableDeclarationFragment> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.FieldAccessWrite__Marker, org.eclipse.modisco.java.VariableDeclarationFragment> message) {
