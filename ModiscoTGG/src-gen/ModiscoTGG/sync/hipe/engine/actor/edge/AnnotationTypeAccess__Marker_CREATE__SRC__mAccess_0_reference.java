...
public class AnnotationTypeAccess__Marker_CREATE__SRC__mAccess_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.TypeAccess, Set<ModiscoTGG.AnnotationTypeAccess__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationTypeAccess__Marker_CREATE__SRC__mAccess_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationTypeAccess__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationTypeAccess__Marker source, org.eclipse.modisco.java.TypeAccess target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationTypeAccess__Marker, org.eclipse.modisco.java.TypeAccess> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationTypeAccess__Marker, org.eclipse.modisco.java.TypeAccess> message) {
