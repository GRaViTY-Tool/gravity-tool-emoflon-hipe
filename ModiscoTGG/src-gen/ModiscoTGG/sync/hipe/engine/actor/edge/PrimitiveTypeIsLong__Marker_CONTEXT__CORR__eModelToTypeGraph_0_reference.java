...
public class PrimitiveTypeIsLong__Marker_CONTEXT__CORR__eModelToTypeGraph_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.ModelToTypeGraph, Set<ModiscoTGG.PrimitiveTypeIsLong__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public PrimitiveTypeIsLong__Marker_CONTEXT__CORR__eModelToTypeGraph_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("PrimitiveTypeIsLong__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.PrimitiveTypeIsLong__Marker source, ModiscoTGG.ModelToTypeGraph target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.PrimitiveTypeIsLong__Marker, ModiscoTGG.ModelToTypeGraph> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.PrimitiveTypeIsLong__Marker, ModiscoTGG.ModelToTypeGraph> message) {
