...
public class TMethodDefinition_returnType_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TAbstractType, Set<org.gravity.typegraph.basic.TMethodDefinition>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public TMethodDefinition_returnType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ReturnType__BWD_5382_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ReturnType__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, org.gravity.typegraph.basic.TMethodDefinition source, org.gravity.typegraph.basic.TAbstractType target) {
	...
	private void leftAdded(NodeAddedLeft<org.gravity.typegraph.basic.TMethodDefinition> message) {
		...
		org.gravity.typegraph.basic.TAbstractType target = (org.gravity.typegraph.basic.TAbstractType) message.input.getReturnType();
	...
	private void addReference(ReferenceAdded<org.gravity.typegraph.basic.TMethodDefinition, org.gravity.typegraph.basic.TAbstractType> message) {
	...
	private void removeReference(ReferenceDeleted<org.gravity.typegraph.basic.TMethodDefinition, org.gravity.typegraph.basic.TAbstractType> message) {
