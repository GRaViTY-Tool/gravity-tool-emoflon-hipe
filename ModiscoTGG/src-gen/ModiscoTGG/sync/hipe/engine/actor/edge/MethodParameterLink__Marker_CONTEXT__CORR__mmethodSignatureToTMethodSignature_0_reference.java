...
public class MethodParameterLink__Marker_CONTEXT__CORR__mmethodSignatureToTMethodSignature_0_reference extends AbstractActor {
	...
	public MethodParameterLink__Marker_CONTEXT__CORR__mmethodSignatureToTMethodSignature_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodParameterLink__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MethodParameterLink__Marker> message) {
		...
		ModiscoTGG.MEntryToTParameter target = (ModiscoTGG.MEntryToTParameter) message.input.getCONTEXT__CORR__mmethodSignatureToTMethodSignature();
