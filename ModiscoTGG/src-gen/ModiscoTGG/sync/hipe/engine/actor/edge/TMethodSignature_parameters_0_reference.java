...
public class TMethodSignature_parameters_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodParameterType__BWD_4169_junction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodParameterType__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodParameter__BWD_4243_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodParameter__CONSISTENCY_4254_junction"), this::returnTrue));
	}	
