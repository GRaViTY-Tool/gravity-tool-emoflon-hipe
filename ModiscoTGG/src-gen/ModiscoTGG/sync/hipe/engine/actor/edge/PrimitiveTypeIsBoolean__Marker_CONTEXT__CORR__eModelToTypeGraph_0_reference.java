...
public class PrimitiveTypeIsBoolean__Marker_CONTEXT__CORR__eModelToTypeGraph_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.ModelToTypeGraph, Set<ModiscoTGG.PrimitiveTypeIsBoolean__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public PrimitiveTypeIsBoolean__Marker_CONTEXT__CORR__eModelToTypeGraph_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("PrimitiveTypeIsBoolean__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.PrimitiveTypeIsBoolean__Marker source, ModiscoTGG.ModelToTypeGraph target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.PrimitiveTypeIsBoolean__Marker> message) {
		...
		ModiscoTGG.ModelToTypeGraph target = (ModiscoTGG.ModelToTypeGraph) message.input.getCONTEXT__CORR__eModelToTypeGraph();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.PrimitiveTypeIsBoolean__Marker, ModiscoTGG.ModelToTypeGraph> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.PrimitiveTypeIsBoolean__Marker, ModiscoTGG.ModelToTypeGraph> message) {
