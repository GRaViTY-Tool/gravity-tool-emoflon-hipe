...
public class ModelToPg__Marker_CREATE__CORR__mModelToTPG_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.ModelToTypeGraph, Set<ModiscoTGG.ModelToPg__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ModelToPg__Marker_CREATE__CORR__mModelToTPG_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ModelToPg__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ModelToPg__Marker source, ModiscoTGG.ModelToTypeGraph target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ModelToPg__Marker> message) {
		...
		ModiscoTGG.ModelToTypeGraph target = (ModiscoTGG.ModelToTypeGraph) message.input.getCREATE__CORR__mModelToTPG();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ModelToPg__Marker, ModiscoTGG.ModelToTypeGraph> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ModelToPg__Marker, ModiscoTGG.ModelToTypeGraph> message) {
