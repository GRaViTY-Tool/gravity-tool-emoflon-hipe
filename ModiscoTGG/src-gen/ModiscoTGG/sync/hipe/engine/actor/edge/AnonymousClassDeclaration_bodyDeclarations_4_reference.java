...
public class AnonymousClassDeclaration_bodyDeclarations_4_reference extends AbstractActor {
	...
	public AnonymousClassDeclaration_bodyDeclarations_4_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("InterfaceInAnonymous__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("InterfaceInAnonymous__FWD_3105_junction"), this::returnTrue));
	}	
