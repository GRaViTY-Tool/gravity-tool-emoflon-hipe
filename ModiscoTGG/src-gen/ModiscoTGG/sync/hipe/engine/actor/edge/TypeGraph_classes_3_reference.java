...
public class TypeGraph_classes_3_reference extends AbstractActor {
	...
	public TypeGraph_classes_3_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("PrimitiveTypeIsByte__BWD_4934_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PrimitiveTypeIsByte__CONSISTENCY_4944_junction"), this::returnTrue));
	}	
