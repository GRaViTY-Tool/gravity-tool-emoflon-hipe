...
public class AnonymousClassTypeInterface__Marker_CONTEXT__SRC__mParent_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.AbstractTypeDeclaration, Set<ModiscoTGG.AnonymousClassTypeInterface__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnonymousClassTypeInterface__Marker_CONTEXT__SRC__mParent_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnonymousClassTypeInterface__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnonymousClassTypeInterface__Marker source, org.eclipse.modisco.java.AbstractTypeDeclaration target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnonymousClassTypeInterface__Marker> message) {
		...
		org.eclipse.modisco.java.AbstractTypeDeclaration target = (org.eclipse.modisco.java.AbstractTypeDeclaration) message.input.getCONTEXT__SRC__mParent();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnonymousClassTypeInterface__Marker, org.eclipse.modisco.java.AbstractTypeDeclaration> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnonymousClassTypeInterface__Marker, org.eclipse.modisco.java.AbstractTypeDeclaration> message) {
