...
public class MethodParameterType__Marker_CREATE__SRC__mEntry_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MEntry, Set<ModiscoTGG.MethodParameterType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodParameterType__Marker_CREATE__SRC__mEntry_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodParameterType__CONSISTENCY_triangle_9_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodParameterType__Marker source, org.gravity.modisco.MEntry target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MethodParameterType__Marker> message) {
		...
		org.gravity.modisco.MEntry target = (org.gravity.modisco.MEntry) message.input.getCREATE__SRC__mEntry();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodParameterType__Marker, org.gravity.modisco.MEntry> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodParameterType__Marker, org.gravity.modisco.MEntry> message) {
