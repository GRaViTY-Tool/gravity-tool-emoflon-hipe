...
public class TWrite_tSource_3_reference extends AbstractActor {
	...
	public TWrite_tSource_3_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessWrite__BWD_2537_junction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("FieldAccessWrite__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
