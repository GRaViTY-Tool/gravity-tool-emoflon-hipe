...
public class AnonymousClassTypeClass__Marker_CREATE__SRC__mCreation_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.ClassInstanceCreation, Set<ModiscoTGG.AnonymousClassTypeClass__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnonymousClassTypeClass__Marker_CREATE__SRC__mCreation_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnonymousClassTypeClass__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnonymousClassTypeClass__Marker source, org.eclipse.modisco.java.ClassInstanceCreation target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnonymousClassTypeClass__Marker, org.eclipse.modisco.java.ClassInstanceCreation> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnonymousClassTypeClass__Marker, org.eclipse.modisco.java.ClassInstanceCreation> message) {
