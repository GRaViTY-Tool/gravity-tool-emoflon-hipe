...
public class MConstructorDefinition_mSignature_0_reference extends AbstractActor {
	...
	public MConstructorDefinition_mSignature_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ConstructorDefinition__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ConstructorDefinition__FWD_2019_junction"), this::returnTrue));
	}	
