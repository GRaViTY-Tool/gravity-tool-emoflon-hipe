...
public class NestedClassInType__Marker_CREATE__TRG__tNestedPackage_0_reference extends AbstractActor {
	...
	public NestedClassInType__Marker_CREATE__TRG__tNestedPackage_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("NestedClassInType__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
	}	
