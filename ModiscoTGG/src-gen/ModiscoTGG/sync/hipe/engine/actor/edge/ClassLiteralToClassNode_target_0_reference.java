...
public class ClassLiteralToClassNode_target_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.annotations.TClassNode, Set<ModiscoTGG.ClassLiteralToClassNode>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ClassLiteralToClassNode_target_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueClassArray__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueClass__CONSISTENCY_triangle_6_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ClassLiteralToClassNode source, org.gravity.typegraph.basic.annotations.TClassNode target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ClassLiteralToClassNode> message) {
		...
		org.gravity.typegraph.basic.annotations.TClassNode target = (org.gravity.typegraph.basic.annotations.TClassNode) message.input.getTarget();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ClassLiteralToClassNode, org.gravity.typegraph.basic.annotations.TClassNode> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ClassLiteralToClassNode, org.gravity.typegraph.basic.annotations.TClassNode> message) {
