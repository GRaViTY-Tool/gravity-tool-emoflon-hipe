...
public class TypeGraph_classes_7_reference extends AbstractActor {
	...
	public TypeGraph_classes_7_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("PrimitiveTypeIsInt__BWD_5158_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PrimitiveTypeIsInt__CONSISTENCY_5168_junction"), this::returnTrue));
	}	
