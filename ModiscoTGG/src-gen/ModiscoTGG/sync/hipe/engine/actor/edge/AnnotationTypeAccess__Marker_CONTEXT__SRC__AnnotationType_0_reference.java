...
public class AnnotationTypeAccess__Marker_CONTEXT__SRC__AnnotationType_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.AnnotationTypeDeclaration, Set<ModiscoTGG.AnnotationTypeAccess__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationTypeAccess__Marker_CONTEXT__SRC__AnnotationType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationTypeAccess__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationTypeAccess__Marker source, org.eclipse.modisco.java.AnnotationTypeDeclaration target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationTypeAccess__Marker> message) {
		...
		org.eclipse.modisco.java.AnnotationTypeDeclaration target = (org.eclipse.modisco.java.AnnotationTypeDeclaration) message.input.getCONTEXT__SRC__AnnotationType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationTypeAccess__Marker, org.eclipse.modisco.java.AnnotationTypeDeclaration> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationTypeAccess__Marker, org.eclipse.modisco.java.AnnotationTypeDeclaration> message) {
