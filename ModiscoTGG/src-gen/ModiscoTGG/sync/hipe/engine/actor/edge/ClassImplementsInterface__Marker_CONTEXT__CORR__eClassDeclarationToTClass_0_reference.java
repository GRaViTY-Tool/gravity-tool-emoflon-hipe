...
public class ClassImplementsInterface__Marker_CONTEXT__CORR__eClassDeclarationToTClass_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.ClassDeclarationToTClass, Set<ModiscoTGG.ClassImplementsInterface__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ClassImplementsInterface__Marker_CONTEXT__CORR__eClassDeclarationToTClass_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassImplementsInterface__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ClassImplementsInterface__Marker source, ModiscoTGG.ClassDeclarationToTClass target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ClassImplementsInterface__Marker> message) {
		...
		ModiscoTGG.ClassDeclarationToTClass target = (ModiscoTGG.ClassDeclarationToTClass) message.input.getCONTEXT__CORR__eClassDeclarationToTClass();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ClassImplementsInterface__Marker, ModiscoTGG.ClassDeclarationToTClass> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ClassImplementsInterface__Marker, ModiscoTGG.ClassDeclarationToTClass> message) {
