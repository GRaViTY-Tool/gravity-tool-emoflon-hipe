...
public class FieldAccessReadWrite__Marker_CONTEXT__TRG__tMember_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TMember, Set<ModiscoTGG.FieldAccessReadWrite__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public FieldAccessReadWrite__Marker_CONTEXT__TRG__tMember_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("FieldAccessReadWrite__CONSISTENCY_triangle_8_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.FieldAccessReadWrite__Marker source, org.gravity.typegraph.basic.TMember target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.FieldAccessReadWrite__Marker, org.gravity.typegraph.basic.TMember> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.FieldAccessReadWrite__Marker, org.gravity.typegraph.basic.TMember> message) {
