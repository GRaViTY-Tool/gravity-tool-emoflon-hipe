...
public class TClass_outerType_3_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TAbstractType, Set<org.gravity.typegraph.basic.TAbstractType>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public TClass_outerType_3_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassInAnonymous__BWD_triangle_1_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassInAnonymous__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("ClassInnerAnonClassMember__BWD_triangle_0_triangleJunction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("ClassInnerAnonClassMember__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("ClassInnerClassMember__BWD_triangle_0_triangleJunction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("ClassInnerClassMember__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("EnumInAnonymous__BWD_triangle_1_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("EnumInAnonymous__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, org.gravity.typegraph.basic.TAbstractType source, org.gravity.typegraph.basic.TAbstractType target) {
	...
	private void leftAdded(NodeAddedLeft<org.gravity.typegraph.basic.TAbstractType> message) {
		...
		org.gravity.typegraph.basic.TAbstractType target = (org.gravity.typegraph.basic.TAbstractType) message.input.getOuterType();
	...
	private void addReference(ReferenceAdded<org.gravity.typegraph.basic.TAbstractType, org.gravity.typegraph.basic.TAbstractType> message) {
	...
	private void removeReference(ReferenceDeleted<org.gravity.typegraph.basic.TAbstractType, org.gravity.typegraph.basic.TAbstractType> message) {
