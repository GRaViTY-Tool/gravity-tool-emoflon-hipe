...
public class FieldDefinition__Marker_CREATE__SRC__mDefinition_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MFieldDefinition, Set<ModiscoTGG.FieldDefinition__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public FieldDefinition__Marker_CREATE__SRC__mDefinition_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("FieldDefinition__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.FieldDefinition__Marker source, org.gravity.modisco.MFieldDefinition target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.FieldDefinition__Marker> message) {
		...
		org.gravity.modisco.MFieldDefinition target = (org.gravity.modisco.MFieldDefinition) message.input.getCREATE__SRC__mDefinition();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.FieldDefinition__Marker, org.gravity.modisco.MFieldDefinition> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.FieldDefinition__Marker, org.gravity.modisco.MFieldDefinition> message) {
