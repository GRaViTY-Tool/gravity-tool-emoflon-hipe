...
public class AnonymousClass__Marker_CONTEXT__TRG__tPackage_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TPackage, Set<ModiscoTGG.AnonymousClass__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnonymousClass__Marker_CONTEXT__TRG__tPackage_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnonymousClass__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnonymousClass__Marker source, org.gravity.typegraph.basic.TPackage target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnonymousClass__Marker, org.gravity.typegraph.basic.TPackage> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnonymousClass__Marker, org.gravity.typegraph.basic.TPackage> message) {
