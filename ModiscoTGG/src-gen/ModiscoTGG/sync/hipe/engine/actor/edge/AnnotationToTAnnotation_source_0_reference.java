...
public class AnnotationToTAnnotation_source_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.Annotation, Set<ModiscoTGG.AnnotationToTAnnotation>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationToTAnnotation_source_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberKey__BWD_3_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberKey__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberKey__FWD_37_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueAnnotationArray__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueAnnotation__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationOnBodyDeclaration__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationTypeAccess__BWD_690_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationTypeAccess__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationTypeAccess__FWD_733_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationToTAnnotation source, org.eclipse.modisco.java.Annotation target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationToTAnnotation> message) {
		...
		org.eclipse.modisco.java.Annotation target = (org.eclipse.modisco.java.Annotation) message.input.getSource();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationToTAnnotation, org.eclipse.modisco.java.Annotation> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationToTAnnotation, org.eclipse.modisco.java.Annotation> message) {
