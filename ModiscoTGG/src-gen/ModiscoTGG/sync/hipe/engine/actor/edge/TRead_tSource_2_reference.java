...
public class TRead_tSource_2_reference extends AbstractActor {
	...
	public TRead_tSource_2_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessRead__BWD_2405_junction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("FieldAccessRead__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
