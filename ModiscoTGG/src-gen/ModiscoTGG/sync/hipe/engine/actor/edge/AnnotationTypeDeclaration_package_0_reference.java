...
public class AnnotationTypeDeclaration_package_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.Package, Set<org.eclipse.modisco.java.AbstractTypeDeclaration>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationTypeDeclaration_package_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationType__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationType__FWD_980_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, org.eclipse.modisco.java.AbstractTypeDeclaration source, org.eclipse.modisco.java.Package target) {
	...
	private void addReference(ReferenceAdded<org.eclipse.modisco.java.AbstractTypeDeclaration, org.eclipse.modisco.java.Package> message) {
	...
	private void removeReference(ReferenceDeleted<org.eclipse.modisco.java.AbstractTypeDeclaration, org.eclipse.modisco.java.Package> message) {
