...
public class MethodParameter__Marker_CREATE__TRG__tParameter_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TParameter, Set<ModiscoTGG.MethodParameter__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodParameter__Marker_CREATE__TRG__tParameter_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodParameter__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodParameter__Marker source, org.gravity.typegraph.basic.TParameter target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodParameter__Marker, org.gravity.typegraph.basic.TParameter> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodParameter__Marker, org.gravity.typegraph.basic.TParameter> message) {
