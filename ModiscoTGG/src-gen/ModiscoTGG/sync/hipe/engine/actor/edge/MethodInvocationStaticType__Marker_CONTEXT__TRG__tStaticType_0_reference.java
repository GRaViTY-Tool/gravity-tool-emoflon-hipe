...
public class MethodInvocationStaticType__Marker_CONTEXT__TRG__tStaticType_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TAbstractType, Set<ModiscoTGG.MethodInvocationStaticType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodInvocationStaticType__Marker_CONTEXT__TRG__tStaticType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodInvocationStaticType__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodInvocationStaticType__Marker source, org.gravity.typegraph.basic.TAbstractType target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MethodInvocationStaticType__Marker> message) {
		...
		org.gravity.typegraph.basic.TAbstractType target = (org.gravity.typegraph.basic.TAbstractType) message.input.getCONTEXT__TRG__tStaticType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodInvocationStaticType__Marker, org.gravity.typegraph.basic.TAbstractType> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodInvocationStaticType__Marker, org.gravity.typegraph.basic.TAbstractType> message) {
