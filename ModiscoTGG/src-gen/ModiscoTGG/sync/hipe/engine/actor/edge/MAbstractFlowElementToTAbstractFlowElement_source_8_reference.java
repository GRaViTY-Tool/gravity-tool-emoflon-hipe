...
public class MAbstractFlowElementToTAbstractFlowElement_source_8_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MAbstractFlowElement, Set<EdgeMatch>> targetElements = new HashMap<org.gravity.modisco.MAbstractFlowElement, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.gravity.modisco.MAbstractFlowElement, Set<ModiscoTGG.MAbstractFlowElementToTAbstractFlowElement>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MAbstractFlowElementToTAbstractFlowElement_source_8_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("Flow__BWD_2867_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("Flow__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("Flow__FWD_2901_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("IncomingFlow__BWD_2909_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("IncomingFlow__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("IncomingFlow__FWD_2949_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("OutgoingFlow__BWD_4686_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("OutgoingFlow__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("OutgoingFlow__FWD_4726_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MAbstractFlowElementToTAbstractFlowElement source, org.gravity.modisco.MAbstractFlowElement target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.gravity.modisco.MAbstractFlowElement) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MAbstractFlowElementToTAbstractFlowElement> message) {
		...
		org.gravity.modisco.MAbstractFlowElement target = (org.gravity.modisco.MAbstractFlowElement) message.input.getSource();
	...
	private void rightAdded(NodeAddedRight<org.gravity.modisco.MAbstractFlowElement> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.gravity.modisco.MAbstractFlowElement> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MAbstractFlowElementToTAbstractFlowElement, org.gravity.modisco.MAbstractFlowElement> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MAbstractFlowElementToTAbstractFlowElement, org.gravity.modisco.MAbstractFlowElement> message) {
