...
public class MethodSignature__Marker_CONTEXT__TRG__tName_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TMethod, Set<ModiscoTGG.MethodSignature__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodSignature__Marker_CONTEXT__TRG__tName_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodSignature__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodSignature__Marker source, org.gravity.typegraph.basic.TMethod target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MethodSignature__Marker> message) {
		...
		org.gravity.typegraph.basic.TMethod target = (org.gravity.typegraph.basic.TMethod) message.input.getCONTEXT__TRG__tName();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodSignature__Marker, org.gravity.typegraph.basic.TMethod> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodSignature__Marker, org.gravity.typegraph.basic.TMethod> message) {
