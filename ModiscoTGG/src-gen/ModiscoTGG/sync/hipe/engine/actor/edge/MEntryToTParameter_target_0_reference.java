...
public class MEntryToTParameter_target_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TParameter, Set<ModiscoTGG.MEntryToTParameter>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MEntryToTParameter_target_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodParameterLinkFirst__BWD_4059_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodParameterLinkFirst__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodParameterLinkFirst__FWD_4099_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodParameterLink__BWD_4109_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodParameterLink__BWD_4114_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodParameterLink__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodParameterLink__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodParameterLink__FWD_4149_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodParameterLink__FWD_4154_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodParameterType__CONSISTENCY_triangle_8_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodParameter__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MEntryToTParameter source, org.gravity.typegraph.basic.TParameter target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MEntryToTParameter> message) {
		...
		org.gravity.typegraph.basic.TParameter target = (org.gravity.typegraph.basic.TParameter) message.input.getTarget();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MEntryToTParameter, org.gravity.typegraph.basic.TParameter> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MEntryToTParameter, org.gravity.typegraph.basic.TParameter> message) {
