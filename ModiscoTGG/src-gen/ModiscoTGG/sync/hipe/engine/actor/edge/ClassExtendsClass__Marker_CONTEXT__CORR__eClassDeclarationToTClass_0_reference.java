...
public class ClassExtendsClass__Marker_CONTEXT__CORR__eClassDeclarationToTClass_0_reference extends AbstractActor {
	...
	public ClassExtendsClass__Marker_CONTEXT__CORR__eClassDeclarationToTClass_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassExtendsClass__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
