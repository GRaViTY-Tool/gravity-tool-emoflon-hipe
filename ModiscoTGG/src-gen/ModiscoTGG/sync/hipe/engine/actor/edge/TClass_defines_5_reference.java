...
public class TClass_defines_5_reference extends AbstractActor {
	...
	public TClass_defines_5_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("SyntethicMethod__BWD_5739_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("SyntethicMethod__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
