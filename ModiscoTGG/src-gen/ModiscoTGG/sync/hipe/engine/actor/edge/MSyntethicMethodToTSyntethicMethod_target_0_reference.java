...
public class MSyntethicMethodToTSyntethicMethod_target_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TSyntethicMethod, Set<ModiscoTGG.MSyntethicMethodToTSyntethicMethod>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MSyntethicMethodToTSyntethicMethod_target_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("SyntethicMethod__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MSyntethicMethodToTSyntethicMethod source, org.gravity.typegraph.basic.TSyntethicMethod target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MSyntethicMethodToTSyntethicMethod> message) {
		...
		org.gravity.typegraph.basic.TSyntethicMethod target = (org.gravity.typegraph.basic.TSyntethicMethod) message.input.getTarget();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MSyntethicMethodToTSyntethicMethod, org.gravity.typegraph.basic.TSyntethicMethod> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MSyntethicMethodToTSyntethicMethod, org.gravity.typegraph.basic.TSyntethicMethod> message) {
