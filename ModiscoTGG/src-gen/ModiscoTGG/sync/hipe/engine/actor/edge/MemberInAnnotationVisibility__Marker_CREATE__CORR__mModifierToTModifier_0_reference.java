...
public class MemberInAnnotationVisibility__Marker_CREATE__CORR__mModifierToTModifier_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.MModifierToTModifier, Set<EdgeMatch>> targetElements = new HashMap<ModiscoTGG.MModifierToTModifier, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<ModiscoTGG.MModifierToTModifier, Set<ModiscoTGG.MemberInAnnotationVisibility__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MemberInAnnotationVisibility__Marker_CREATE__CORR__mModifierToTModifier_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MemberInAnnotationVisibility__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MemberInAnnotationVisibility__Marker source, ModiscoTGG.MModifierToTModifier target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((ModiscoTGG.MModifierToTModifier) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MemberInAnnotationVisibility__Marker> message) {
		...
		ModiscoTGG.MModifierToTModifier target = (ModiscoTGG.MModifierToTModifier) message.input.getCREATE__CORR__mModifierToTModifier();
	...
	private void rightAdded(NodeAddedRight<ModiscoTGG.MModifierToTModifier> message) {
	...
	private void rightRemoved(NodeDeletedRight<ModiscoTGG.MModifierToTModifier> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MemberInAnnotationVisibility__Marker, ModiscoTGG.MModifierToTModifier> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MemberInAnnotationVisibility__Marker, ModiscoTGG.MModifierToTModifier> message) {
