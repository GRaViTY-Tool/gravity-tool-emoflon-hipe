...
public class FieldName__Marker_CREATE__SRC__mFieldName_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MFieldName, Set<ModiscoTGG.FieldName__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public FieldName__Marker_CREATE__SRC__mFieldName_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("FieldName__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.FieldName__Marker source, org.gravity.modisco.MFieldName target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.FieldName__Marker> message) {
		...
		org.gravity.modisco.MFieldName target = (org.gravity.modisco.MFieldName) message.input.getCREATE__SRC__mFieldName();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.FieldName__Marker, org.gravity.modisco.MFieldName> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.FieldName__Marker, org.gravity.modisco.MFieldName> message) {
