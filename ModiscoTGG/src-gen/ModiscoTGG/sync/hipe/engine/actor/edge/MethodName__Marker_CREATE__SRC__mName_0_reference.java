...
public class MethodName__Marker_CREATE__SRC__mName_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MMethodName, Set<ModiscoTGG.MethodName__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodName__Marker_CREATE__SRC__mName_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodName__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodName__Marker source, org.gravity.modisco.MMethodName target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MethodName__Marker> message) {
		...
		org.gravity.modisco.MMethodName target = (org.gravity.modisco.MMethodName) message.input.getCREATE__SRC__mName();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodName__Marker, org.gravity.modisco.MMethodName> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodName__Marker, org.gravity.modisco.MMethodName> message) {
