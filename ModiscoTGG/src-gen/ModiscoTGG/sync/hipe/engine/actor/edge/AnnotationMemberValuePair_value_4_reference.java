...
public class AnnotationMemberValuePair_value_4_reference extends AbstractActor {
	...
	public AnnotationMemberValuePair_value_4_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueNumber__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueNumber__FWD_539_junction"), this::returnTrue));
	}	
