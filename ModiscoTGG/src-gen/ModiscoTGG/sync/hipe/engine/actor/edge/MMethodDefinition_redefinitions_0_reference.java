...
public class MMethodDefinition_redefinitions_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.MethodDeclaration, Set<EdgeMatch>> targetElements = new HashMap<org.eclipse.modisco.java.MethodDeclaration, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.eclipse.modisco.java.MethodDeclaration, Set<org.eclipse.modisco.java.MethodDeclaration>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MMethodDefinition_redefinitions_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodOverriding__CONSISTENCY_triangle_0_triangleJunction"), this::check_constraint_175));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodOverriding__FWD_4040_junction"), this::check_constraint_178));
	}	
	...
	private void addMatch(InputMessage message, org.eclipse.modisco.java.MethodDeclaration source, org.eclipse.modisco.java.MethodDeclaration target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.eclipse.modisco.java.MethodDeclaration) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<org.eclipse.modisco.java.MethodDeclaration> message) {
		...
		for(org.eclipse.modisco.java.MethodDeclaration target : message.input.getRedefinitions()) {
	...
	private void rightAdded(NodeAddedRight<org.eclipse.modisco.java.MethodDeclaration> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.eclipse.modisco.java.MethodDeclaration> message) {
	...
	private void addReference(ReferenceAdded<org.eclipse.modisco.java.MethodDeclaration, org.eclipse.modisco.java.MethodDeclaration> message) {
	...
	private void removeReference(ReferenceDeleted<org.eclipse.modisco.java.MethodDeclaration, org.eclipse.modisco.java.MethodDeclaration> message) {
	...
	public boolean check_constraint_175(EdgeMatch edge) {
	...
	public boolean check_constraint_178(EdgeMatch edge) {
		org.eclipse.modisco.java.MethodDeclaration mMethod = (org.eclipse.modisco.java.MethodDeclaration) edge.source();
		org.eclipse.modisco.java.MethodDeclaration mOverriding = (org.eclipse.modisco.java.MethodDeclaration) edge.target();
		boolean predicate = !mMethod.equals(mOverriding);
		edge.setConstraintSatisfied(predicate);
