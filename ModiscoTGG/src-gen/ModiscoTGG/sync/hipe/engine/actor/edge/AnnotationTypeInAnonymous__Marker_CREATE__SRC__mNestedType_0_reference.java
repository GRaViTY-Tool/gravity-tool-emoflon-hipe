...
public class AnnotationTypeInAnonymous__Marker_CREATE__SRC__mNestedType_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.AnnotationTypeDeclaration, Set<ModiscoTGG.AnnotationTypeInAnonymous__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationTypeInAnonymous__Marker_CREATE__SRC__mNestedType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationTypeInAnonymous__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationTypeInAnonymous__Marker source, org.eclipse.modisco.java.AnnotationTypeDeclaration target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationTypeInAnonymous__Marker> message) {
		...
		org.eclipse.modisco.java.AnnotationTypeDeclaration target = (org.eclipse.modisco.java.AnnotationTypeDeclaration) message.input.getCREATE__SRC__mNestedType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationTypeInAnonymous__Marker, org.eclipse.modisco.java.AnnotationTypeDeclaration> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationTypeInAnonymous__Marker, org.eclipse.modisco.java.AnnotationTypeDeclaration> message) {
