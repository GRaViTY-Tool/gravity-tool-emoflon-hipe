...
public class ClassImplementsInterface__Marker_CONTEXT__TRG__tSuperInterface_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TInterface, Set<ModiscoTGG.ClassImplementsInterface__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ClassImplementsInterface__Marker_CONTEXT__TRG__tSuperInterface_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ClassImplementsInterface__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ClassImplementsInterface__Marker source, org.gravity.typegraph.basic.TInterface target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ClassImplementsInterface__Marker, org.gravity.typegraph.basic.TInterface> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ClassImplementsInterface__Marker, org.gravity.typegraph.basic.TInterface> message) {
