...
public class ArrayInitializerIgnoreExpressionsEdge__Marker_CONTEXT__SRC__array_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.ArrayInitializer, Set<EdgeMatch>> targetElements = new HashMap<org.eclipse.modisco.java.ArrayInitializer, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.eclipse.modisco.java.ArrayInitializer, Set<ModiscoTGG.ArrayInitializerIgnoreExpressionsEdge__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ArrayInitializerIgnoreExpressionsEdge__Marker_CONTEXT__SRC__array_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ArrayInitializerIgnoreExpressionsEdge__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ArrayInitializerIgnoreExpressionsEdge__Marker source, org.eclipse.modisco.java.ArrayInitializer target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.eclipse.modisco.java.ArrayInitializer) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ArrayInitializerIgnoreExpressionsEdge__Marker> message) {
		...
		org.eclipse.modisco.java.ArrayInitializer target = (org.eclipse.modisco.java.ArrayInitializer) message.input.getCONTEXT__SRC__array();
	...
	private void rightAdded(NodeAddedRight<org.eclipse.modisco.java.ArrayInitializer> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.eclipse.modisco.java.ArrayInitializer> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ArrayInitializerIgnoreExpressionsEdge__Marker, org.eclipse.modisco.java.ArrayInitializer> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ArrayInitializerIgnoreExpressionsEdge__Marker, org.eclipse.modisco.java.ArrayInitializer> message) {
