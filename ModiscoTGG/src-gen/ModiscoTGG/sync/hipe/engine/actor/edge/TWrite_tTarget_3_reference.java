...
public class TWrite_tTarget_3_reference extends AbstractActor {
	...
	public TWrite_tTarget_3_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("FieldAccessWrite__BWD_2546_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessWrite__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
