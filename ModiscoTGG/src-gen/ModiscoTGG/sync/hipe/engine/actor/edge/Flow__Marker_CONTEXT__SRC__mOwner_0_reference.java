...
public class Flow__Marker_CONTEXT__SRC__mOwner_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MAbstractFlowElement, Set<ModiscoTGG.Flow__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public Flow__Marker_CONTEXT__SRC__mOwner_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("Flow__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.Flow__Marker source, org.gravity.modisco.MAbstractFlowElement target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.Flow__Marker> message) {
		...
		org.gravity.modisco.MAbstractFlowElement target = (org.gravity.modisco.MAbstractFlowElement) message.input.getCONTEXT__SRC__mOwner();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.Flow__Marker, org.gravity.modisco.MAbstractFlowElement> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.Flow__Marker, org.gravity.modisco.MAbstractFlowElement> message) {
