...
public class TypesOrphaned__Marker_CREATE__SRC__mType_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MClass, Set<ModiscoTGG.TypesOrphaned__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public TypesOrphaned__Marker_CREATE__SRC__mType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("TypesOrphaned__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.TypesOrphaned__Marker source, org.gravity.modisco.MClass target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.TypesOrphaned__Marker> message) {
		...
		org.gravity.modisco.MClass target = (org.gravity.modisco.MClass) message.input.getCREATE__SRC__mType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.TypesOrphaned__Marker, org.gravity.modisco.MClass> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.TypesOrphaned__Marker, org.gravity.modisco.MClass> message) {
