...
public class ConstructorDefinition__Marker_CONTEXT__TRG__tMethodSignature_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TMethodSignature, Set<ModiscoTGG.ConstructorDefinition__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ConstructorDefinition__Marker_CONTEXT__TRG__tMethodSignature_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ConstructorDefinition__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ConstructorDefinition__Marker source, org.gravity.typegraph.basic.TMethodSignature target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ConstructorDefinition__Marker, org.gravity.typegraph.basic.TMethodSignature> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ConstructorDefinition__Marker, org.gravity.typegraph.basic.TMethodSignature> message) {
