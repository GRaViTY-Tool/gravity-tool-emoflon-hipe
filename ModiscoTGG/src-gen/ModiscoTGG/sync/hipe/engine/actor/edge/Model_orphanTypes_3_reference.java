...
public class Model_orphanTypes_3_reference extends AbstractActor {
	...
	public Model_orphanTypes_3_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PrimitiveTypeIsByte__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PrimitiveTypeIsByte__FWD_4976_junction"), this::returnTrue));
	}	
