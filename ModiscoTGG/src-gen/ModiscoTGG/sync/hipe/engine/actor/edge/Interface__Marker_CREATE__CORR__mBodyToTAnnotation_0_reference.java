...
public class Interface__Marker_CREATE__CORR__mBodyToTAnnotation_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.ASTNodeToTAnnotatable, Set<ModiscoTGG.Interface__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public Interface__Marker_CREATE__CORR__mBodyToTAnnotation_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("Interface__CONSISTENCY_triangle_10_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.Interface__Marker source, ModiscoTGG.ASTNodeToTAnnotatable target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.Interface__Marker, ModiscoTGG.ASTNodeToTAnnotatable> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.Interface__Marker, ModiscoTGG.ASTNodeToTAnnotatable> message) {
