...
public class AnnotationTypeInAnonymous__Marker_CONTEXT__SRC__eAnonymousClassDeclaration_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.AnonymousClassDeclaration, Set<ModiscoTGG.AnnotationTypeInAnonymous__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationTypeInAnonymous__Marker_CONTEXT__SRC__eAnonymousClassDeclaration_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationTypeInAnonymous__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationTypeInAnonymous__Marker source, org.eclipse.modisco.java.AnonymousClassDeclaration target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationTypeInAnonymous__Marker> message) {
		...
		org.eclipse.modisco.java.AnonymousClassDeclaration target = (org.eclipse.modisco.java.AnonymousClassDeclaration) message.input.getCONTEXT__SRC__eAnonymousClassDeclaration();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationTypeInAnonymous__Marker, org.eclipse.modisco.java.AnonymousClassDeclaration> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationTypeInAnonymous__Marker, org.eclipse.modisco.java.AnonymousClassDeclaration> message) {
