...
public class Flow__Marker_CREATE__SRC__mFlow_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MFlow, Set<ModiscoTGG.Flow__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public Flow__Marker_CREATE__SRC__mFlow_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("Flow__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.Flow__Marker source, org.gravity.modisco.MFlow target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.Flow__Marker> message) {
		...
		org.gravity.modisco.MFlow target = (org.gravity.modisco.MFlow) message.input.getCREATE__SRC__mFlow();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.Flow__Marker, org.gravity.modisco.MFlow> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.Flow__Marker, org.gravity.modisco.MFlow> message) {
