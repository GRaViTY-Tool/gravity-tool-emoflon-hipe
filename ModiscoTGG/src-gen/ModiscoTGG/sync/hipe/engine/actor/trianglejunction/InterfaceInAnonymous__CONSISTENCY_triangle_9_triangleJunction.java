...
public class InterfaceInAnonymous__CONSISTENCY_triangle_9_triangleJunction extends GenericTriangleJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, TriangleJunctionNode node) {
		...
		ports.add(new PortJunctionRight(getSelf(), name2actor.get("InterfaceInAnonymous__CONSISTENCY_triangle_8_triangleJunction"), this::check_constraint_156));
	}
	...
	public boolean check_constraint_156(HMatch match) {
		...
		csp_32.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mNestedType.isProxy(), "boolean"));
		csp_32.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tNestedType.isTLib(), "boolean"));
		csp_32.solve();
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_33 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_33.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mNestedType.getName(), "java.lang.String"));
		csp_33.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tNestedType.getTName(), "java.lang.String"));
		csp_33.solve();
