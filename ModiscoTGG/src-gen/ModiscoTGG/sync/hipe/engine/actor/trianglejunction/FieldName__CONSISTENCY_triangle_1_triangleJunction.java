...
public class FieldName__CONSISTENCY_triangle_1_triangleJunction extends GenericTriangleJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, TriangleJunctionNode node) {
		...
		ports.add(new PortJunction(getSelf(), name2actor.get("FieldName__CONSISTENCY_triangle_0_triangleJunction"), this::check_constraint_139));
	}
	...
	public boolean check_constraint_139(HMatch match) {
		...
		csp_31.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mFieldName.getMName(), "java.lang.String"));
		csp_31.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tField.getTName(), "java.lang.String"));
		csp_31.solve();
