...
public class TypesOrphaned__CONSISTENCY_triangle_4_triangleJunction extends GenericTriangleJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, TriangleJunctionNode node) {
		...
		ports.add(new PortJunctionRight(getSelf(), name2actor.get("TypesOrphaned__CONSISTENCY_triangle_2_triangleJunction"), this::check_constraint_302));
	}
	...
	public boolean check_constraint_302(HMatch match) {
		...
		csp_61.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mType.isProxy(), "boolean"));
		csp_61.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tType.isTLib(), "boolean"));
		csp_61.solve();
