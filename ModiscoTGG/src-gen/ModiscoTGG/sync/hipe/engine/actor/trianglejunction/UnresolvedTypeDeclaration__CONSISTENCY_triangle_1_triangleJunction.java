...
public class UnresolvedTypeDeclaration__CONSISTENCY_triangle_1_triangleJunction extends GenericTriangleJunctionActor{
	...
	public boolean check_constraint_304(HMatch match) {
		...
		csp_64.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tClass.isTLib(), "boolean"));
		csp_64.solve();
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_65 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_65.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, unresolvedType.getName(), "java.lang.String"));
		csp_65.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tClass.getTName(), "java.lang.String"));
		csp_65.solve();
