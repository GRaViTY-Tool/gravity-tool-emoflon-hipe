...
public class EnumInAnonymous__CONSISTENCY_triangle_8_triangleJunction extends GenericTriangleJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, TriangleJunctionNode node) {
		...
		ports.add(new PortJunctionRight(getSelf(), name2actor.get("EnumInAnonymous__CONSISTENCY_triangle_7_triangleJunction"), this::check_constraint_96));
	}
	...
	public boolean check_constraint_96(HMatch match) {
		...
		csp_27.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mNestedType.isProxy(), "boolean"));
		csp_27.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tNestedType.isTLib(), "boolean"));
		csp_27.solve();
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_28 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_28.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mNestedType.getName(), "java.lang.String"));
		csp_28.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tNestedType.getTName(), "java.lang.String"));
		csp_28.solve();
		
		boolean predicate = csp_27.isSatisfied() && csp_28.isSatisfied();
