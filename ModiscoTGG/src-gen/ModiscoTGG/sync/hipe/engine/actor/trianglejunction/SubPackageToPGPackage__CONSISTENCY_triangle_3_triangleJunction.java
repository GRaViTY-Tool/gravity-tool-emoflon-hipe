...
public class SubPackageToPGPackage__CONSISTENCY_triangle_3_triangleJunction extends GenericTriangleJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, TriangleJunctionNode node) {
		...
		ports.add(new PortJunction(getSelf(), name2actor.get("SubPackageToPGPackage__CONSISTENCY_triangle_2_triangleJunction"), this::check_constraint_277));
	}
	...
	public boolean check_constraint_277(HMatch match) {
		...
		csp_59.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mPackage.getName(), "java.lang.String"));
		csp_59.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tSub.getTName(), "java.lang.String"));
		csp_59.solve();
