...
public class TClass_object_SP18 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TClass>> ports;		
		
	public TClass_object_SP18() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("AnonymousClassDeclarationToTClass_target_2_reference"), this::check_constraint_42));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("PrimitiveTypeToTClass_target_3_reference"), this::check_constraint_247));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("PrimitiveTypesIsVoid__Marker_CREATE__TRG__tPrimitiveClass_0_reference"), this::check_constraint_273));
	...
	public boolean check_constraint_42(org.gravity.typegraph.basic.TClass tAnonymous) {
