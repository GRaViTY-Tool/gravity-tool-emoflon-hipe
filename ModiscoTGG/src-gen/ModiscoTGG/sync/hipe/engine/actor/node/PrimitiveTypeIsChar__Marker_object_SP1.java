...
public class PrimitiveTypeIsChar__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.PrimitiveTypeIsChar__Marker>> ports;		
		
	public PrimitiveTypeIsChar__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.PrimitiveTypeIsChar__Marker>(getSelf(), name2actor.get("PrimitiveTypeIsChar__Marker_CONTEXT__CORR__eModelToTypeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.PrimitiveTypeIsChar__Marker>(getSelf(), name2actor.get("PrimitiveTypeIsChar__Marker_CONTEXT__TRG__typeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.PrimitiveTypeIsChar__Marker>(getSelf(), name2actor.get("PrimitiveTypeIsChar__Marker_CREATE__SRC__ePrimitiveType_0_reference"), this::returnTrue));
	}
