...
public class TClass_object_SP4 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TClass>> ports;		
		
	public TClass_object_SP4() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("PrimitiveTypeIsBoolean__Marker_CREATE__TRG__tPrimitiveClass_0_reference"), this::check_constraint_233));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("TClass_pg_11_reference"), this::check_constraint_259));
	}
	...
	public boolean check_constraint_233(org.gravity.typegraph.basic.TClass tPrimitiveClass) {
