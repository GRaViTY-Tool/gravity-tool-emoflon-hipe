...
public class Type_object_SP2 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.Type>> ports;		
		
	public Type_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Type>(getSelf(), name2actor.get("AnnotationMemberValueClassArray__Marker_CONTEXT__SRC__mType_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Type>(getSelf(), name2actor.get("MEntry_type_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Type>(getSelf(), name2actor.get("MFieldSignature_type_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Type>(getSelf(), name2actor.get("MMethodSignature_returnType_0_reference"), this::returnTrue));
	}
