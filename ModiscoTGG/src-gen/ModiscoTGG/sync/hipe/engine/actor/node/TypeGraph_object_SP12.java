...
public class TypeGraph_object_SP12 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TypeGraph>> ports;		
		
	public TypeGraph_object_SP12() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TypeGraph>(getSelf(), name2actor.get("AnonymousClass__Marker_CONTEXT__TRG__pg_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TypeGraph>(getSelf(), name2actor.get("ModelToPg__Marker_CREATE__TRG__tPG_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TypeGraph>(getSelf(), name2actor.get("TClass_pg_9_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TypeGraph>(getSelf(), name2actor.get("TypeParameter__Marker_CONTEXT__TRG__pg_0_reference"), this::returnTrue));
	}
