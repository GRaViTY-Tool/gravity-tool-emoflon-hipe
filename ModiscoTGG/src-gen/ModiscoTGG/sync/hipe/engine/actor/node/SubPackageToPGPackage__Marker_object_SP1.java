...
public class SubPackageToPGPackage__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.SubPackageToPGPackage__Marker>> ports;		
		
	public SubPackageToPGPackage__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.SubPackageToPGPackage__Marker>(getSelf(), name2actor.get("SubPackageToPGPackage__Marker_CONTEXT__SRC__mParentPackage_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.SubPackageToPGPackage__Marker>(getSelf(), name2actor.get("SubPackageToPGPackage__Marker_CREATE__CORR__mPackageToTSub_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.SubPackageToPGPackage__Marker>(getSelf(), name2actor.get("SubPackageToPGPackage__Marker_CREATE__TRG__tSub_0_reference"), this::returnTrue));
	}
