...
public class ModelToTypeGraph_object_SP3 extends AbstractActor {
	
	private List<Port<ModiscoTGG.ModelToTypeGraph>> ports;		
		
	public ModelToTypeGraph_object_SP3() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.ModelToTypeGraph>(getSelf(), name2actor.get("ModelToTypeGraph_source_1_reference"), this::returnTrue));
		ports.add(new PortNodeRight<ModiscoTGG.ModelToTypeGraph>(getSelf(), name2actor.get("PrimitiveTypeIsBoolean__Marker_CONTEXT__CORR__eModelToTypeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<ModiscoTGG.ModelToTypeGraph>(getSelf(), name2actor.get("PrimitiveTypeIsLong__Marker_CONTEXT__CORR__eModelToTypeGraph_0_reference"), this::returnTrue));
	}
