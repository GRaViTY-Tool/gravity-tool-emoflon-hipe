...
public class TClass_object_SP3 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TClass>> ports;		
		
	public TClass_object_SP3() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("PrimitiveTypeIsInt__Marker_CREATE__TRG__tPrimitiveClass_0_reference"), this::check_constraint_258));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("PrimitiveTypeToTClass_target_0_reference"), this::check_constraint_232));
	}
	...
	public boolean check_constraint_232(org.gravity.typegraph.basic.TClass tPrimitiveClass) {
