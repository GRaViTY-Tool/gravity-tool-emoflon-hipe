...
public class MConstructorDefinition_object_SP0 extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MConstructorDefinition>> ports;		
		
	public MConstructorDefinition_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.modisco.MConstructorDefinition>(getSelf(), name2actor.get("ConstructorDefinition__Marker_CREATE__SRC__mDefinition_0_reference"), this::returnTrue));
