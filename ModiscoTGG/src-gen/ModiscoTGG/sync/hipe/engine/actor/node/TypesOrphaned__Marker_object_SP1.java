...
public class TypesOrphaned__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.TypesOrphaned__Marker>> ports;		
		
	public TypesOrphaned__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.TypesOrphaned__Marker>(getSelf(), name2actor.get("TypesOrphaned__Marker_CONTEXT__CORR__mModelToTypeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.TypesOrphaned__Marker>(getSelf(), name2actor.get("TypesOrphaned__Marker_CONTEXT__TRG__pg_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.TypesOrphaned__Marker>(getSelf(), name2actor.get("TypesOrphaned__Marker_CREATE__SRC__mType_0_reference"), this::returnTrue));
	}
