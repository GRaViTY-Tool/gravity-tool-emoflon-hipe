...
public class PrimitiveTypeIsDouble__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.PrimitiveTypeIsDouble__Marker>> ports;		
		
	public PrimitiveTypeIsDouble__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.PrimitiveTypeIsDouble__Marker>(getSelf(), name2actor.get("PrimitiveTypeIsDouble__Marker_CONTEXT__CORR__eModelToTypeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.PrimitiveTypeIsDouble__Marker>(getSelf(), name2actor.get("PrimitiveTypeIsDouble__Marker_CONTEXT__TRG__typeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.PrimitiveTypeIsDouble__Marker>(getSelf(), name2actor.get("PrimitiveTypeIsDouble__Marker_CREATE__SRC__ePrimitiveType_0_reference"), this::returnTrue));
	}
