...
public class TypeGraph_object_SP15 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TypeGraph>> ports;		
		
	public TypeGraph_object_SP15() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TypeGraph>(getSelf(), name2actor.get("ClassInAnonymous__Marker_CONTEXT__TRG__pg_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TypeGraph>(getSelf(), name2actor.get("NestedInterfaceInType__Marker_CONTEXT__TRG__typeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TypeGraph>(getSelf(), name2actor.get("TClass_pg_10_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TypeGraph>(getSelf(), name2actor.get("UnresolvedTypeDeclaration__Marker_CONTEXT__TRG__pg_0_reference"), this::returnTrue));
	}
