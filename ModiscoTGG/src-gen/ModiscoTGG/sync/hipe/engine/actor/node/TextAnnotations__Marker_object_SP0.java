...
public class TextAnnotations__Marker_object_SP0 extends AbstractActor {
	
	private List<Port<ModiscoTGG.TextAnnotations__Marker>> ports;		
		
	public TextAnnotations__Marker_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.TextAnnotations__Marker>(getSelf(), name2actor.get("TextAnnotations__Marker_CONTEXT__SRC__mMember_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.TextAnnotations__Marker>(getSelf(), name2actor.get("TextAnnotations__Marker_CREATE__CORR__mCommentToTText_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.TextAnnotations__Marker>(getSelf(), name2actor.get("TextAnnotations__Marker_CREATE__TRG__tText_0_reference"), this::returnTrue));
	}
