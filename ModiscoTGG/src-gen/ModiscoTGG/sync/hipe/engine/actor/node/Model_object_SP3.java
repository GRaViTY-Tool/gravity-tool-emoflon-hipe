...
public class Model_object_SP3 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.Model>> ports;		
		
	public Model_object_SP3() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.Model>(getSelf(), name2actor.get("Model_orphanTypes_7_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.Model>(getSelf(), name2actor.get("Model_ownedElements_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Model>(getSelf(), name2actor.get("PrimitiveTypeIsByte__Marker_CONTEXT__SRC__eModel_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Model>(getSelf(), name2actor.get("PrimitiveTypesIsVoid__Marker_CONTEXT__SRC__eModel_0_reference"), this::returnTrue));
	}
