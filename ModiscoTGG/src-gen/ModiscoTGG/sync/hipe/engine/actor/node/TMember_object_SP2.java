...
public class TMember_object_SP2 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TMember>> ports;		
		
	public TMember_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TMember>(getSelf(), name2actor.get("LinkDefinitionToType__Marker_CONTEXT__TRG__tDefinition_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TMember>(getSelf(), name2actor.get("SuperMethodInvocation__Marker_CONTEXT__TRG__tMethod_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TMember>(getSelf(), name2actor.get("TCall_tTarget_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TMember>(getSelf(), name2actor.get("TWrite_tSource_3_reference"), this::returnTrue));
	}
