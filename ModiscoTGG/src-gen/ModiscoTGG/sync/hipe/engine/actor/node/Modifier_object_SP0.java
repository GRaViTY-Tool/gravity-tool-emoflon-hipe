...
public class Modifier_object_SP0 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.Modifier>> ports;		
		
	public Modifier_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Modifier>(getSelf(), name2actor.get("AbstractTypeDeclaration_modifier_1_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Modifier>(getSelf(), name2actor.get("InterfaceMember__Marker_CREATE__SRC__mModifier_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Modifier>(getSelf(), name2actor.get("MDefinition_modifier_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Modifier>(getSelf(), name2actor.get("MemberInClassVisibility__Marker_CREATE__SRC__mModifier_0_reference"), this::returnTrue));
	}
