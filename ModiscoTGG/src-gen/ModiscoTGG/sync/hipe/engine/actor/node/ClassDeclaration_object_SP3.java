...
public class ClassDeclaration_object_SP3 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.ClassDeclaration>> ports;		
		
	public ClassDeclaration_object_SP3() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.eclipse.modisco.java.ClassDeclaration>(getSelf(), name2actor.get("ClassExtendsClass__Marker_CONTEXT__SRC__eExtendedClass_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.ClassDeclaration>(getSelf(), name2actor.get("MemberInClassVisibility__Marker_CONTEXT__SRC__mClass_0_reference"), this::returnTrue));
	}
