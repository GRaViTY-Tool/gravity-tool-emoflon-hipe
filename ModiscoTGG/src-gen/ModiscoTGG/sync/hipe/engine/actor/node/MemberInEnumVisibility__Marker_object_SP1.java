...
public class MemberInEnumVisibility__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.MemberInEnumVisibility__Marker>> ports;		
		
	public MemberInEnumVisibility__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.MemberInEnumVisibility__Marker>(getSelf(), name2actor.get("MemberInEnumVisibility__Marker_CONTEXT__SRC__mClass_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MemberInEnumVisibility__Marker>(getSelf(), name2actor.get("MemberInEnumVisibility__Marker_CONTEXT__SRC__mDefinition_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MemberInEnumVisibility__Marker>(getSelf(), name2actor.get("MemberInEnumVisibility__Marker_CREATE__SRC__mModifier_0_reference"), this::returnTrue));
	}
