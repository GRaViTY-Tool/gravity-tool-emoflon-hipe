...
public class OutgoingFlow__Marker_object_SP0 extends AbstractActor {
	
	private List<Port<ModiscoTGG.OutgoingFlow__Marker>> ports;		
		
	public OutgoingFlow__Marker_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.OutgoingFlow__Marker>(getSelf(), name2actor.get("OutgoingFlow__Marker_CONTEXT__CORR__mFlowToTFlow_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.OutgoingFlow__Marker>(getSelf(), name2actor.get("OutgoingFlow__Marker_CONTEXT__SRC__mTarget_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.OutgoingFlow__Marker>(getSelf(), name2actor.get("OutgoingFlow__Marker_CONTEXT__TRG__tFlow_0_reference"), this::returnTrue));
	}
