...
public class MAbstractMethodInvocation_object_SP1 extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MAbstractMethodInvocation>> ports;		
		
	public MAbstractMethodInvocation_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.modisco.MAbstractMethodInvocation>(getSelf(), name2actor.get("AbstractMethodInvocationToTAccess_source_1_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MAbstractMethodInvocation>(getSelf(), name2actor.get("MDefinition_mMethodInvocations_1_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MAbstractMethodInvocation>(getSelf(), name2actor.get("SuperConstructorInvocation__Marker_CREATE__SRC__invocation_0_reference"), this::returnTrue));
	}
