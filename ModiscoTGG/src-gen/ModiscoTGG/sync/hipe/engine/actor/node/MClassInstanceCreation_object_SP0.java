...
public class MClassInstanceCreation_object_SP0 extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MClassInstanceCreation>> ports;		
		
	public MClassInstanceCreation_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.modisco.MClassInstanceCreation>(getSelf(), name2actor.get("ClassInstanceCreation__Marker_CREATE__SRC__invocation_0_reference"), this::returnTrue));
