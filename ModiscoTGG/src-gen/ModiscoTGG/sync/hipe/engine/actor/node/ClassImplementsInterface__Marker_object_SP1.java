...
public class ClassImplementsInterface__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.ClassImplementsInterface__Marker>> ports;		
		
	public ClassImplementsInterface__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.ClassImplementsInterface__Marker>(getSelf(), name2actor.get("ClassImplementsInterface__Marker_CONTEXT__SRC__eClassDeclaration_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.ClassImplementsInterface__Marker>(getSelf(), name2actor.get("ClassImplementsInterface__Marker_CONTEXT__SRC__eSuperInterface_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.ClassImplementsInterface__Marker>(getSelf(), name2actor.get("ClassImplementsInterface__Marker_CREATE__SRC__eTypeAccess_0_reference"), this::returnTrue));
	}
