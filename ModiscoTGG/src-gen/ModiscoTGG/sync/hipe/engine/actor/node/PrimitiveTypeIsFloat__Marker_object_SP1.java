...
public class PrimitiveTypeIsFloat__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.PrimitiveTypeIsFloat__Marker>> ports;		
		
	public PrimitiveTypeIsFloat__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.PrimitiveTypeIsFloat__Marker>(getSelf(), name2actor.get("PrimitiveTypeIsFloat__Marker_CONTEXT__CORR__eModelToTypeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.PrimitiveTypeIsFloat__Marker>(getSelf(), name2actor.get("PrimitiveTypeIsFloat__Marker_CONTEXT__TRG__typeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.PrimitiveTypeIsFloat__Marker>(getSelf(), name2actor.get("PrimitiveTypeIsFloat__Marker_CREATE__SRC__ePrimitiveType_0_reference"), this::returnTrue));
	}
