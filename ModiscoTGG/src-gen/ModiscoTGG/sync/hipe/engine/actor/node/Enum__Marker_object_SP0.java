...
public class Enum__Marker_object_SP0 extends AbstractActor {
	
	private List<Port<ModiscoTGG.Enum__Marker>> ports;		
		
	public Enum__Marker_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.Enum__Marker>(getSelf(), name2actor.get("Enum__Marker_CONTEXT__SRC__mPackage_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.Enum__Marker>(getSelf(), name2actor.get("Enum__Marker_CREATE__CORR__mTypeToTType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.Enum__Marker>(getSelf(), name2actor.get("Enum__Marker_CREATE__TRG__tType_0_reference"), this::returnTrue));
	}
