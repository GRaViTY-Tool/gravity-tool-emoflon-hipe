...
public class ClassDeclaration_object_SP2 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.ClassDeclaration>> ports;		
		
	public ClassDeclaration_object_SP2() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.eclipse.modisco.java.ClassDeclaration>(getSelf(), name2actor.get("ClassImplementsInterface__Marker_CONTEXT__SRC__eClassDeclaration_0_reference"), this::returnTrue));
	}
