...
public class TClass_object_SP6 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TClass>> ports;		
		
	public TClass_object_SP6() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("TClass_parentClass_0_reference"), this::check_constraint_22));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("TypeGraph_classes_3_reference"), this::check_constraint_235));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("TypeToTAbstractType_target_10_reference"), this::check_constraint_261));
	}
	...
	public boolean check_constraint_22(org.gravity.typegraph.basic.TClass tClass) {
