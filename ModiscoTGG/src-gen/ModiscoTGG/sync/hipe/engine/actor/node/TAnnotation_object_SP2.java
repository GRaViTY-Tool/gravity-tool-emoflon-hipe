...
public class TAnnotation_object_SP2 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.annotations.TAnnotation>> ports;		
		
	public TAnnotation_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.annotations.TAnnotation>(getSelf(), name2actor.get("AnnotationMemberKey__Marker_CONTEXT__TRG__tAnnotation_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.annotations.TAnnotation>(getSelf(), name2actor.get("AnnotationMemberValueAnnotationArray__Marker_CREATE__TRG__tValue_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.annotations.TAnnotation>(getSelf(), name2actor.get("TAnnotation_type_0_reference"), this::returnTrue));
	}
