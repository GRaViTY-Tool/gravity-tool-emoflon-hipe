...
public class TypeToTAbstractType_object_SP18 extends AbstractActor {
	
	private List<Port<ModiscoTGG.TypeToTAbstractType>> ports;		
		
	public TypeToTAbstractType_object_SP18() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<ModiscoTGG.TypeToTAbstractType>(getSelf(), name2actor.get("MemberInClassVisibility__Marker_CONTEXT__CORR__mTypeToTType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.TypeToTAbstractType>(getSelf(), name2actor.get("TypeToTAbstractType_source_12_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.TypeToTAbstractType>(getSelf(), name2actor.get("TypeToTAbstractType_source_3_reference"), this::returnTrue));
		ports.add(new PortNodeRight<ModiscoTGG.TypeToTAbstractType>(getSelf(), name2actor.get("TypesVisibility__Marker_CONTEXT__CORR__mTypeToTType_0_reference"), this::returnTrue));
	}
