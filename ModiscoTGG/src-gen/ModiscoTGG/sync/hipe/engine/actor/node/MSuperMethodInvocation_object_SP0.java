...
public class MSuperMethodInvocation_object_SP0 extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MSuperMethodInvocation>> ports;		
		
	public MSuperMethodInvocation_object_SP0() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.modisco.MSuperMethodInvocation>(getSelf(), name2actor.get("SuperMethodInvocation__Marker_CREATE__SRC__invocation_0_reference"), this::returnTrue));
	}
