...
public class TClass_object_SP2 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("PrimitiveTypeToTClass_target_5_reference"), this::check_constraint_257));
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("TypeToTAbstractType_target_4_reference"), this::check_constraint_231));
	}
	...
	public boolean check_constraint_231(org.gravity.typegraph.basic.TClass tPrimitiveClass) {
