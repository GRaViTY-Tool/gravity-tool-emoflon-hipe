...
public class MMethodInvocation_object_SP1 extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MMethodInvocation>> ports;		
		
	public MMethodInvocation_object_SP1() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.modisco.MMethodInvocation>(getSelf(), name2actor.get("MethodInvocationRecursive__Marker_CREATE__SRC__invocation_0_reference"), this::returnTrue));
	}
