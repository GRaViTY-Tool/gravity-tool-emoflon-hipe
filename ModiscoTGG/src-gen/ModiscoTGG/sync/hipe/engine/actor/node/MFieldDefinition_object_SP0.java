...
public class MFieldDefinition_object_SP0 extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MFieldDefinition>> ports;		
		
	public MFieldDefinition_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.modisco.MFieldDefinition>(getSelf(), name2actor.get("FieldAccessReadWrite__Marker_CONTEXT__SRC__mField_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MFieldDefinition>(getSelf(), name2actor.get("FieldDefinition__Marker_CREATE__SRC__mDefinition_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MFieldDefinition>(getSelf(), name2actor.get("MDefinitionToTMember_source_3_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.modisco.MFieldDefinition>(getSelf(), name2actor.get("MFieldDefinition_mSignature_1_reference"), this::returnTrue));
	}
