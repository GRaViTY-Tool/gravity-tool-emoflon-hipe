...
public class TClass_object_SP8 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TClass>> ports;		
		
	public TClass_object_SP8() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("AnonymousClassDeclarationToTClass_target_1_reference"), this::check_constraint_23));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("ClassInnerAnonClassMember__Marker_CONTEXT__TRG__tOuterClass_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("PrimitiveTypeIsLong__Marker_CREATE__TRG__tPrimitiveClass_0_reference"), this::check_constraint_263));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("PrimitiveTypeToTClass_target_1_reference"), this::check_constraint_237));
	}
	...
	public boolean check_constraint_23(org.gravity.typegraph.basic.TClass tClass) {
