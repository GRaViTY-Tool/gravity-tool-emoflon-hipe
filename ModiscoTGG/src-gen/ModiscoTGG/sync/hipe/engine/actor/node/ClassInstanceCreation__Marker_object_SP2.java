...
public class ClassInstanceCreation__Marker_object_SP2 extends AbstractActor {
	
	private List<Port<ModiscoTGG.ClassInstanceCreation__Marker>> ports;		
		
	public ClassInstanceCreation__Marker_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.ClassInstanceCreation__Marker>(getSelf(), name2actor.get("ClassInstanceCreation__Marker_CONTEXT__SRC__mMember_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.ClassInstanceCreation__Marker>(getSelf(), name2actor.get("ClassInstanceCreation__Marker_CONTEXT__SRC__mMethod_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.ClassInstanceCreation__Marker>(getSelf(), name2actor.get("ClassInstanceCreation__Marker_CREATE__SRC__invocation_0_reference"), this::returnTrue));
	}
