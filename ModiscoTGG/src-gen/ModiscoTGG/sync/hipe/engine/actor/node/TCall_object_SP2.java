...
public class TCall_object_SP2 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TCall>> ports;		
		
	public TCall_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TCall>(getSelf(), name2actor.get("MAbstractFlowElementToTAbstractFlowElement_target_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TCall>(getSelf(), name2actor.get("MethodInvocationStaticType__Marker_CONTEXT__TRG__tAccess_0_reference"), this::returnTrue));
