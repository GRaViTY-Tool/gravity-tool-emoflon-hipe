...
public class TSignature_object_SP1 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TSignature>> ports;		
		
	public TSignature_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TSignature>(getSelf(), name2actor.get("LinkDefinitionToAnonymous__Marker_CONTEXT__TRG__tSignature_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TSignature>(getSelf(), name2actor.get("LinkDefinitionToType__Marker_CONTEXT__TRG__tSignature_0_reference"), this::returnTrue));
