...
public class MethodParameterType__Marker_object_SP2 extends AbstractActor {
	
	private List<Port<ModiscoTGG.MethodParameterType__Marker>> ports;		
		
	public MethodParameterType__Marker_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.MethodParameterType__Marker>(getSelf(), name2actor.get("MethodParameterType__Marker_CONTEXT__SRC__mSignature_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MethodParameterType__Marker>(getSelf(), name2actor.get("MethodParameterType__Marker_CONTEXT__SRC__mType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MethodParameterType__Marker>(getSelf(), name2actor.get("MethodParameterType__Marker_CREATE__SRC__mEntry_0_reference"), this::returnTrue));
	}
