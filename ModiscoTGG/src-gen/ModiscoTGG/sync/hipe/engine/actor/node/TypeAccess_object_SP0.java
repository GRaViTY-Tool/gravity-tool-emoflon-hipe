...
public class TypeAccess_object_SP0 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.eclipse.modisco.java.TypeAccess>(getSelf(), name2actor.get("InterfaceDeclaration_superInterfaces_2_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.TypeAccess>(getSelf(), name2actor.get("MethodDeclaration_returnType_0_reference"), this::returnTrue));
