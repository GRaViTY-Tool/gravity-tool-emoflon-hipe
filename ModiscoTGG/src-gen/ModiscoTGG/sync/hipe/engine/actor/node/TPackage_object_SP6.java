...
public class TPackage_object_SP6 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TPackage>> ports;		
		
	public TPackage_object_SP6() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TPackage>(getSelf(), name2actor.get("AnnotationTypeNested__Marker_CREATE__TRG__tNestedPackage_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TPackage>(getSelf(), name2actor.get("ClassInnerAnonClassMember__Marker_CONTEXT__TRG__tOuterPackage_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TPackage>(getSelf(), name2actor.get("NestedClassInType__Marker_CONTEXT__TRG__tOuterPackage_0_reference"), this::returnTrue));
	}
