...
public class VariableDeclarationFragment__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.VariableDeclarationFragment__Marker>> ports;		
		
	public VariableDeclarationFragment__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.VariableDeclarationFragment__Marker>(getSelf(), name2actor.get("VariableDeclarationFragment__Marker_CONTEXT__SRC__mDefinition_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.VariableDeclarationFragment__Marker>(getSelf(), name2actor.get("VariableDeclarationFragment__Marker_CREATE__CORR__varDeclFragmentToTFieldDefinition_0_reference"), this::returnTrue));
	}
