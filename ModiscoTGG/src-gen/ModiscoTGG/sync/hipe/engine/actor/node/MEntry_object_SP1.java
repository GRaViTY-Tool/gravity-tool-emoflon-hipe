...
public class MEntry_object_SP1 extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MEntry>> ports;		
		
	public MEntry_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.modisco.MEntry>(getSelf(), name2actor.get("MEntry_mPrevious_0_reference"), this::returnTrue));
		...
		ports.add(new PortNodeRight<org.gravity.modisco.MEntry>(getSelf(), name2actor.get("MethodParameterType__Marker_CREATE__SRC__mEntry_0_reference"), this::returnTrue));
	}
