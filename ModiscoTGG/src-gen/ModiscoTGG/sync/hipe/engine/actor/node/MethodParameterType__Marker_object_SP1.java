...
public class MethodParameterType__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.MethodParameterType__Marker>> ports;		
		
	public MethodParameterType__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.MethodParameterType__Marker>(getSelf(), name2actor.get("MethodParameterType__Marker_CONTEXT__TRG__tAbstractType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MethodParameterType__Marker>(getSelf(), name2actor.get("MethodParameterType__Marker_CONTEXT__TRG__tSiganture_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MethodParameterType__Marker>(getSelf(), name2actor.get("MethodParameterType__Marker_CREATE__TRG__tParameter_0_reference"), this::returnTrue));
	}
