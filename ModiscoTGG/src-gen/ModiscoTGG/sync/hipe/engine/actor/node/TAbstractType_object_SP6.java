...
public class TAbstractType_object_SP6 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TAbstractType>> ports;		
		
	public TAbstractType_object_SP6() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TAbstractType>(getSelf(), name2actor.get("MethodParameterType__Marker_CONTEXT__TRG__tAbstractType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TAbstractType>(getSelf(), name2actor.get("TAbstractType_pg_2_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TAbstractType>(getSelf(), name2actor.get("TFieldSignature_type_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TAbstractType>(getSelf(), name2actor.get("TMethodSignature_returnType_0_reference"), this::returnTrue));
	}
