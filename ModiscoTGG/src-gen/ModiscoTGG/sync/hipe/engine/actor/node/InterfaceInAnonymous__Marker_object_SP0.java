...
public class InterfaceInAnonymous__Marker_object_SP0 extends AbstractActor {
	
	private List<Port<ModiscoTGG.InterfaceInAnonymous__Marker>> ports;		
		
	public InterfaceInAnonymous__Marker_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.InterfaceInAnonymous__Marker>(getSelf(), name2actor.get("InterfaceInAnonymous__Marker_CONTEXT__TRG__tClass_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.InterfaceInAnonymous__Marker>(getSelf(), name2actor.get("InterfaceInAnonymous__Marker_CREATE__CORR__mNestedTypeToTNestedType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.InterfaceInAnonymous__Marker>(getSelf(), name2actor.get("InterfaceInAnonymous__Marker_CREATE__TRG__tNestedType_0_reference"), this::returnTrue));
	}
