...
public class Interface__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.Interface__Marker>> ports;		
		
	public Interface__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.Interface__Marker>(getSelf(), name2actor.get("Interface__Marker_CONTEXT__SRC__mPackage_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.Interface__Marker>(getSelf(), name2actor.get("Interface__Marker_CREATE__CORR__mTypeToTType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.Interface__Marker>(getSelf(), name2actor.get("Interface__Marker_CREATE__SRC__mType_0_reference"), this::returnTrue));
	}
