...
public class SyntethicMethod__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.SyntethicMethod__Marker>> ports;		
		
	public SyntethicMethod__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.SyntethicMethod__Marker>(getSelf(), name2actor.get("SyntethicMethod__Marker_CONTEXT__TRG__tClass_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.SyntethicMethod__Marker>(getSelf(), name2actor.get("SyntethicMethod__Marker_CONTEXT__TRG__tDef_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.SyntethicMethod__Marker>(getSelf(), name2actor.get("SyntethicMethod__Marker_CREATE__TRG__tSyntethic_0_reference"), this::returnTrue));
	}
