...
public class TAnnotationType_object_SP3 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.annotations.TAnnotationType>> ports;		
		
	public TAnnotationType_object_SP3() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.annotations.TAnnotationType>(getSelf(), name2actor.get("AnnotationType__Marker_CREATE__TRG__tType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.annotations.TAnnotationType>(getSelf(), name2actor.get("TAnnotationType_outerType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.annotations.TAnnotationType>(getSelf(), name2actor.get("TAnnotationType_package_0_reference"), this::returnTrue));
	}
