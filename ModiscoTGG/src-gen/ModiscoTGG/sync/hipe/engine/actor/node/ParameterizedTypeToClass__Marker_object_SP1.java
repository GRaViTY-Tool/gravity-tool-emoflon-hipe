...
public class ParameterizedTypeToClass__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.ParameterizedTypeToClass__Marker>> ports;		
		
	public ParameterizedTypeToClass__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.ParameterizedTypeToClass__Marker>(getSelf(), name2actor.get("ParameterizedTypeToClass__Marker_CONTEXT__SRC__eType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.ParameterizedTypeToClass__Marker>(getSelf(), name2actor.get("ParameterizedTypeToClass__Marker_CONTEXT__TRG__pg_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.ParameterizedTypeToClass__Marker>(getSelf(), name2actor.get("ParameterizedTypeToClass__Marker_CREATE__SRC__eParameterizedType_0_reference"), this::returnTrue));
	}
