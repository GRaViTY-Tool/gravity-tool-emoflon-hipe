...
public class TInterface_object_SP5 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TInterface>> ports;		
		
	public TInterface_object_SP5() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TInterface>(getSelf(), name2actor.get("InterfaceMember__Marker_CONTEXT__TRG__tInterface_0_reference"), this::returnTrue));
