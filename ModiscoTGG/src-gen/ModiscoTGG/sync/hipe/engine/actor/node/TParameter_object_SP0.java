...
public class TParameter_object_SP0 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TParameter>> ports;		
		
	public TParameter_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TParameter>(getSelf(), name2actor.get("MAbstractFlowElementToTAbstractFlowElement_target_8_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TParameter>(getSelf(), name2actor.get("MethodParameterLink__Marker_CONTEXT__TRG__tPrevParameter_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TParameter>(getSelf(), name2actor.get("TMethodSignature_firstParameter_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TParameter>(getSelf(), name2actor.get("TParameter_previous_0_reference"), this::returnTrue));
	}
