...
public class InterfaceExtendsInterface__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.InterfaceExtendsInterface__Marker>> ports;		
		
	public InterfaceExtendsInterface__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.InterfaceExtendsInterface__Marker>(getSelf(), name2actor.get("InterfaceExtendsInterface__Marker_CONTEXT__SRC__eInterfaceDeclaration_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.InterfaceExtendsInterface__Marker>(getSelf(), name2actor.get("InterfaceExtendsInterface__Marker_CONTEXT__SRC__eSuperInterface_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.InterfaceExtendsInterface__Marker>(getSelf(), name2actor.get("InterfaceExtendsInterface__Marker_CREATE__SRC__eTypeAccess_0_reference"), this::returnTrue));
	}
