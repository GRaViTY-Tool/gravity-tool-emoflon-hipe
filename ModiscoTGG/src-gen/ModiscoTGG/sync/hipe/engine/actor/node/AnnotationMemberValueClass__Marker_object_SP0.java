...
public class AnnotationMemberValueClass__Marker_object_SP0 extends AbstractActor {
	
	private List<Port<ModiscoTGG.AnnotationMemberValueClass__Marker>> ports;		
		
	public AnnotationMemberValueClass__Marker_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.AnnotationMemberValueClass__Marker>(getSelf(), name2actor.get("AnnotationMemberValueClass__Marker_CONTEXT__CORR__AnnotationMemberValuePairToTAnnotationValue_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.AnnotationMemberValueClass__Marker>(getSelf(), name2actor.get("AnnotationMemberValueClass__Marker_CONTEXT__TRG__tType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.AnnotationMemberValueClass__Marker>(getSelf(), name2actor.get("AnnotationMemberValueClass__Marker_CREATE__CORR__mValueToTValue_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.AnnotationMemberValueClass__Marker>(getSelf(), name2actor.get("AnnotationMemberValueClass__Marker_CREATE__SRC__mAccess_0_reference"), this::returnTrue));
	}
