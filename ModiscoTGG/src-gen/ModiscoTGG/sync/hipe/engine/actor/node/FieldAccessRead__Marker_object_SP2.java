...
public class FieldAccessRead__Marker_object_SP2 extends AbstractActor {
	
	private List<Port<ModiscoTGG.FieldAccessRead__Marker>> ports;		
		
	public FieldAccessRead__Marker_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.FieldAccessRead__Marker>(getSelf(), name2actor.get("FieldAccessRead__Marker_CONTEXT__CORR__mMethodToTMethod_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.FieldAccessRead__Marker>(getSelf(), name2actor.get("FieldAccessRead__Marker_CONTEXT__SRC__mType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.FieldAccessRead__Marker>(getSelf(), name2actor.get("FieldAccessRead__Marker_CONTEXT__SRC__varDeclFrag_0_reference"), this::returnTrue));
	}
