...
public class TInterface_object_SP1 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TInterface>(getSelf(), name2actor.get("TClass_implements_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TInterface>(getSelf(), name2actor.get("TInterface_parentInterfaces_0_reference"), this::returnTrue));
