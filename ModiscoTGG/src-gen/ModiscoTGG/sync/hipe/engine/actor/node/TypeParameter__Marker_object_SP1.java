...
public class TypeParameter__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.TypeParameter__Marker>> ports;		
		
	public TypeParameter__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.TypeParameter__Marker>(getSelf(), name2actor.get("TypeParameter__Marker_CONTEXT__CORR__eModelToPg_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.TypeParameter__Marker>(getSelf(), name2actor.get("TypeParameter__Marker_CONTEXT__TRG__pg_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.TypeParameter__Marker>(getSelf(), name2actor.get("TypeParameter__Marker_CREATE__SRC__typeParameter_0_reference"), this::returnTrue));
	}
