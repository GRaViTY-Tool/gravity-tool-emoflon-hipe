...
public class MAbstractMethodDefinition_object_SP3 extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MAbstractMethodDefinition>> ports;		
		
	public MAbstractMethodDefinition_object_SP3() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.modisco.MAbstractMethodDefinition>(getSelf(), name2actor.get("ClassInstanceCreation__Marker_CONTEXT__SRC__mMethod_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MAbstractMethodDefinition>(getSelf(), name2actor.get("MethodInvocation__Marker_CONTEXT__SRC__mMethod_0_reference"), this::returnTrue));
	}
