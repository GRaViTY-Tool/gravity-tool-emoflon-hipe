...
public class LinkDefinitionToType__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.LinkDefinitionToType__Marker>> ports;		
		
	public LinkDefinitionToType__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.LinkDefinitionToType__Marker>(getSelf(), name2actor.get("LinkDefinitionToType__Marker_CONTEXT__SRC__mDefinition_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.LinkDefinitionToType__Marker>(getSelf(), name2actor.get("LinkDefinitionToType__Marker_CONTEXT__SRC__mSignature_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.LinkDefinitionToType__Marker>(getSelf(), name2actor.get("LinkDefinitionToType__Marker_CONTEXT__SRC__mType_0_reference"), this::returnTrue));
	}
