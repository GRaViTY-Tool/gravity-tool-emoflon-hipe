...
public class Package_object_SP1 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.Package>> ports;		
		
	public Package_object_SP1() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Package>(getSelf(), name2actor.get("EnumDeclaration_package_2_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Package>(getSelf(), name2actor.get("Model_ownedElements_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Package>(getSelf(), name2actor.get("SubPackageToPGPackage__Marker_CREATE__SRC__mPackage_0_reference"), this::returnTrue));
	}
