...
public class MClass_object_SP2 extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MClass>> ports;		
		
	public MClass_object_SP2() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.modisco.MClass>(getSelf(), name2actor.get("ClassInnerAnonClassMember__Marker_CREATE__SRC__mInnerClass_0_reference"), this::returnTrue));
