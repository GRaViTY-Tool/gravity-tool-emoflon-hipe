...
public class TInterface_object_SP0 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TInterface>> ports;		
		
	public TInterface_object_SP0() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TInterface>(getSelf(), name2actor.get("TInterface_package_4_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TInterface>(getSelf(), name2actor.get("TInterface_parentInterfaces_0_reference"), this::returnTrue));
