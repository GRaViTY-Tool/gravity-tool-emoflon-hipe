...
public class MClass_object_SP0 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.modisco.MClass>(getSelf(), name2actor.get("ClassInAnonymous__Marker_CREATE__SRC__mNestedType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.modisco.MClass>(getSelf(), name2actor.get("MClass_package_1_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MClass>(getSelf(), name2actor.get("Model_orphanTypes_11_reference"), this::returnTrue));
	}
