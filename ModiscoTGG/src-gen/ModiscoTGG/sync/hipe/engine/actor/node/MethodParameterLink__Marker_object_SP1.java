...
public class MethodParameterLink__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.MethodParameterLink__Marker>> ports;		
		
	public MethodParameterLink__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.MethodParameterLink__Marker>(getSelf(), name2actor.get("MethodParameterLink__Marker_CONTEXT__CORR__mmethodSignatureToTMethodSignature_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MethodParameterLink__Marker>(getSelf(), name2actor.get("MethodParameterLink__Marker_CONTEXT__SRC__mEntry_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MethodParameterLink__Marker>(getSelf(), name2actor.get("MethodParameterLink__Marker_CONTEXT__TRG__tPrevParameter_0_reference"), this::returnTrue));
	}
