...
public class EnumDeclaration_object_SP1 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.eclipse.modisco.java.EnumDeclaration>(getSelf(), name2actor.get("ASTNodeToTAnnotatable_source_4_reference"), this::returnTrue));
		...
		ports.add(new PortNodeRight<org.eclipse.modisco.java.EnumDeclaration>(getSelf(), name2actor.get("MemberInEnumVisibility__Marker_CONTEXT__SRC__mClass_0_reference"), this::returnTrue));
	}
