...
public class MMethodSignature_object_SP1 extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MMethodSignature>> ports;		
		
	public MMethodSignature_object_SP1() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeLeft<org.gravity.modisco.MMethodSignature>(getSelf(), name2actor.get("MMethodSignature_mFirstEntry_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.modisco.MMethodSignature>(getSelf(), name2actor.get("MMethodSignature_returnType_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MMethodSignature>(getSelf(), name2actor.get("MethodParameter__Marker_CONTEXT__SRC__mSignature_0_reference"), this::returnTrue));
	}
