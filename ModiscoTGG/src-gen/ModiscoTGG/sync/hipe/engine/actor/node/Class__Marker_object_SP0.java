...
public class Class__Marker_object_SP0 extends AbstractActor {
	
	private List<Port<ModiscoTGG.Class__Marker>> ports;		
		
	public Class__Marker_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.Class__Marker>(getSelf(), name2actor.get("Class__Marker_CONTEXT__TRG__tPackage_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.Class__Marker>(getSelf(), name2actor.get("Class__Marker_CREATE__CORR__mClassDeclarationToTClass_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.Class__Marker>(getSelf(), name2actor.get("Class__Marker_CREATE__TRG__tType_0_reference"), this::returnTrue));
	}
