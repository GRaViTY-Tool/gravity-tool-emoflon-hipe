...
public class TMember_object_SP4 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TMember>> ports;		
		
	public TMember_object_SP4() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TMember>(getSelf(), name2actor.get("ClassInstanceCreation__Marker_CONTEXT__TRG__tMember_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TMember>(getSelf(), name2actor.get("MemberInAnnotationVisibility__Marker_CONTEXT__TRG__tMember_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TMember>(getSelf(), name2actor.get("TMember_tAnnotation_3_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TMember>(getSelf(), name2actor.get("TMember_tModifier_0_reference"), this::returnTrue));
	}
