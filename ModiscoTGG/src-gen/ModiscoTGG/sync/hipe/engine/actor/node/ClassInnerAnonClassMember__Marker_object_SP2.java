...
public class ClassInnerAnonClassMember__Marker_object_SP2 extends AbstractActor {
	
	private List<Port<ModiscoTGG.ClassInnerAnonClassMember__Marker>> ports;		
		
	public ClassInnerAnonClassMember__Marker_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.ClassInnerAnonClassMember__Marker>(getSelf(), name2actor.get("ClassInnerAnonClassMember__Marker_CONTEXT__TRG__tOuterClass_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.ClassInnerAnonClassMember__Marker>(getSelf(), name2actor.get("ClassInnerAnonClassMember__Marker_CONTEXT__TRG__typeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.ClassInnerAnonClassMember__Marker>(getSelf(), name2actor.get("ClassInnerAnonClassMember__Marker_CREATE__SRC__mInnerClass_0_reference"), this::returnTrue));
	}
