...
public class UnresolvedTypeDeclaration__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.UnresolvedTypeDeclaration__Marker>> ports;		
		
	public UnresolvedTypeDeclaration__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.UnresolvedTypeDeclaration__Marker>(getSelf(), name2actor.get("UnresolvedTypeDeclaration__Marker_CONTEXT__CORR__eModelToPg_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.UnresolvedTypeDeclaration__Marker>(getSelf(), name2actor.get("UnresolvedTypeDeclaration__Marker_CONTEXT__TRG__pg_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.UnresolvedTypeDeclaration__Marker>(getSelf(), name2actor.get("UnresolvedTypeDeclaration__Marker_CREATE__SRC__unresolvedType_0_reference"), this::returnTrue));
	}
