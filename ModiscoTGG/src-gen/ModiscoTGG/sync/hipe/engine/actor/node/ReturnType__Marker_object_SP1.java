...
public class ReturnType__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.ReturnType__Marker>> ports;		
		
	public ReturnType__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.ReturnType__Marker>(getSelf(), name2actor.get("ReturnType__Marker_CONTEXT__SRC__eReturnType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.ReturnType__Marker>(getSelf(), name2actor.get("ReturnType__Marker_CONTEXT__SRC__mDefinition_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.ReturnType__Marker>(getSelf(), name2actor.get("ReturnType__Marker_CREATE__SRC__eTypeAccess_0_reference"), this::returnTrue));
	}
