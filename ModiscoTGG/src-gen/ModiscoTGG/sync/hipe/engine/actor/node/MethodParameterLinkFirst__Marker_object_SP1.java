...
public class MethodParameterLinkFirst__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.MethodParameterLinkFirst__Marker>> ports;		
		
	public MethodParameterLinkFirst__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.MethodParameterLinkFirst__Marker>(getSelf(), name2actor.get("MethodParameterLinkFirst__Marker_CONTEXT__CORR__mmethodSignatureToTMethodSignature_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MethodParameterLinkFirst__Marker>(getSelf(), name2actor.get("MethodParameterLinkFirst__Marker_CONTEXT__SRC__mEntry_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MethodParameterLinkFirst__Marker>(getSelf(), name2actor.get("MethodParameterLinkFirst__Marker_CONTEXT__TRG__tMethodSignature_0_reference"), this::returnTrue));
	}
