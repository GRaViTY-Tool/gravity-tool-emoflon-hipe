...
public class MDefinition_object_SP2 extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MDefinition>> ports;		
		
	public MDefinition_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.modisco.MDefinition>(getSelf(), name2actor.get("AnnotationTypeDeclaration_bodyDeclarations_5_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MDefinition>(getSelf(), name2actor.get("ClassInstanceCreation__Marker_CONTEXT__SRC__mMember_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MDefinition>(getSelf(), name2actor.get("FieldAccessWrite__Marker_CONTEXT__SRC__mMember_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.modisco.MDefinition>(getSelf(), name2actor.get("MDefinition_mMethodInvocations_4_reference"), this::returnTrue));
	}
