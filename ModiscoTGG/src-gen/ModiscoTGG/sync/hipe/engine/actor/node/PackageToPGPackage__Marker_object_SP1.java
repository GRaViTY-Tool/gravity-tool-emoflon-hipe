...
public class PackageToPGPackage__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.PackageToPGPackage__Marker>> ports;		
		
	public PackageToPGPackage__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.PackageToPGPackage__Marker>(getSelf(), name2actor.get("PackageToPGPackage__Marker_CONTEXT__SRC__mModel_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.PackageToPGPackage__Marker>(getSelf(), name2actor.get("PackageToPGPackage__Marker_CREATE__CORR__mPackageToTPackage_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.PackageToPGPackage__Marker>(getSelf(), name2actor.get("PackageToPGPackage__Marker_CREATE__TRG__tPackage_0_reference"), this::returnTrue));
	}
