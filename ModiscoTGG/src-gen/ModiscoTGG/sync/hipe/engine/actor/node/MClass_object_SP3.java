...
public class MClass_object_SP3 extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MClass>> ports;		
		
	public MClass_object_SP3() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.modisco.MClass>(getSelf(), name2actor.get("ClassInnerClassMember__Marker_CREATE__SRC__mInnerClass_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MClass>(getSelf(), name2actor.get("NestedClassInType__Marker_CREATE__SRC__eNestedType_0_reference"), this::returnTrue));
	}
