...
public class ModelToTypeGraph_object_SP0 extends AbstractActor {
	
	private List<Port<ModiscoTGG.ModelToTypeGraph>> ports;		
		
	public ModelToTypeGraph_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<ModiscoTGG.ModelToTypeGraph>(getSelf(), name2actor.get("ModelToPg__Marker_CREATE__CORR__mModelToTPG_0_reference"), this::returnTrue));
		...
		ports.add(new PortNodeRight<ModiscoTGG.ModelToTypeGraph>(getSelf(), name2actor.get("PrimitiveTypeIsDouble__Marker_CONTEXT__CORR__eModelToTypeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<ModiscoTGG.ModelToTypeGraph>(getSelf(), name2actor.get("TypeParameter__Marker_CONTEXT__CORR__eModelToPg_0_reference"), this::returnTrue));
	}
