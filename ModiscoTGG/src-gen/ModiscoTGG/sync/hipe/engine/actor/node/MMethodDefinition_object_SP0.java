...
public class MMethodDefinition_object_SP0 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeLeft<org.gravity.modisco.MMethodDefinition>(getSelf(), name2actor.get("MMethodDefinition_mSignature_3_reference"), this::returnTrue));
		...
		ports.add(new PortNodeLeft<org.gravity.modisco.MMethodDefinition>(getSelf(), name2actor.get("MMethodDefinition_returnType_1_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MMethodDefinition>(getSelf(), name2actor.get("MethodDefinition__Marker_CREATE__SRC__mDefinition_0_reference"), this::returnTrue));
	}
