...
public class Annotation_object_SP0 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.Annotation>> ports;		
		
	public Annotation_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Annotation>(getSelf(), name2actor.get("AnnotationMemberValuePair_value_1_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Annotation>(getSelf(), name2actor.get("AnnotationOnBodyDeclaration__Marker_CREATE__SRC__Annotation_0_reference"), this::returnTrue));
		...
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Annotation>(getSelf(), name2actor.get("ArrayInitializer_expressions_0_reference"), this::returnTrue));
	}
