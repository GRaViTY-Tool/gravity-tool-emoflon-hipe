...
public class VariableDeclarationFragment_object_SP0 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.eclipse.modisco.java.VariableDeclarationFragment>(getSelf(), name2actor.get("FieldAccessWrite__Marker_CONTEXT__SRC__varDeclFrag_0_reference"), this::returnTrue));
