...
public class MDefinition_object_SP6 extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MDefinition>> ports;		
		
	public MDefinition_object_SP6() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.modisco.MDefinition>(getSelf(), name2actor.get("EnumDeclaration_bodyDeclarations_7_reference"), this::returnTrue));
		...
		ports.add(new PortNodeLeft<org.gravity.modisco.MDefinition>(getSelf(), name2actor.get("MDefinition_mSignature_2_reference"), this::returnTrue));
	}
