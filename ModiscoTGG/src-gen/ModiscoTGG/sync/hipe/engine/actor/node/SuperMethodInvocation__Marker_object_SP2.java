...
public class SuperMethodInvocation__Marker_object_SP2 extends AbstractActor {
	
	private List<Port<ModiscoTGG.SuperMethodInvocation__Marker>> ports;		
		
	public SuperMethodInvocation__Marker_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.SuperMethodInvocation__Marker>(getSelf(), name2actor.get("SuperMethodInvocation__Marker_CONTEXT__SRC__mMember_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.SuperMethodInvocation__Marker>(getSelf(), name2actor.get("SuperMethodInvocation__Marker_CONTEXT__SRC__mMethod_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.SuperMethodInvocation__Marker>(getSelf(), name2actor.get("SuperMethodInvocation__Marker_CREATE__SRC__invocation_0_reference"), this::returnTrue));
	}
