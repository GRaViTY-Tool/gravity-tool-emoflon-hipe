...
public class TMethodDefinition_object_SP3 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TMethodDefinition>> ports;		
		
	public TMethodDefinition_object_SP3() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TMethodDefinition>(getSelf(), name2actor.get("MethodOverriding__Marker_CONTEXT__TRG__tOverriding_0_reference"), this::returnTrue));
