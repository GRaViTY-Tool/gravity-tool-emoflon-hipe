...
public class ConstructorDefinition__Marker_object_SP2 extends AbstractActor {
	
	private List<Port<ModiscoTGG.ConstructorDefinition__Marker>> ports;		
		
	public ConstructorDefinition__Marker_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.ConstructorDefinition__Marker>(getSelf(), name2actor.get("ConstructorDefinition__Marker_CONTEXT__TRG__tMethodSignature_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.ConstructorDefinition__Marker>(getSelf(), name2actor.get("ConstructorDefinition__Marker_CREATE__CORR__mBodyToTAnnotation_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.ConstructorDefinition__Marker>(getSelf(), name2actor.get("ConstructorDefinition__Marker_CREATE__TRG__tAnnotation_0_reference"), this::returnTrue));
	}
