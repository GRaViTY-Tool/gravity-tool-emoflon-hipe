...
public class TCall_object_SP1 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TCall>> ports;		
		
	public TCall_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TCall>(getSelf(), name2actor.get("ConstructorInvocation__Marker_CREATE__TRG__tAccess_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TCall>(getSelf(), name2actor.get("SuperMethodInvocation__Marker_CREATE__TRG__tAccess_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TCall>(getSelf(), name2actor.get("TCall_staticType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TCall>(getSelf(), name2actor.get("TCall_tTarget_0_reference"), this::returnTrue));
	}
