...
public class MethodInvocationStaticType__Marker_object_SP0 extends AbstractActor {
	
	private List<Port<ModiscoTGG.MethodInvocationStaticType__Marker>> ports;		
		
	public MethodInvocationStaticType__Marker_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.MethodInvocationStaticType__Marker>(getSelf(), name2actor.get("MethodInvocationStaticType__Marker_CONTEXT__CORR__invocationToTAccess_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MethodInvocationStaticType__Marker>(getSelf(), name2actor.get("MethodInvocationStaticType__Marker_CONTEXT__SRC__mStaticType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MethodInvocationStaticType__Marker>(getSelf(), name2actor.get("MethodInvocationStaticType__Marker_CONTEXT__TRG__tAccess_0_reference"), this::returnTrue));
	}
