...
public class Model_object_SP5 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.Model>> ports;		
		
	public Model_object_SP5() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.Model>(getSelf(), name2actor.get("Model_orphanTypes_1_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.Model>(getSelf(), name2actor.get("Model_orphanTypes_8_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Model>(getSelf(), name2actor.get("PrimitiveTypeIsChar__Marker_CONTEXT__SRC__eModel_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Model>(getSelf(), name2actor.get("TypesOrphaned__Marker_CONTEXT__SRC__mModel_0_reference"), this::returnTrue));
	}
