...
public class TCall_object_SP3 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TCall>> ports;		
		
	public TCall_object_SP3() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TCall>(getSelf(), name2actor.get("MethodInvocation__Marker_CREATE__TRG__tAccess_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TCall>(getSelf(), name2actor.get("TCall_tTarget_4_reference"), this::returnTrue));
	}
