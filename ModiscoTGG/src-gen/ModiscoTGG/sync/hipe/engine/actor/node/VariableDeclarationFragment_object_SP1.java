...
public class VariableDeclarationFragment_object_SP1 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.eclipse.modisco.java.VariableDeclarationFragment>(getSelf(), name2actor.get("MSingleVariableAccess_variable_0_reference"), this::returnTrue));
