...
public class TClass_object_SP23 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TClass>> ports;		
		
	public TClass_object_SP23() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("PrimitiveTypeToTClass_target_4_reference"), this::check_constraint_252));
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("TypeToTAbstractType_target_13_reference"), this::check_constraint_300));
	}
	...
	public boolean check_constraint_300(org.gravity.typegraph.basic.TClass tClass) {
