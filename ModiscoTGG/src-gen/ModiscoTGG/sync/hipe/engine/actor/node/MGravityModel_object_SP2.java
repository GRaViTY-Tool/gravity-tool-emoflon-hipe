...
public class MGravityModel_object_SP2 extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MGravityModel>> ports;		
		
	public MGravityModel_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.modisco.MGravityModel>(getSelf(), name2actor.get("FieldName__Marker_CONTEXT__SRC__model_0_reference"), this::returnTrue));
		...
		ports.add(new PortNodeRight<org.gravity.modisco.MGravityModel>(getSelf(), name2actor.get("TypeParameter__Marker_CONTEXT__SRC__eModel_0_reference"), this::returnTrue));
	}
