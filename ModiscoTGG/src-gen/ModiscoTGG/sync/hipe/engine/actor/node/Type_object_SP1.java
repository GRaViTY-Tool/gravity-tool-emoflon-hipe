...
public class Type_object_SP1 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.Type>> ports;		
		
	public Type_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Type>(getSelf(), name2actor.get("ClassImplementsInterface__Marker_CONTEXT__SRC__eSuperInterface_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Type>(getSelf(), name2actor.get("MethodInvocationStaticType__Marker_CONTEXT__SRC__mStaticType_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Type>(getSelf(), name2actor.get("ReturnType__Marker_CONTEXT__SRC__eReturnType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.Type>(getSelf(), name2actor.get("Type_usagesInTypeAccess_0_reference"), this::returnTrue));
	}
