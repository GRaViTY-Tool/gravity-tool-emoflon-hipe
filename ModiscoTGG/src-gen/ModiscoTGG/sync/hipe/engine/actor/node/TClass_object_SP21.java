...
public class TClass_object_SP21 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TClass>> ports;		
		
	public TClass_object_SP21() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("TypeGraph_classes_11_reference"), this::check_constraint_298));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("TypeGraph_classes_6_reference"), this::check_constraint_250));
	}
	...
	public boolean check_constraint_298(org.gravity.typegraph.basic.TClass tClass) {
