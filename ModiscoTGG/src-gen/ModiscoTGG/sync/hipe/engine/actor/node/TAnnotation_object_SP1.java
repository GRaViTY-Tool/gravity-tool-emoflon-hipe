...
public class TAnnotation_object_SP1 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.annotations.TAnnotation>> ports;		
		
	public TAnnotation_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.annotations.TAnnotation>(getSelf(), name2actor.get("AnnotationOnBodyDeclaration__Marker_CREATE__TRG__tAnnotation_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.annotations.TAnnotation>(getSelf(), name2actor.get("AnnotationToTAnnotation_target_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.annotations.TAnnotation>(getSelf(), name2actor.get("TAnnotatable_tAnnotation_0_reference"), this::returnTrue));
	}
