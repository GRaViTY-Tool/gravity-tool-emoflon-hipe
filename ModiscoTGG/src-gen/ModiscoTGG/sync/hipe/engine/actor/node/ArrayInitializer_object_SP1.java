...
public class ArrayInitializer_object_SP1 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.ArrayInitializer>> ports;		
		
	public ArrayInitializer_object_SP1() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.ArrayInitializer>(getSelf(), name2actor.get("ArrayInitializer_expressions_2_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.ArrayInitializer>(getSelf(), name2actor.get("ArrayInitializer_expressions_4_reference"), this::returnTrue));
	}
