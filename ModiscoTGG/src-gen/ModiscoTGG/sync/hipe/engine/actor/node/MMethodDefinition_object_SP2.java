...
public class MMethodDefinition_object_SP2 extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MMethodDefinition>> ports;		
		
	public MMethodDefinition_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.modisco.MMethodDefinition>(getSelf(), name2actor.get("MDefinitionToTMember_source_4_reference"), this::returnTrue));
		...
		ports.add(new PortNodeLeft<org.gravity.modisco.MMethodDefinition>(getSelf(), name2actor.get("MMethodDefinition_syntheticMethodDefinitions_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MMethodDefinition>(getSelf(), name2actor.get("MethodOverriding__Marker_CONTEXT__SRC__mMethod_0_reference"), this::returnTrue));
	}
