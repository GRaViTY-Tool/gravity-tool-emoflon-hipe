...
public class TPackage_object_SP2 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TPackage>> ports;		
		
	public TPackage_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TPackage>(getSelf(), name2actor.get("Enum__Marker_CONTEXT__TRG__tPackage_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TPackage>(getSelf(), name2actor.get("NestedInterfaceInType__Marker_CREATE__TRG__tNestedPackage_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TPackage>(getSelf(), name2actor.get("TPackage_classes_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TPackage>(getSelf(), name2actor.get("TPackage_typeGraph_0_reference"), this::returnTrue));
	}
