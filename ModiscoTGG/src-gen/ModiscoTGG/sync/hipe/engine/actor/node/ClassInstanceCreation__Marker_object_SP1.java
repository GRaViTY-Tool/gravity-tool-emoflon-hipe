...
public class ClassInstanceCreation__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.ClassInstanceCreation__Marker>> ports;		
		
	public ClassInstanceCreation__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.ClassInstanceCreation__Marker>(getSelf(), name2actor.get("ClassInstanceCreation__Marker_CONTEXT__TRG__tMember_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.ClassInstanceCreation__Marker>(getSelf(), name2actor.get("ClassInstanceCreation__Marker_CONTEXT__TRG__tMethod_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.ClassInstanceCreation__Marker>(getSelf(), name2actor.get("ClassInstanceCreation__Marker_CREATE__TRG__tAccess_0_reference"), this::returnTrue));
	}
