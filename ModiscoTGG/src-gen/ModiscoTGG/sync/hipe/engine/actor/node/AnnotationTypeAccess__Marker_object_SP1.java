...
public class AnnotationTypeAccess__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.AnnotationTypeAccess__Marker>> ports;		
		
	public AnnotationTypeAccess__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.AnnotationTypeAccess__Marker>(getSelf(), name2actor.get("AnnotationTypeAccess__Marker_CONTEXT__SRC__AnnotationType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.AnnotationTypeAccess__Marker>(getSelf(), name2actor.get("AnnotationTypeAccess__Marker_CONTEXT__SRC__Annotation_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.AnnotationTypeAccess__Marker>(getSelf(), name2actor.get("AnnotationTypeAccess__Marker_CREATE__SRC__mAccess_0_reference"), this::returnTrue));
	}
