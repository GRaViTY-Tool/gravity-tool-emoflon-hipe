...
public class AnnotationMemberKey__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.AnnotationMemberKey__Marker>> ports;		
		
	public AnnotationMemberKey__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.AnnotationMemberKey__Marker>(getSelf(), name2actor.get("AnnotationMemberKey__Marker_CONTEXT__CORR__AnnotationToTAnnotation_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.AnnotationMemberKey__Marker>(getSelf(), name2actor.get("AnnotationMemberKey__Marker_CONTEXT__TRG__tAnnotation_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.AnnotationMemberKey__Marker>(getSelf(), name2actor.get("AnnotationMemberKey__Marker_CREATE__SRC__mValue_0_reference"), this::returnTrue));
	}
