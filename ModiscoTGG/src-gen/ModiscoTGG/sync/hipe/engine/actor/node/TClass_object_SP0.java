...
public class TClass_object_SP0 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("TClass_pg_5_reference"), this::check_constraint_229));
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("TypeGraph_classes_7_reference"), this::check_constraint_255));
	}
	...
	public boolean check_constraint_229(org.gravity.typegraph.basic.TClass tPrimitiveClass) {
