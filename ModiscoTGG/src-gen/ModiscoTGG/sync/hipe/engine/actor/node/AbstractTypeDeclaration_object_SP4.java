...
public class AbstractTypeDeclaration_object_SP4 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.AbstractTypeDeclaration>> ports;		
		
	public AbstractTypeDeclaration_object_SP4() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.AbstractTypeDeclaration>(getSelf(), name2actor.get("AbstractTypeDeclaration_usagesInTypeAccess_2_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.AbstractTypeDeclaration>(getSelf(), name2actor.get("FieldAccessReadWrite__Marker_CONTEXT__SRC__mType_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.AbstractTypeDeclaration>(getSelf(), name2actor.get("NestedClassInType__Marker_CONTEXT__SRC__eOuterType_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.AbstractTypeDeclaration>(getSelf(), name2actor.get("TypesVisibility__Marker_CONTEXT__SRC__mType_0_reference"), this::returnTrue));
	}
