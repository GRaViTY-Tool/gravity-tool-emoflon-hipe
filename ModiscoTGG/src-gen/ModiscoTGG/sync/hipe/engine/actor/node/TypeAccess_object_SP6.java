...
public class TypeAccess_object_SP6 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.TypeAccess>> ports;		
		
	public TypeAccess_object_SP6() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.eclipse.modisco.java.TypeAccess>(getSelf(), name2actor.get("AnonymousClassTypeClass__Marker_CREATE__SRC__mType_0_reference"), this::returnTrue));
