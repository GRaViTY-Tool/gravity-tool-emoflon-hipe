...
public class AbstractTypeDeclaration_object_SP2 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.AbstractTypeDeclaration>> ports;		
		
	public AbstractTypeDeclaration_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.AbstractTypeDeclaration>(getSelf(), name2actor.get("AbstractTypeDeclaration_bodyDeclarations_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.AbstractTypeDeclaration>(getSelf(), name2actor.get("AnonymousClass__Marker_CONTEXT__SRC__mType_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.AbstractTypeDeclaration>(getSelf(), name2actor.get("LinkDefinitionToType__Marker_CONTEXT__SRC__mType_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.AbstractTypeDeclaration>(getSelf(), name2actor.get("NestedInterfaceInType__Marker_CONTEXT__SRC__eOuterType_0_reference"), this::returnTrue));
	}
