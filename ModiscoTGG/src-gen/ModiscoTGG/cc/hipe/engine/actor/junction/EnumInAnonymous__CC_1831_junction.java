...
public class EnumInAnonymous__CC_1831_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		...
		ports.add(new PortJunctionLeft(getSelf(), name2actor.get("EnumInAnonymous__CC_5367_nacjunction"), this::check_constraint_103));
	}
	...
	public boolean check_constraint_103(HMatch match) {
		...
		org.eclipse.modisco.java.EnumDeclaration mNestedType = (org.eclipse.modisco.java.EnumDeclaration) match.getNodes()[1];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_46 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_46.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mNestedType.isProxy(), "boolean"));
		...
		csp_47.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mNestedType.getName(), "java.lang.String"));
