...
public class NestedInterfaceInType__CONSISTENCY_3895_junction extends GenericJunctionActor{
	...
	public boolean check_constraint_214(HMatch match) {
		...
		csp_99.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "$", "java.lang.String"));
		csp_99.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tNestedPackage.getTName(), "java.lang.String"));
		csp_99.solve();
