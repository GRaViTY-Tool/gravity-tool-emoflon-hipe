...
public class InterfaceMember__CC_2667_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		...
		ports.add(new PortJunctionLeft(getSelf(), name2actor.get("InterfaceMember__CC_5401_nacjunction"), this::check_constraint_159));
	}
	...
	public boolean check_constraint_159(HMatch match) {
		...
		csp_60.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mModifier.isStatic(), "boolean"));
		csp_60.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tModifier.isIsStatic(), "boolean"));
		csp_60.solve();
		
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.modiscotgg.UserDefined_interfaceVisibility csp_61 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.modiscotgg.UserDefined_interfaceVisibility();
		csp_61.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mModifier.getVisibility(), "org.eclipse.modisco.java.VisibilityKind"));
		csp_61.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tModifier.getTVisibility(), "org.gravity.typegraph.basic.TVisibility"));
		csp_61.solve();
		
		boolean predicate = csp_60.isSatisfied() && csp_61.isSatisfied();
