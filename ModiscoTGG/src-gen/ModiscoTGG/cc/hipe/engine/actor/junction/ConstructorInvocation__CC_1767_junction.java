...
public class ConstructorInvocation__CC_1767_junction extends GenericJunctionActor{
	
	@Override
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		ports = new LinkedList<>();
		ports.add(new PortJunctionRight(getSelf(), name2actor.get("ConstructorInvocation__CC_1764_junction"), this::check_constraint_99));
	}
