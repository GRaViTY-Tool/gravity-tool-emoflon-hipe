...
public class ClassInnerAnonClassMember__CC_1394_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		...
		ports.add(new PortJunctionLeft(getSelf(), name2actor.get("ClassInnerAnonClassMember__CC_1387_junction"), this::check_constraint_70));
	}
	...
	public boolean check_constraint_70(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.AddSuffix csp_34 = new org.emoflon.ibex.tgg.operational.csp.constraints.AddSuffix();
		csp_34.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tOuterClass.getTName(), "java.lang.String"));
		csp_34.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "$1", "java.lang.String"));
		csp_34.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tInnerPackage.getTName(), "java.lang.String"));
		csp_34.solve();
