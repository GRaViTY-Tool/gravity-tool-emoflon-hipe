...
public class NestedInterfaceInType_tNestedType_interfaces_incoming_TRG__FILTER_NAC_3955_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, AbstractJunctionNode node) {
		...
		ports.add(new PortJunctionRight(getSelf(), name2actor.get("NestedInterfaceInType__CONSISTENCY_5433_nacjunction"), this::check_constraint_215));
		ports.add(new PortJunctionRight(getSelf(), name2actor.get("NestedInterfaceInType__CONSISTENCY_5434_nacjunction"), this::check_constraint_216));
		ports.add(new PortJunction(getSelf(), name2actor.get("NestedInterfaceInType_tNestedType_interfaces_incoming_TRG__FILTER_NAC_production"), this::check_constraint_217));
	}
	...
	public boolean check_constraint_212(HMatch match) {
		org.gravity.typegraph.basic.TPackage FILTER_NAC_NODE = (org.gravity.typegraph.basic.TPackage) match.getNodes()[2];
		org.gravity.typegraph.basic.TPackage tNestedPackage = (org.gravity.typegraph.basic.TPackage) match.getNodes()[0];
		boolean predicate = !FILTER_NAC_NODE.equals(tNestedPackage);
		match.setConstraintSatisfied(predicate);
	...
	public boolean check_constraint_215(HMatch match) {
		org.gravity.typegraph.basic.TPackage FILTER_NAC_NODE = (org.gravity.typegraph.basic.TPackage) match.getNodes()[2];
		org.gravity.typegraph.basic.TPackage tNestedPackage = (org.gravity.typegraph.basic.TPackage) match.getNodes()[0];
		boolean predicate = !FILTER_NAC_NODE.equals(tNestedPackage);
		match.setConstraintSatisfied(predicate);
	...
	public boolean check_constraint_217(HMatch match) {
		org.gravity.typegraph.basic.TPackage FILTER_NAC_NODE = (org.gravity.typegraph.basic.TPackage) match.getNodes()[2];
		org.gravity.typegraph.basic.TPackage tNestedPackage = (org.gravity.typegraph.basic.TPackage) match.getNodes()[0];
		boolean predicate = !FILTER_NAC_NODE.equals(tNestedPackage);
		match.setConstraintSatisfied(predicate);
