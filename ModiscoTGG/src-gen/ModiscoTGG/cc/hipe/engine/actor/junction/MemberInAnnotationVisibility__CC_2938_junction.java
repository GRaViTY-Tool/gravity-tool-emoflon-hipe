...
public class MemberInAnnotationVisibility__CC_2938_junction extends GenericJunctionActor{
	...
	protected void registerMatchForAttributeChanges(HMatch match) {
		...
		Collection<HMatch> modifier_7_Matches = modifierAttrMap.get(matchObjects[7]);
		if(modifier_7_Matches == null) {
			modifier_7_Matches = new LinkedList<>();
			modifierAttrMap.put(matchObjects[7], modifier_7_Matches);
		}
		
		modifier_7_Matches.add(match);
	...
	protected void deregisterMatchForAttributeChanges(Set<HMatch> matches, HMatch match) {
		Object[] matchObjects = match.getNodes();
		Collection<HMatch> matches_0 = modifierAttrMap.get(matchObjects[7]);
		if(matches_0 != null) {
	...
	public boolean check_constraint_168(HMatch match) {
		...
		csp_68.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tModifier.getTVisibility(), "org.gravity.typegraph.basic.TVisibility"));
		csp_68.solve();
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_69 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_69.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mModifier.isStatic(), "boolean"));
		csp_69.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tModifier.isIsStatic(), "boolean"));
		csp_69.solve();
		
		boolean predicate = csp_68.isSatisfied() && csp_69.isSatisfied();
