...
public class SuperMethodInvocation__CC_4812_junction extends GenericJunctionActor{
	
	@Override
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		ports = new LinkedList<>();
		ports.add(new PortJunction(getSelf(), name2actor.get("SuperMethodInvocation__CC_production"), this::check_constraint_290));
	}
