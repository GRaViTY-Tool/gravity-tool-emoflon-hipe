...
public class AnnotationMemberValueNumber__CC_443_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, AbstractJunctionNode node) {
		...
		ports.add(new PortJunction(getSelf(), name2actor.get("AnnotationMemberValueNumber__CC_production"), this::check_constraint_15));
	}
	...
	public boolean check_constraint_15(HMatch match) {
		...
		csp_8.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mValue.getTokenValue(), "java.lang.String"));
		csp_8.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tValue.getTNumber(), "java.lang.String"));
		csp_8.solve();
