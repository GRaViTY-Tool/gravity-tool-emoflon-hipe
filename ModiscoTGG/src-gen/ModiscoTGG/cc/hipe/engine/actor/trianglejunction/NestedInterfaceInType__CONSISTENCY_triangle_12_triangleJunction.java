...
public class NestedInterfaceInType__CONSISTENCY_triangle_12_triangleJunction extends GenericTriangleJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, TriangleJunctionNode node) {
		...
		ports.add(new PortJunctionRight(getSelf(), name2actor.get("NestedInterfaceInType__CONSISTENCY_triangle_11_triangleJunction"), this::check_constraint_213));
	}
	...
	public boolean check_constraint_213(HMatch match) {
		...
		csp_100.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, eNestedType.isProxy(), "boolean"));
		csp_100.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tNestedType.isTLib(), "boolean"));
		csp_100.solve();
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_101 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_101.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, eNestedType.getName(), "java.lang.String"));
		csp_101.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tNestedType.getTName(), "java.lang.String"));
		csp_101.solve();
		
		boolean predicate = csp_100.isSatisfied() && csp_101.isSatisfied();
