...
public class NestedEnum__CONSISTENCY_triangle_0_triangleJunction extends GenericTriangleJunctionActor{
	...
	public boolean check_constraint_206(HMatch match) {
		...
		csp_93.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "$", "java.lang.String"));
		csp_93.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tNestedPackage.getTName(), "java.lang.String"));
		csp_93.solve();
		
		boolean predicate = csp_93.isSatisfied();
