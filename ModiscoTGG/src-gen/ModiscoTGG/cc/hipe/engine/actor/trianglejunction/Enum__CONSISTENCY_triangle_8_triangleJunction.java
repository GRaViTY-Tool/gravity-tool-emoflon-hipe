...
public class Enum__CONSISTENCY_triangle_8_triangleJunction extends GenericTriangleJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, TriangleJunctionNode node) {
		...
		ports.add(new PortJunctionRight(getSelf(), name2actor.get("Enum__CONSISTENCY_triangle_7_triangleJunction"), this::check_constraint_108));
	}
	...
	public boolean check_constraint_108(HMatch match) {
		...
		csp_52.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mType.isProxy(), "boolean"));
		csp_52.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tType.isTLib(), "boolean"));
		csp_52.solve();
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_53 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_53.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mType.getName(), "java.lang.String"));
		csp_53.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tType.getTName(), "java.lang.String"));
		csp_53.solve();
