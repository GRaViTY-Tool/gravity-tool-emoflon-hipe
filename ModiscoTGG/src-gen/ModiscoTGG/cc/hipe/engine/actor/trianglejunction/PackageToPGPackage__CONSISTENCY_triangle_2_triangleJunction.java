...
public class PackageToPGPackage__CONSISTENCY_triangle_2_triangleJunction extends GenericTriangleJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, TriangleJunctionNode node) {
		...
		ports.add(new PortJunctionRight(getSelf(), name2actor.get("PackageToPGPackage__CONSISTENCY_triangle_0_triangleJunction"), this::check_constraint_226));
	}
	...
	public boolean check_constraint_226(HMatch match) {
		...
		csp_103.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mPackage.getName(), "java.lang.String"));
		csp_103.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tPackage.getTName(), "java.lang.String"));
		csp_103.solve();
