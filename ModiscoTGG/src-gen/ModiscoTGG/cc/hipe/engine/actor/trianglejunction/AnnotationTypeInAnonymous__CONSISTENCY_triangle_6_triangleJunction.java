...
public class AnnotationTypeInAnonymous__CONSISTENCY_triangle_6_triangleJunction extends GenericTriangleJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, TriangleJunctionNode node) {
		...
		ports.add(new PortJunctionRight(getSelf(), name2actor.get("AnnotationTypeInAnonymous__CONSISTENCY_triangle_4_triangleJunction"), this::check_constraint_25));
	}
	...
	public boolean check_constraint_25(HMatch match) {
		...
		csp_16.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mNestedType.isProxy(), "boolean"));
		csp_16.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tNestedType.isTLib(), "boolean"));
		csp_16.solve();
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_17 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_17.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mNestedType.getName(), "java.lang.String"));
		csp_17.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tNestedType.getTName(), "java.lang.String"));
		csp_17.solve();
		
		boolean predicate = csp_16.isSatisfied() && csp_17.isSatisfied();
