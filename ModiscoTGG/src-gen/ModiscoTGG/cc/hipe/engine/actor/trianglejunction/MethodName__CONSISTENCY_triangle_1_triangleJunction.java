...
public class MethodName__CONSISTENCY_triangle_1_triangleJunction extends GenericTriangleJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, TriangleJunctionNode node) {
		...
		ports.add(new PortJunction(getSelf(), name2actor.get("MethodName__CONSISTENCY_triangle_0_triangleJunction"), this::check_constraint_179));
	}
	...
	public boolean check_constraint_179(HMatch match) {
		...
		csp_81.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tName.getTName(), "java.lang.String"));
		csp_81.solve();
		
		boolean predicate = csp_81.isSatisfied();
