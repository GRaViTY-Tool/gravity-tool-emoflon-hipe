...
public class AnnotationMemberKey__CONSISTENCY_triangle_1_triangleJunction extends GenericTriangleJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, AbstractJunctionNode node) {
		...
		ports.add(new PortJunction(getSelf(), name2actor.get("AnnotationMemberKey__CONSISTENCY_triangle_0_triangleJunction"), this::check_constraint_2));
	}
	...
	public boolean check_constraint_2(HMatch match) {
		...
		csp_1.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mValue.getName(), "java.lang.String"));
		csp_1.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tAnnotationValue.getTKey(), "java.lang.String"));
		csp_1.solve();
