...
public class Class__CONSISTENCY_triangle_9_triangleJunction extends GenericTriangleJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, TriangleJunctionNode node) {
		...
		ports.add(new PortJunctionRight(getSelf(), name2actor.get("Class__CONSISTENCY_triangle_8_triangleJunction"), this::check_constraint_95));
	}
	...
	public boolean check_constraint_95(HMatch match) {
		...
		csp_44.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mType.isProxy(), "boolean"));
		csp_44.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tType.isTLib(), "boolean"));
		csp_44.solve();
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_45 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_45.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mType.getName(), "java.lang.String"));
		csp_45.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tType.getTName(), "java.lang.String"));
		csp_45.solve();
		
		boolean predicate = csp_44.isSatisfied() && csp_45.isSatisfied();
