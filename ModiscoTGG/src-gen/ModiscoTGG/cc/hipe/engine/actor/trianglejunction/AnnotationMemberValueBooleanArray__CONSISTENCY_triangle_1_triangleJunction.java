...
public class AnnotationMemberValueBooleanArray__CONSISTENCY_triangle_1_triangleJunction extends GenericTriangleJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, TriangleJunctionNode node) {
		...
		ports.add(new PortJunction(getSelf(), name2actor.get("AnnotationMemberValueBooleanArray__CONSISTENCY_triangle_0_triangleJunction"), this::check_constraint_4));
	}
	...
	protected void deregisterMatchForAttributeChanges(Set<HMatch> matches, HMatch match) {
		...
		Collection<HMatch> matches_1 = booleanLiteralAttrMap.get(matchObjects[3]);
		if(matches_1 != null) {
			matches.remove(match);
		}
	}
	...
	public boolean check_constraint_4(HMatch match) {
		...
		csp_3.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mValue.isValue(), "boolean"));
		csp_3.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tValue.isValue(), "boolean"));
		csp_3.solve();
