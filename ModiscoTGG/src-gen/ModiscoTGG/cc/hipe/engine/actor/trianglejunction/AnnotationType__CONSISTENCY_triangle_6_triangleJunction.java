...
public class AnnotationType__CONSISTENCY_triangle_6_triangleJunction extends GenericTriangleJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, TriangleJunctionNode node) {
		...
		ports.add(new PortJunctionRight(getSelf(), name2actor.get("AnnotationType__CONSISTENCY_triangle_4_triangleJunction"), this::check_constraint_30));
	}
	...
	public boolean check_constraint_30(HMatch match) {
		...
		csp_26.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mType.isProxy(), "boolean"));
		csp_26.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tType.isTLib(), "boolean"));
		csp_26.solve();
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_27 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_27.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mType.getName(), "java.lang.String"));
		csp_27.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tType.getTName(), "java.lang.String"));
		csp_27.solve();
		
		boolean predicate = csp_26.isSatisfied() && csp_27.isSatisfied();
