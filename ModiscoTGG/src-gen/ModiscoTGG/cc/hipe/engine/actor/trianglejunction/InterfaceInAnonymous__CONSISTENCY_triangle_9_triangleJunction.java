...
public class InterfaceInAnonymous__CONSISTENCY_triangle_9_triangleJunction extends GenericTriangleJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, AbstractJunctionNode node) {
		...
		ports.add(new PortJunctionRight(getSelf(), name2actor.get("InterfaceInAnonymous__CONSISTENCY_triangle_8_triangleJunction"), this::check_constraint_158));
	}
	...
	public boolean check_constraint_158(HMatch match) {
		...
		csp_58.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mNestedType.isProxy(), "boolean"));
		csp_58.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tNestedType.isTLib(), "boolean"));
		csp_58.solve();
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_59 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_59.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mNestedType.getName(), "java.lang.String"));
		csp_59.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tNestedType.getTName(), "java.lang.String"));
		csp_59.solve();
		
		boolean predicate = csp_58.isSatisfied() && csp_59.isSatisfied();
