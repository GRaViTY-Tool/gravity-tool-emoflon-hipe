...
public class TextAnnotations__CONSISTENCY_triangle_1_triangleJunction extends GenericTriangleJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, TriangleJunctionNode node) {
		...
		ports.add(new PortJunction(getSelf(), name2actor.get("TextAnnotations__CONSISTENCY_triangle_0_triangleJunction"), this::check_constraint_302));
	}
	...
	public boolean check_constraint_302(HMatch match) {
		...
		csp_107.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mComment.getContent(), "java.lang.String"));
		csp_107.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tText.getText(), "java.lang.String"));
		csp_107.solve();
