...
public class ClassInnerAnonClassMember__CONSISTENCY_triangle_9_triangleJunction extends GenericTriangleJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, TriangleJunctionNode node) {
		...
		ports.add(new PortJunctionRight(getSelf(), name2actor.get("ClassInnerAnonClassMember__CONSISTENCY_triangle_7_triangleJunction"), this::check_constraint_74));
	}
	...
	public boolean check_constraint_74(HMatch match) {
		...
		csp_37.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mInnerClass.getName(), "java.lang.String"));
		csp_37.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, tInnerClass.getTName(), "java.lang.String"));
		csp_37.solve();
