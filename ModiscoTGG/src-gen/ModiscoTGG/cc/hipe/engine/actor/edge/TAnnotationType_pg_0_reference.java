...
public class TAnnotationType_pg_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationTypeInAnonymous__CC_triangle_0_triangleJunction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationTypeNested__CC_triangle_1_triangleJunction"), this::returnTrue));
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationType__CC_806_junction"), this::returnTrue));
