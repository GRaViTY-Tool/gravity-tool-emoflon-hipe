...
public class SuperConstructorInvocation__Marker_CREATE__TRG__tAccess_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TCall, Set<ModiscoTGG.SuperConstructorInvocation__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public SuperConstructorInvocation__Marker_CREATE__TRG__tAccess_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("SuperConstructorInvocation__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.SuperConstructorInvocation__Marker source, org.gravity.typegraph.basic.TCall target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.SuperConstructorInvocation__Marker> message) {
		...
		org.gravity.typegraph.basic.TCall target = (org.gravity.typegraph.basic.TCall) message.input.getCREATE__TRG__tAccess();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.SuperConstructorInvocation__Marker, org.gravity.typegraph.basic.TCall> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.SuperConstructorInvocation__Marker, org.gravity.typegraph.basic.TCall> message) {
