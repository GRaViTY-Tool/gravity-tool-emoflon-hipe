...
public class SignatureReturnType__Marker_CONTEXT__CORR__mTypeToTType_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.TypeToTAbstractType, Set<ModiscoTGG.SignatureReturnType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public SignatureReturnType__Marker_CONTEXT__CORR__mTypeToTType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("SignatureReturnType__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.SignatureReturnType__Marker source, ModiscoTGG.TypeToTAbstractType target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.SignatureReturnType__Marker, ModiscoTGG.TypeToTAbstractType> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.SignatureReturnType__Marker, ModiscoTGG.TypeToTAbstractType> message) {
