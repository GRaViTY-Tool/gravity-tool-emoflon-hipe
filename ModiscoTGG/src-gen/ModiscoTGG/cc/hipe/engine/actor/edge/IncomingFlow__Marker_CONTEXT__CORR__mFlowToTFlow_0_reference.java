...
public class IncomingFlow__Marker_CONTEXT__CORR__mFlowToTFlow_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.MFlowToTFlow, Set<ModiscoTGG.IncomingFlow__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public IncomingFlow__Marker_CONTEXT__CORR__mFlowToTFlow_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("IncomingFlow__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.IncomingFlow__Marker source, ModiscoTGG.MFlowToTFlow target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.IncomingFlow__Marker, ModiscoTGG.MFlowToTFlow> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.IncomingFlow__Marker, ModiscoTGG.MFlowToTFlow> message) {
