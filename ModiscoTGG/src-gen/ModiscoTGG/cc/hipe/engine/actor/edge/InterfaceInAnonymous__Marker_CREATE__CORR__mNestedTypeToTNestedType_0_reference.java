...
public class InterfaceInAnonymous__Marker_CREATE__CORR__mNestedTypeToTNestedType_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.TypeToTAbstractType, Set<ModiscoTGG.InterfaceInAnonymous__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public InterfaceInAnonymous__Marker_CREATE__CORR__mNestedTypeToTNestedType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("InterfaceInAnonymous__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.InterfaceInAnonymous__Marker source, ModiscoTGG.TypeToTAbstractType target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.InterfaceInAnonymous__Marker, ModiscoTGG.TypeToTAbstractType> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.InterfaceInAnonymous__Marker, ModiscoTGG.TypeToTAbstractType> message) {
