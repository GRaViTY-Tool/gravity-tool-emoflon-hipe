...
public class TClass_pg_5_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PrimitiveTypeIsBoolean__CC_4134_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("PrimitiveTypeIsBoolean__CONSISTENCY_4148_junction"), this::returnTrue));
	}	
