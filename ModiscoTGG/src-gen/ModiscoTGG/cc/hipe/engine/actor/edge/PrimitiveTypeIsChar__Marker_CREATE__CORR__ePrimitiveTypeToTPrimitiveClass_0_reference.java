...
public class PrimitiveTypeIsChar__Marker_CREATE__CORR__ePrimitiveTypeToTPrimitiveClass_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.PrimitiveTypeToTClass, Set<ModiscoTGG.PrimitiveTypeIsChar__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public PrimitiveTypeIsChar__Marker_CREATE__CORR__ePrimitiveTypeToTPrimitiveClass_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("PrimitiveTypeIsChar__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.PrimitiveTypeIsChar__Marker source, ModiscoTGG.PrimitiveTypeToTClass target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.PrimitiveTypeIsChar__Marker, ModiscoTGG.PrimitiveTypeToTClass> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.PrimitiveTypeIsChar__Marker, ModiscoTGG.PrimitiveTypeToTClass> message) {
