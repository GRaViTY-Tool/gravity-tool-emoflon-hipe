...
public class MethodName__Marker_CONTEXT__CORR__modelToPg_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.ModelToTypeGraph, Set<ModiscoTGG.MethodName__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodName__Marker_CONTEXT__CORR__modelToPg_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodName__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodName__Marker source, ModiscoTGG.ModelToTypeGraph target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MethodName__Marker> message) {
		...
		ModiscoTGG.ModelToTypeGraph target = (ModiscoTGG.ModelToTypeGraph) message.input.getCONTEXT__CORR__modelToPg();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodName__Marker, ModiscoTGG.ModelToTypeGraph> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodName__Marker, ModiscoTGG.ModelToTypeGraph> message) {
