...
public class TMember_tAnnotation_3_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("TextAnnotations__CC_4963_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("TextAnnotations__CONSISTENCY_4975_junction"), this::returnTrue));
	}	
