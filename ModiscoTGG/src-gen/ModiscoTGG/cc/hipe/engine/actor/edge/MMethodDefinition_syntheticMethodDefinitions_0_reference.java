...
public class MMethodDefinition_syntheticMethodDefinitions_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("SyntethicMethod__CC_4884_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("SyntethicMethod_mSyntethic_syntheticMethodDefinitions_incoming_SRC__FILTER_NAC_4951_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("SyntethicMethod_mSyntethic_syntheticMethodDefinitions_incoming_SRC__FILTER_NAC_4951_junction"), this::returnTrue));
	}	
