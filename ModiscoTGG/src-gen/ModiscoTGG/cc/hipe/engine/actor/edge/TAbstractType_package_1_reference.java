...
public class TAbstractType_package_1_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationTypeNested__CC_triangle_3_triangleJunction"), this::returnTrue));
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnonymousClass__CC_1017_junction"), this::returnTrue));
		...
		ports.add(new PortEdge(getSelf(), name2actor.get("NestedClassInType__CC_triangle_3_triangleJunction"), this::returnTrue));
		...
		ports.add(new PortEdge(getSelf(), name2actor.get("NestedEnum__CC_triangle_3_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("NestedEnum__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("NestedInterfaceInType__CC_triangle_3_triangleJunction"), this::returnTrue));
