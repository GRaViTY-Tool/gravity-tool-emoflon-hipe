...
public class AnnotationMemberValueClass__Marker_CONTEXT__SRC__mType_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.Type, Set<ModiscoTGG.AnnotationMemberValueClass__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueClass__Marker_CONTEXT__SRC__mType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationMemberValueClass__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueClass__Marker source, org.eclipse.modisco.java.Type target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationMemberValueClass__Marker> message) {
		...
		org.eclipse.modisco.java.Type target = (org.eclipse.modisco.java.Type) message.input.getCONTEXT__SRC__mType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueClass__Marker, org.eclipse.modisco.java.Type> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueClass__Marker, org.eclipse.modisco.java.Type> message) {
