...
public class MAbstractFlowElementToTAbstractFlowElement_source_9_reference extends AbstractActor {
	...
	public MAbstractFlowElementToTAbstractFlowElement_source_9_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodDefinition__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
