...
public class ParameterizedTypeToClass__Marker_CONTEXT__SRC__eType_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.Type, Set<ModiscoTGG.ParameterizedTypeToClass__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ParameterizedTypeToClass__Marker_CONTEXT__SRC__eType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ParameterizedTypeToClass__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ParameterizedTypeToClass__Marker source, org.eclipse.modisco.java.Type target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ParameterizedTypeToClass__Marker> message) {
		...
		org.eclipse.modisco.java.Type target = (org.eclipse.modisco.java.Type) message.input.getCONTEXT__SRC__eType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ParameterizedTypeToClass__Marker, org.eclipse.modisco.java.Type> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ParameterizedTypeToClass__Marker, org.eclipse.modisco.java.Type> message) {
