...
public class TextAnnotations__Marker_CREATE__TRG__tText_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.annotations.TTextAnnotation, Set<ModiscoTGG.TextAnnotations__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public TextAnnotations__Marker_CREATE__TRG__tText_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("TextAnnotations__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.TextAnnotations__Marker source, org.gravity.typegraph.basic.annotations.TTextAnnotation target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.TextAnnotations__Marker> message) {
		...
		org.gravity.typegraph.basic.annotations.TTextAnnotation target = (org.gravity.typegraph.basic.annotations.TTextAnnotation) message.input.getCREATE__TRG__tText();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.TextAnnotations__Marker, org.gravity.typegraph.basic.annotations.TTextAnnotation> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.TextAnnotations__Marker, org.gravity.typegraph.basic.annotations.TTextAnnotation> message) {
