...
public class AnnotationType__Marker_CONTEXT__TRG__tPackage_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TPackage, Set<ModiscoTGG.AnnotationType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationType__Marker_CONTEXT__TRG__tPackage_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationType__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationType__Marker source, org.gravity.typegraph.basic.TPackage target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationType__Marker> message) {
		...
		org.gravity.typegraph.basic.TPackage target = (org.gravity.typegraph.basic.TPackage) message.input.getCONTEXT__TRG__tPackage();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationType__Marker, org.gravity.typegraph.basic.TPackage> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationType__Marker, org.gravity.typegraph.basic.TPackage> message) {
