...
public class EnumInAnonymous__Marker_CREATE__TRG__tAnnotation_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TEnum, Set<EdgeMatch>> targetElements = new HashMap<org.gravity.typegraph.basic.TEnum, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.gravity.typegraph.basic.TEnum, Set<ModiscoTGG.EnumInAnonymous__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public EnumInAnonymous__Marker_CREATE__TRG__tAnnotation_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("EnumInAnonymous__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.EnumInAnonymous__Marker source, org.gravity.typegraph.basic.TEnum target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.gravity.typegraph.basic.TEnum) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.EnumInAnonymous__Marker> message) {
		...
		org.gravity.typegraph.basic.TEnum target = (org.gravity.typegraph.basic.TEnum) message.input.getCREATE__TRG__tAnnotation();
	...
	private void rightAdded(NodeAddedRight<org.gravity.typegraph.basic.TEnum> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.gravity.typegraph.basic.TEnum> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.EnumInAnonymous__Marker, org.gravity.typegraph.basic.TEnum> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.EnumInAnonymous__Marker, org.gravity.typegraph.basic.TEnum> message) {
