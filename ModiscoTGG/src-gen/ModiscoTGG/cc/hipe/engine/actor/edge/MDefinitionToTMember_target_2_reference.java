...
public class MDefinitionToTMember_target_2_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("FieldAccessReadWrite__CC_1981_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("FieldAccessRead__CC_2086_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("FieldAccessWrite__CC_2191_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("VariableDeclarationFragment__CC_5169_junction"), this::returnTrue));
