...
public class OutgoingFlow__Marker_CONTEXT__TRG__tTarget_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TAbstractFlowElement, Set<ModiscoTGG.OutgoingFlow__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public OutgoingFlow__Marker_CONTEXT__TRG__tTarget_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("OutgoingFlow__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.OutgoingFlow__Marker source, org.gravity.typegraph.basic.TAbstractFlowElement target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.OutgoingFlow__Marker> message) {
		...
		org.gravity.typegraph.basic.TAbstractFlowElement target = (org.gravity.typegraph.basic.TAbstractFlowElement) message.input.getCONTEXT__TRG__tTarget();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.OutgoingFlow__Marker, org.gravity.typegraph.basic.TAbstractFlowElement> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.OutgoingFlow__Marker, org.gravity.typegraph.basic.TAbstractFlowElement> message) {
