...
public class ClassInstanceCreation__Marker_CREATE__SRC__invocation_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MClassInstanceCreation, Set<EdgeMatch>> targetElements = new HashMap<org.gravity.modisco.MClassInstanceCreation, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.gravity.modisco.MClassInstanceCreation, Set<ModiscoTGG.ClassInstanceCreation__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ClassInstanceCreation__Marker_CREATE__SRC__invocation_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ClassInstanceCreation__CONSISTENCY_triangle_8_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ClassInstanceCreation__Marker source, org.gravity.modisco.MClassInstanceCreation target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.gravity.modisco.MClassInstanceCreation) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ClassInstanceCreation__Marker> message) {
		...
		org.gravity.modisco.MClassInstanceCreation target = (org.gravity.modisco.MClassInstanceCreation) message.input.getCREATE__SRC__invocation();
	...
	private void rightAdded(NodeAddedRight<org.gravity.modisco.MClassInstanceCreation> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.gravity.modisco.MClassInstanceCreation> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ClassInstanceCreation__Marker, org.gravity.modisco.MClassInstanceCreation> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ClassInstanceCreation__Marker, org.gravity.modisco.MClassInstanceCreation> message) {
