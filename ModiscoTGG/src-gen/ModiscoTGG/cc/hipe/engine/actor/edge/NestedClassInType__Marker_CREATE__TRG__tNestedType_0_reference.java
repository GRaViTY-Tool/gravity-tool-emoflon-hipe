...
public class NestedClassInType__Marker_CREATE__TRG__tNestedType_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TClass, Set<ModiscoTGG.NestedClassInType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public NestedClassInType__Marker_CREATE__TRG__tNestedType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("NestedClassInType__CONSISTENCY_triangle_12_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.NestedClassInType__Marker source, org.gravity.typegraph.basic.TClass target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.NestedClassInType__Marker> message) {
		...
		org.gravity.typegraph.basic.TClass target = (org.gravity.typegraph.basic.TClass) message.input.getCREATE__TRG__tNestedType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.NestedClassInType__Marker, org.gravity.typegraph.basic.TClass> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.NestedClassInType__Marker, org.gravity.typegraph.basic.TClass> message) {
