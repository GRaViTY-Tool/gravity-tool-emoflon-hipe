...
public class PrimitiveTypeIsDouble__Marker_CONTEXT__SRC__eModel_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.Model, Set<ModiscoTGG.PrimitiveTypeIsDouble__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public PrimitiveTypeIsDouble__Marker_CONTEXT__SRC__eModel_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("PrimitiveTypeIsDouble__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.PrimitiveTypeIsDouble__Marker source, org.eclipse.modisco.java.Model target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.PrimitiveTypeIsDouble__Marker, org.eclipse.modisco.java.Model> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.PrimitiveTypeIsDouble__Marker, org.eclipse.modisco.java.Model> message) {
