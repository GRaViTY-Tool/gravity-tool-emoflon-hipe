...
public class MAbstractFlowElement_outgoingFlows_0_reference extends AbstractActor {
	...
	public MAbstractFlowElement_outgoingFlows_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("IncomingFlow__CC_2493_junction"), this::check_constraint_144));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("IncomingFlow__CONSISTENCY_2509_junction"), this::check_constraint_147));
	}	
	...
	private void leftAdded(NodeAddedLeft<org.gravity.modisco.MAbstractFlowElement> message) {
		...
		for(org.gravity.modisco.MFlow target : message.input.getOutgoingFlows()) {
	...
	public boolean check_constraint_144(EdgeMatch edge) {
