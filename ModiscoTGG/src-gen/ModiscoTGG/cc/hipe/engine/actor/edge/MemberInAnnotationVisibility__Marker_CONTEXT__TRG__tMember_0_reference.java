...
public class MemberInAnnotationVisibility__Marker_CONTEXT__TRG__tMember_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TMember, Set<ModiscoTGG.MemberInAnnotationVisibility__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MemberInAnnotationVisibility__Marker_CONTEXT__TRG__tMember_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MemberInAnnotationVisibility__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MemberInAnnotationVisibility__Marker source, org.gravity.typegraph.basic.TMember target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MemberInAnnotationVisibility__Marker> message) {
		...
		org.gravity.typegraph.basic.TMember target = (org.gravity.typegraph.basic.TMember) message.input.getCONTEXT__TRG__tMember();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MemberInAnnotationVisibility__Marker, org.gravity.typegraph.basic.TMember> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MemberInAnnotationVisibility__Marker, org.gravity.typegraph.basic.TMember> message) {
