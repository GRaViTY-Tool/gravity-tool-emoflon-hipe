...
public class OutgoingFlow__Marker_CONTEXT__SRC__mFlow_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MFlow, Set<ModiscoTGG.OutgoingFlow__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public OutgoingFlow__Marker_CONTEXT__SRC__mFlow_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("OutgoingFlow__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.OutgoingFlow__Marker source, org.gravity.modisco.MFlow target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.OutgoingFlow__Marker, org.gravity.modisco.MFlow> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.OutgoingFlow__Marker, org.gravity.modisco.MFlow> message) {
