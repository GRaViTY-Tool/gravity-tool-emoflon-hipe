...
public class AnnotationTypeInAnonymous__Marker_CONTEXT__CORR__eAnonymousClassDeclarationToTClass_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.AnonymousClassDeclarationToTClass, Set<ModiscoTGG.AnnotationTypeInAnonymous__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationTypeInAnonymous__Marker_CONTEXT__CORR__eAnonymousClassDeclarationToTClass_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationTypeInAnonymous__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationTypeInAnonymous__Marker source, ModiscoTGG.AnonymousClassDeclarationToTClass target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationTypeInAnonymous__Marker, ModiscoTGG.AnonymousClassDeclarationToTClass> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationTypeInAnonymous__Marker, ModiscoTGG.AnonymousClassDeclarationToTClass> message) {
