...
public class MethodParameterType__Marker_CREATE__TRG__tParameter_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TParameter, Set<ModiscoTGG.MethodParameterType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodParameterType__Marker_CREATE__TRG__tParameter_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodParameterType__CONSISTENCY_triangle_8_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodParameterType__Marker source, org.gravity.typegraph.basic.TParameter target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MethodParameterType__Marker> message) {
		...
		org.gravity.typegraph.basic.TParameter target = (org.gravity.typegraph.basic.TParameter) message.input.getCREATE__TRG__tParameter();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodParameterType__Marker, org.gravity.typegraph.basic.TParameter> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodParameterType__Marker, org.gravity.typegraph.basic.TParameter> message) {
