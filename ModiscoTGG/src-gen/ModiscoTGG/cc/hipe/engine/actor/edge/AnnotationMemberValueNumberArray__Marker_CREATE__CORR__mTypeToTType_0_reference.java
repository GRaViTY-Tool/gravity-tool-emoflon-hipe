...
public class AnnotationMemberValueNumberArray__Marker_CREATE__CORR__mTypeToTType_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.NumberLiteralToTNumberNode, Set<EdgeMatch>> targetElements = new HashMap<ModiscoTGG.NumberLiteralToTNumberNode, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<ModiscoTGG.NumberLiteralToTNumberNode, Set<ModiscoTGG.AnnotationMemberValueNumberArray__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueNumberArray__Marker_CREATE__CORR__mTypeToTType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationMemberValueNumberArray__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueNumberArray__Marker source, ModiscoTGG.NumberLiteralToTNumberNode target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((ModiscoTGG.NumberLiteralToTNumberNode) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationMemberValueNumberArray__Marker> message) {
		...
		ModiscoTGG.NumberLiteralToTNumberNode target = (ModiscoTGG.NumberLiteralToTNumberNode) message.input.getCREATE__CORR__mTypeToTType();
	...
	private void rightAdded(NodeAddedRight<ModiscoTGG.NumberLiteralToTNumberNode> message) {
	...
	private void rightRemoved(NodeDeletedRight<ModiscoTGG.NumberLiteralToTNumberNode> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueNumberArray__Marker, ModiscoTGG.NumberLiteralToTNumberNode> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueNumberArray__Marker, ModiscoTGG.NumberLiteralToTNumberNode> message) {
