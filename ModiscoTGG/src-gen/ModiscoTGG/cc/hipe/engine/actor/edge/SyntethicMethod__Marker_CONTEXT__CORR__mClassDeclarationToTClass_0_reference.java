...
public class SyntethicMethod__Marker_CONTEXT__CORR__mClassDeclarationToTClass_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.ClassDeclarationToTClass, Set<ModiscoTGG.SyntethicMethod__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public SyntethicMethod__Marker_CONTEXT__CORR__mClassDeclarationToTClass_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("SyntethicMethod__CONSISTENCY_triangle_8_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.SyntethicMethod__Marker source, ModiscoTGG.ClassDeclarationToTClass target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.SyntethicMethod__Marker> message) {
		...
		ModiscoTGG.ClassDeclarationToTClass target = (ModiscoTGG.ClassDeclarationToTClass) message.input.getCONTEXT__CORR__mClassDeclarationToTClass();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.SyntethicMethod__Marker, ModiscoTGG.ClassDeclarationToTClass> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.SyntethicMethod__Marker, ModiscoTGG.ClassDeclarationToTClass> message) {
