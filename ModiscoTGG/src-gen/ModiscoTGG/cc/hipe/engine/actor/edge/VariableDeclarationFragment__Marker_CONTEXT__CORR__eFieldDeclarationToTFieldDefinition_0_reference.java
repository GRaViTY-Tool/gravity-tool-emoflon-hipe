...
public class VariableDeclarationFragment__Marker_CONTEXT__CORR__eFieldDeclarationToTFieldDefinition_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.MDefinitionToTMember, Set<ModiscoTGG.VariableDeclarationFragment__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public VariableDeclarationFragment__Marker_CONTEXT__CORR__eFieldDeclarationToTFieldDefinition_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("VariableDeclarationFragment__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.VariableDeclarationFragment__Marker source, ModiscoTGG.MDefinitionToTMember target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.VariableDeclarationFragment__Marker> message) {
		...
		ModiscoTGG.MDefinitionToTMember target = (ModiscoTGG.MDefinitionToTMember) message.input.getCONTEXT__CORR__eFieldDeclarationToTFieldDefinition();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.VariableDeclarationFragment__Marker, ModiscoTGG.MDefinitionToTMember> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.VariableDeclarationFragment__Marker, ModiscoTGG.MDefinitionToTMember> message) {
