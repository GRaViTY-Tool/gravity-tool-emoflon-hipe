...
public class NumberLiteralToTNumberNode_source_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.NumberLiteral, Set<ModiscoTGG.NumberLiteralToTNumberNode>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public NumberLiteralToTNumberNode_source_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueNumberArray__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationMemberValueNumber__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.NumberLiteralToTNumberNode source, org.eclipse.modisco.java.NumberLiteral target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.NumberLiteralToTNumberNode> message) {
		...
		org.eclipse.modisco.java.NumberLiteral target = (org.eclipse.modisco.java.NumberLiteral) message.input.getSource();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.NumberLiteralToTNumberNode, org.eclipse.modisco.java.NumberLiteral> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.NumberLiteralToTNumberNode, org.eclipse.modisco.java.NumberLiteral> message) {
