...
public class MAbstractMethodDefinition_mInnerTypes_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassInnerAnonClassMember__CC_1385_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassInnerClassMember__CC_1480_junction"), this::returnTrue));
