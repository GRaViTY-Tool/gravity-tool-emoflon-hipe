...
public class AnnotationMemberValueAnnotationArray__Marker_CONTEXT__SRC__AnnotationValue_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.AnnotationMemberValuePair, Set<ModiscoTGG.AnnotationMemberValueAnnotationArray__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueAnnotationArray__Marker_CONTEXT__SRC__AnnotationValue_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationMemberValueAnnotationArray__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueAnnotationArray__Marker source, org.eclipse.modisco.java.AnnotationMemberValuePair target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationMemberValueAnnotationArray__Marker> message) {
		...
		org.eclipse.modisco.java.AnnotationMemberValuePair target = (org.eclipse.modisco.java.AnnotationMemberValuePair) message.input.getCONTEXT__SRC__AnnotationValue();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueAnnotationArray__Marker, org.eclipse.modisco.java.AnnotationMemberValuePair> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueAnnotationArray__Marker, org.eclipse.modisco.java.AnnotationMemberValuePair> message) {
