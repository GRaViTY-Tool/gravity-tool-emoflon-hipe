...
public class ASTNodeToTAnnotatable_target_4_reference extends AbstractActor {
	...
	public ASTNodeToTAnnotatable_target_4_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldDefinition__CONSISTENCY_triangle_6_triangleJunction"), this::returnTrue));
	}	
