...
public class PackageToPGPackage__Marker_CREATE__CORR__mPackageToTPackage_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.PackageToTPackage, Set<ModiscoTGG.PackageToPGPackage__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public PackageToPGPackage__Marker_CREATE__CORR__mPackageToTPackage_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("PackageToPGPackage__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.PackageToPGPackage__Marker source, ModiscoTGG.PackageToTPackage target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.PackageToPGPackage__Marker> message) {
		...
		ModiscoTGG.PackageToTPackage target = (ModiscoTGG.PackageToTPackage) message.input.getCREATE__CORR__mPackageToTPackage();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.PackageToPGPackage__Marker, ModiscoTGG.PackageToTPackage> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.PackageToPGPackage__Marker, ModiscoTGG.PackageToTPackage> message) {
