...
public class MAbstractMethodDefinition_usages_4_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("SuperMethodInvocation__CC_4816_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("SuperMethodInvocation__CONSISTENCY_4841_junction"), this::returnTrue));
	}	
