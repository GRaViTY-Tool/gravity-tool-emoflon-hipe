...
public class SyntethicMethod__Marker_CREATE__TRG__tSyntethic_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TSyntethicMethod, Set<ModiscoTGG.SyntethicMethod__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public SyntethicMethod__Marker_CREATE__TRG__tSyntethic_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("SyntethicMethod__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.SyntethicMethod__Marker source, org.gravity.typegraph.basic.TSyntethicMethod target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.SyntethicMethod__Marker> message) {
		...
		org.gravity.typegraph.basic.TSyntethicMethod target = (org.gravity.typegraph.basic.TSyntethicMethod) message.input.getCREATE__TRG__tSyntethic();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.SyntethicMethod__Marker, org.gravity.typegraph.basic.TSyntethicMethod> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.SyntethicMethod__Marker, org.gravity.typegraph.basic.TSyntethicMethod> message) {
