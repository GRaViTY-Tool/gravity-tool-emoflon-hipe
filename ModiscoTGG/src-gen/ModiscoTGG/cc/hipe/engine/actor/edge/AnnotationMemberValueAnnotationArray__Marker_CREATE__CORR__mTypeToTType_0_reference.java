...
public class AnnotationMemberValueAnnotationArray__Marker_CREATE__CORR__mTypeToTType_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.AnnotationToTAnnotation, Set<EdgeMatch>> targetElements = new HashMap<ModiscoTGG.AnnotationToTAnnotation, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<ModiscoTGG.AnnotationToTAnnotation, Set<ModiscoTGG.AnnotationMemberValueAnnotationArray__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueAnnotationArray__Marker_CREATE__CORR__mTypeToTType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationMemberValueAnnotationArray__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueAnnotationArray__Marker source, ModiscoTGG.AnnotationToTAnnotation target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((ModiscoTGG.AnnotationToTAnnotation) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationMemberValueAnnotationArray__Marker> message) {
		...
		ModiscoTGG.AnnotationToTAnnotation target = (ModiscoTGG.AnnotationToTAnnotation) message.input.getCREATE__CORR__mTypeToTType();
	...
	private void rightAdded(NodeAddedRight<ModiscoTGG.AnnotationToTAnnotation> message) {
	...
	private void rightRemoved(NodeDeletedRight<ModiscoTGG.AnnotationToTAnnotation> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueAnnotationArray__Marker, ModiscoTGG.AnnotationToTAnnotation> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueAnnotationArray__Marker, ModiscoTGG.AnnotationToTAnnotation> message) {
