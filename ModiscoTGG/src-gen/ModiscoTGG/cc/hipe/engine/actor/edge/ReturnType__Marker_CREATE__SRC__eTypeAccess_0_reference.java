...
public class ReturnType__Marker_CREATE__SRC__eTypeAccess_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.TypeAccess, Set<ModiscoTGG.ReturnType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ReturnType__Marker_CREATE__SRC__eTypeAccess_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ReturnType__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ReturnType__Marker source, org.eclipse.modisco.java.TypeAccess target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ReturnType__Marker, org.eclipse.modisco.java.TypeAccess> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ReturnType__Marker, org.eclipse.modisco.java.TypeAccess> message) {
