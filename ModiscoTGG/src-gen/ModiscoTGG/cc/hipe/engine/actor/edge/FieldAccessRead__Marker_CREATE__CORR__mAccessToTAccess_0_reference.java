...
public class FieldAccessRead__Marker_CREATE__CORR__mAccessToTAccess_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.MSingleVariableAccessToTAccess, Set<ModiscoTGG.FieldAccessRead__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public FieldAccessRead__Marker_CREATE__CORR__mAccessToTAccess_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("FieldAccessRead__CONSISTENCY_triangle_13_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.FieldAccessRead__Marker source, ModiscoTGG.MSingleVariableAccessToTAccess target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.FieldAccessRead__Marker, ModiscoTGG.MSingleVariableAccessToTAccess> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.FieldAccessRead__Marker, ModiscoTGG.MSingleVariableAccessToTAccess> message) {
