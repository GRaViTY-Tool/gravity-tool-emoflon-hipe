...
public class TClass_parentClass_1_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TClass, Set<org.gravity.typegraph.basic.TClass>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public TClass_parentClass_1_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassExtendsClass__CC_1182_junction"), this::check_constraint_55));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassExtendsClass__CONSISTENCY_triangle_0_triangleJunction"), this::check_constraint_59));
	}	
	...
	private void addMatch(InputMessage message, org.gravity.typegraph.basic.TClass source, org.gravity.typegraph.basic.TClass target) {
	...
	private void leftAdded(NodeAddedLeft<org.gravity.typegraph.basic.TClass> message) {
		...
		org.gravity.typegraph.basic.TClass target = (org.gravity.typegraph.basic.TClass) message.input.getParentClass();
	...
	private void addReference(ReferenceAdded<org.gravity.typegraph.basic.TClass, org.gravity.typegraph.basic.TClass> message) {
	...
	private void removeReference(ReferenceDeleted<org.gravity.typegraph.basic.TClass, org.gravity.typegraph.basic.TClass> message) {
	...
	public boolean check_constraint_59(EdgeMatch edge) {
		org.gravity.typegraph.basic.TClass tClass = (org.gravity.typegraph.basic.TClass) edge.source();
		org.gravity.typegraph.basic.TClass tExtendedClass = (org.gravity.typegraph.basic.TClass) edge.target();
		boolean predicate = !tClass.equals(tExtendedClass);
		edge.setConstraintSatisfied(predicate);
