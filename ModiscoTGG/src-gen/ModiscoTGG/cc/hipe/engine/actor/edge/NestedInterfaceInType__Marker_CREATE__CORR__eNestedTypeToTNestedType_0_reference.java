...
public class NestedInterfaceInType__Marker_CREATE__CORR__eNestedTypeToTNestedType_0_reference extends AbstractActor {
	...
	public NestedInterfaceInType__Marker_CREATE__CORR__eNestedTypeToTNestedType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("NestedInterfaceInType__CONSISTENCY_triangle_13_triangleJunction"), this::returnTrue));
	}	
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.NestedInterfaceInType__Marker> message) {
		...
		ModiscoTGG.TypeToTAbstractType target = (ModiscoTGG.TypeToTAbstractType) message.input.getCREATE__CORR__eNestedTypeToTNestedType();
