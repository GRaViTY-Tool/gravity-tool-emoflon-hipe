...
public class TCall_tTarget_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassInstanceCreation__CC_1577_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ConstructorInvocation__CC_1769_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodInvocation__CC_3277_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("SuperConstructorInvocation__CC_4750_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("SuperMethodInvocation__CC_4818_junction"), this::returnTrue));
