...
public class IncomingFlow__Marker_CONTEXT__TRG__tSource_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TAbstractFlowElement, Set<ModiscoTGG.IncomingFlow__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public IncomingFlow__Marker_CONTEXT__TRG__tSource_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("IncomingFlow__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.IncomingFlow__Marker source, org.gravity.typegraph.basic.TAbstractFlowElement target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.IncomingFlow__Marker> message) {
		...
		org.gravity.typegraph.basic.TAbstractFlowElement target = (org.gravity.typegraph.basic.TAbstractFlowElement) message.input.getCONTEXT__TRG__tSource();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.IncomingFlow__Marker, org.gravity.typegraph.basic.TAbstractFlowElement> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.IncomingFlow__Marker, org.gravity.typegraph.basic.TAbstractFlowElement> message) {
