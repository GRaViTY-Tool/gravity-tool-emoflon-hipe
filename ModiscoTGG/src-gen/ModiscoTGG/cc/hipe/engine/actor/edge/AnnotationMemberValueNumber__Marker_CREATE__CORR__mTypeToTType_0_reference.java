...
public class AnnotationMemberValueNumber__Marker_CREATE__CORR__mTypeToTType_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.NumberLiteralToTNumberNode, Set<ModiscoTGG.AnnotationMemberValueNumber__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueNumber__Marker_CREATE__CORR__mTypeToTType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationMemberValueNumber__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueNumber__Marker source, ModiscoTGG.NumberLiteralToTNumberNode target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueNumber__Marker, ModiscoTGG.NumberLiteralToTNumberNode> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueNumber__Marker, ModiscoTGG.NumberLiteralToTNumberNode> message) {
