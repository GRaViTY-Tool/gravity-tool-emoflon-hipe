...
public class MethodSignature__Marker_CREATE__TRG__tSignature_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TMethodSignature, Set<ModiscoTGG.MethodSignature__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodSignature__Marker_CREATE__TRG__tSignature_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodSignature__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodSignature__Marker source, org.gravity.typegraph.basic.TMethodSignature target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MethodSignature__Marker> message) {
		...
		org.gravity.typegraph.basic.TMethodSignature target = (org.gravity.typegraph.basic.TMethodSignature) message.input.getCREATE__TRG__tSignature();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodSignature__Marker, org.gravity.typegraph.basic.TMethodSignature> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodSignature__Marker, org.gravity.typegraph.basic.TMethodSignature> message) {
