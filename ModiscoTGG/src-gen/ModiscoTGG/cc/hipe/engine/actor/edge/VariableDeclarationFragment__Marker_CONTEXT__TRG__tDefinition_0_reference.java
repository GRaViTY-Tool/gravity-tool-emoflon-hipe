...
public class VariableDeclarationFragment__Marker_CONTEXT__TRG__tDefinition_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TFieldDefinition, Set<ModiscoTGG.VariableDeclarationFragment__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public VariableDeclarationFragment__Marker_CONTEXT__TRG__tDefinition_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("VariableDeclarationFragment__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.VariableDeclarationFragment__Marker source, org.gravity.typegraph.basic.TFieldDefinition target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.VariableDeclarationFragment__Marker> message) {
		...
		org.gravity.typegraph.basic.TFieldDefinition target = (org.gravity.typegraph.basic.TFieldDefinition) message.input.getCONTEXT__TRG__tDefinition();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.VariableDeclarationFragment__Marker, org.gravity.typegraph.basic.TFieldDefinition> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.VariableDeclarationFragment__Marker, org.gravity.typegraph.basic.TFieldDefinition> message) {
