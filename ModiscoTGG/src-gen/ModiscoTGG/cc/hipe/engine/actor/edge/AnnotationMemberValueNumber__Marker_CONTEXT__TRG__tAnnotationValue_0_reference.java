...
public class AnnotationMemberValueNumber__Marker_CONTEXT__TRG__tAnnotationValue_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.annotations.TAnnotationValue, Set<ModiscoTGG.AnnotationMemberValueNumber__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueNumber__Marker_CONTEXT__TRG__tAnnotationValue_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationMemberValueNumber__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueNumber__Marker source, org.gravity.typegraph.basic.annotations.TAnnotationValue target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueNumber__Marker, org.gravity.typegraph.basic.annotations.TAnnotationValue> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueNumber__Marker, org.gravity.typegraph.basic.annotations.TAnnotationValue> message) {
