...
public class TAbstractFlowElement_ownedFlows_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("Flow__CC_2455_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("Flow__CONSISTENCY_2467_junction"), this::returnTrue));
	}	
