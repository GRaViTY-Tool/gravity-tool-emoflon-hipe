...
public class MethodInvocationStaticType__Marker_CONTEXT__SRC__mStaticType_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.Type, Set<ModiscoTGG.MethodInvocationStaticType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodInvocationStaticType__Marker_CONTEXT__SRC__mStaticType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodInvocationStaticType__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodInvocationStaticType__Marker source, org.eclipse.modisco.java.Type target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MethodInvocationStaticType__Marker> message) {
		...
		org.eclipse.modisco.java.Type target = (org.eclipse.modisco.java.Type) message.input.getCONTEXT__SRC__mStaticType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodInvocationStaticType__Marker, org.eclipse.modisco.java.Type> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodInvocationStaticType__Marker, org.eclipse.modisco.java.Type> message) {
