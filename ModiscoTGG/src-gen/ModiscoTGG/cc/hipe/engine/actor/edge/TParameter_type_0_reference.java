...
public class TParameter_type_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodParameterType__CC_3508_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodParameter__CC_5414_nacjunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodParameter__CONSISTENCY_5416_nacjunction"), this::returnTrue));
