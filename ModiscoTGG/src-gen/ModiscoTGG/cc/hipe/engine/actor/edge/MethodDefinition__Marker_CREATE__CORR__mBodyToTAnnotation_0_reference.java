...
public class MethodDefinition__Marker_CREATE__CORR__mBodyToTAnnotation_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.ASTNodeToTAnnotatable, Set<ModiscoTGG.MethodDefinition__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodDefinition__Marker_CREATE__CORR__mBodyToTAnnotation_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodDefinition__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodDefinition__Marker source, ModiscoTGG.ASTNodeToTAnnotatable target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodDefinition__Marker, ModiscoTGG.ASTNodeToTAnnotatable> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodDefinition__Marker, ModiscoTGG.ASTNodeToTAnnotatable> message) {
