...
public class TClass_pg_10_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PrimitiveTypeIsInt__CC_4384_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("PrimitiveTypeIsInt__CONSISTENCY_4398_junction"), this::returnTrue));
	}	
