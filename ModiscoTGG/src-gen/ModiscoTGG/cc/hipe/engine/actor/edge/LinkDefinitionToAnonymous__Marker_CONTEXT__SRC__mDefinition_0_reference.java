...
public class LinkDefinitionToAnonymous__Marker_CONTEXT__SRC__mDefinition_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MDefinition, Set<ModiscoTGG.LinkDefinitionToAnonymous__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public LinkDefinitionToAnonymous__Marker_CONTEXT__SRC__mDefinition_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("LinkDefinitionToAnonymous__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.LinkDefinitionToAnonymous__Marker source, org.gravity.modisco.MDefinition target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.LinkDefinitionToAnonymous__Marker, org.gravity.modisco.MDefinition> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.LinkDefinitionToAnonymous__Marker, org.gravity.modisco.MDefinition> message) {
