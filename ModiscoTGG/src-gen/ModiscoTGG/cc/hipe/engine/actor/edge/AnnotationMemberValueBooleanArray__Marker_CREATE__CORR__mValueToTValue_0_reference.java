...
public class AnnotationMemberValueBooleanArray__Marker_CREATE__CORR__mValueToTValue_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.BooleanLiteralToTBoolNode, Set<EdgeMatch>> targetElements = new HashMap<ModiscoTGG.BooleanLiteralToTBoolNode, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<ModiscoTGG.BooleanLiteralToTBoolNode, Set<ModiscoTGG.AnnotationMemberValueBooleanArray__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueBooleanArray__Marker_CREATE__CORR__mValueToTValue_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationMemberValueBooleanArray__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueBooleanArray__Marker source, ModiscoTGG.BooleanLiteralToTBoolNode target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((ModiscoTGG.BooleanLiteralToTBoolNode) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationMemberValueBooleanArray__Marker> message) {
		...
		ModiscoTGG.BooleanLiteralToTBoolNode target = (ModiscoTGG.BooleanLiteralToTBoolNode) message.input.getCREATE__CORR__mValueToTValue();
	...
	private void rightAdded(NodeAddedRight<ModiscoTGG.BooleanLiteralToTBoolNode> message) {
	...
	private void rightRemoved(NodeDeletedRight<ModiscoTGG.BooleanLiteralToTBoolNode> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueBooleanArray__Marker, ModiscoTGG.BooleanLiteralToTBoolNode> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueBooleanArray__Marker, ModiscoTGG.BooleanLiteralToTBoolNode> message) {
