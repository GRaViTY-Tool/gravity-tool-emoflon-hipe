...
public class MemberInClassVisibility__Marker_CREATE__TRG__tModifier_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TModifier, Set<ModiscoTGG.MemberInClassVisibility__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MemberInClassVisibility__Marker_CREATE__TRG__tModifier_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MemberInClassVisibility__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MemberInClassVisibility__Marker source, org.gravity.typegraph.basic.TModifier target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MemberInClassVisibility__Marker, org.gravity.typegraph.basic.TModifier> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MemberInClassVisibility__Marker, org.gravity.typegraph.basic.TModifier> message) {
