...
public class AnnotationOnBodyDeclaration__Marker_CONTEXT__SRC__astNode_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.BodyDeclaration, Set<ModiscoTGG.AnnotationOnBodyDeclaration__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationOnBodyDeclaration__Marker_CONTEXT__SRC__astNode_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationOnBodyDeclaration__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationOnBodyDeclaration__Marker source, org.eclipse.modisco.java.BodyDeclaration target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationOnBodyDeclaration__Marker> message) {
		...
		org.eclipse.modisco.java.BodyDeclaration target = (org.eclipse.modisco.java.BodyDeclaration) message.input.getCONTEXT__SRC__astNode();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationOnBodyDeclaration__Marker, org.eclipse.modisco.java.BodyDeclaration> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationOnBodyDeclaration__Marker, org.eclipse.modisco.java.BodyDeclaration> message) {
