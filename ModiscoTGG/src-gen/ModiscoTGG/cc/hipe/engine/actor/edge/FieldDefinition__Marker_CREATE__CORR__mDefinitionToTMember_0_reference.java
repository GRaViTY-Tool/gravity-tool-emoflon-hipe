...
public class FieldDefinition__Marker_CREATE__CORR__mDefinitionToTMember_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.MDefinitionToTMember, Set<ModiscoTGG.FieldDefinition__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public FieldDefinition__Marker_CREATE__CORR__mDefinitionToTMember_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("FieldDefinition__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.FieldDefinition__Marker source, ModiscoTGG.MDefinitionToTMember target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.FieldDefinition__Marker, ModiscoTGG.MDefinitionToTMember> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.FieldDefinition__Marker, ModiscoTGG.MDefinitionToTMember> message) {
