...
public class SuperMethodInvocation__Marker_CONTEXT__TRG__tMember_0_reference extends AbstractActor {
	...
	public SuperMethodInvocation__Marker_CONTEXT__TRG__tMember_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("SuperMethodInvocation__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
