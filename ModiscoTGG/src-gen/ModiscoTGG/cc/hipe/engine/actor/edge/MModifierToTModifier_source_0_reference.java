...
public class MModifierToTModifier_source_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.Modifier, Set<ModiscoTGG.MModifierToTModifier>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MModifierToTModifier_source_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("InterfaceMember__CONSISTENCY_triangle_8_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MemberInAnnotationVisibility__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MemberInClassVisibility__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MemberInEnumVisibility__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("TypesVisibility__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MModifierToTModifier source, org.eclipse.modisco.java.Modifier target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MModifierToTModifier> message) {
		...
		org.eclipse.modisco.java.Modifier target = (org.eclipse.modisco.java.Modifier) message.input.getSource();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MModifierToTModifier, org.eclipse.modisco.java.Modifier> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MModifierToTModifier, org.eclipse.modisco.java.Modifier> message) {
