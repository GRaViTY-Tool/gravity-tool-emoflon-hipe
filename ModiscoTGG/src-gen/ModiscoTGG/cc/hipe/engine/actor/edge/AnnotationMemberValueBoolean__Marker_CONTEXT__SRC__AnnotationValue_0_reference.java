...
public class AnnotationMemberValueBoolean__Marker_CONTEXT__SRC__AnnotationValue_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.AnnotationMemberValuePair, Set<ModiscoTGG.AnnotationMemberValueBoolean__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueBoolean__Marker_CONTEXT__SRC__AnnotationValue_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationMemberValueBoolean__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueBoolean__Marker source, org.eclipse.modisco.java.AnnotationMemberValuePair target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueBoolean__Marker, org.eclipse.modisco.java.AnnotationMemberValuePair> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueBoolean__Marker, org.eclipse.modisco.java.AnnotationMemberValuePair> message) {
