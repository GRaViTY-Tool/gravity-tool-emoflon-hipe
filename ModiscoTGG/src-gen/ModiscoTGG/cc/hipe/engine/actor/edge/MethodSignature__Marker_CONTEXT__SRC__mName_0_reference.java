...
public class MethodSignature__Marker_CONTEXT__SRC__mName_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MMethodName, Set<ModiscoTGG.MethodSignature__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodSignature__Marker_CONTEXT__SRC__mName_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodSignature__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodSignature__Marker source, org.gravity.modisco.MMethodName target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MethodSignature__Marker> message) {
		...
		org.gravity.modisco.MMethodName target = (org.gravity.modisco.MMethodName) message.input.getCONTEXT__SRC__mName();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodSignature__Marker, org.gravity.modisco.MMethodName> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodSignature__Marker, org.gravity.modisco.MMethodName> message) {
