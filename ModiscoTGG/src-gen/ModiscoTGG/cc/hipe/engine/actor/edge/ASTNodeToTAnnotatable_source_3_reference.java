...
public class ASTNodeToTAnnotatable_source_3_reference extends AbstractActor {
	...
	public ASTNodeToTAnnotatable_source_3_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ConstructorDefinition__CONSISTENCY_triangle_8_triangleJunction"), this::returnTrue));
	}	
