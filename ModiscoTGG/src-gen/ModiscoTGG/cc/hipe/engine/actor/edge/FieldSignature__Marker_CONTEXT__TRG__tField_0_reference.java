...
public class FieldSignature__Marker_CONTEXT__TRG__tField_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TField, Set<ModiscoTGG.FieldSignature__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public FieldSignature__Marker_CONTEXT__TRG__tField_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("FieldSignature__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.FieldSignature__Marker source, org.gravity.typegraph.basic.TField target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.FieldSignature__Marker> message) {
		...
		org.gravity.typegraph.basic.TField target = (org.gravity.typegraph.basic.TField) message.input.getCONTEXT__TRG__tField();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.FieldSignature__Marker, org.gravity.typegraph.basic.TField> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.FieldSignature__Marker, org.gravity.typegraph.basic.TField> message) {
