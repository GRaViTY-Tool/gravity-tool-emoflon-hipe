...
public class TClass_pg_14_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("TypeParameter__CC_5001_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("TypeParameter__CONSISTENCY_5015_junction"), this::returnTrue));
	}	
