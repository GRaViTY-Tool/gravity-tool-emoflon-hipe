...
public class InterfaceExtendsInterface__Marker_CONTEXT__SRC__eInterfaceDeclaration_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.InterfaceDeclaration, Set<EdgeMatch>> targetElements = new HashMap<org.eclipse.modisco.java.InterfaceDeclaration, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.eclipse.modisco.java.InterfaceDeclaration, Set<ModiscoTGG.InterfaceExtendsInterface__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public InterfaceExtendsInterface__Marker_CONTEXT__SRC__eInterfaceDeclaration_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("InterfaceExtendsInterface__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.InterfaceExtendsInterface__Marker source, org.eclipse.modisco.java.InterfaceDeclaration target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.eclipse.modisco.java.InterfaceDeclaration) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.InterfaceExtendsInterface__Marker> message) {
		...
		org.eclipse.modisco.java.InterfaceDeclaration target = (org.eclipse.modisco.java.InterfaceDeclaration) message.input.getCONTEXT__SRC__eInterfaceDeclaration();
	...
	private void rightAdded(NodeAddedRight<org.eclipse.modisco.java.InterfaceDeclaration> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.eclipse.modisco.java.InterfaceDeclaration> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.InterfaceExtendsInterface__Marker, org.eclipse.modisco.java.InterfaceDeclaration> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.InterfaceExtendsInterface__Marker, org.eclipse.modisco.java.InterfaceDeclaration> message) {
