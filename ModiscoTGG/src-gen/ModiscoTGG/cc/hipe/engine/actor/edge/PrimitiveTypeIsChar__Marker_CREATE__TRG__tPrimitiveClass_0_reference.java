...
public class PrimitiveTypeIsChar__Marker_CREATE__TRG__tPrimitiveClass_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TClass, Set<ModiscoTGG.PrimitiveTypeIsChar__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public PrimitiveTypeIsChar__Marker_CREATE__TRG__tPrimitiveClass_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("PrimitiveTypeIsChar__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.PrimitiveTypeIsChar__Marker source, org.gravity.typegraph.basic.TClass target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.PrimitiveTypeIsChar__Marker, org.gravity.typegraph.basic.TClass> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.PrimitiveTypeIsChar__Marker, org.gravity.typegraph.basic.TClass> message) {
