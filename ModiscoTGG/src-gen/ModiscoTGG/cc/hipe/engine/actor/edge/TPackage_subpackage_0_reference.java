...
public class TPackage_subpackage_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TPackage, Set<org.gravity.typegraph.basic.TPackage>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public TPackage_subpackage_0_reference() {
	}
	...
	private void addMatch(InputMessage message, org.gravity.typegraph.basic.TPackage source, org.gravity.typegraph.basic.TPackage target) {
	...
	private void leftAdded(NodeAddedLeft<org.gravity.typegraph.basic.TPackage> message) {
		...
		for(org.gravity.typegraph.basic.TPackage target : message.input.getSubpackage()) {
	...
	private void addReference(ReferenceAdded<org.gravity.typegraph.basic.TPackage, org.gravity.typegraph.basic.TPackage> message) {
	...
	private void removeReference(ReferenceDeleted<org.gravity.typegraph.basic.TPackage, org.gravity.typegraph.basic.TPackage> message) {
