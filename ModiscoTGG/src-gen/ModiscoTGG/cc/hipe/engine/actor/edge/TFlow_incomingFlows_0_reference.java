...
public class TFlow_incomingFlows_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("IncomingFlow__CC_2494_junction"), this::check_constraint_145));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("IncomingFlow__CONSISTENCY_triangle_0_triangleJunction"), this::check_constraint_146));
	}	
