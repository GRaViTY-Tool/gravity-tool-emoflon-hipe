...
public class VariableDeclarationFragment_variablesContainer_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("FieldAccessReadWrite__CC_1982_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("FieldAccessRead__CC_2087_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("FieldAccessWrite__CC_2192_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("VariableDeclarationFragment__CC_5167_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("VariableDeclarationFragment__CONSISTENCY_5176_junction"), this::returnTrue));
	}	
