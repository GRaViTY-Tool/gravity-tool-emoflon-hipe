...
public class NestedClassInType__Marker_CONTEXT__TRG__tOuterPackage_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TPackage, Set<ModiscoTGG.NestedClassInType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public NestedClassInType__Marker_CONTEXT__TRG__tOuterPackage_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("NestedClassInType__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.NestedClassInType__Marker source, org.gravity.typegraph.basic.TPackage target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.NestedClassInType__Marker, org.gravity.typegraph.basic.TPackage> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.NestedClassInType__Marker, org.gravity.typegraph.basic.TPackage> message) {
