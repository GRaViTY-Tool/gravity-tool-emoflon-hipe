...
public class TextAnnotations__Marker_CREATE__SRC__mComment_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.LineComment, Set<ModiscoTGG.TextAnnotations__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public TextAnnotations__Marker_CREATE__SRC__mComment_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("TextAnnotations__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.TextAnnotations__Marker source, org.eclipse.modisco.java.LineComment target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.TextAnnotations__Marker> message) {
		...
		org.eclipse.modisco.java.LineComment target = (org.eclipse.modisco.java.LineComment) message.input.getCREATE__SRC__mComment();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.TextAnnotations__Marker, org.eclipse.modisco.java.LineComment> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.TextAnnotations__Marker, org.eclipse.modisco.java.LineComment> message) {
