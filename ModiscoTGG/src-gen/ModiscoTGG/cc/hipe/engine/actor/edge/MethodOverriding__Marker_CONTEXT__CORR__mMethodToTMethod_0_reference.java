...
public class MethodOverriding__Marker_CONTEXT__CORR__mMethodToTMethod_0_reference extends AbstractActor {
	...
	public MethodOverriding__Marker_CONTEXT__CORR__mMethodToTMethod_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodOverriding__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
