...
public class FieldSignature__Marker_CREATE__CORR__mSignatureToTSignature_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.MSignatureToTSignature, Set<ModiscoTGG.FieldSignature__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public FieldSignature__Marker_CREATE__CORR__mSignatureToTSignature_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldSignature__CONSISTENCY_2382_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.FieldSignature__Marker source, ModiscoTGG.MSignatureToTSignature target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.FieldSignature__Marker, ModiscoTGG.MSignatureToTSignature> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.FieldSignature__Marker, ModiscoTGG.MSignatureToTSignature> message) {
