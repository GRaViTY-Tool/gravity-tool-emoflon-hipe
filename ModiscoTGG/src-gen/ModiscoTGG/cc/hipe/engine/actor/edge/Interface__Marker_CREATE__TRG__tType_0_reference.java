...
public class Interface__Marker_CREATE__TRG__tType_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TInterface, Set<ModiscoTGG.Interface__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public Interface__Marker_CREATE__TRG__tType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("Interface__CONSISTENCY_triangle_9_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.Interface__Marker source, org.gravity.typegraph.basic.TInterface target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.Interface__Marker> message) {
		...
		org.gravity.typegraph.basic.TInterface target = (org.gravity.typegraph.basic.TInterface) message.input.getCREATE__TRG__tType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.Interface__Marker, org.gravity.typegraph.basic.TInterface> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.Interface__Marker, org.gravity.typegraph.basic.TInterface> message) {
