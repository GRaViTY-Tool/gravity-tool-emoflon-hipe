...
public class SyntethicMethod__Marker_CONTEXT__SRC__mClass_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.ClassDeclaration, Set<ModiscoTGG.SyntethicMethod__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public SyntethicMethod__Marker_CONTEXT__SRC__mClass_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("SyntethicMethod__CONSISTENCY_triangle_8_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.SyntethicMethod__Marker source, org.eclipse.modisco.java.ClassDeclaration target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.SyntethicMethod__Marker, org.eclipse.modisco.java.ClassDeclaration> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.SyntethicMethod__Marker, org.eclipse.modisco.java.ClassDeclaration> message) {
