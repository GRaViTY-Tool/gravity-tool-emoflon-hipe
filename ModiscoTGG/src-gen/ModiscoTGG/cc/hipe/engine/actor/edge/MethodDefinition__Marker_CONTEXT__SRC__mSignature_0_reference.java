...
public class MethodDefinition__Marker_CONTEXT__SRC__mSignature_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MMethodSignature, Set<ModiscoTGG.MethodDefinition__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodDefinition__Marker_CONTEXT__SRC__mSignature_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodDefinition__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodDefinition__Marker source, org.gravity.modisco.MMethodSignature target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodDefinition__Marker, org.gravity.modisco.MMethodSignature> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodDefinition__Marker, org.gravity.modisco.MMethodSignature> message) {
