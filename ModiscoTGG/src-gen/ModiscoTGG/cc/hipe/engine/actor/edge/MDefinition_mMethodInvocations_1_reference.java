...
public class MDefinition_mMethodInvocations_1_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ConstructorInvocation__CC_1767_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("SuperConstructorInvocation__CC_4748_junction"), this::returnTrue));
