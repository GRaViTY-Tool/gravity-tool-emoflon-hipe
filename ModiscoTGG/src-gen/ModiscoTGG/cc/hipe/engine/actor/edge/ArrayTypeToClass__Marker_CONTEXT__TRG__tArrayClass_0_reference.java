...
public class ArrayTypeToClass__Marker_CONTEXT__TRG__tArrayClass_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TAbstractType, Set<ModiscoTGG.ArrayTypeToClass__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ArrayTypeToClass__Marker_CONTEXT__TRG__tArrayClass_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ArrayTypeToClass__CONSISTENCY_triangle_6_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ArrayTypeToClass__Marker source, org.gravity.typegraph.basic.TAbstractType target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ArrayTypeToClass__Marker> message) {
		...
		org.gravity.typegraph.basic.TAbstractType target = (org.gravity.typegraph.basic.TAbstractType) message.input.getCONTEXT__TRG__tArrayClass();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ArrayTypeToClass__Marker, org.gravity.typegraph.basic.TAbstractType> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ArrayTypeToClass__Marker, org.gravity.typegraph.basic.TAbstractType> message) {
