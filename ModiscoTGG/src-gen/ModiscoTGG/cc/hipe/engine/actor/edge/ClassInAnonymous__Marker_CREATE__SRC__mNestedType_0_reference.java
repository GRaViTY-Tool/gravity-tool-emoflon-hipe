...
public class ClassInAnonymous__Marker_CREATE__SRC__mNestedType_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MClass, Set<ModiscoTGG.ClassInAnonymous__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ClassInAnonymous__Marker_CREATE__SRC__mNestedType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ClassInAnonymous__CONSISTENCY_triangle_10_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ClassInAnonymous__Marker source, org.gravity.modisco.MClass target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ClassInAnonymous__Marker> message) {
		...
		org.gravity.modisco.MClass target = (org.gravity.modisco.MClass) message.input.getCREATE__SRC__mNestedType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ClassInAnonymous__Marker, org.gravity.modisco.MClass> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ClassInAnonymous__Marker, org.gravity.modisco.MClass> message) {
