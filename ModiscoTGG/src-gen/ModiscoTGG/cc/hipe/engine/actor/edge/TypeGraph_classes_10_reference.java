...
public class TypeGraph_classes_10_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("PrimitiveTypesIsVoid__CC_4534_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PrimitiveTypesIsVoid__CONSISTENCY_4548_junction"), this::returnTrue));
	}	
