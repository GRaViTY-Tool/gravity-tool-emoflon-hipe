...
public class MDefinitionToTMember_source_3_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessReadWrite__CC_1981_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessRead__CC_2086_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessWrite__CC_2191_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("VariableDeclarationFragment__CC_5169_junction"), this::returnTrue));
