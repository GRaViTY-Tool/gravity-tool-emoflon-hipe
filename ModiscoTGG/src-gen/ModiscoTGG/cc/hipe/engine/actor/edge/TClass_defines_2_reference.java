...
public class TClass_defines_2_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdge(getSelf(), name2actor.get("LinkDefinitionToAnonymous__CC_triangle_0_triangleJunction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MemberInClassVisibility__CC_3006_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MemberInEnumVisibility__CC_3070_junction"), this::returnTrue));
