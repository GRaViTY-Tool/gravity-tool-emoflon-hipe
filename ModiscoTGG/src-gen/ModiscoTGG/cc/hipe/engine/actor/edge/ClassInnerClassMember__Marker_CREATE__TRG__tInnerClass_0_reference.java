...
public class ClassInnerClassMember__Marker_CREATE__TRG__tInnerClass_0_reference extends AbstractActor {
	...
	public ClassInnerClassMember__Marker_CREATE__TRG__tInnerClass_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ClassInnerClassMember__CONSISTENCY_triangle_9_triangleJunction"), this::returnTrue));
	}	
