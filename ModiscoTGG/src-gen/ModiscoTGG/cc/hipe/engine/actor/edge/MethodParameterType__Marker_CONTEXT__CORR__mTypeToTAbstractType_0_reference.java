...
public class MethodParameterType__Marker_CONTEXT__CORR__mTypeToTAbstractType_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.TypeToTAbstractType, Set<ModiscoTGG.MethodParameterType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodParameterType__Marker_CONTEXT__CORR__mTypeToTAbstractType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodParameterType__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodParameterType__Marker source, ModiscoTGG.TypeToTAbstractType target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MethodParameterType__Marker> message) {
		...
		ModiscoTGG.TypeToTAbstractType target = (ModiscoTGG.TypeToTAbstractType) message.input.getCONTEXT__CORR__mTypeToTAbstractType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodParameterType__Marker, ModiscoTGG.TypeToTAbstractType> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodParameterType__Marker, ModiscoTGG.TypeToTAbstractType> message) {
