...
public class PrimitiveTypeToTClass_source_4_reference extends AbstractActor {
	...
	public PrimitiveTypeToTClass_source_4_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PrimitiveTypeIsFloat__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
