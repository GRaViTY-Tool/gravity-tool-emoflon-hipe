...
public class PrimitiveTypeToTClass_target_1_reference extends AbstractActor {
	...
	public PrimitiveTypeToTClass_target_1_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PrimitiveTypeIsByte__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
