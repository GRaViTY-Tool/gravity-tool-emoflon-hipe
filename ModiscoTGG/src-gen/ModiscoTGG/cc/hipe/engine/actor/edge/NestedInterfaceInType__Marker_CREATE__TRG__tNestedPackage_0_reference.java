...
public class NestedInterfaceInType__Marker_CREATE__TRG__tNestedPackage_0_reference extends AbstractActor {
	...
	public NestedInterfaceInType__Marker_CREATE__TRG__tNestedPackage_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("NestedInterfaceInType__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
	}	
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.NestedInterfaceInType__Marker> message) {
		...
		org.gravity.typegraph.basic.TPackage target = (org.gravity.typegraph.basic.TPackage) message.input.getCREATE__TRG__tNestedPackage();
