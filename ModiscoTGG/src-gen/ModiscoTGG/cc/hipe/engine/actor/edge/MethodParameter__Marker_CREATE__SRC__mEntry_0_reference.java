...
public class MethodParameter__Marker_CREATE__SRC__mEntry_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MEntry, Set<ModiscoTGG.MethodParameter__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodParameter__Marker_CREATE__SRC__mEntry_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodParameter__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodParameter__Marker source, org.gravity.modisco.MEntry target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodParameter__Marker, org.gravity.modisco.MEntry> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodParameter__Marker, org.gravity.modisco.MEntry> message) {
