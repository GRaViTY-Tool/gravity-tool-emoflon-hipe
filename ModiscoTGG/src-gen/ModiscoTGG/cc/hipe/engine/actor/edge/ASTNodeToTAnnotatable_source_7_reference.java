...
public class ASTNodeToTAnnotatable_source_7_reference extends AbstractActor {
	...
	public ASTNodeToTAnnotatable_source_7_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodDefinition__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
	}	
