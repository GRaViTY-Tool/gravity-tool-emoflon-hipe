...
public class PrimitiveTypeIsBoolean__Marker_CREATE__TRG__tPrimitiveClass_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TClass, Set<ModiscoTGG.PrimitiveTypeIsBoolean__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public PrimitiveTypeIsBoolean__Marker_CREATE__TRG__tPrimitiveClass_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("PrimitiveTypeIsBoolean__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.PrimitiveTypeIsBoolean__Marker source, org.gravity.typegraph.basic.TClass target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.PrimitiveTypeIsBoolean__Marker> message) {
		...
		org.gravity.typegraph.basic.TClass target = (org.gravity.typegraph.basic.TClass) message.input.getCREATE__TRG__tPrimitiveClass();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.PrimitiveTypeIsBoolean__Marker, org.gravity.typegraph.basic.TClass> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.PrimitiveTypeIsBoolean__Marker, org.gravity.typegraph.basic.TClass> message) {
