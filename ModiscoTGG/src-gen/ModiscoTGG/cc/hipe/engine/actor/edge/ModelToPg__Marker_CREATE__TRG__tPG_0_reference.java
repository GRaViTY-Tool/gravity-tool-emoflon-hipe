...
public class ModelToPg__Marker_CREATE__TRG__tPG_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TypeGraph, Set<ModiscoTGG.ModelToPg__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ModelToPg__Marker_CREATE__TRG__tPG_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ModelToPg__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ModelToPg__Marker source, org.gravity.typegraph.basic.TypeGraph target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ModelToPg__Marker> message) {
		...
		org.gravity.typegraph.basic.TypeGraph target = (org.gravity.typegraph.basic.TypeGraph) message.input.getCREATE__TRG__tPG();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ModelToPg__Marker, org.gravity.typegraph.basic.TypeGraph> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ModelToPg__Marker, org.gravity.typegraph.basic.TypeGraph> message) {
