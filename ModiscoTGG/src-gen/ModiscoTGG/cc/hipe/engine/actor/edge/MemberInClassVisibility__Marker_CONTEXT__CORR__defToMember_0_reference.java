...
public class MemberInClassVisibility__Marker_CONTEXT__CORR__defToMember_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.MDefinitionToTMember, Set<ModiscoTGG.MemberInClassVisibility__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MemberInClassVisibility__Marker_CONTEXT__CORR__defToMember_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MemberInClassVisibility__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MemberInClassVisibility__Marker source, ModiscoTGG.MDefinitionToTMember target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MemberInClassVisibility__Marker, ModiscoTGG.MDefinitionToTMember> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MemberInClassVisibility__Marker, ModiscoTGG.MDefinitionToTMember> message) {
