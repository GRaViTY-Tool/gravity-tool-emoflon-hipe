...
public class AnnotationMemberValueNumber__Marker_CREATE__SRC__mValue_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.NumberLiteral, Set<ModiscoTGG.AnnotationMemberValueNumber__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueNumber__Marker_CREATE__SRC__mValue_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationMemberValueNumber__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueNumber__Marker source, org.eclipse.modisco.java.NumberLiteral target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueNumber__Marker, org.eclipse.modisco.java.NumberLiteral> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueNumber__Marker, org.eclipse.modisco.java.NumberLiteral> message) {
