...
public class MethodOverriding__Marker_CONTEXT__SRC__mMethod_0_reference extends AbstractActor {
	...
	public MethodOverriding__Marker_CONTEXT__SRC__mMethod_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodOverriding__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MethodOverriding__Marker> message) {
		...
		org.gravity.modisco.MMethodDefinition target = (org.gravity.modisco.MMethodDefinition) message.input.getCONTEXT__SRC__mMethod();
