...
public class MethodDefinition__Marker_CREATE__SRC__mDefinition_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MMethodDefinition, Set<ModiscoTGG.MethodDefinition__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodDefinition__Marker_CREATE__SRC__mDefinition_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodDefinition__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodDefinition__Marker source, org.gravity.modisco.MMethodDefinition target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MethodDefinition__Marker> message) {
		...
		org.gravity.modisco.MMethodDefinition target = (org.gravity.modisco.MMethodDefinition) message.input.getCREATE__SRC__mDefinition();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodDefinition__Marker, org.gravity.modisco.MMethodDefinition> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodDefinition__Marker, org.gravity.modisco.MMethodDefinition> message) {
