...
public class AnonymousClassDeclarationToTClass_source_1_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnonymousClassTypeClass__CC_864_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnonymousClassTypeInterface__CC_941_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("LinkDefinitionToAnonymous__CC_2803_junction"), this::returnTrue));
