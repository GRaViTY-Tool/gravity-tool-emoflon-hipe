...
public class SyntethicMethod__Marker_CREATE__SRC__mSyntethic_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MSyntheticMethodDefinition, Set<ModiscoTGG.SyntethicMethod__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public SyntethicMethod__Marker_CREATE__SRC__mSyntethic_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("SyntethicMethod__CONSISTENCY_triangle_9_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.SyntethicMethod__Marker source, org.gravity.modisco.MSyntheticMethodDefinition target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.SyntethicMethod__Marker> message) {
		...
		org.gravity.modisco.MSyntheticMethodDefinition target = (org.gravity.modisco.MSyntheticMethodDefinition) message.input.getCREATE__SRC__mSyntethic();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.SyntethicMethod__Marker, org.gravity.modisco.MSyntheticMethodDefinition> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.SyntethicMethod__Marker, org.gravity.modisco.MSyntheticMethodDefinition> message) {
