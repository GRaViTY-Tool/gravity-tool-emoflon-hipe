...
public class InterfaceExtendsInterface__Marker_CREATE__SRC__eTypeAccess_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.TypeAccess, Set<ModiscoTGG.InterfaceExtendsInterface__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public InterfaceExtendsInterface__Marker_CREATE__SRC__eTypeAccess_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("InterfaceExtendsInterface__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.InterfaceExtendsInterface__Marker source, org.eclipse.modisco.java.TypeAccess target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.InterfaceExtendsInterface__Marker> message) {
		...
		org.eclipse.modisco.java.TypeAccess target = (org.eclipse.modisco.java.TypeAccess) message.input.getCREATE__SRC__eTypeAccess();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.InterfaceExtendsInterface__Marker, org.eclipse.modisco.java.TypeAccess> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.InterfaceExtendsInterface__Marker, org.eclipse.modisco.java.TypeAccess> message) {
