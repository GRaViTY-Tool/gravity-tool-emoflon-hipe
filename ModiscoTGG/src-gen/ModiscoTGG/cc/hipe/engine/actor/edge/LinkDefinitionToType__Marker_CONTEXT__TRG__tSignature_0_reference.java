...
public class LinkDefinitionToType__Marker_CONTEXT__TRG__tSignature_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TSignature, Set<ModiscoTGG.LinkDefinitionToType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public LinkDefinitionToType__Marker_CONTEXT__TRG__tSignature_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("LinkDefinitionToType__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.LinkDefinitionToType__Marker source, org.gravity.typegraph.basic.TSignature target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.LinkDefinitionToType__Marker> message) {
		...
		org.gravity.typegraph.basic.TSignature target = (org.gravity.typegraph.basic.TSignature) message.input.getCONTEXT__TRG__tSignature();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.LinkDefinitionToType__Marker, org.gravity.typegraph.basic.TSignature> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.LinkDefinitionToType__Marker, org.gravity.typegraph.basic.TSignature> message) {
