...
public class MAbstractFlowElementToTAbstractFlowElement_target_0_reference extends AbstractActor {
	...
	public MAbstractFlowElementToTAbstractFlowElement_target_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ClassInstanceCreation__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("ConstructorInvocation__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodInvocationRecursive__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodInvocation__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("SuperConstructorInvocation__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("SuperMethodInvocation__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
