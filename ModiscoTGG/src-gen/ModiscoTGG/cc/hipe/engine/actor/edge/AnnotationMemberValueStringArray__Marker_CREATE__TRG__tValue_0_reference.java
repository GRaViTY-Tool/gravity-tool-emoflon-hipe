...
public class AnnotationMemberValueStringArray__Marker_CREATE__TRG__tValue_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.annotations.TTextNode, Set<EdgeMatch>> targetElements = new HashMap<org.gravity.typegraph.basic.annotations.TTextNode, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.gravity.typegraph.basic.annotations.TTextNode, Set<ModiscoTGG.AnnotationMemberValueStringArray__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueStringArray__Marker_CREATE__TRG__tValue_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationMemberValueStringArray__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueStringArray__Marker source, org.gravity.typegraph.basic.annotations.TTextNode target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.gravity.typegraph.basic.annotations.TTextNode) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationMemberValueStringArray__Marker> message) {
		...
		org.gravity.typegraph.basic.annotations.TTextNode target = (org.gravity.typegraph.basic.annotations.TTextNode) message.input.getCREATE__TRG__tValue();
	...
	private void rightAdded(NodeAddedRight<org.gravity.typegraph.basic.annotations.TTextNode> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.gravity.typegraph.basic.annotations.TTextNode> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueStringArray__Marker, org.gravity.typegraph.basic.annotations.TTextNode> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueStringArray__Marker, org.gravity.typegraph.basic.annotations.TTextNode> message) {
