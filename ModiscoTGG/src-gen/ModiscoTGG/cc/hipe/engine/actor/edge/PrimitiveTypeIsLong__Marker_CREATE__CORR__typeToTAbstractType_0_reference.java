...
public class PrimitiveTypeIsLong__Marker_CREATE__CORR__typeToTAbstractType_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.TypeToTAbstractType, Set<ModiscoTGG.PrimitiveTypeIsLong__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public PrimitiveTypeIsLong__Marker_CREATE__CORR__typeToTAbstractType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PrimitiveTypeIsLong__CONSISTENCY_4449_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.PrimitiveTypeIsLong__Marker source, ModiscoTGG.TypeToTAbstractType target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.PrimitiveTypeIsLong__Marker, ModiscoTGG.TypeToTAbstractType> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.PrimitiveTypeIsLong__Marker, ModiscoTGG.TypeToTAbstractType> message) {
