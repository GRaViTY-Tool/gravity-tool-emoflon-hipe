...
public class AnnotationMemberValueClass__Marker_CREATE__SRC__mValue_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.TypeLiteral, Set<EdgeMatch>> targetElements = new HashMap<org.eclipse.modisco.java.TypeLiteral, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.eclipse.modisco.java.TypeLiteral, Set<ModiscoTGG.AnnotationMemberValueClass__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueClass__Marker_CREATE__SRC__mValue_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationMemberValueClass__CONSISTENCY_triangle_8_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueClass__Marker source, org.eclipse.modisco.java.TypeLiteral target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.eclipse.modisco.java.TypeLiteral) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationMemberValueClass__Marker> message) {
		...
		org.eclipse.modisco.java.TypeLiteral target = (org.eclipse.modisco.java.TypeLiteral) message.input.getCREATE__SRC__mValue();
	...
	private void rightAdded(NodeAddedRight<org.eclipse.modisco.java.TypeLiteral> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.eclipse.modisco.java.TypeLiteral> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueClass__Marker, org.eclipse.modisco.java.TypeLiteral> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueClass__Marker, org.eclipse.modisco.java.TypeLiteral> message) {
