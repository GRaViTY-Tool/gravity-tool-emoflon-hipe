...
public class TClass_pg_8_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PrimitiveTypeIsDouble__CC_4284_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("PrimitiveTypeIsDouble__CONSISTENCY_4298_junction"), this::returnTrue));
	}	
