...
public class MethodOverriding__Marker_CONTEXT__CORR__mOverridingToTOverriding_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.MDefinitionToTMember, Set<ModiscoTGG.MethodOverriding__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodOverriding__Marker_CONTEXT__CORR__mOverridingToTOverriding_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodOverriding__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodOverriding__Marker source, ModiscoTGG.MDefinitionToTMember target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MethodOverriding__Marker> message) {
		...
		ModiscoTGG.MDefinitionToTMember target = (ModiscoTGG.MDefinitionToTMember) message.input.getCONTEXT__CORR__mOverridingToTOverriding();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodOverriding__Marker, ModiscoTGG.MDefinitionToTMember> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodOverriding__Marker, ModiscoTGG.MDefinitionToTMember> message) {
