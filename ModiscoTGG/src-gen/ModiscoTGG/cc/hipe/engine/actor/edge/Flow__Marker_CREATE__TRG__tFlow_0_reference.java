...
public class Flow__Marker_CREATE__TRG__tFlow_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TFlow, Set<ModiscoTGG.Flow__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public Flow__Marker_CREATE__TRG__tFlow_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("Flow__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.Flow__Marker source, org.gravity.typegraph.basic.TFlow target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.Flow__Marker> message) {
		...
		org.gravity.typegraph.basic.TFlow target = (org.gravity.typegraph.basic.TFlow) message.input.getCREATE__TRG__tFlow();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.Flow__Marker, org.gravity.typegraph.basic.TFlow> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.Flow__Marker, org.gravity.typegraph.basic.TFlow> message) {
