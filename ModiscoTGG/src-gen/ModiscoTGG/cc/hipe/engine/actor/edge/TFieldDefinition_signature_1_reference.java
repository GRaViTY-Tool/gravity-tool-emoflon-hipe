...
public class TFieldDefinition_signature_1_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldDefinition__CC_2285_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldDefinition__CONSISTENCY_2297_junction"), this::returnTrue));
	}	
