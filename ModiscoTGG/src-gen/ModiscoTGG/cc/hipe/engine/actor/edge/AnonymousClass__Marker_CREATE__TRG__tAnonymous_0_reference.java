...
public class AnonymousClass__Marker_CREATE__TRG__tAnonymous_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TClass, Set<ModiscoTGG.AnonymousClass__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnonymousClass__Marker_CREATE__TRG__tAnonymous_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnonymousClass__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnonymousClass__Marker source, org.gravity.typegraph.basic.TClass target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnonymousClass__Marker> message) {
		...
		org.gravity.typegraph.basic.TClass target = (org.gravity.typegraph.basic.TClass) message.input.getCREATE__TRG__tAnonymous();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnonymousClass__Marker, org.gravity.typegraph.basic.TClass> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnonymousClass__Marker, org.gravity.typegraph.basic.TClass> message) {
