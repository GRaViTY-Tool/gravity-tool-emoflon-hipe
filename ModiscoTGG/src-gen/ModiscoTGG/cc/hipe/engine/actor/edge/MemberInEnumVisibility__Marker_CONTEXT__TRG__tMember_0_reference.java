...
public class MemberInEnumVisibility__Marker_CONTEXT__TRG__tMember_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TMember, Set<ModiscoTGG.MemberInEnumVisibility__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MemberInEnumVisibility__Marker_CONTEXT__TRG__tMember_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MemberInEnumVisibility__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MemberInEnumVisibility__Marker source, org.gravity.typegraph.basic.TMember target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MemberInEnumVisibility__Marker, org.gravity.typegraph.basic.TMember> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MemberInEnumVisibility__Marker, org.gravity.typegraph.basic.TMember> message) {
