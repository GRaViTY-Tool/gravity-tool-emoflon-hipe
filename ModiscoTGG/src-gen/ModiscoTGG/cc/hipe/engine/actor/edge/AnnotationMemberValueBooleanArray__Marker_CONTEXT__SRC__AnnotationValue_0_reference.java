...
public class AnnotationMemberValueBooleanArray__Marker_CONTEXT__SRC__AnnotationValue_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.AnnotationMemberValuePair, Set<ModiscoTGG.AnnotationMemberValueBooleanArray__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueBooleanArray__Marker_CONTEXT__SRC__AnnotationValue_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationMemberValueBooleanArray__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueBooleanArray__Marker source, org.eclipse.modisco.java.AnnotationMemberValuePair target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueBooleanArray__Marker, org.eclipse.modisco.java.AnnotationMemberValuePair> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueBooleanArray__Marker, org.eclipse.modisco.java.AnnotationMemberValuePair> message) {
