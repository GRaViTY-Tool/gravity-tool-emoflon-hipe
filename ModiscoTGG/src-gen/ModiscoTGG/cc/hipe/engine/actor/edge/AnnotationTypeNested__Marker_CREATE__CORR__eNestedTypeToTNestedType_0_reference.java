...
public class AnnotationTypeNested__Marker_CREATE__CORR__eNestedTypeToTNestedType_0_reference extends AbstractActor {
	...
	public AnnotationTypeNested__Marker_CREATE__CORR__eNestedTypeToTNestedType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationTypeNested__CONSISTENCY_triangle_11_triangleJunction"), this::returnTrue));
	}	
