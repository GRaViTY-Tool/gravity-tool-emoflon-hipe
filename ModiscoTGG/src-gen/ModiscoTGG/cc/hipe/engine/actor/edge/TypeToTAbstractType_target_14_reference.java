...
public class TypeToTAbstractType_target_14_reference extends AbstractActor {
	...
	public TypeToTAbstractType_target_14_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("UnresolvedTypeDeclaration__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
