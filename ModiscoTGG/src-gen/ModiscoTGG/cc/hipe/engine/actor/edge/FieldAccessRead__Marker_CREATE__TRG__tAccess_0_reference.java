...
public class FieldAccessRead__Marker_CREATE__TRG__tAccess_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TRead, Set<EdgeMatch>> targetElements = new HashMap<org.gravity.typegraph.basic.TRead, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.gravity.typegraph.basic.TRead, Set<ModiscoTGG.FieldAccessRead__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public FieldAccessRead__Marker_CREATE__TRG__tAccess_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("FieldAccessRead__CONSISTENCY_triangle_12_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.FieldAccessRead__Marker source, org.gravity.typegraph.basic.TRead target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.gravity.typegraph.basic.TRead) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.FieldAccessRead__Marker> message) {
		...
		org.gravity.typegraph.basic.TRead target = (org.gravity.typegraph.basic.TRead) message.input.getCREATE__TRG__tAccess();
	...
	private void rightAdded(NodeAddedRight<org.gravity.typegraph.basic.TRead> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.gravity.typegraph.basic.TRead> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.FieldAccessRead__Marker, org.gravity.typegraph.basic.TRead> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.FieldAccessRead__Marker, org.gravity.typegraph.basic.TRead> message) {
