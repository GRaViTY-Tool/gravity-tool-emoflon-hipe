...
public class ReturnType__Marker_CONTEXT__SRC__mDefinition_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MMethodDefinition, Set<ModiscoTGG.ReturnType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ReturnType__Marker_CONTEXT__SRC__mDefinition_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ReturnType__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ReturnType__Marker source, org.gravity.modisco.MMethodDefinition target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ReturnType__Marker> message) {
		...
		org.gravity.modisco.MMethodDefinition target = (org.gravity.modisco.MMethodDefinition) message.input.getCONTEXT__SRC__mDefinition();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ReturnType__Marker, org.gravity.modisco.MMethodDefinition> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ReturnType__Marker, org.gravity.modisco.MMethodDefinition> message) {
