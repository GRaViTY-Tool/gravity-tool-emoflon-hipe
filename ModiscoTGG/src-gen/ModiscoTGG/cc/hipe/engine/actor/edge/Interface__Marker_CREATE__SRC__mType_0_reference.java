...
public class Interface__Marker_CREATE__SRC__mType_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.InterfaceDeclaration, Set<ModiscoTGG.Interface__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public Interface__Marker_CREATE__SRC__mType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("Interface__CONSISTENCY_triangle_10_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.Interface__Marker source, org.eclipse.modisco.java.InterfaceDeclaration target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.Interface__Marker> message) {
		...
		org.eclipse.modisco.java.InterfaceDeclaration target = (org.eclipse.modisco.java.InterfaceDeclaration) message.input.getCREATE__SRC__mType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.Interface__Marker, org.eclipse.modisco.java.InterfaceDeclaration> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.Interface__Marker, org.eclipse.modisco.java.InterfaceDeclaration> message) {
