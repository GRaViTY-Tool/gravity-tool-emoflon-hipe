...
public class AnnotationMemberKey__Marker_CONTEXT__TRG__tAnnotation_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.annotations.TAnnotation, Set<ModiscoTGG.AnnotationMemberKey__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberKey__Marker_CONTEXT__TRG__tAnnotation_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationMemberKey__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberKey__Marker source, org.gravity.typegraph.basic.annotations.TAnnotation target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberKey__Marker, org.gravity.typegraph.basic.annotations.TAnnotation> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberKey__Marker, org.gravity.typegraph.basic.annotations.TAnnotation> message) {
