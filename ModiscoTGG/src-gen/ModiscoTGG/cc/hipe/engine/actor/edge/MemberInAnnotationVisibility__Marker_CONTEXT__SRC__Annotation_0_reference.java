...
public class MemberInAnnotationVisibility__Marker_CONTEXT__SRC__Annotation_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.AnnotationTypeDeclaration, Set<EdgeMatch>> targetElements = new HashMap<org.eclipse.modisco.java.AnnotationTypeDeclaration, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.eclipse.modisco.java.AnnotationTypeDeclaration, Set<ModiscoTGG.MemberInAnnotationVisibility__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MemberInAnnotationVisibility__Marker_CONTEXT__SRC__Annotation_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MemberInAnnotationVisibility__CONSISTENCY_triangle_8_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MemberInAnnotationVisibility__Marker source, org.eclipse.modisco.java.AnnotationTypeDeclaration target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.eclipse.modisco.java.AnnotationTypeDeclaration) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MemberInAnnotationVisibility__Marker> message) {
		...
		org.eclipse.modisco.java.AnnotationTypeDeclaration target = (org.eclipse.modisco.java.AnnotationTypeDeclaration) message.input.getCONTEXT__SRC__Annotation();
	...
	private void rightAdded(NodeAddedRight<org.eclipse.modisco.java.AnnotationTypeDeclaration> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.eclipse.modisco.java.AnnotationTypeDeclaration> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MemberInAnnotationVisibility__Marker, org.eclipse.modisco.java.AnnotationTypeDeclaration> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MemberInAnnotationVisibility__Marker, org.eclipse.modisco.java.AnnotationTypeDeclaration> message) {
