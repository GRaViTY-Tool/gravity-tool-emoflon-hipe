...
public class AnonymousClass__Marker_CREATE__TRG__tNewPackage_0_reference extends AbstractActor {
	...
	public AnonymousClass__Marker_CREATE__TRG__tNewPackage_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnonymousClass__CONSISTENCY_1042_junction"), this::returnTrue));
	}	
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnonymousClass__Marker> message) {
		...
		org.gravity.typegraph.basic.TPackage target = (org.gravity.typegraph.basic.TPackage) message.input.getCREATE__TRG__tNewPackage();
