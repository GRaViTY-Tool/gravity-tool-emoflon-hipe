...
public class MethodName__Marker_CONTEXT__SRC__mModel_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MGravityModel, Set<ModiscoTGG.MethodName__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodName__Marker_CONTEXT__SRC__mModel_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodName__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodName__Marker source, org.gravity.modisco.MGravityModel target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MethodName__Marker> message) {
		...
		org.gravity.modisco.MGravityModel target = (org.gravity.modisco.MGravityModel) message.input.getCONTEXT__SRC__mModel();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodName__Marker, org.gravity.modisco.MGravityModel> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodName__Marker, org.gravity.modisco.MGravityModel> message) {
