...
public class PrimitiveTypeIsByte__Marker_CONTEXT__SRC__eModel_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.Model, Set<ModiscoTGG.PrimitiveTypeIsByte__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public PrimitiveTypeIsByte__Marker_CONTEXT__SRC__eModel_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("PrimitiveTypeIsByte__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.PrimitiveTypeIsByte__Marker source, org.eclipse.modisco.java.Model target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.PrimitiveTypeIsByte__Marker, org.eclipse.modisco.java.Model> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.PrimitiveTypeIsByte__Marker, org.eclipse.modisco.java.Model> message) {
