...
public class Flow__Marker_CREATE__CORR__mFlowToTFlow_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.MFlowToTFlow, Set<ModiscoTGG.Flow__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public Flow__Marker_CREATE__CORR__mFlowToTFlow_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("Flow__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.Flow__Marker source, ModiscoTGG.MFlowToTFlow target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.Flow__Marker> message) {
		...
		ModiscoTGG.MFlowToTFlow target = (ModiscoTGG.MFlowToTFlow) message.input.getCREATE__CORR__mFlowToTFlow();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.Flow__Marker, ModiscoTGG.MFlowToTFlow> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.Flow__Marker, ModiscoTGG.MFlowToTFlow> message) {
