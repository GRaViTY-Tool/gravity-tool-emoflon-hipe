...
public class NestedInterfaceInType__Marker_CONTEXT__TRG__tOuterType_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TAbstractType, Set<ModiscoTGG.NestedInterfaceInType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public NestedInterfaceInType__Marker_CONTEXT__TRG__tOuterType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("NestedInterfaceInType__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.NestedInterfaceInType__Marker source, org.gravity.typegraph.basic.TAbstractType target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.NestedInterfaceInType__Marker> message) {
		...
		org.gravity.typegraph.basic.TAbstractType target = (org.gravity.typegraph.basic.TAbstractType) message.input.getCONTEXT__TRG__tOuterType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.NestedInterfaceInType__Marker, org.gravity.typegraph.basic.TAbstractType> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.NestedInterfaceInType__Marker, org.gravity.typegraph.basic.TAbstractType> message) {
