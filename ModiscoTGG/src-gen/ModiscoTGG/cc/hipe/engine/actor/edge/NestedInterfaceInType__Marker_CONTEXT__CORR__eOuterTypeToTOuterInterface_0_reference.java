...
public class NestedInterfaceInType__Marker_CONTEXT__CORR__eOuterTypeToTOuterInterface_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.TypeToTAbstractType, Set<ModiscoTGG.NestedInterfaceInType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public NestedInterfaceInType__Marker_CONTEXT__CORR__eOuterTypeToTOuterInterface_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("NestedInterfaceInType__CONSISTENCY_triangle_10_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.NestedInterfaceInType__Marker source, ModiscoTGG.TypeToTAbstractType target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.NestedInterfaceInType__Marker> message) {
		...
		ModiscoTGG.TypeToTAbstractType target = (ModiscoTGG.TypeToTAbstractType) message.input.getCONTEXT__CORR__eOuterTypeToTOuterInterface();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.NestedInterfaceInType__Marker, ModiscoTGG.TypeToTAbstractType> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.NestedInterfaceInType__Marker, ModiscoTGG.TypeToTAbstractType> message) {
