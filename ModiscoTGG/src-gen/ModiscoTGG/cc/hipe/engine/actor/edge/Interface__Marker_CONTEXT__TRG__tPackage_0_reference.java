...
public class Interface__Marker_CONTEXT__TRG__tPackage_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TPackage, Set<ModiscoTGG.Interface__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public Interface__Marker_CONTEXT__TRG__tPackage_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("Interface__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.Interface__Marker source, org.gravity.typegraph.basic.TPackage target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.Interface__Marker, org.gravity.typegraph.basic.TPackage> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.Interface__Marker, org.gravity.typegraph.basic.TPackage> message) {
