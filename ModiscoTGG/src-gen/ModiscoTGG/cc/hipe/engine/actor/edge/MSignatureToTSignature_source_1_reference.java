...
public class MSignatureToTSignature_source_1_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldDefinition__CC_2291_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldType__CC_2419_junction"), this::returnTrue));
