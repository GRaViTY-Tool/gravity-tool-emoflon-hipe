...
public class AnnotationOnBodyDeclaration__Marker_CREATE__CORR__AnnotationToTAnnotation_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.AnnotationToTAnnotation, Set<ModiscoTGG.AnnotationOnBodyDeclaration__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationOnBodyDeclaration__Marker_CREATE__CORR__AnnotationToTAnnotation_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationOnBodyDeclaration__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationOnBodyDeclaration__Marker source, ModiscoTGG.AnnotationToTAnnotation target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationOnBodyDeclaration__Marker> message) {
		...
		ModiscoTGG.AnnotationToTAnnotation target = (ModiscoTGG.AnnotationToTAnnotation) message.input.getCREATE__CORR__AnnotationToTAnnotation();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationOnBodyDeclaration__Marker, ModiscoTGG.AnnotationToTAnnotation> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationOnBodyDeclaration__Marker, ModiscoTGG.AnnotationToTAnnotation> message) {
