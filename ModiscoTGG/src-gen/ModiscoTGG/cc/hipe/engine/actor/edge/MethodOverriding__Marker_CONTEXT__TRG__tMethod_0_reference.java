...
public class MethodOverriding__Marker_CONTEXT__TRG__tMethod_0_reference extends AbstractActor {
	...
	public MethodOverriding__Marker_CONTEXT__TRG__tMethod_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodOverriding__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MethodOverriding__Marker> message) {
		...
		org.gravity.typegraph.basic.TMethodDefinition target = (org.gravity.typegraph.basic.TMethodDefinition) message.input.getCONTEXT__TRG__tMethod();
