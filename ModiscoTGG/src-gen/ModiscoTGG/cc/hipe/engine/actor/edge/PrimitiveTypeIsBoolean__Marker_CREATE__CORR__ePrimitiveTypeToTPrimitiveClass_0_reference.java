...
public class PrimitiveTypeIsBoolean__Marker_CREATE__CORR__ePrimitiveTypeToTPrimitiveClass_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.PrimitiveTypeToTClass, Set<EdgeMatch>> targetElements = new HashMap<ModiscoTGG.PrimitiveTypeToTClass, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<ModiscoTGG.PrimitiveTypeToTClass, Set<ModiscoTGG.PrimitiveTypeIsBoolean__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public PrimitiveTypeIsBoolean__Marker_CREATE__CORR__ePrimitiveTypeToTPrimitiveClass_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("PrimitiveTypeIsBoolean__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.PrimitiveTypeIsBoolean__Marker source, ModiscoTGG.PrimitiveTypeToTClass target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((ModiscoTGG.PrimitiveTypeToTClass) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.PrimitiveTypeIsBoolean__Marker> message) {
		...
		ModiscoTGG.PrimitiveTypeToTClass target = (ModiscoTGG.PrimitiveTypeToTClass) message.input.getCREATE__CORR__ePrimitiveTypeToTPrimitiveClass();
	...
	private void rightAdded(NodeAddedRight<ModiscoTGG.PrimitiveTypeToTClass> message) {
	...
	private void rightRemoved(NodeDeletedRight<ModiscoTGG.PrimitiveTypeToTClass> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.PrimitiveTypeIsBoolean__Marker, ModiscoTGG.PrimitiveTypeToTClass> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.PrimitiveTypeIsBoolean__Marker, ModiscoTGG.PrimitiveTypeToTClass> message) {
