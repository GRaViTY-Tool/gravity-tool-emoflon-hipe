...
public class ASTNodeToTAnnotatable_target_3_reference extends AbstractActor {
	...
	public ASTNodeToTAnnotatable_target_3_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ConstructorDefinition__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodDefinition__CONSISTENCY_triangle_6_triangleJunction"), this::returnTrue));
	}	
