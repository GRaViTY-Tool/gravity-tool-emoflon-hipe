...
public class AnonymousClassTypeInterface__Marker_CONTEXT__SRC__mAnonymous_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MAnonymous, Set<ModiscoTGG.AnonymousClassTypeInterface__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnonymousClassTypeInterface__Marker_CONTEXT__SRC__mAnonymous_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnonymousClassTypeInterface__CONSISTENCY_triangle_6_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnonymousClassTypeInterface__Marker source, org.gravity.modisco.MAnonymous target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnonymousClassTypeInterface__Marker> message) {
		...
		org.gravity.modisco.MAnonymous target = (org.gravity.modisco.MAnonymous) message.input.getCONTEXT__SRC__mAnonymous();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnonymousClassTypeInterface__Marker, org.gravity.modisco.MAnonymous> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnonymousClassTypeInterface__Marker, org.gravity.modisco.MAnonymous> message) {
