...
public class AnnotationTypeAccess__Marker_CONTEXT__TRG__tAnnotation_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.annotations.TAnnotation, Set<ModiscoTGG.AnnotationTypeAccess__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationTypeAccess__Marker_CONTEXT__TRG__tAnnotation_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationTypeAccess__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationTypeAccess__Marker source, org.gravity.typegraph.basic.annotations.TAnnotation target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationTypeAccess__Marker> message) {
		...
		org.gravity.typegraph.basic.annotations.TAnnotation target = (org.gravity.typegraph.basic.annotations.TAnnotation) message.input.getCONTEXT__TRG__tAnnotation();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationTypeAccess__Marker, org.gravity.typegraph.basic.annotations.TAnnotation> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationTypeAccess__Marker, org.gravity.typegraph.basic.annotations.TAnnotation> message) {
