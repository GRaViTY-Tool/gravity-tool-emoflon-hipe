...
public class TInterface_pg_4_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdge(getSelf(), name2actor.get("InterfaceInAnonymous__CC_triangle_0_triangleJunction"), this::returnTrue));
		...
		ports.add(new PortEdge(getSelf(), name2actor.get("Interface__CC_triangle_0_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("Interface__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("NestedInterfaceInType__CC_triangle_0_triangleJunction"), this::returnTrue));
