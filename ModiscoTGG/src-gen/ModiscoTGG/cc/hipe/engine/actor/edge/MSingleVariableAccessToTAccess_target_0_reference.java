...
public class MSingleVariableAccessToTAccess_target_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TAccess, Set<ModiscoTGG.MSingleVariableAccessToTAccess>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MSingleVariableAccessToTAccess_target_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessReadWrite__CONSISTENCY_triangle_12_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MSingleVariableAccessToTAccess source, org.gravity.typegraph.basic.TAccess target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MSingleVariableAccessToTAccess, org.gravity.typegraph.basic.TAccess> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MSingleVariableAccessToTAccess, org.gravity.typegraph.basic.TAccess> message) {
