...
public class AnnotationMemberValueClass__Marker_CREATE__SRC__mAccess_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.TypeAccess, Set<ModiscoTGG.AnnotationMemberValueClass__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueClass__Marker_CREATE__SRC__mAccess_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationMemberValueClass__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueClass__Marker source, org.eclipse.modisco.java.TypeAccess target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationMemberValueClass__Marker> message) {
		...
		org.eclipse.modisco.java.TypeAccess target = (org.eclipse.modisco.java.TypeAccess) message.input.getCREATE__SRC__mAccess();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueClass__Marker, org.eclipse.modisco.java.TypeAccess> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueClass__Marker, org.eclipse.modisco.java.TypeAccess> message) {
