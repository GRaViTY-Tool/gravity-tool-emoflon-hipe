...
public class TMethodSignature_returnType_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("SignatureReturnType__CC_4652_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("SignatureReturnType__CONSISTENCY_4667_junction"), this::returnTrue));
	}	
