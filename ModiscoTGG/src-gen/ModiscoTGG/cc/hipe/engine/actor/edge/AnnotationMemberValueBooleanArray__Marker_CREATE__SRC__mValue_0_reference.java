...
public class AnnotationMemberValueBooleanArray__Marker_CREATE__SRC__mValue_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.BooleanLiteral, Set<EdgeMatch>> targetElements = new HashMap<org.eclipse.modisco.java.BooleanLiteral, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.eclipse.modisco.java.BooleanLiteral, Set<ModiscoTGG.AnnotationMemberValueBooleanArray__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueBooleanArray__Marker_CREATE__SRC__mValue_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationMemberValueBooleanArray__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueBooleanArray__Marker source, org.eclipse.modisco.java.BooleanLiteral target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.eclipse.modisco.java.BooleanLiteral) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationMemberValueBooleanArray__Marker> message) {
		...
		org.eclipse.modisco.java.BooleanLiteral target = (org.eclipse.modisco.java.BooleanLiteral) message.input.getCREATE__SRC__mValue();
	...
	private void rightAdded(NodeAddedRight<org.eclipse.modisco.java.BooleanLiteral> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.eclipse.modisco.java.BooleanLiteral> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueBooleanArray__Marker, org.eclipse.modisco.java.BooleanLiteral> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueBooleanArray__Marker, org.eclipse.modisco.java.BooleanLiteral> message) {
