...
public class MethodParameterLink__Marker_CONTEXT__TRG__tPrevParameter_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TParameter, Set<ModiscoTGG.MethodParameterLink__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodParameterLink__Marker_CONTEXT__TRG__tPrevParameter_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodParameterLink__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodParameterLink__Marker source, org.gravity.typegraph.basic.TParameter target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MethodParameterLink__Marker> message) {
		...
		org.gravity.typegraph.basic.TParameter target = (org.gravity.typegraph.basic.TParameter) message.input.getCONTEXT__TRG__tPrevParameter();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodParameterLink__Marker, org.gravity.typegraph.basic.TParameter> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodParameterLink__Marker, org.gravity.typegraph.basic.TParameter> message) {
