...
public class TypeGraph_classes_9_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("PrimitiveTypeIsShort__CC_4484_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PrimitiveTypeIsShort__CONSISTENCY_4498_junction"), this::returnTrue));
	}	
