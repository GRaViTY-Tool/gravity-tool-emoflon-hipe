...
public class AnnotationMemberValueString__Marker_CREATE__SRC__mValue_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.StringLiteral, Set<ModiscoTGG.AnnotationMemberValueString__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueString__Marker_CREATE__SRC__mValue_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationMemberValueString__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueString__Marker source, org.eclipse.modisco.java.StringLiteral target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueString__Marker, org.eclipse.modisco.java.StringLiteral> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueString__Marker, org.eclipse.modisco.java.StringLiteral> message) {
