...
public class PrimitiveTypeIsInt__Marker_CREATE__CORR__ePrimitiveTypeToTPrimitiveClass_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.PrimitiveTypeToTClass, Set<ModiscoTGG.PrimitiveTypeIsInt__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public PrimitiveTypeIsInt__Marker_CREATE__CORR__ePrimitiveTypeToTPrimitiveClass_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("PrimitiveTypeIsInt__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.PrimitiveTypeIsInt__Marker source, ModiscoTGG.PrimitiveTypeToTClass target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.PrimitiveTypeIsInt__Marker, ModiscoTGG.PrimitiveTypeToTClass> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.PrimitiveTypeIsInt__Marker, ModiscoTGG.PrimitiveTypeToTClass> message) {
