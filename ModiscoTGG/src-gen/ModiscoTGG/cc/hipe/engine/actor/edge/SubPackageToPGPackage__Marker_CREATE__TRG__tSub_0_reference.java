...
public class SubPackageToPGPackage__Marker_CREATE__TRG__tSub_0_reference extends AbstractActor {
	...
	public SubPackageToPGPackage__Marker_CREATE__TRG__tSub_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("SubPackageToPGPackage__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.SubPackageToPGPackage__Marker> message) {
		...
		org.gravity.typegraph.basic.TPackage target = (org.gravity.typegraph.basic.TPackage) message.input.getCREATE__TRG__tSub();
