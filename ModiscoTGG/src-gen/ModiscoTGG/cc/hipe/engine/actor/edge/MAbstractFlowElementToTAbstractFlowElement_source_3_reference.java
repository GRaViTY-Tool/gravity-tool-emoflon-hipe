...
public class MAbstractFlowElementToTAbstractFlowElement_source_3_reference extends AbstractActor {
	...
	public MAbstractFlowElementToTAbstractFlowElement_source_3_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessReadWrite__CONSISTENCY_triangle_11_triangleJunction"), this::returnTrue));
	}	
