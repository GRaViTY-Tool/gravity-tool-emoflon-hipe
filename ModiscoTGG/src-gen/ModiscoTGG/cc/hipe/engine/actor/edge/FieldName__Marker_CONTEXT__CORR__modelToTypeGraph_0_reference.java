...
public class FieldName__Marker_CONTEXT__CORR__modelToTypeGraph_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.ModelToTypeGraph, Set<ModiscoTGG.FieldName__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public FieldName__Marker_CONTEXT__CORR__modelToTypeGraph_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("FieldName__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.FieldName__Marker source, ModiscoTGG.ModelToTypeGraph target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.FieldName__Marker> message) {
		...
		ModiscoTGG.ModelToTypeGraph target = (ModiscoTGG.ModelToTypeGraph) message.input.getCONTEXT__CORR__modelToTypeGraph();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.FieldName__Marker, ModiscoTGG.ModelToTypeGraph> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.FieldName__Marker, ModiscoTGG.ModelToTypeGraph> message) {
