...
public class AnnotationTypeInAnonymous__Marker_CREATE__CORR__mbodyToTAnnotatable_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.ASTNodeToTAnnotatable, Set<ModiscoTGG.AnnotationTypeInAnonymous__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationTypeInAnonymous__Marker_CREATE__CORR__mbodyToTAnnotatable_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("AnnotationTypeInAnonymous__CONSISTENCY_688_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationTypeInAnonymous__Marker source, ModiscoTGG.ASTNodeToTAnnotatable target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationTypeInAnonymous__Marker> message) {
		...
		ModiscoTGG.ASTNodeToTAnnotatable target = (ModiscoTGG.ASTNodeToTAnnotatable) message.input.getCREATE__CORR__mbodyToTAnnotatable();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationTypeInAnonymous__Marker, ModiscoTGG.ASTNodeToTAnnotatable> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationTypeInAnonymous__Marker, ModiscoTGG.ASTNodeToTAnnotatable> message) {
