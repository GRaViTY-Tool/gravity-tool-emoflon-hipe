...
public class ConstructorInvocation__Marker_CREATE__SRC__invocation_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MAbstractMethodInvocation, Set<ModiscoTGG.ConstructorInvocation__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ConstructorInvocation__Marker_CREATE__SRC__invocation_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ConstructorInvocation__CONSISTENCY_triangle_8_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ConstructorInvocation__Marker source, org.gravity.modisco.MAbstractMethodInvocation target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ConstructorInvocation__Marker, org.gravity.modisco.MAbstractMethodInvocation> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ConstructorInvocation__Marker, org.gravity.modisco.MAbstractMethodInvocation> message) {
