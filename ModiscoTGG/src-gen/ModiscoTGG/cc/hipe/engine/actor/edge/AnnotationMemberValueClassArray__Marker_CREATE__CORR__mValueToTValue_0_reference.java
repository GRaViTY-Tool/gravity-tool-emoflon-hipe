...
public class AnnotationMemberValueClassArray__Marker_CREATE__CORR__mValueToTValue_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.ClassLiteralToClassNode, Set<ModiscoTGG.AnnotationMemberValueClassArray__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueClassArray__Marker_CREATE__CORR__mValueToTValue_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationMemberValueClassArray__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueClassArray__Marker source, ModiscoTGG.ClassLiteralToClassNode target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueClassArray__Marker, ModiscoTGG.ClassLiteralToClassNode> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueClassArray__Marker, ModiscoTGG.ClassLiteralToClassNode> message) {
