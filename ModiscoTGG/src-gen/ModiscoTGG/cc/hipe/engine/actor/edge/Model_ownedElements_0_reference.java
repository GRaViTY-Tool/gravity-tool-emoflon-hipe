...
public class Model_ownedElements_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PackageToPGPackage__CC_4005_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PackageToPGPackage__CONSISTENCY_4019_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("SubPackageToPGPackage__CC_5507_nacjunction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("SubPackageToPGPackage__CONSISTENCY_5509_nacjunction"), this::returnTrue));
