...
public class ConstructorDefinition__Marker_CREATE__CORR__mBodyToTAnnotation_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.ASTNodeToTAnnotatable, Set<ModiscoTGG.ConstructorDefinition__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ConstructorDefinition__Marker_CREATE__CORR__mBodyToTAnnotation_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ConstructorDefinition__CONSISTENCY_triangle_8_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ConstructorDefinition__Marker source, ModiscoTGG.ASTNodeToTAnnotatable target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ConstructorDefinition__Marker> message) {
		...
		ModiscoTGG.ASTNodeToTAnnotatable target = (ModiscoTGG.ASTNodeToTAnnotatable) message.input.getCREATE__CORR__mBodyToTAnnotation();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ConstructorDefinition__Marker, ModiscoTGG.ASTNodeToTAnnotatable> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ConstructorDefinition__Marker, ModiscoTGG.ASTNodeToTAnnotatable> message) {
