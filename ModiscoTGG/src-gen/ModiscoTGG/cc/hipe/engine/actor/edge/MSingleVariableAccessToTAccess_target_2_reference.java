...
public class MSingleVariableAccessToTAccess_target_2_reference extends AbstractActor {
	...
	public MSingleVariableAccessToTAccess_target_2_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessWrite__CONSISTENCY_triangle_12_triangleJunction"), this::returnTrue));
	}	
