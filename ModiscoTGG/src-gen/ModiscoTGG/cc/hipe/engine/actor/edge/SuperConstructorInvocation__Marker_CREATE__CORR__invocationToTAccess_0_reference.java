...
public class SuperConstructorInvocation__Marker_CREATE__CORR__invocationToTAccess_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.AbstractMethodInvocationToTAccess, Set<ModiscoTGG.SuperConstructorInvocation__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public SuperConstructorInvocation__Marker_CREATE__CORR__invocationToTAccess_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("SuperConstructorInvocation__CONSISTENCY_triangle_8_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.SuperConstructorInvocation__Marker source, ModiscoTGG.AbstractMethodInvocationToTAccess target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.SuperConstructorInvocation__Marker> message) {
		...
		ModiscoTGG.AbstractMethodInvocationToTAccess target = (ModiscoTGG.AbstractMethodInvocationToTAccess) message.input.getCREATE__CORR__invocationToTAccess();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.SuperConstructorInvocation__Marker, ModiscoTGG.AbstractMethodInvocationToTAccess> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.SuperConstructorInvocation__Marker, ModiscoTGG.AbstractMethodInvocationToTAccess> message) {
