...
public class AnnotationTypeNested__Marker_CONTEXT__SRC__eOuterType_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.AbstractTypeDeclaration, Set<ModiscoTGG.AnnotationTypeNested__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationTypeNested__Marker_CONTEXT__SRC__eOuterType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationTypeNested__CONSISTENCY_triangle_9_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationTypeNested__Marker source, org.eclipse.modisco.java.AbstractTypeDeclaration target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationTypeNested__Marker, org.eclipse.modisco.java.AbstractTypeDeclaration> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationTypeNested__Marker, org.eclipse.modisco.java.AbstractTypeDeclaration> message) {
