...
public class AnnotationMemberValueBooleanArray__Marker_CREATE__TRG__tValue_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.annotations.TBoolNode, Set<EdgeMatch>> targetElements = new HashMap<org.gravity.typegraph.basic.annotations.TBoolNode, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.gravity.typegraph.basic.annotations.TBoolNode, Set<ModiscoTGG.AnnotationMemberValueBooleanArray__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueBooleanArray__Marker_CREATE__TRG__tValue_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationMemberValueBooleanArray__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueBooleanArray__Marker source, org.gravity.typegraph.basic.annotations.TBoolNode target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.gravity.typegraph.basic.annotations.TBoolNode) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationMemberValueBooleanArray__Marker> message) {
		...
		org.gravity.typegraph.basic.annotations.TBoolNode target = (org.gravity.typegraph.basic.annotations.TBoolNode) message.input.getCREATE__TRG__tValue();
	...
	private void rightAdded(NodeAddedRight<org.gravity.typegraph.basic.annotations.TBoolNode> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.gravity.typegraph.basic.annotations.TBoolNode> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueBooleanArray__Marker, org.gravity.typegraph.basic.annotations.TBoolNode> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueBooleanArray__Marker, org.gravity.typegraph.basic.annotations.TBoolNode> message) {
