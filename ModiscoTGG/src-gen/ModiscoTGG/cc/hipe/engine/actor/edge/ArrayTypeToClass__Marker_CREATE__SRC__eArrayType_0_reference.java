...
public class ArrayTypeToClass__Marker_CREATE__SRC__eArrayType_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.ArrayType, Set<EdgeMatch>> targetElements = new HashMap<org.eclipse.modisco.java.ArrayType, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.eclipse.modisco.java.ArrayType, Set<ModiscoTGG.ArrayTypeToClass__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ArrayTypeToClass__Marker_CREATE__SRC__eArrayType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ArrayTypeToClass__CONSISTENCY_triangle_7_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ArrayTypeToClass__Marker source, org.eclipse.modisco.java.ArrayType target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.eclipse.modisco.java.ArrayType) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ArrayTypeToClass__Marker> message) {
		...
		org.eclipse.modisco.java.ArrayType target = (org.eclipse.modisco.java.ArrayType) message.input.getCREATE__SRC__eArrayType();
	...
	private void rightAdded(NodeAddedRight<org.eclipse.modisco.java.ArrayType> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.eclipse.modisco.java.ArrayType> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ArrayTypeToClass__Marker, org.eclipse.modisco.java.ArrayType> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ArrayTypeToClass__Marker, org.eclipse.modisco.java.ArrayType> message) {
