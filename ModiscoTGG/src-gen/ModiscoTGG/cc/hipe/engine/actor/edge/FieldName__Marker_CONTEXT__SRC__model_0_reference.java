...
public class FieldName__Marker_CONTEXT__SRC__model_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MGravityModel, Set<ModiscoTGG.FieldName__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public FieldName__Marker_CONTEXT__SRC__model_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("FieldName__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.FieldName__Marker source, org.gravity.modisco.MGravityModel target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.FieldName__Marker> message) {
		...
		org.gravity.modisco.MGravityModel target = (org.gravity.modisco.MGravityModel) message.input.getCONTEXT__SRC__model();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.FieldName__Marker, org.gravity.modisco.MGravityModel> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.FieldName__Marker, org.gravity.modisco.MGravityModel> message) {
