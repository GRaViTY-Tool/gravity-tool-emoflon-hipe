...
public class TypeToTAbstractType_source_9_reference extends AbstractActor {
	...
	public TypeToTAbstractType_source_9_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PrimitiveTypeIsBoolean__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
