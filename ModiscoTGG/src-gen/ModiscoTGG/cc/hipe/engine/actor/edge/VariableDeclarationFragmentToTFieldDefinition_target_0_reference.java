...
public class VariableDeclarationFragmentToTFieldDefinition_target_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TFieldDefinition, Set<EdgeMatch>> targetElements = new HashMap<org.gravity.typegraph.basic.TFieldDefinition, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.gravity.typegraph.basic.TFieldDefinition, Set<ModiscoTGG.VariableDeclarationFragmentToTFieldDefinition>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public VariableDeclarationFragmentToTFieldDefinition_target_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("VariableDeclarationFragment__CONSISTENCY_triangle_0_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.VariableDeclarationFragmentToTFieldDefinition source, org.gravity.typegraph.basic.TFieldDefinition target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.gravity.typegraph.basic.TFieldDefinition) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.VariableDeclarationFragmentToTFieldDefinition> message) {
		...
		org.gravity.typegraph.basic.TFieldDefinition target = (org.gravity.typegraph.basic.TFieldDefinition) message.input.getTarget();
	...
	private void rightAdded(NodeAddedRight<org.gravity.typegraph.basic.TFieldDefinition> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.gravity.typegraph.basic.TFieldDefinition> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.VariableDeclarationFragmentToTFieldDefinition, org.gravity.typegraph.basic.TFieldDefinition> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.VariableDeclarationFragmentToTFieldDefinition, org.gravity.typegraph.basic.TFieldDefinition> message) {
