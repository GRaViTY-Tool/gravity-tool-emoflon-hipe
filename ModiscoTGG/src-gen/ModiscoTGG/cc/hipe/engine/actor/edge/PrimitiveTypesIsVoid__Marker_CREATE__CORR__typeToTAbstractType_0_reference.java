...
public class PrimitiveTypesIsVoid__Marker_CREATE__CORR__typeToTAbstractType_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.TypeToTAbstractType, Set<ModiscoTGG.PrimitiveTypesIsVoid__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public PrimitiveTypesIsVoid__Marker_CREATE__CORR__typeToTAbstractType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("PrimitiveTypesIsVoid__CONSISTENCY_4549_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.PrimitiveTypesIsVoid__Marker source, ModiscoTGG.TypeToTAbstractType target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.PrimitiveTypesIsVoid__Marker, ModiscoTGG.TypeToTAbstractType> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.PrimitiveTypesIsVoid__Marker, ModiscoTGG.TypeToTAbstractType> message) {
