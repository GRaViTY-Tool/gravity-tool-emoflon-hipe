...
public class AnnotationMemberValueStringArray__Marker_CREATE__CORR__mTypeToTType_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.StringLiteralToTTextNode, Set<EdgeMatch>> targetElements = new HashMap<ModiscoTGG.StringLiteralToTTextNode, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<ModiscoTGG.StringLiteralToTTextNode, Set<ModiscoTGG.AnnotationMemberValueStringArray__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueStringArray__Marker_CREATE__CORR__mTypeToTType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnnotationMemberValueStringArray__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueStringArray__Marker source, ModiscoTGG.StringLiteralToTTextNode target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((ModiscoTGG.StringLiteralToTTextNode) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationMemberValueStringArray__Marker> message) {
		...
		ModiscoTGG.StringLiteralToTTextNode target = (ModiscoTGG.StringLiteralToTTextNode) message.input.getCREATE__CORR__mTypeToTType();
	...
	private void rightAdded(NodeAddedRight<ModiscoTGG.StringLiteralToTTextNode> message) {
	...
	private void rightRemoved(NodeDeletedRight<ModiscoTGG.StringLiteralToTTextNode> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueStringArray__Marker, ModiscoTGG.StringLiteralToTTextNode> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueStringArray__Marker, ModiscoTGG.StringLiteralToTTextNode> message) {
