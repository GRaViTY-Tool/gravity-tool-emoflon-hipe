...
public class SuperMethodInvocation__Marker_CONTEXT__CORR__mMethodToTMethod_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.MDefinitionToTMember, Set<ModiscoTGG.SuperMethodInvocation__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public SuperMethodInvocation__Marker_CONTEXT__CORR__mMethodToTMethod_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("SuperMethodInvocation__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.SuperMethodInvocation__Marker source, ModiscoTGG.MDefinitionToTMember target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.SuperMethodInvocation__Marker, ModiscoTGG.MDefinitionToTMember> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.SuperMethodInvocation__Marker, ModiscoTGG.MDefinitionToTMember> message) {
