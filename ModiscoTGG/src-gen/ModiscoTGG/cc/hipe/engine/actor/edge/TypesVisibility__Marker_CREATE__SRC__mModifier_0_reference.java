...
public class TypesVisibility__Marker_CREATE__SRC__mModifier_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.Modifier, Set<ModiscoTGG.TypesVisibility__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public TypesVisibility__Marker_CREATE__SRC__mModifier_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("TypesVisibility__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.TypesVisibility__Marker source, org.eclipse.modisco.java.Modifier target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.TypesVisibility__Marker, org.eclipse.modisco.java.Modifier> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.TypesVisibility__Marker, org.eclipse.modisco.java.Modifier> message) {
