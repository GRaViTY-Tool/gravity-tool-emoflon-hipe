...
public class NestedClassInType__Marker_CREATE__CORR__mNestedClassDeclarationToTNestedClass_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.ClassDeclarationToTClass, Set<ModiscoTGG.NestedClassInType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public NestedClassInType__Marker_CREATE__CORR__mNestedClassDeclarationToTNestedClass_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("NestedClassInType__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.NestedClassInType__Marker source, ModiscoTGG.ClassDeclarationToTClass target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.NestedClassInType__Marker> message) {
		...
		ModiscoTGG.ClassDeclarationToTClass target = (ModiscoTGG.ClassDeclarationToTClass) message.input.getCREATE__CORR__mNestedClassDeclarationToTNestedClass();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.NestedClassInType__Marker, ModiscoTGG.ClassDeclarationToTClass> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.NestedClassInType__Marker, ModiscoTGG.ClassDeclarationToTClass> message) {
