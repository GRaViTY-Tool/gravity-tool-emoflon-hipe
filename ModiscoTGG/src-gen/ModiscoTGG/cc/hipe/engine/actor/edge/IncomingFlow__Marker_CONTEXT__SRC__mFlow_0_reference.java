...
public class IncomingFlow__Marker_CONTEXT__SRC__mFlow_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MFlow, Set<ModiscoTGG.IncomingFlow__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public IncomingFlow__Marker_CONTEXT__SRC__mFlow_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("IncomingFlow__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.IncomingFlow__Marker source, org.gravity.modisco.MFlow target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.IncomingFlow__Marker> message) {
		...
		org.gravity.modisco.MFlow target = (org.gravity.modisco.MFlow) message.input.getCONTEXT__SRC__mFlow();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.IncomingFlow__Marker, org.gravity.modisco.MFlow> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.IncomingFlow__Marker, org.gravity.modisco.MFlow> message) {
