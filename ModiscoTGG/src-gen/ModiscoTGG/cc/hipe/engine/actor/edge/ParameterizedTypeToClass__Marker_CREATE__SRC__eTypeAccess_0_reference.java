...
public class ParameterizedTypeToClass__Marker_CREATE__SRC__eTypeAccess_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.TypeAccess, Set<ModiscoTGG.ParameterizedTypeToClass__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ParameterizedTypeToClass__Marker_CREATE__SRC__eTypeAccess_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ParameterizedTypeToClass__CONSISTENCY_4073_junction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ParameterizedTypeToClass__Marker source, org.eclipse.modisco.java.TypeAccess target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ParameterizedTypeToClass__Marker, org.eclipse.modisco.java.TypeAccess> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ParameterizedTypeToClass__Marker, org.eclipse.modisco.java.TypeAccess> message) {
