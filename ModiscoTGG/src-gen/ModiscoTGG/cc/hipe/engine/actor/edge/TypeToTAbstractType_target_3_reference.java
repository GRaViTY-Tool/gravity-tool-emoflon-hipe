...
public class TypeToTAbstractType_target_3_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("AnonymousClassTypeInterface__CC_951_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("ClassImplementsInterface__CC_1253_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("InterfaceMember__CC_2671_junction"), this::returnTrue));
