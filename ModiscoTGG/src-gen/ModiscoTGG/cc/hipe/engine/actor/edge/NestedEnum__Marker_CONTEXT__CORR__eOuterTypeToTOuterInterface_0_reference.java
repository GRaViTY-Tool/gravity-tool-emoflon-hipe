...
public class NestedEnum__Marker_CONTEXT__CORR__eOuterTypeToTOuterInterface_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.TypeToTAbstractType, Set<ModiscoTGG.NestedEnum__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public NestedEnum__Marker_CONTEXT__CORR__eOuterTypeToTOuterInterface_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("NestedEnum__CONSISTENCY_triangle_9_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.NestedEnum__Marker source, ModiscoTGG.TypeToTAbstractType target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.NestedEnum__Marker, ModiscoTGG.TypeToTAbstractType> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.NestedEnum__Marker, ModiscoTGG.TypeToTAbstractType> message) {
