...
public class Flow__Marker_CONTEXT__TRG__tOwner_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TAbstractFlowElement, Set<ModiscoTGG.Flow__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public Flow__Marker_CONTEXT__TRG__tOwner_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("Flow__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.Flow__Marker source, org.gravity.typegraph.basic.TAbstractFlowElement target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.Flow__Marker> message) {
		...
		org.gravity.typegraph.basic.TAbstractFlowElement target = (org.gravity.typegraph.basic.TAbstractFlowElement) message.input.getCONTEXT__TRG__tOwner();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.Flow__Marker, org.gravity.typegraph.basic.TAbstractFlowElement> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.Flow__Marker, org.gravity.typegraph.basic.TAbstractFlowElement> message) {
