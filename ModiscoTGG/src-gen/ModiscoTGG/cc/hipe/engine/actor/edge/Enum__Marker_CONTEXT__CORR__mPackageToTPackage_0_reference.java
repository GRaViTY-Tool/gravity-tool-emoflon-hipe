...
public class Enum__Marker_CONTEXT__CORR__mPackageToTPackage_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.PackageToTPackage, Set<ModiscoTGG.Enum__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public Enum__Marker_CONTEXT__CORR__mPackageToTPackage_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("Enum__CONSISTENCY_triangle_6_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.Enum__Marker source, ModiscoTGG.PackageToTPackage target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.Enum__Marker, ModiscoTGG.PackageToTPackage> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.Enum__Marker, ModiscoTGG.PackageToTPackage> message) {
