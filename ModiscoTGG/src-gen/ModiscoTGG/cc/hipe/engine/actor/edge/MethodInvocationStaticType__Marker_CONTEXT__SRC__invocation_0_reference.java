...
public class MethodInvocationStaticType__Marker_CONTEXT__SRC__invocation_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MMethodInvocation, Set<EdgeMatch>> targetElements = new HashMap<org.gravity.modisco.MMethodInvocation, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.gravity.modisco.MMethodInvocation, Set<ModiscoTGG.MethodInvocationStaticType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodInvocationStaticType__Marker_CONTEXT__SRC__invocation_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("MethodInvocationStaticType__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodInvocationStaticType__Marker source, org.gravity.modisco.MMethodInvocation target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.gravity.modisco.MMethodInvocation) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.MethodInvocationStaticType__Marker> message) {
		...
		org.gravity.modisco.MMethodInvocation target = (org.gravity.modisco.MMethodInvocation) message.input.getCONTEXT__SRC__invocation();
	...
	private void rightAdded(NodeAddedRight<org.gravity.modisco.MMethodInvocation> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.gravity.modisco.MMethodInvocation> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodInvocationStaticType__Marker, org.gravity.modisco.MMethodInvocation> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodInvocationStaticType__Marker, org.gravity.modisco.MMethodInvocation> message) {
