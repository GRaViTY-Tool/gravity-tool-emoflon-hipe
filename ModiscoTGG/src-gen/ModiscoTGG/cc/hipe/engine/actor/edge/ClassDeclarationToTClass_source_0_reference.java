...
public class ClassDeclarationToTClass_source_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassExtendsClass__CC_1185_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassExtendsClass__CC_1186_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassImplementsInterface__CC_1252_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("SyntethicMethod__CC_4895_junction"), this::returnTrue));
