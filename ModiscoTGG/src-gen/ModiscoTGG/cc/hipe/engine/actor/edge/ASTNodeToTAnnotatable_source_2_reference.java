...
public class ASTNodeToTAnnotatable_source_2_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.ASTNode, Set<EdgeMatch>> targetElements = new HashMap<org.eclipse.modisco.java.ASTNode, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.eclipse.modisco.java.ASTNode, Set<ModiscoTGG.ASTNodeToTAnnotatable>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ASTNodeToTAnnotatable_source_2_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("ClassInAnonymous__CONSISTENCY_triangle_6_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("Class__CONSISTENCY_triangle_10_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("NestedClassInType__CONSISTENCY_triangle_11_triangleJunction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("TypesOrphaned__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ASTNodeToTAnnotatable source, org.eclipse.modisco.java.ASTNode target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.eclipse.modisco.java.ASTNode) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ASTNodeToTAnnotatable> message) {
		...
		org.eclipse.modisco.java.ASTNode target = (org.eclipse.modisco.java.ASTNode) message.input.getSource();
	...
	private void rightAdded(NodeAddedRight<org.eclipse.modisco.java.ASTNode> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.eclipse.modisco.java.ASTNode> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ASTNodeToTAnnotatable, org.eclipse.modisco.java.ASTNode> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ASTNodeToTAnnotatable, org.eclipse.modisco.java.ASTNode> message) {
