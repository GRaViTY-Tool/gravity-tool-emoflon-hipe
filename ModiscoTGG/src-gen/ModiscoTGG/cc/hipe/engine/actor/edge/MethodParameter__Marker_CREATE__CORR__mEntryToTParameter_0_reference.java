...
public class MethodParameter__Marker_CREATE__CORR__mEntryToTParameter_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.MEntryToTParameter, Set<ModiscoTGG.MethodParameter__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MethodParameter__Marker_CREATE__CORR__mEntryToTParameter_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodParameter__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.MethodParameter__Marker source, ModiscoTGG.MEntryToTParameter target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.MethodParameter__Marker, ModiscoTGG.MEntryToTParameter> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.MethodParameter__Marker, ModiscoTGG.MEntryToTParameter> message) {
