...
public class SignatureReturnType__Marker_CONTEXT__CORR__mSignatureToTSignature_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.MSignatureToTSignature, Set<ModiscoTGG.SignatureReturnType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public SignatureReturnType__Marker_CONTEXT__CORR__mSignatureToTSignature_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("SignatureReturnType__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.SignatureReturnType__Marker source, ModiscoTGG.MSignatureToTSignature target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.SignatureReturnType__Marker, ModiscoTGG.MSignatureToTSignature> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.SignatureReturnType__Marker, ModiscoTGG.MSignatureToTSignature> message) {
