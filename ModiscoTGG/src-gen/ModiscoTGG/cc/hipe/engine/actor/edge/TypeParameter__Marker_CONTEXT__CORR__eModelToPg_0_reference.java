...
public class TypeParameter__Marker_CONTEXT__CORR__eModelToPg_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.ModelToTypeGraph, Set<ModiscoTGG.TypeParameter__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public TypeParameter__Marker_CONTEXT__CORR__eModelToPg_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("TypeParameter__CONSISTENCY_triangle_4_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.TypeParameter__Marker source, ModiscoTGG.ModelToTypeGraph target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.TypeParameter__Marker, ModiscoTGG.ModelToTypeGraph> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.TypeParameter__Marker, ModiscoTGG.ModelToTypeGraph> message) {
