...
public class FieldAccessReadWrite__Marker_CONTEXT__TRG__tField_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TFieldDefinition, Set<ModiscoTGG.FieldAccessReadWrite__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public FieldAccessReadWrite__Marker_CONTEXT__TRG__tField_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("FieldAccessReadWrite__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.FieldAccessReadWrite__Marker source, org.gravity.typegraph.basic.TFieldDefinition target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.FieldAccessReadWrite__Marker> message) {
		...
		org.gravity.typegraph.basic.TFieldDefinition target = (org.gravity.typegraph.basic.TFieldDefinition) message.input.getCONTEXT__TRG__tField();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.FieldAccessReadWrite__Marker, org.gravity.typegraph.basic.TFieldDefinition> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.FieldAccessReadWrite__Marker, org.gravity.typegraph.basic.TFieldDefinition> message) {
