...
public class AnonymousClassTypeClass__Marker_CONTEXT__TRG__tParent_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TClass, Set<ModiscoTGG.AnonymousClassTypeClass__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnonymousClassTypeClass__Marker_CONTEXT__TRG__tParent_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnonymousClassTypeClass__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnonymousClassTypeClass__Marker source, org.gravity.typegraph.basic.TClass target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnonymousClassTypeClass__Marker> message) {
		...
		org.gravity.typegraph.basic.TClass target = (org.gravity.typegraph.basic.TClass) message.input.getCONTEXT__TRG__tParent();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnonymousClassTypeClass__Marker, org.gravity.typegraph.basic.TClass> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnonymousClassTypeClass__Marker, org.gravity.typegraph.basic.TClass> message) {
