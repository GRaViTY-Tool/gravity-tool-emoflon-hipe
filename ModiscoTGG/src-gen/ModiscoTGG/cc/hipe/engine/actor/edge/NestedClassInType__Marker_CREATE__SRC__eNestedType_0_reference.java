...
public class NestedClassInType__Marker_CREATE__SRC__eNestedType_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MClass, Set<ModiscoTGG.NestedClassInType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public NestedClassInType__Marker_CREATE__SRC__eNestedType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("NestedClassInType__CONSISTENCY_triangle_13_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.NestedClassInType__Marker source, org.gravity.modisco.MClass target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.NestedClassInType__Marker> message) {
		...
		org.gravity.modisco.MClass target = (org.gravity.modisco.MClass) message.input.getCREATE__SRC__eNestedType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.NestedClassInType__Marker, org.gravity.modisco.MClass> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.NestedClassInType__Marker, org.gravity.modisco.MClass> message) {
