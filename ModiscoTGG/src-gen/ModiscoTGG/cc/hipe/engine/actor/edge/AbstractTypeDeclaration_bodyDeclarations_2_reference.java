...
public class AbstractTypeDeclaration_bodyDeclarations_2_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessReadWrite__CC_1982_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessRead__CC_2087_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldAccessWrite__CC_2192_junction"), this::returnTrue));
