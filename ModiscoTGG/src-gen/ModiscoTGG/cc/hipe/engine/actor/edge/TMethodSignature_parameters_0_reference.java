...
public class TMethodSignature_parameters_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodParameterType__CC_3508_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodParameter__CC_3569_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodParameter__CONSISTENCY_3583_junction"), this::returnTrue));
	}	
