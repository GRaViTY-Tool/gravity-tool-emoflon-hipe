...
public class TCall_tSource_4_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodInvocationRecursive__CC_3179_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("MethodInvocationRecursive__CONSISTENCY_3195_junction"), this::returnTrue));
	}	
