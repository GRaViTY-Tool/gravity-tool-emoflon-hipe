...
public class LinkDefinitionToType__Marker_CONTEXT__TRG__tDefinition_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TMember, Set<ModiscoTGG.LinkDefinitionToType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public LinkDefinitionToType__Marker_CONTEXT__TRG__tDefinition_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("LinkDefinitionToType__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.LinkDefinitionToType__Marker source, org.gravity.typegraph.basic.TMember target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.LinkDefinitionToType__Marker> message) {
		...
		org.gravity.typegraph.basic.TMember target = (org.gravity.typegraph.basic.TMember) message.input.getCONTEXT__TRG__tDefinition();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.LinkDefinitionToType__Marker, org.gravity.typegraph.basic.TMember> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.LinkDefinitionToType__Marker, org.gravity.typegraph.basic.TMember> message) {
