...
public class FieldName__Marker_CREATE__TRG__tField_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TField, Set<ModiscoTGG.FieldName__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public FieldName__Marker_CREATE__TRG__tField_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("FieldName__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.FieldName__Marker source, org.gravity.typegraph.basic.TField target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.FieldName__Marker> message) {
		...
		org.gravity.typegraph.basic.TField target = (org.gravity.typegraph.basic.TField) message.input.getCREATE__TRG__tField();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.FieldName__Marker, org.gravity.typegraph.basic.TField> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.FieldName__Marker, org.gravity.typegraph.basic.TField> message) {
