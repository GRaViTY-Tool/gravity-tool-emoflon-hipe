...
public class ClassInstanceCreation__Marker_CONTEXT__TRG__tMethod_0_reference extends AbstractActor {
	...
	public ClassInstanceCreation__Marker_CONTEXT__TRG__tMethod_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ClassInstanceCreation__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
