...
public class AnnotationType__Marker_CONTEXT__SRC__mPackage_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.Package, Set<ModiscoTGG.AnnotationType__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationType__Marker_CONTEXT__SRC__mPackage_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationType__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationType__Marker source, org.eclipse.modisco.java.Package target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationType__Marker> message) {
		...
		org.eclipse.modisco.java.Package target = (org.eclipse.modisco.java.Package) message.input.getCONTEXT__SRC__mPackage();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationType__Marker, org.eclipse.modisco.java.Package> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationType__Marker, org.eclipse.modisco.java.Package> message) {
