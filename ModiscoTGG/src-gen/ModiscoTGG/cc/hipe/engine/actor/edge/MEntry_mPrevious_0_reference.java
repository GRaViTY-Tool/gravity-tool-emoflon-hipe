...
public class MEntry_mPrevious_0_reference extends AbstractActor {
	...
	private Map<org.gravity.modisco.MEntry, Set<org.gravity.modisco.MEntry>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public MEntry_mPrevious_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodParameterLink__CC_3461_junction"), this::check_constraint_186));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("MethodParameterLink__CONSISTENCY_triangle_0_triangleJunction"), this::check_constraint_189));
	}	
	...
	private void addMatch(InputMessage message, org.gravity.modisco.MEntry source, org.gravity.modisco.MEntry target) {
	...
	private void leftAdded(NodeAddedLeft<org.gravity.modisco.MEntry> message) {
		...
		org.gravity.modisco.MEntry target = (org.gravity.modisco.MEntry) message.input.getMPrevious();
	...
	private void addReference(ReferenceAdded<org.gravity.modisco.MEntry, org.gravity.modisco.MEntry> message) {
	...
	private void removeReference(ReferenceDeleted<org.gravity.modisco.MEntry, org.gravity.modisco.MEntry> message) {
	...
	public boolean check_constraint_186(EdgeMatch edge) {
	...
	public boolean check_constraint_189(EdgeMatch edge) {
		org.gravity.modisco.MEntry mEntry = (org.gravity.modisco.MEntry) edge.source();
		org.gravity.modisco.MEntry mPrevEntry = (org.gravity.modisco.MEntry) edge.target();
		boolean predicate = !mEntry.equals(mPrevEntry);
		edge.setConstraintSatisfied(predicate);
