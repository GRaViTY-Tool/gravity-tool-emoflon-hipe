...
public class TypeToTAbstractType_target_7_reference extends AbstractActor {
	...
	public TypeToTAbstractType_target_7_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("PrimitiveTypeIsDouble__CONSISTENCY_triangle_2_triangleJunction"), this::returnTrue));
	}	
