...
public class AnnotationMemberValueAnnotationArray__Marker_CREATE__SRC__mValue_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.Annotation, Set<ModiscoTGG.AnnotationMemberValueAnnotationArray__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueAnnotationArray__Marker_CREATE__SRC__mValue_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationMemberValueAnnotationArray__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueAnnotationArray__Marker source, org.eclipse.modisco.java.Annotation target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationMemberValueAnnotationArray__Marker> message) {
		...
		org.eclipse.modisco.java.Annotation target = (org.eclipse.modisco.java.Annotation) message.input.getCREATE__SRC__mValue();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueAnnotationArray__Marker, org.eclipse.modisco.java.Annotation> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueAnnotationArray__Marker, org.eclipse.modisco.java.Annotation> message) {
