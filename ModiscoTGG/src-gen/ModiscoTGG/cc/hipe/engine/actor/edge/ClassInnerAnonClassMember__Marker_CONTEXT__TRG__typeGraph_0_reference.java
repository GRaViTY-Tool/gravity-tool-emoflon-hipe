...
public class ClassInnerAnonClassMember__Marker_CONTEXT__TRG__typeGraph_0_reference extends AbstractActor {
	...
	private Map<org.gravity.typegraph.basic.TypeGraph, Set<ModiscoTGG.ClassInnerAnonClassMember__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public ClassInnerAnonClassMember__Marker_CONTEXT__TRG__typeGraph_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("ClassInnerAnonClassMember__CONSISTENCY_triangle_1_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.ClassInnerAnonClassMember__Marker source, org.gravity.typegraph.basic.TypeGraph target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.ClassInnerAnonClassMember__Marker> message) {
		...
		org.gravity.typegraph.basic.TypeGraph target = (org.gravity.typegraph.basic.TypeGraph) message.input.getCONTEXT__TRG__typeGraph();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.ClassInnerAnonClassMember__Marker, org.gravity.typegraph.basic.TypeGraph> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.ClassInnerAnonClassMember__Marker, org.gravity.typegraph.basic.TypeGraph> message) {
