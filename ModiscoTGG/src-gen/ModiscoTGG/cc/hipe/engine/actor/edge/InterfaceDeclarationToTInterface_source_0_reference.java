...
public class InterfaceDeclarationToTInterface_source_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("InterfaceExtendsInterface__CC_2538_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("InterfaceExtendsInterface__CC_2539_junction"), this::returnTrue));
