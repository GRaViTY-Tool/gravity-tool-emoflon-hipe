...
public class FieldAccessWrite__Marker_CREATE__CORR__mAccessToTAccess_0_reference extends AbstractActor {
	...
	private Map<ModiscoTGG.MSingleVariableAccessToTAccess, Set<ModiscoTGG.FieldAccessWrite__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public FieldAccessWrite__Marker_CREATE__CORR__mAccessToTAccess_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("FieldAccessWrite__CONSISTENCY_triangle_13_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.FieldAccessWrite__Marker source, ModiscoTGG.MSingleVariableAccessToTAccess target) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.FieldAccessWrite__Marker, ModiscoTGG.MSingleVariableAccessToTAccess> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.FieldAccessWrite__Marker, ModiscoTGG.MSingleVariableAccessToTAccess> message) {
