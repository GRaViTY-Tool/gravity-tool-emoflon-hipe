...
public class AnnotationMemberValueStringArray__Marker_CREATE__SRC__mValue_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.StringLiteral, Set<EdgeMatch>> targetElements = new HashMap<org.eclipse.modisco.java.StringLiteral, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<org.eclipse.modisco.java.StringLiteral, Set<ModiscoTGG.AnnotationMemberValueStringArray__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public AnnotationMemberValueStringArray__Marker_CREATE__SRC__mValue_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("AnnotationMemberValueStringArray__CONSISTENCY_triangle_3_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.AnnotationMemberValueStringArray__Marker source, org.eclipse.modisco.java.StringLiteral target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((org.eclipse.modisco.java.StringLiteral) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.AnnotationMemberValueStringArray__Marker> message) {
		...
		org.eclipse.modisco.java.StringLiteral target = (org.eclipse.modisco.java.StringLiteral) message.input.getCREATE__SRC__mValue();
	...
	private void rightAdded(NodeAddedRight<org.eclipse.modisco.java.StringLiteral> message) {
	...
	private void rightRemoved(NodeDeletedRight<org.eclipse.modisco.java.StringLiteral> message) {
	...
	private void addReference(ReferenceAdded<ModiscoTGG.AnnotationMemberValueStringArray__Marker, org.eclipse.modisco.java.StringLiteral> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.AnnotationMemberValueStringArray__Marker, org.eclipse.modisco.java.StringLiteral> message) {
