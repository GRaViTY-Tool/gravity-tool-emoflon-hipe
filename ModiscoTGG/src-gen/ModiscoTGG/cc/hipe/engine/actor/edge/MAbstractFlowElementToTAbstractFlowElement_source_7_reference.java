...
public class MAbstractFlowElementToTAbstractFlowElement_source_7_reference extends AbstractActor {
	...
	public MAbstractFlowElementToTAbstractFlowElement_source_7_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("FieldSignature__CONSISTENCY_triangle_5_triangleJunction"), this::returnTrue));
	}	
