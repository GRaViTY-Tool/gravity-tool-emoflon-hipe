...
public class NestedEnum__Marker_CREATE__SRC__eNestedType_0_reference extends AbstractActor {
	...
	private Map<org.eclipse.modisco.java.EnumDeclaration, Set<ModiscoTGG.NestedEnum__Marker>> pending = new HashMap<>();

	private int finishedNodes = 0;
	
	public NestedEnum__Marker_CREATE__SRC__eNestedType_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdge(getSelf(), name2actor.get("NestedEnum__CONSISTENCY_triangle_13_triangleJunction"), this::returnTrue));
	}	
	...
	private void addMatch(InputMessage message, ModiscoTGG.NestedEnum__Marker source, org.eclipse.modisco.java.EnumDeclaration target) {
	...
	private void leftAdded(NodeAddedLeft<ModiscoTGG.NestedEnum__Marker> message) {
		...
		org.eclipse.modisco.java.EnumDeclaration target = (org.eclipse.modisco.java.EnumDeclaration) message.input.getCREATE__SRC__eNestedType();
	...
	private void addReference(ReferenceAdded<ModiscoTGG.NestedEnum__Marker, org.eclipse.modisco.java.EnumDeclaration> message) {
	...
	private void removeReference(ReferenceDeleted<ModiscoTGG.NestedEnum__Marker, org.eclipse.modisco.java.EnumDeclaration> message) {
