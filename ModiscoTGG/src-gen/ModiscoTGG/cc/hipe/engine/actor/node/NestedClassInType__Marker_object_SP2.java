...
public class NestedClassInType__Marker_object_SP2 extends AbstractActor {
	
	private List<Port<ModiscoTGG.NestedClassInType__Marker>> ports;		
		
	public NestedClassInType__Marker_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.NestedClassInType__Marker>(getSelf(), name2actor.get("NestedClassInType__Marker_CONTEXT__TRG__tOuterType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.NestedClassInType__Marker>(getSelf(), name2actor.get("NestedClassInType__Marker_CREATE__CORR__mBodyToTAnnotation_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.NestedClassInType__Marker>(getSelf(), name2actor.get("NestedClassInType__Marker_CREATE__TRG__tNestedType_0_reference"), this::returnTrue));
	}
