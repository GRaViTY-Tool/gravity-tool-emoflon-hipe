...
public class FieldAccessReadWrite__Marker_object_SP2 extends AbstractActor {
	
	private List<Port<ModiscoTGG.FieldAccessReadWrite__Marker>> ports;		
		
	public FieldAccessReadWrite__Marker_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.FieldAccessReadWrite__Marker>(getSelf(), name2actor.get("FieldAccessReadWrite__Marker_CONTEXT__CORR__mMethodToTMethod_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.FieldAccessReadWrite__Marker>(getSelf(), name2actor.get("FieldAccessReadWrite__Marker_CONTEXT__SRC__mType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.FieldAccessReadWrite__Marker>(getSelf(), name2actor.get("FieldAccessReadWrite__Marker_CONTEXT__SRC__varDeclFrag_0_reference"), this::returnTrue));
	}
