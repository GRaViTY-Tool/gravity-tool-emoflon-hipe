...
public class LinkDefinitionToAnonymous__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.LinkDefinitionToAnonymous__Marker>> ports;		
		
	public LinkDefinitionToAnonymous__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.LinkDefinitionToAnonymous__Marker>(getSelf(), name2actor.get("LinkDefinitionToAnonymous__Marker_CONTEXT__SRC__mDefinition_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.LinkDefinitionToAnonymous__Marker>(getSelf(), name2actor.get("LinkDefinitionToAnonymous__Marker_CONTEXT__SRC__mSignature_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.LinkDefinitionToAnonymous__Marker>(getSelf(), name2actor.get("LinkDefinitionToAnonymous__Marker_CONTEXT__SRC__mType_0_reference"), this::returnTrue));
	}
