...
public class TClass_object_SP8 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("PrimitiveTypeIsLong__Marker_CREATE__TRG__tPrimitiveClass_0_reference"), this::check_constraint_268));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("PrimitiveTypeToTClass_target_1_reference"), this::check_constraint_242));
