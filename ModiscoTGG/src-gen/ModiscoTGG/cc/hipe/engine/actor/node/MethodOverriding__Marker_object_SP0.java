...
public class MethodOverriding__Marker_object_SP0 extends AbstractActor {
	
	private List<Port<ModiscoTGG.MethodOverriding__Marker>> ports;		
		
	public MethodOverriding__Marker_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.MethodOverriding__Marker>(getSelf(), name2actor.get("MethodOverriding__Marker_CONTEXT__CORR__mMethodToTMethod_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MethodOverriding__Marker>(getSelf(), name2actor.get("MethodOverriding__Marker_CONTEXT__SRC__mOverriding_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MethodOverriding__Marker>(getSelf(), name2actor.get("MethodOverriding__Marker_CONTEXT__TRG__tMethod_0_reference"), this::returnTrue));
	}
