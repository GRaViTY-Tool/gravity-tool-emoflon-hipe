...
public class InterfaceMember__Marker_object_SP0 extends AbstractActor {
	
	private List<Port<ModiscoTGG.InterfaceMember__Marker>> ports;		
		
	public InterfaceMember__Marker_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.InterfaceMember__Marker>(getSelf(), name2actor.get("InterfaceMember__Marker_CONTEXT__TRG__tInterface_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.InterfaceMember__Marker>(getSelf(), name2actor.get("InterfaceMember__Marker_CONTEXT__TRG__tMember_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.InterfaceMember__Marker>(getSelf(), name2actor.get("InterfaceMember__Marker_CREATE__TRG__tModifier_0_reference"), this::returnTrue));
	}
