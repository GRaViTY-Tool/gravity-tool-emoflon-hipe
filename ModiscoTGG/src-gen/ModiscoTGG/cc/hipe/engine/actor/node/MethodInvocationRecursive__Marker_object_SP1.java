...
public class MethodInvocationRecursive__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.MethodInvocationRecursive__Marker>> ports;		
		
	public MethodInvocationRecursive__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.MethodInvocationRecursive__Marker>(getSelf(), name2actor.get("MethodInvocationRecursive__Marker_CONTEXT__CORR__mMemberToTMember_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MethodInvocationRecursive__Marker>(getSelf(), name2actor.get("MethodInvocationRecursive__Marker_CONTEXT__TRG__tMember_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MethodInvocationRecursive__Marker>(getSelf(), name2actor.get("MethodInvocationRecursive__Marker_CREATE__SRC__invocation_0_reference"), this::returnTrue));
	}
