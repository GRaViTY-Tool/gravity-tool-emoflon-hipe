...
public class Annotation_object_SP2 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.Annotation>> ports;		
		
	public Annotation_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Annotation>(getSelf(), name2actor.get("AnnotationMemberKey__Marker_CONTEXT__SRC__Annotation_0_reference"), this::returnTrue));
		...
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.Annotation>(getSelf(), name2actor.get("Annotation_type_0_reference"), this::returnTrue));
	}
