...
public class TypeAccess_object_SP0 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.TypeAccess>> ports;		
		
	public TypeAccess_object_SP0() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.eclipse.modisco.java.TypeAccess>(getSelf(), name2actor.get("AnonymousClassTypeInterface__Marker_CREATE__SRC__mType_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.TypeAccess>(getSelf(), name2actor.get("InterfaceDeclaration_usagesInTypeAccess_4_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.TypeAccess>(getSelf(), name2actor.get("Type_usagesInTypeAccess_0_reference"), this::returnTrue));
	}
