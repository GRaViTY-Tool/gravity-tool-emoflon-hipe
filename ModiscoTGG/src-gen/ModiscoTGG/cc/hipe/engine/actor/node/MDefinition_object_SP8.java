...
public class MDefinition_object_SP8 extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MDefinition>> ports;		
		
	public MDefinition_object_SP8() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.modisco.MDefinition>(getSelf(), name2actor.get("LinkDefinitionToAnonymous__Marker_CONTEXT__SRC__mDefinition_0_reference"), this::returnTrue));
