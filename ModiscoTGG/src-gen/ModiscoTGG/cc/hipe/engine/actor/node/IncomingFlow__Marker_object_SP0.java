...
public class IncomingFlow__Marker_object_SP0 extends AbstractActor {
	
	private List<Port<ModiscoTGG.IncomingFlow__Marker>> ports;		
		
	public IncomingFlow__Marker_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.IncomingFlow__Marker>(getSelf(), name2actor.get("IncomingFlow__Marker_CONTEXT__CORR__mFlowToTFlow_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.IncomingFlow__Marker>(getSelf(), name2actor.get("IncomingFlow__Marker_CONTEXT__SRC__mSource_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.IncomingFlow__Marker>(getSelf(), name2actor.get("IncomingFlow__Marker_CONTEXT__TRG__tFlow_0_reference"), this::returnTrue));
	}
