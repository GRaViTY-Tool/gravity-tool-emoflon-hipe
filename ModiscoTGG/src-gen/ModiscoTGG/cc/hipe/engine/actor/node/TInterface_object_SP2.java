...
public class TInterface_object_SP2 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TInterface>> ports;		
		
	public TInterface_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TInterface>(getSelf(), name2actor.get("ASTNodeToTAnnotatable_target_5_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TInterface>(getSelf(), name2actor.get("AnonymousClassTypeInterface__Marker_CONTEXT__TRG__tParent_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TInterface>(getSelf(), name2actor.get("InterfaceExtendsInterface__Marker_CONTEXT__TRG__tSuperInterface_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TInterface>(getSelf(), name2actor.get("TInterface_outerType_6_reference"), this::returnTrue));
	}
