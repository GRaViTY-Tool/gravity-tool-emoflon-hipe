...
public class SuperMethodInvocation__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.SuperMethodInvocation__Marker>> ports;		
		
	public SuperMethodInvocation__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.SuperMethodInvocation__Marker>(getSelf(), name2actor.get("SuperMethodInvocation__Marker_CONTEXT__TRG__tMember_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.SuperMethodInvocation__Marker>(getSelf(), name2actor.get("SuperMethodInvocation__Marker_CONTEXT__TRG__tMethod_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.SuperMethodInvocation__Marker>(getSelf(), name2actor.get("SuperMethodInvocation__Marker_CREATE__TRG__tAccess_0_reference"), this::returnTrue));
	}
