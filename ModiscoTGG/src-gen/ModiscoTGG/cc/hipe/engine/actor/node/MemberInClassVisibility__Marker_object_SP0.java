...
public class MemberInClassVisibility__Marker_object_SP0 extends AbstractActor {
	
	private List<Port<ModiscoTGG.MemberInClassVisibility__Marker>> ports;		
		
	public MemberInClassVisibility__Marker_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.MemberInClassVisibility__Marker>(getSelf(), name2actor.get("MemberInClassVisibility__Marker_CONTEXT__TRG__tClass_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MemberInClassVisibility__Marker>(getSelf(), name2actor.get("MemberInClassVisibility__Marker_CONTEXT__TRG__tMember_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MemberInClassVisibility__Marker>(getSelf(), name2actor.get("MemberInClassVisibility__Marker_CREATE__TRG__tModifier_0_reference"), this::returnTrue));
	}
