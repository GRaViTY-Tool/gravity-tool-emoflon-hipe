...
public class TParameter_object_SP1 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TParameter>> ports;		
		
	public TParameter_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TParameter>(getSelf(), name2actor.get("MethodParameterType__Marker_CREATE__TRG__tParameter_0_reference"), this::returnTrue));
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TParameter>(getSelf(), name2actor.get("TParameter_previous_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TParameter>(getSelf(), name2actor.get("TParameter_type_0_reference"), this::returnTrue));
	}
