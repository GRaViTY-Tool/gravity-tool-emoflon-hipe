...
public class MMethodInvocation_object_SP2 extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MMethodInvocation>> ports;		
		
	public MMethodInvocation_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.modisco.MMethodInvocation>(getSelf(), name2actor.get("MAbstractFlowElementToTAbstractFlowElement_source_10_reference"), this::returnTrue));
