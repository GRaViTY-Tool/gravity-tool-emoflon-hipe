...
public class AnnotationTypeNested__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.AnnotationTypeNested__Marker>> ports;		
		
	public AnnotationTypeNested__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.AnnotationTypeNested__Marker>(getSelf(), name2actor.get("AnnotationTypeNested__Marker_CONTEXT__TRG__tOuterType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.AnnotationTypeNested__Marker>(getSelf(), name2actor.get("AnnotationTypeNested__Marker_CREATE__TRG__tNestedPackage_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.AnnotationTypeNested__Marker>(getSelf(), name2actor.get("AnnotationTypeNested__Marker_CREATE__TRG__tNestedType_0_reference"), this::returnTrue));
	}
