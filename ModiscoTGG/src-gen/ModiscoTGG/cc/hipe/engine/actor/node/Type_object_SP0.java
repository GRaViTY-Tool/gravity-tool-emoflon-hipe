...
public class Type_object_SP0 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.Type>> ports;		
		
	public Type_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Type>(getSelf(), name2actor.get("ArrayTypeToClass__Marker_CONTEXT__SRC__eType_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Type>(getSelf(), name2actor.get("MMethodInvocation_mStaticType_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Type>(getSelf(), name2actor.get("ParameterizedTypeToClass__Marker_CONTEXT__SRC__eType_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Type>(getSelf(), name2actor.get("TypeToTAbstractType_source_0_reference"), this::returnTrue));
	}
