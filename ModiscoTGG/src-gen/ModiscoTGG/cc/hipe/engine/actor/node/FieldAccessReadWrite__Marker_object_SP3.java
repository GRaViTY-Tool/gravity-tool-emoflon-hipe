...
public class FieldAccessReadWrite__Marker_object_SP3 extends AbstractActor {
	
	private List<Port<ModiscoTGG.FieldAccessReadWrite__Marker>> ports;		
		
	public FieldAccessReadWrite__Marker_object_SP3() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.FieldAccessReadWrite__Marker>(getSelf(), name2actor.get("FieldAccessReadWrite__Marker_CONTEXT__CORR__mTypeToTType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.FieldAccessReadWrite__Marker>(getSelf(), name2actor.get("FieldAccessReadWrite__Marker_CONTEXT__TRG__tMember_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.FieldAccessReadWrite__Marker>(getSelf(), name2actor.get("FieldAccessReadWrite__Marker_CREATE__TRG__tAccess_0_reference"), this::returnTrue));
	}
