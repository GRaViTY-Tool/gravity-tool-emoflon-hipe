...
public class TypeGraph_object_SP14 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TypeGraph>> ports;		
		
	public TypeGraph_object_SP14() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TypeGraph>(getSelf(), name2actor.get("ArrayTypeToClass__Marker_CONTEXT__TRG__typeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TypeGraph>(getSelf(), name2actor.get("NestedEnum__Marker_CONTEXT__TRG__typeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TypeGraph>(getSelf(), name2actor.get("PrimitiveTypeIsFloat__Marker_CONTEXT__TRG__typeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TypeGraph>(getSelf(), name2actor.get("TUnresolvedType_pg_15_reference"), this::returnTrue));
	}
