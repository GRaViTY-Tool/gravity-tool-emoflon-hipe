...
public class AnnotationToTAnnotation_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.AnnotationToTAnnotation>> ports;		
		
	public AnnotationToTAnnotation_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<ModiscoTGG.AnnotationToTAnnotation>(getSelf(), name2actor.get("AnnotationMemberValueAnnotationArray__Marker_CREATE__CORR__mTypeToTType_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<ModiscoTGG.AnnotationToTAnnotation>(getSelf(), name2actor.get("AnnotationOnBodyDeclaration__Marker_CREATE__CORR__AnnotationToTAnnotation_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.AnnotationToTAnnotation>(getSelf(), name2actor.get("AnnotationToTAnnotation_target_0_reference"), this::returnTrue));
	}
