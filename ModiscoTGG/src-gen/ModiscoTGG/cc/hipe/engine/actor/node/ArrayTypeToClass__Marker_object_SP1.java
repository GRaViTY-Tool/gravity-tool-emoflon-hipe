...
public class ArrayTypeToClass__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.ArrayTypeToClass__Marker>> ports;		
		
	public ArrayTypeToClass__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.ArrayTypeToClass__Marker>(getSelf(), name2actor.get("ArrayTypeToClass__Marker_CONTEXT__SRC__eType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.ArrayTypeToClass__Marker>(getSelf(), name2actor.get("ArrayTypeToClass__Marker_CONTEXT__TRG__typeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.ArrayTypeToClass__Marker>(getSelf(), name2actor.get("ArrayTypeToClass__Marker_CREATE__SRC__eArrayType_0_reference"), this::returnTrue));
	}
