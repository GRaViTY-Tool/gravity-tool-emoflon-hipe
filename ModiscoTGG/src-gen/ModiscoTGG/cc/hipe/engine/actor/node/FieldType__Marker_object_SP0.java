...
public class FieldType__Marker_object_SP0 extends AbstractActor {
	
	private List<Port<ModiscoTGG.FieldType__Marker>> ports;		
		
	public FieldType__Marker_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.FieldType__Marker>(getSelf(), name2actor.get("FieldType__Marker_CONTEXT__CORR__ePrimitiveTypeToTPrimitiv_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.FieldType__Marker>(getSelf(), name2actor.get("FieldType__Marker_CONTEXT__SRC__mSignature_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.FieldType__Marker>(getSelf(), name2actor.get("FieldType__Marker_CONTEXT__TRG__tPrimitiv_0_reference"), this::returnTrue));
	}
