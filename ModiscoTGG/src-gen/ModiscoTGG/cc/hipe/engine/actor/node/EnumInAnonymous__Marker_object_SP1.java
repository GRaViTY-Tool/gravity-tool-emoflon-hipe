...
public class EnumInAnonymous__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.EnumInAnonymous__Marker>> ports;		
		
	public EnumInAnonymous__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.EnumInAnonymous__Marker>(getSelf(), name2actor.get("EnumInAnonymous__Marker_CONTEXT__CORR__eAnonymousClassDeclarationToTClass_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.EnumInAnonymous__Marker>(getSelf(), name2actor.get("EnumInAnonymous__Marker_CONTEXT__TRG__pg_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.EnumInAnonymous__Marker>(getSelf(), name2actor.get("EnumInAnonymous__Marker_CREATE__SRC__mNestedType_0_reference"), this::returnTrue));
	}
