...
public class SyntethicMethod__Marker_object_SP2 extends AbstractActor {
	
	private List<Port<ModiscoTGG.SyntethicMethod__Marker>> ports;		
		
	public SyntethicMethod__Marker_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.SyntethicMethod__Marker>(getSelf(), name2actor.get("SyntethicMethod__Marker_CONTEXT__SRC__mClass_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.SyntethicMethod__Marker>(getSelf(), name2actor.get("SyntethicMethod__Marker_CONTEXT__SRC__mDef_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.SyntethicMethod__Marker>(getSelf(), name2actor.get("SyntethicMethod__Marker_CREATE__SRC__mSyntethic_0_reference"), this::returnTrue));
	}
