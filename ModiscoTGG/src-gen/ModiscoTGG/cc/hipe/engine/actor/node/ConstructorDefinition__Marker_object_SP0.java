...
public class ConstructorDefinition__Marker_object_SP0 extends AbstractActor {
	
	private List<Port<ModiscoTGG.ConstructorDefinition__Marker>> ports;		
		
	public ConstructorDefinition__Marker_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.ConstructorDefinition__Marker>(getSelf(), name2actor.get("ConstructorDefinition__Marker_CONTEXT__SRC__mSignature_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.ConstructorDefinition__Marker>(getSelf(), name2actor.get("ConstructorDefinition__Marker_CREATE__CORR__mDefinitionToTMember_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.ConstructorDefinition__Marker>(getSelf(), name2actor.get("ConstructorDefinition__Marker_CREATE__TRG__tDefinition_0_reference"), this::returnTrue));
	}
