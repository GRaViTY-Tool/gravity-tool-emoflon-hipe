...
public class TypeGraph_object_SP11 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TypeGraph>> ports;		
		
	public TypeGraph_object_SP11() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeMatchRight<org.gravity.typegraph.basic.TypeGraph>(getSelf(), name2actor.get("ModelToPg__CC_3661_junction"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TypeGraph>(getSelf(), name2actor.get("PrimitiveTypeIsDouble__Marker_CONTEXT__TRG__typeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TypeGraph>(getSelf(), name2actor.get("TClass_pg_14_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TypeGraph>(getSelf(), name2actor.get("TypeGraph_classes_1_reference"), this::returnTrue));
	}
