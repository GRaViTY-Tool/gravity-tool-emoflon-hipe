...
public class Interface__Marker_object_SP2 extends AbstractActor {
	
	private List<Port<ModiscoTGG.Interface__Marker>> ports;		
		
	public Interface__Marker_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.Interface__Marker>(getSelf(), name2actor.get("Interface__Marker_CONTEXT__CORR__mPackageToTPackage_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.Interface__Marker>(getSelf(), name2actor.get("Interface__Marker_CONTEXT__TRG__pg_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.Interface__Marker>(getSelf(), name2actor.get("Interface__Marker_CREATE__CORR__mBodyToTAnnotation_0_reference"), this::returnTrue));
	}
