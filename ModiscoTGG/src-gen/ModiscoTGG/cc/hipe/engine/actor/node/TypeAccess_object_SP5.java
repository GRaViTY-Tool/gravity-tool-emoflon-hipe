...
public class TypeAccess_object_SP5 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.TypeAccess>> ports;		
		
	public TypeAccess_object_SP5() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.eclipse.modisco.java.TypeAccess>(getSelf(), name2actor.get("AbstractTypeDeclaration_usagesInTypeAccess_2_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.TypeAccess>(getSelf(), name2actor.get("ClassDeclaration_superClass_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.TypeAccess>(getSelf(), name2actor.get("ClassImplementsInterface__Marker_CREATE__SRC__eTypeAccess_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.TypeAccess>(getSelf(), name2actor.get("ReturnType__Marker_CREATE__SRC__eTypeAccess_0_reference"), this::returnTrue));
	}
