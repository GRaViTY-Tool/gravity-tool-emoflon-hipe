...
public class TypeGraph_object_SP2 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TypeGraph>> ports;		
		
	public TypeGraph_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TypeGraph>(getSelf(), name2actor.get("Enum__Marker_CONTEXT__TRG__pg_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TypeGraph>(getSelf(), name2actor.get("PrimitiveTypeIsBoolean__Marker_CONTEXT__TRG__typeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TypeGraph>(getSelf(), name2actor.get("PrimitiveTypeIsLong__Marker_CONTEXT__TRG__typeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TypeGraph>(getSelf(), name2actor.get("TClass_pg_1_reference"), this::returnTrue));
	}
