...
public class TClassNode_object_SP1 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.annotations.TClassNode>> ports;		
		
	public TClassNode_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.annotations.TClassNode>(getSelf(), name2actor.get("AnnotationMemberValueClassArray__Marker_CREATE__TRG__tValue_0_reference"), this::returnTrue));
