...
public class PackageToTPackage_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.PackageToTPackage>> ports;		
		
	public PackageToTPackage_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<ModiscoTGG.PackageToTPackage>(getSelf(), name2actor.get("Enum__Marker_CONTEXT__CORR__mPackageToTPackage_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.PackageToTPackage>(getSelf(), name2actor.get("PackageToTPackage_target_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<ModiscoTGG.PackageToTPackage>(getSelf(), name2actor.get("SubPackageToPGPackage__Marker_CREATE__CORR__mPackageToTSub_0_reference"), this::returnTrue));
	}
