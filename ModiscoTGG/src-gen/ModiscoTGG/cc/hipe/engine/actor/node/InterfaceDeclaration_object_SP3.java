...
public class InterfaceDeclaration_object_SP3 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.InterfaceDeclaration>> ports;		
		
	public InterfaceDeclaration_object_SP3() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.InterfaceDeclaration>(getSelf(), name2actor.get("InterfaceDeclaration_package_3_reference"), this::returnTrue));
		...
		ports.add(new PortNodeRight<org.eclipse.modisco.java.InterfaceDeclaration>(getSelf(), name2actor.get("TypeToTAbstractType_source_7_reference"), this::returnTrue));
	}
