...
public class TReadWrite_object_SP0 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TReadWrite>> ports;		
		
	public TReadWrite_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TReadWrite>(getSelf(), name2actor.get("FieldAccessReadWrite__Marker_CREATE__TRG__tAccess_0_reference"), this::returnTrue));
