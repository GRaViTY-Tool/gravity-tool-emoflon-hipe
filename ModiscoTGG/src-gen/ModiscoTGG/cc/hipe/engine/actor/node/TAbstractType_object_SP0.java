...
public class TAbstractType_object_SP0 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TAbstractType>> ports;		
		
	public TAbstractType_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TAbstractType>(getSelf(), name2actor.get("AnonymousClass__Marker_CONTEXT__TRG__tType_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TAbstractType>(getSelf(), name2actor.get("NestedEnum__Marker_CONTEXT__TRG__tOuterType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TAbstractType>(getSelf(), name2actor.get("TAbstractType_defines_3_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TAbstractType>(getSelf(), name2actor.get("TypeToTAbstractType_target_0_reference"), this::returnTrue));
	}
