...
public class TAbstractType_object_SP1 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TAbstractType>> ports;		
		
	public TAbstractType_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TAbstractType>(getSelf(), name2actor.get("ArrayTypeToClass__Marker_CONTEXT__TRG__tArrayClass_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TAbstractType>(getSelf(), name2actor.get("TAbstractType_signature_1_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TAbstractType>(getSelf(), name2actor.get("TClassNode_tClass_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TAbstractType>(getSelf(), name2actor.get("TInterface_outerType_6_reference"), this::returnTrue));
	}
