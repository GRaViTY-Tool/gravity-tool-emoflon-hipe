...
public class TClass_object_SP9 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("PrimitiveTypeIsByte__Marker_CREATE__TRG__tPrimitiveClass_0_reference"), this::check_constraint_243));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("TClass_pg_12_reference"), this::check_constraint_269));
	}
