...
public class TModifier_object_SP0 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TModifier>> ports;		
		
	public TModifier_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TModifier>(getSelf(), name2actor.get("MModifierToTModifier_target_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TModifier>(getSelf(), name2actor.get("MemberInAnnotationVisibility__Marker_CREATE__TRG__tModifier_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TModifier>(getSelf(), name2actor.get("MemberInEnumVisibility__Marker_CREATE__TRG__tModifier_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TModifier>(getSelf(), name2actor.get("TMember_tModifier_0_reference"), this::returnTrue));
	}
