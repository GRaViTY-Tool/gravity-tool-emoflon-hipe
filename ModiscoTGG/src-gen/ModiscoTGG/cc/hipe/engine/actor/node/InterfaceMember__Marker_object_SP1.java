...
public class InterfaceMember__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.InterfaceMember__Marker>> ports;		
		
	public InterfaceMember__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.InterfaceMember__Marker>(getSelf(), name2actor.get("InterfaceMember__Marker_CONTEXT__SRC__mDefinition_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.InterfaceMember__Marker>(getSelf(), name2actor.get("InterfaceMember__Marker_CONTEXT__SRC__mInterface_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.InterfaceMember__Marker>(getSelf(), name2actor.get("InterfaceMember__Marker_CREATE__SRC__mModifier_0_reference"), this::returnTrue));
	}
