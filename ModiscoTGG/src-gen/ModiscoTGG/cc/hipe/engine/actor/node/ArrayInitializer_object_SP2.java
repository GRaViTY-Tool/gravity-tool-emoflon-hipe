...
public class ArrayInitializer_object_SP2 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.ArrayInitializer>> ports;		
		
	public ArrayInitializer_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.eclipse.modisco.java.ArrayInitializer>(getSelf(), name2actor.get("AnnotationMemberValueAnnotationArray__Marker_CREATE__SRC__mArray_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.ArrayInitializer>(getSelf(), name2actor.get("AnnotationMemberValueClassArray__Marker_CREATE__SRC__mArray_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.ArrayInitializer>(getSelf(), name2actor.get("AnnotationMemberValueStringArray__Marker_CREATE__SRC__mArray_0_reference"), this::returnTrue));
	}
