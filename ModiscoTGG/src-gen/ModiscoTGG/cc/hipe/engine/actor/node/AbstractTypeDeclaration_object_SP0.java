...
public class AbstractTypeDeclaration_object_SP0 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.AbstractTypeDeclaration>> ports;		
		
	public AbstractTypeDeclaration_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.AbstractTypeDeclaration>(getSelf(), name2actor.get("AbstractTypeDeclaration_superInterfaces_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.AbstractTypeDeclaration>(getSelf(), name2actor.get("AnonymousClassTypeInterface__Marker_CONTEXT__SRC__mParent_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.AbstractTypeDeclaration>(getSelf(), name2actor.get("FieldAccessWrite__Marker_CONTEXT__SRC__mType_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.AbstractTypeDeclaration>(getSelf(), name2actor.get("NestedEnum__Marker_CONTEXT__SRC__eOuterType_0_reference"), this::returnTrue));
	}
