...
public class TypeAccess_object_SP1 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.TypeAccess>> ports;		
		
	public TypeAccess_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.eclipse.modisco.java.TypeAccess>(getSelf(), name2actor.get("AnnotationMemberValueClass__Marker_CREATE__SRC__mAccess_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.TypeAccess>(getSelf(), name2actor.get("ArrayTypeToClass__Marker_CREATE__SRC__eTypeAccess_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.TypeAccess>(getSelf(), name2actor.get("InterfaceExtendsInterface__Marker_CREATE__SRC__eTypeAccess_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.TypeAccess>(getSelf(), name2actor.get("TypeLiteral_type_0_reference"), this::returnTrue));
	}
