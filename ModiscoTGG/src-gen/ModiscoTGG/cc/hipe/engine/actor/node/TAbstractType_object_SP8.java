...
public class TAbstractType_object_SP8 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TAbstractType>> ports;		
		
	public TAbstractType_object_SP8() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TAbstractType>(getSelf(), name2actor.get("NestedClassInType__Marker_CONTEXT__TRG__tOuterType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TAbstractType>(getSelf(), name2actor.get("TAbstractType_tModifier_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TAbstractType>(getSelf(), name2actor.get("TClass_outerType_2_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TAbstractType>(getSelf(), name2actor.get("TypesVisibility__Marker_CONTEXT__TRG__tType_0_reference"), this::returnTrue));
	}
