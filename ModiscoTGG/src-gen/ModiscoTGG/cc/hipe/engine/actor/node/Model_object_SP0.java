...
public class Model_object_SP0 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.Model>> ports;		
		
	public Model_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.Model>(getSelf(), name2actor.get("Model_orphanTypes_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.Model>(getSelf(), name2actor.get("Model_orphanTypes_2_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.eclipse.modisco.java.Model>(getSelf(), name2actor.get("Model_orphanTypes_9_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Model>(getSelf(), name2actor.get("PrimitiveTypeIsDouble__Marker_CONTEXT__SRC__eModel_0_reference"), this::returnTrue));
	}
