...
public class FieldAccessWrite__Marker_object_SP3 extends AbstractActor {
	
	private List<Port<ModiscoTGG.FieldAccessWrite__Marker>> ports;		
		
	public FieldAccessWrite__Marker_object_SP3() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.FieldAccessWrite__Marker>(getSelf(), name2actor.get("FieldAccessWrite__Marker_CONTEXT__CORR__mTypeToTType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.FieldAccessWrite__Marker>(getSelf(), name2actor.get("FieldAccessWrite__Marker_CONTEXT__TRG__tMember_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.FieldAccessWrite__Marker>(getSelf(), name2actor.get("FieldAccessWrite__Marker_CREATE__TRG__tAccess_0_reference"), this::returnTrue));
	}
