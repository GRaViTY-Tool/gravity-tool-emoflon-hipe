...
public class SignatureReturnType__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.SignatureReturnType__Marker>> ports;		
		
	public SignatureReturnType__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.SignatureReturnType__Marker>(getSelf(), name2actor.get("SignatureReturnType__Marker_CONTEXT__CORR__mTypeToTType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.SignatureReturnType__Marker>(getSelf(), name2actor.get("SignatureReturnType__Marker_CONTEXT__SRC__mSignature_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.SignatureReturnType__Marker>(getSelf(), name2actor.get("SignatureReturnType__Marker_CONTEXT__TRG__tType_0_reference"), this::returnTrue));
	}
