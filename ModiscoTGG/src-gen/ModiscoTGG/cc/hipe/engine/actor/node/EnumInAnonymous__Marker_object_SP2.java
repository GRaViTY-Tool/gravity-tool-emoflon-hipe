...
public class EnumInAnonymous__Marker_object_SP2 extends AbstractActor {
	
	private List<Port<ModiscoTGG.EnumInAnonymous__Marker>> ports;		
		
	public EnumInAnonymous__Marker_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.EnumInAnonymous__Marker>(getSelf(), name2actor.get("EnumInAnonymous__Marker_CONTEXT__TRG__tClass_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.EnumInAnonymous__Marker>(getSelf(), name2actor.get("EnumInAnonymous__Marker_CREATE__CORR__mNestedTypeToTNestedType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.EnumInAnonymous__Marker>(getSelf(), name2actor.get("EnumInAnonymous__Marker_CREATE__TRG__tAnnotation_0_reference"), this::returnTrue));
	}
