...
public class NestedInterfaceInType__Marker_object_SP2 extends AbstractActor {
	
	private List<Port<ModiscoTGG.NestedInterfaceInType__Marker>> ports;		
		
	public NestedInterfaceInType__Marker_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.NestedInterfaceInType__Marker>(getSelf(), name2actor.get("NestedInterfaceInType__Marker_CONTEXT__TRG__tOuterType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.NestedInterfaceInType__Marker>(getSelf(), name2actor.get("NestedInterfaceInType__Marker_CREATE__CORR__mBodyToTAnnotation_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.NestedInterfaceInType__Marker>(getSelf(), name2actor.get("NestedInterfaceInType__Marker_CREATE__TRG__tNestedType_0_reference"), this::returnTrue));
	}
