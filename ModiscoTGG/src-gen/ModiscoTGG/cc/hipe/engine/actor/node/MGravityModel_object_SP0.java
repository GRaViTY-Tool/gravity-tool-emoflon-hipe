...
public class MGravityModel_object_SP0 extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MGravityModel>> ports;		
		
	public MGravityModel_object_SP0() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeLeft<org.gravity.modisco.MGravityModel>(getSelf(), name2actor.get("MGravityModel_mMethodNames_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.modisco.MGravityModel>(getSelf(), name2actor.get("MGravityModel_unresolvedItems_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MGravityModel>(getSelf(), name2actor.get("ModelToPg__Marker_CREATE__SRC__mModel_0_reference"), this::returnTrue));
	}
