...
public class Flow__Marker_object_SP0 extends AbstractActor {
	
	private List<Port<ModiscoTGG.Flow__Marker>> ports;		
		
	public Flow__Marker_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.Flow__Marker>(getSelf(), name2actor.get("Flow__Marker_CONTEXT__SRC__mOwner_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.Flow__Marker>(getSelf(), name2actor.get("Flow__Marker_CREATE__CORR__mFlowToTFlow_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.Flow__Marker>(getSelf(), name2actor.get("Flow__Marker_CREATE__TRG__tFlow_0_reference"), this::returnTrue));
	}
