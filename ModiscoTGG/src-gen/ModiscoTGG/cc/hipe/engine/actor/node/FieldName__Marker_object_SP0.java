...
public class FieldName__Marker_object_SP0 extends AbstractActor {
	
	private List<Port<ModiscoTGG.FieldName__Marker>> ports;		
		
	public FieldName__Marker_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.FieldName__Marker>(getSelf(), name2actor.get("FieldName__Marker_CONTEXT__SRC__model_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.FieldName__Marker>(getSelf(), name2actor.get("FieldName__Marker_CREATE__CORR__eFieldDeclarationToTField_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.FieldName__Marker>(getSelf(), name2actor.get("FieldName__Marker_CREATE__TRG__tField_0_reference"), this::returnTrue));
	}
