...
public class MethodParameter__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.MethodParameter__Marker>> ports;		
		
	public MethodParameter__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.MethodParameter__Marker>(getSelf(), name2actor.get("MethodParameter__Marker_CONTEXT__CORR__mSignatureToTSignature_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MethodParameter__Marker>(getSelf(), name2actor.get("MethodParameter__Marker_CONTEXT__TRG__tSiganture_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MethodParameter__Marker>(getSelf(), name2actor.get("MethodParameter__Marker_CREATE__SRC__mEntry_0_reference"), this::returnTrue));
	}
