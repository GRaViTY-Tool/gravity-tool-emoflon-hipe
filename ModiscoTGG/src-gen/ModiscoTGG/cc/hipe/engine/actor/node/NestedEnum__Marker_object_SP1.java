...
public class NestedEnum__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.NestedEnum__Marker>> ports;		
		
	public NestedEnum__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.NestedEnum__Marker>(getSelf(), name2actor.get("NestedEnum__Marker_CONTEXT__TRG__tOuterPackage_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.NestedEnum__Marker>(getSelf(), name2actor.get("NestedEnum__Marker_CONTEXT__TRG__tOuterType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.NestedEnum__Marker>(getSelf(), name2actor.get("NestedEnum__Marker_CREATE__CORR__eNestedTypeToTNestedType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.NestedEnum__Marker>(getSelf(), name2actor.get("NestedEnum__Marker_CREATE__TRG__tAnnotation_0_reference"), this::returnTrue));
	}
