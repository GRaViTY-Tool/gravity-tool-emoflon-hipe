...
public class TypeLiteral_object_SP1 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.TypeLiteral>> ports;		
		
	public TypeLiteral_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.eclipse.modisco.java.TypeLiteral>(getSelf(), name2actor.get("AnnotationMemberValueClassArray__Marker_CREATE__SRC__mValue_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.TypeLiteral>(getSelf(), name2actor.get("AnnotationMemberValueClass__Marker_CREATE__SRC__mValue_0_reference"), this::returnTrue));
