...
public class MethodName__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.MethodName__Marker>> ports;		
		
	public MethodName__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.MethodName__Marker>(getSelf(), name2actor.get("MethodName__Marker_CONTEXT__CORR__modelToPg_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MethodName__Marker>(getSelf(), name2actor.get("MethodName__Marker_CONTEXT__TRG__pg_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MethodName__Marker>(getSelf(), name2actor.get("MethodName__Marker_CREATE__SRC__mName_0_reference"), this::returnTrue));
	}
