...
public class ConstructorInvocation__Marker_object_SP2 extends AbstractActor {
	
	private List<Port<ModiscoTGG.ConstructorInvocation__Marker>> ports;		
		
	public ConstructorInvocation__Marker_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.ConstructorInvocation__Marker>(getSelf(), name2actor.get("ConstructorInvocation__Marker_CONTEXT__SRC__mMember_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.ConstructorInvocation__Marker>(getSelf(), name2actor.get("ConstructorInvocation__Marker_CONTEXT__SRC__mMethod_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.ConstructorInvocation__Marker>(getSelf(), name2actor.get("ConstructorInvocation__Marker_CREATE__SRC__invocation_0_reference"), this::returnTrue));
	}
