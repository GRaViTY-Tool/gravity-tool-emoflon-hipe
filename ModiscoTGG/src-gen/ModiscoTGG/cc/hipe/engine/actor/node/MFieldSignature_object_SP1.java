...
public class MFieldSignature_object_SP1 extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MFieldSignature>> ports;		
		
	public MFieldSignature_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.modisco.MFieldSignature>(getSelf(), name2actor.get("FieldSignature__Marker_CREATE__SRC__mSignature_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MFieldSignature>(getSelf(), name2actor.get("FieldType__Marker_CONTEXT__SRC__mSignature_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MFieldSignature>(getSelf(), name2actor.get("MFieldName_mSignatures_0_reference"), this::returnTrue));
