...
public class TMember_object_SP5 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TMember>> ports;		
		
	public TMember_object_SP5() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TMember>(getSelf(), name2actor.get("ConstructorInvocation__Marker_CONTEXT__TRG__tMethod_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TMember>(getSelf(), name2actor.get("MemberInClassVisibility__Marker_CONTEXT__TRG__tMember_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TMember>(getSelf(), name2actor.get("TInterface_defines_1_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TMember>(getSelf(), name2actor.get("TextAnnotations__Marker_CONTEXT__TRG__tMember_0_reference"), this::returnTrue));
	}
