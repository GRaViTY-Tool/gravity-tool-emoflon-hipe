...
public class TFieldDefinition_object_SP3 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TFieldDefinition>> ports;		
		
	public TFieldDefinition_object_SP3() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TFieldDefinition>(getSelf(), name2actor.get("FieldAccessReadWrite__Marker_CONTEXT__TRG__tField_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TFieldDefinition>(getSelf(), name2actor.get("FieldAccessWrite__Marker_CONTEXT__TRG__tField_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TFieldDefinition>(getSelf(), name2actor.get("FieldDefinition__Marker_CREATE__TRG__tDefinition_0_reference"), this::returnTrue));
	}
