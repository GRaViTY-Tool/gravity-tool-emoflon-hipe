...
public class AbstractTypeDeclaration_object_SP3 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.AbstractTypeDeclaration>> ports;		
		
	public AbstractTypeDeclaration_object_SP3() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.eclipse.modisco.java.AbstractTypeDeclaration>(getSelf(), name2actor.get("AnnotationTypeNested__Marker_CONTEXT__SRC__eOuterType_0_reference"), this::returnTrue));
	}
