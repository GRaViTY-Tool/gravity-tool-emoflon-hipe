...
public class MFieldDefinition_object_SP2 extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MFieldDefinition>> ports;		
		
	public MFieldDefinition_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.modisco.MFieldDefinition>(getSelf(), name2actor.get("ASTNodeToTAnnotatable_source_5_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MFieldDefinition>(getSelf(), name2actor.get("FieldAccessWrite__Marker_CONTEXT__SRC__mField_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MFieldDefinition>(getSelf(), name2actor.get("VariableDeclarationFragment_variablesContainer_0_reference"), this::returnTrue));
	}
