...
public class MModifierToTModifier_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.MModifierToTModifier>> ports;		
		
	public MModifierToTModifier_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.MModifierToTModifier>(getSelf(), name2actor.get("MModifierToTModifier_source_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<ModiscoTGG.MModifierToTModifier>(getSelf(), name2actor.get("MemberInAnnotationVisibility__Marker_CREATE__CORR__mModifierToTModifier_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<ModiscoTGG.MModifierToTModifier>(getSelf(), name2actor.get("MemberInEnumVisibility__Marker_CREATE__CORR__mModifierToTModifier_0_reference"), this::returnTrue));
	}
