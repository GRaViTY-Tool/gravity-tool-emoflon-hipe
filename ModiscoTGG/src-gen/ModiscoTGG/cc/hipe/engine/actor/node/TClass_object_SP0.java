...
public class TClass_object_SP0 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TClass>> ports;		
		
	public TClass_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("ClassImplementsInterface__Marker_CONTEXT__TRG__tClass_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("TClass_pg_5_reference"), this::check_constraint_234));
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("TypeGraph_classes_7_reference"), this::check_constraint_260));
	}
	...
	public boolean check_constraint_234(org.gravity.typegraph.basic.TClass tPrimitiveClass) {
		return String.valueOf(tPrimitiveClass.getTName()).equals("boolean") && tPrimitiveClass.isTLib()==true;
	}
	
	public boolean check_constraint_260(org.gravity.typegraph.basic.TClass tPrimitiveClass) {
