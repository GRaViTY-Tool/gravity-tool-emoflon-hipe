...
public class TAbstractType_object_SP5 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TAbstractType>> ports;		
		
	public TAbstractType_object_SP5() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TAbstractType>(getSelf(), name2actor.get("FieldAccessWrite__Marker_CONTEXT__TRG__tType_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TAbstractType>(getSelf(), name2actor.get("ReturnType__Marker_CONTEXT__TRG__tAbstractType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TAbstractType>(getSelf(), name2actor.get("TAbstractType_package_1_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TAbstractType>(getSelf(), name2actor.get("TParameter_type_0_reference"), this::returnTrue));
	}
