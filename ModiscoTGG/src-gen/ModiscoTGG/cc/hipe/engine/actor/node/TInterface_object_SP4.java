...
public class TInterface_object_SP4 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TInterface>> ports;		
		
	public TInterface_object_SP4() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TInterface>(getSelf(), name2actor.get("ClassImplementsInterface__Marker_CONTEXT__TRG__tSuperInterface_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TInterface>(getSelf(), name2actor.get("TInterface_defines_1_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TInterface>(getSelf(), name2actor.get("TInterface_pg_4_reference"), this::returnTrue));
	}
