...
public class TSyntethicMethod_object_SP0 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TSyntethicMethod>> ports;		
		
	public TSyntethicMethod_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TSyntethicMethod>(getSelf(), name2actor.get("SyntethicMethod__Marker_CREATE__TRG__tSyntethic_0_reference"), this::returnTrue));
