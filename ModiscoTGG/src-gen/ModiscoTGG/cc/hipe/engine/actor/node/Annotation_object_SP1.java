...
public class Annotation_object_SP1 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Annotation>(getSelf(), name2actor.get("AnnotationToTAnnotation_source_0_reference"), this::returnTrue));
		...
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Annotation>(getSelf(), name2actor.get("BodyDeclaration_annotations_0_reference"), this::returnTrue));
	}
