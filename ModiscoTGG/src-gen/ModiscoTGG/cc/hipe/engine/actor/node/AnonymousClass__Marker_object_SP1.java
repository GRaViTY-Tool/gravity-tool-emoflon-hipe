...
public class AnonymousClass__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.AnonymousClass__Marker>> ports;		
		
	public AnonymousClass__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.AnonymousClass__Marker>(getSelf(), name2actor.get("AnonymousClass__Marker_CONTEXT__SRC__mType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.AnonymousClass__Marker>(getSelf(), name2actor.get("AnonymousClass__Marker_CONTEXT__TRG__pg_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.AnonymousClass__Marker>(getSelf(), name2actor.get("AnonymousClass__Marker_CREATE__SRC__mAnonymous_0_reference"), this::returnTrue));
	}
