...
public class InterfaceInAnonymous__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.InterfaceInAnonymous__Marker>> ports;		
		
	public InterfaceInAnonymous__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.InterfaceInAnonymous__Marker>(getSelf(), name2actor.get("InterfaceInAnonymous__Marker_CONTEXT__SRC__eAnonymousClassDeclaration_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.InterfaceInAnonymous__Marker>(getSelf(), name2actor.get("InterfaceInAnonymous__Marker_CREATE__CORR__mbodyToTAnnotatable_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.InterfaceInAnonymous__Marker>(getSelf(), name2actor.get("InterfaceInAnonymous__Marker_CREATE__SRC__mNestedType_0_reference"), this::returnTrue));
	}
