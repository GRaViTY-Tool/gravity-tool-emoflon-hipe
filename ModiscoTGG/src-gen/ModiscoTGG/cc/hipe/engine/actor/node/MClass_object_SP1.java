...
public class MClass_object_SP1 extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MClass>> ports;		
		
	public MClass_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.modisco.MClass>(getSelf(), name2actor.get("ASTNodeToTAnnotatable_source_2_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MClass>(getSelf(), name2actor.get("Class__Marker_CREATE__SRC__mType_0_reference"), this::returnTrue));
		...
		ports.add(new PortNodeRight<org.gravity.modisco.MClass>(getSelf(), name2actor.get("TypesOrphaned__Marker_CREATE__SRC__mType_0_reference"), this::returnTrue));
	}
