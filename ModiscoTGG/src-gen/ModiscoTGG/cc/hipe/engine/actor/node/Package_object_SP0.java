...
public class Package_object_SP0 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.Package>> ports;		
		
	public Package_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Package>(getSelf(), name2actor.get("AnnotationTypeDeclaration_package_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Package>(getSelf(), name2actor.get("Class__Marker_CONTEXT__SRC__mPackage_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.Package>(getSelf(), name2actor.get("Interface__Marker_CONTEXT__SRC__mPackage_0_reference"), this::returnTrue));
