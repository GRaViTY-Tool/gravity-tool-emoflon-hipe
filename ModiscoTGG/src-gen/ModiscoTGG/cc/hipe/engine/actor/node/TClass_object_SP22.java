...
public class TClass_object_SP22 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TClass>> ports;		
		
	public TClass_object_SP22() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeLeft<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("TClass_pg_14_reference"), this::check_constraint_304));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TClass>(getSelf(), name2actor.get("TypeToTAbstractType_target_8_reference"), this::check_constraint_256));
	}
	...
	public boolean check_constraint_304(org.gravity.typegraph.basic.TClass tClass) {
