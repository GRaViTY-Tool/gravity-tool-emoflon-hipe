...
public class AnnotationType__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.AnnotationType__Marker>> ports;		
		
	public AnnotationType__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.AnnotationType__Marker>(getSelf(), name2actor.get("AnnotationType__Marker_CONTEXT__SRC__mPackage_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.AnnotationType__Marker>(getSelf(), name2actor.get("AnnotationType__Marker_CONTEXT__TRG__pg_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.AnnotationType__Marker>(getSelf(), name2actor.get("AnnotationType__Marker_CREATE__CORR__mBodyToTAnnotation_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.AnnotationType__Marker>(getSelf(), name2actor.get("AnnotationType__Marker_CREATE__TRG__tType_0_reference"), this::returnTrue));
	}
