...
public class PrimitiveTypeIsInt__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.PrimitiveTypeIsInt__Marker>> ports;		
		
	public PrimitiveTypeIsInt__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.PrimitiveTypeIsInt__Marker>(getSelf(), name2actor.get("PrimitiveTypeIsInt__Marker_CONTEXT__CORR__eModelToTypeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.PrimitiveTypeIsInt__Marker>(getSelf(), name2actor.get("PrimitiveTypeIsInt__Marker_CONTEXT__TRG__typeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.PrimitiveTypeIsInt__Marker>(getSelf(), name2actor.get("PrimitiveTypeIsInt__Marker_CREATE__SRC__ePrimitiveType_0_reference"), this::returnTrue));
	}
