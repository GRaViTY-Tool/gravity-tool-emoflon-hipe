...
public class ModelToTypeGraph_object_SP4 extends AbstractActor {
	
	private List<Port<ModiscoTGG.ModelToTypeGraph>> ports;		
		
	public ModelToTypeGraph_object_SP4() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<ModiscoTGG.ModelToTypeGraph>(getSelf(), name2actor.get("FieldName__Marker_CONTEXT__CORR__modelToTypeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<ModiscoTGG.ModelToTypeGraph>(getSelf(), name2actor.get("PrimitiveTypeIsByte__Marker_CONTEXT__CORR__eModelToTypeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<ModiscoTGG.ModelToTypeGraph>(getSelf(), name2actor.get("PrimitiveTypeIsShort__Marker_CONTEXT__CORR__eModelToTypeGraph_0_reference"), this::returnTrue));
	}
