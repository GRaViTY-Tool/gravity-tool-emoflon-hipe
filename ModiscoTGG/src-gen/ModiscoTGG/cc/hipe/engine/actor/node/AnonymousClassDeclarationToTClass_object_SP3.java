...
public class AnonymousClassDeclarationToTClass_object_SP3 extends AbstractActor {
	
	private List<Port<ModiscoTGG.AnonymousClassDeclarationToTClass>> ports;		
		
	public AnonymousClassDeclarationToTClass_object_SP3() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeLeft<ModiscoTGG.AnonymousClassDeclarationToTClass>(getSelf(), name2actor.get("AnonymousClassDeclarationToTClass_target_2_reference"), this::returnTrue));
		ports.add(new PortNodeRight<ModiscoTGG.AnonymousClassDeclarationToTClass>(getSelf(), name2actor.get("EnumInAnonymous__Marker_CONTEXT__CORR__eAnonymousClassDeclarationToTClass_0_reference"), this::returnTrue));
	}
