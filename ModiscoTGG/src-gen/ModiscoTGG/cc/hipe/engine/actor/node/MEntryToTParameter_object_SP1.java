...
public class MEntryToTParameter_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.MEntryToTParameter>> ports;		
		
	public MEntryToTParameter_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.MEntryToTParameter>(getSelf(), name2actor.get("MEntryToTParameter_target_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<ModiscoTGG.MEntryToTParameter>(getSelf(), name2actor.get("MethodParameterLink__Marker_CONTEXT__CORR__eSingleVariableDeclarationToTParameter_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<ModiscoTGG.MEntryToTParameter>(getSelf(), name2actor.get("MethodParameterType__Marker_CREATE__CORR__mEntryToTParameter_0_reference"), this::returnTrue));
	}
