...
public class LinkDefinitionToType__Marker_object_SP0 extends AbstractActor {
	
	private List<Port<ModiscoTGG.LinkDefinitionToType__Marker>> ports;		
		
	public LinkDefinitionToType__Marker_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.LinkDefinitionToType__Marker>(getSelf(), name2actor.get("LinkDefinitionToType__Marker_CONTEXT__TRG__tDefinition_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.LinkDefinitionToType__Marker>(getSelf(), name2actor.get("LinkDefinitionToType__Marker_CONTEXT__TRG__tSignature_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.LinkDefinitionToType__Marker>(getSelf(), name2actor.get("LinkDefinitionToType__Marker_CONTEXT__TRG__tType_0_reference"), this::returnTrue));
	}
