...
public class AnonymousClass__Marker_object_SP0 extends AbstractActor {
	
	private List<Port<ModiscoTGG.AnonymousClass__Marker>> ports;		
		
	public AnonymousClass__Marker_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.AnonymousClass__Marker>(getSelf(), name2actor.get("AnonymousClass__Marker_CONTEXT__TRG__tType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.AnonymousClass__Marker>(getSelf(), name2actor.get("AnonymousClass__Marker_CREATE__TRG__tAnonymous_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.AnonymousClass__Marker>(getSelf(), name2actor.get("AnonymousClass__Marker_CREATE__TRG__tNewPackage_0_reference"), this::returnTrue));
	}
