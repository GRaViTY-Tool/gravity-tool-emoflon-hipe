...
public class InterfaceDeclarationToTInterface_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.InterfaceDeclarationToTInterface>> ports;		
		
	public InterfaceDeclarationToTInterface_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.InterfaceDeclarationToTInterface>(getSelf(), name2actor.get("InterfaceDeclarationToTInterface_target_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<ModiscoTGG.InterfaceDeclarationToTInterface>(getSelf(), name2actor.get("InterfaceExtendsInterface__Marker_CONTEXT__CORR__eInterfaceDeclarationToTInterface_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<ModiscoTGG.InterfaceDeclarationToTInterface>(getSelf(), name2actor.get("Interface__Marker_CREATE__CORR__mInterfaceDeclarationtoTInterface_0_reference"), this::returnTrue));
	}
