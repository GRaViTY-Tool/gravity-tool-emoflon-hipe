...
public class TMethodDefinition_object_SP4 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TMethodDefinition>> ports;		
		
	public TMethodDefinition_object_SP4() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TMethodDefinition>(getSelf(), name2actor.get("MethodInvocationRecursive__Marker_CONTEXT__TRG__tMember_0_reference"), this::returnTrue));
