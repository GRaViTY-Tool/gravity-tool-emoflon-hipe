...
public class MFlowToTFlow_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.MFlowToTFlow>> ports;		
		
	public MFlowToTFlow_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<ModiscoTGG.MFlowToTFlow>(getSelf(), name2actor.get("IncomingFlow__Marker_CONTEXT__CORR__mFlowToTFlow_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MFlowToTFlow>(getSelf(), name2actor.get("MFlowToTFlow_source_0_reference"), this::returnTrue));
	}
