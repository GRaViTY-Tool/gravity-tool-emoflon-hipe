...
public class MEntry_object_SP0 extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MEntry>> ports;		
		
	public MEntry_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.modisco.MEntry>(getSelf(), name2actor.get("MAbstractFlowElementToTAbstractFlowElement_source_11_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.modisco.MEntry>(getSelf(), name2actor.get("MEntry_mPrevious_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MEntry>(getSelf(), name2actor.get("MMethodSignature_mFirstEntry_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MEntry>(getSelf(), name2actor.get("MethodParameterLink__Marker_CONTEXT__SRC__mPrevEntry_0_reference"), this::returnTrue));
	}
