...
public class EnumDeclaration_object_SP2 extends AbstractActor {
	
	private List<Port<org.eclipse.modisco.java.EnumDeclaration>> ports;		
		
	public EnumDeclaration_object_SP2() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeRight<org.eclipse.modisco.java.EnumDeclaration>(getSelf(), name2actor.get("Enum__Marker_CREATE__SRC__mType_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.eclipse.modisco.java.EnumDeclaration>(getSelf(), name2actor.get("TypeToTAbstractType_source_6_reference"), this::returnTrue));
	}
