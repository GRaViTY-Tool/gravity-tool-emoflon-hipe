...
public class TRead_object_SP0 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TRead>> ports;		
		
	public TRead_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TRead>(getSelf(), name2actor.get("FieldAccessRead__Marker_CREATE__TRG__tAccess_0_reference"), this::returnTrue));
