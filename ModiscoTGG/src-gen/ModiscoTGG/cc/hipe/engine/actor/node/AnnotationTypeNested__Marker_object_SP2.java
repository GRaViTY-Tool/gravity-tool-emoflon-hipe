...
public class AnnotationTypeNested__Marker_object_SP2 extends AbstractActor {
	
	private List<Port<ModiscoTGG.AnnotationTypeNested__Marker>> ports;		
		
	public AnnotationTypeNested__Marker_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.AnnotationTypeNested__Marker>(getSelf(), name2actor.get("AnnotationTypeNested__Marker_CONTEXT__SRC__eOuterType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.AnnotationTypeNested__Marker>(getSelf(), name2actor.get("AnnotationTypeNested__Marker_CONTEXT__TRG__tOuterPackage_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.AnnotationTypeNested__Marker>(getSelf(), name2actor.get("AnnotationTypeNested__Marker_CREATE__SRC__eNestedType_0_reference"), this::returnTrue));
	}
