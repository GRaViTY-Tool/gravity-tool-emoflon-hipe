...
public class TypesVisibility__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.TypesVisibility__Marker>> ports;		
		
	public TypesVisibility__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.TypesVisibility__Marker>(getSelf(), name2actor.get("TypesVisibility__Marker_CONTEXT__CORR__mTypeToTType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.TypesVisibility__Marker>(getSelf(), name2actor.get("TypesVisibility__Marker_CONTEXT__TRG__tType_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.TypesVisibility__Marker>(getSelf(), name2actor.get("TypesVisibility__Marker_CREATE__SRC__mModifier_0_reference"), this::returnTrue));
	}
