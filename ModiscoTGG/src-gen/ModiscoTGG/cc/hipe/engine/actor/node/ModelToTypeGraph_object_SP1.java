...
public class ModelToTypeGraph_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.ModelToTypeGraph>> ports;		
		
	public ModelToTypeGraph_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.ModelToTypeGraph>(getSelf(), name2actor.get("ModelToTypeGraph_target_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<ModiscoTGG.ModelToTypeGraph>(getSelf(), name2actor.get("PackageToPGPackage__Marker_CONTEXT__CORR__mModelToTypeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<ModiscoTGG.ModelToTypeGraph>(getSelf(), name2actor.get("PrimitiveTypeIsFloat__Marker_CONTEXT__CORR__eModelToTypeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<ModiscoTGG.ModelToTypeGraph>(getSelf(), name2actor.get("TypesOrphaned__Marker_CONTEXT__CORR__mModelToTypeGraph_0_reference"), this::returnTrue));
	}
