...
public class ClassInnerClassMember__Marker_object_SP2 extends AbstractActor {
	
	private List<Port<ModiscoTGG.ClassInnerClassMember__Marker>> ports;		
		
	public ClassInnerClassMember__Marker_object_SP2() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.ClassInnerClassMember__Marker>(getSelf(), name2actor.get("ClassInnerClassMember__Marker_CONTEXT__TRG__tOuterClass_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.ClassInnerClassMember__Marker>(getSelf(), name2actor.get("ClassInnerClassMember__Marker_CONTEXT__TRG__typeGraph_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.ClassInnerClassMember__Marker>(getSelf(), name2actor.get("ClassInnerClassMember__Marker_CREATE__SRC__mInnerClass_0_reference"), this::returnTrue));
	}
