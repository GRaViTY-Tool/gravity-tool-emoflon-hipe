...
public class TInterface_object_SP1 extends AbstractActor {
	
	private List<Port<org.gravity.typegraph.basic.TInterface>> ports;		
		
	public TInterface_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TInterface>(getSelf(), name2actor.get("InterfaceDeclarationToTInterface_target_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TInterface>(getSelf(), name2actor.get("Interface__Marker_CREATE__TRG__tType_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TInterface>(getSelf(), name2actor.get("TPackage_interfaces_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.typegraph.basic.TInterface>(getSelf(), name2actor.get("TypeToTAbstractType_target_3_reference"), this::returnTrue));
	}
