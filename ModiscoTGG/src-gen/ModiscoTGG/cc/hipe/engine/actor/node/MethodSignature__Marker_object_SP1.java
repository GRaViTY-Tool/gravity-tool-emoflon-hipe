...
public class MethodSignature__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.MethodSignature__Marker>> ports;		
		
	public MethodSignature__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.MethodSignature__Marker>(getSelf(), name2actor.get("MethodSignature__Marker_CONTEXT__CORR__mNameToTName_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MethodSignature__Marker>(getSelf(), name2actor.get("MethodSignature__Marker_CONTEXT__TRG__tName_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.MethodSignature__Marker>(getSelf(), name2actor.get("MethodSignature__Marker_CREATE__SRC__mSignature_0_reference"), this::returnTrue));
	}
