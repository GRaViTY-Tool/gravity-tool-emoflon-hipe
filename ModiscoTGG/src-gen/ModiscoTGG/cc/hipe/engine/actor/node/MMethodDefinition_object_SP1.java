...
public class MMethodDefinition_object_SP1 extends AbstractActor {
	
	private List<Port<org.gravity.modisco.MMethodDefinition>> ports;		
		
	public MMethodDefinition_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<org.gravity.modisco.MMethodDefinition>(getSelf(), name2actor.get("MAbstractFlowElementToTAbstractFlowElement_source_9_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<org.gravity.modisco.MMethodDefinition>(getSelf(), name2actor.get("MMethodDefinition_mMethodInvocations_2_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MMethodDefinition>(getSelf(), name2actor.get("MMethodDefinition_redefinitions_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<org.gravity.modisco.MMethodDefinition>(getSelf(), name2actor.get("ReturnType__Marker_CONTEXT__SRC__mDefinition_0_reference"), this::returnTrue));
	}
