...
public class FieldSignature__Marker_object_SP1 extends AbstractActor {
	
	private List<Port<ModiscoTGG.FieldSignature__Marker>> ports;		
		
	public FieldSignature__Marker_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<ModiscoTGG.FieldSignature__Marker>(getSelf(), name2actor.get("FieldSignature__Marker_CONTEXT__CORR__eFieldDeclarationToTField_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.FieldSignature__Marker>(getSelf(), name2actor.get("FieldSignature__Marker_CONTEXT__TRG__tField_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<ModiscoTGG.FieldSignature__Marker>(getSelf(), name2actor.get("FieldSignature__Marker_CREATE__SRC__mSignature_0_reference"), this::returnTrue));
	}
