 ...
 * <!-- end-user-doc -->
 * @see java.JavaPackage#getInfixExpressionKind()
 * @model
 * @generated
 */
public enum InfixExpressionKind implements Enumerator {
	 ...
	 * @generated
	 */
	private static final InfixExpressionKind[] VALUES_ARRAY = new InfixExpressionKind[] { TIMES, DIVIDE, REMAINDER,
			PLUS, MINUS, LEFT_SHIFT, RIGHT_SHIFT_SIGNED, RIGHT_SHIFT_UNSIGNED, LESS, GREATER, LESS_EQUALS,
			GREATER_EQUALS, EQUALS, NOT_EQUALS, XOR, AND, OR, CONDITIONAL_AND, CONDITIONAL_OR, };
	...
	public static InfixExpressionKind get(int value) {
		...
		case LEFT_SHIFT_VALUE:
			return LEFT_SHIFT;
		case RIGHT_SHIFT_SIGNED_VALUE:
			return RIGHT_SHIFT_SIGNED;
		case RIGHT_SHIFT_UNSIGNED_VALUE:
		...
		case OR_VALUE:
			return OR;
		case CONDITIONAL_AND_VALUE:
			return CONDITIONAL_AND;
		case CONDITIONAL_OR_VALUE:
