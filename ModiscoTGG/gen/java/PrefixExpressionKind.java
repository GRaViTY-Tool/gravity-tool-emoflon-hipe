 ...
 * <!-- end-user-doc -->
 * @see java.JavaPackage#getPrefixExpressionKind()
 * @model
 * @generated
 */
public enum PrefixExpressionKind implements Enumerator {
	 ...
	 * @generated
	 */
	private static final PrefixExpressionKind[] VALUES_ARRAY = new PrefixExpressionKind[] { INCREMENT, DECREMENT, PLUS,
			MINUS, COMPLEMENT, NOT, };
