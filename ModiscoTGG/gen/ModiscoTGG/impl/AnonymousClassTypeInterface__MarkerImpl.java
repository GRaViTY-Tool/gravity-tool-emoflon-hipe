...
import ModiscoTGG.AnonymousClassTypeInterface__Marker;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Anonymous Class Type Interface Marker</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ModiscoTGG.impl.AnonymousClassTypeInterface__MarkerImpl#getCONTEXT__SRC__mAnonymous <em>CONTEXT SRC mAnonymous</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnonymousClassTypeInterface__MarkerImpl#getCREATE__SRC__mCreation <em>CREATE SRC mCreation</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnonymousClassTypeInterface__MarkerImpl#getCONTEXT__SRC__mParent <em>CONTEXT SRC mParent</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnonymousClassTypeInterface__MarkerImpl#getCREATE__SRC__mType <em>CREATE SRC mType</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnonymousClassTypeInterface__MarkerImpl#getCONTEXT__TRG__tClass <em>CONTEXT TRG tClass</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnonymousClassTypeInterface__MarkerImpl#getCONTEXT__TRG__tParent <em>CONTEXT TRG tParent</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnonymousClassTypeInterface__MarkerImpl#getCONTEXT__CORR__eAnonymousClassDeclarationToTClass <em>CONTEXT CORR eAnonymous Class Declaration To TClass</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnonymousClassTypeInterface__MarkerImpl#getCONTEXT__CORR__parentToParent <em>CONTEXT CORR parent To Parent</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnonymousClassTypeInterface__MarkerImpl extends TGGRuleApplicationImpl
		implements AnonymousClassTypeInterface__Marker {
	/**
	 ...
	 * @ordered
	 */
	protected TInterface contexT__TRG__tParent;
	 ...
	 * @generated
	 */
	protected AnonymousClassTypeInterface__MarkerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModiscoTGGPackage.eINSTANCE.getAnonymousClassTypeInterface__Marker();
	}
			...
			if (contexT__SRC__mAnonymous != oldCONTEXT__SRC__mAnonymous) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANONYMOUS_CLASS_TYPE_INTERFACE_MARKER__CONTEXT_SRC_MANONYMOUS,
	...
	public ClassInstanceCreation getCREATE__SRC__mCreation() {
		if (creatE__SRC__mCreation != null && creatE__SRC__mCreation.eIsProxy()) {
			...
			if (creatE__SRC__mCreation != oldCREATE__SRC__mCreation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANONYMOUS_CLASS_TYPE_INTERFACE_MARKER__CREATE_SRC_MCREATION,
	...
	public AbstractTypeDeclaration getCONTEXT__SRC__mParent() {
		if (contexT__SRC__mParent != null && contexT__SRC__mParent.eIsProxy()) {
			...
			if (contexT__SRC__mParent != oldCONTEXT__SRC__mParent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANONYMOUS_CLASS_TYPE_INTERFACE_MARKER__CONTEXT_SRC_MPARENT,
	...
	public TypeAccess getCREATE__SRC__mType() {
		if (creatE__SRC__mType != null && creatE__SRC__mType.eIsProxy()) {
			...
			if (creatE__SRC__mType != oldCREATE__SRC__mType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANONYMOUS_CLASS_TYPE_INTERFACE_MARKER__CREATE_SRC_MTYPE,
	...
	public void setCREATE__SRC__mType(TypeAccess newCREATE__SRC__mType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.ANONYMOUS_CLASS_TYPE_INTERFACE_MARKER__CREATE_SRC_MTYPE, oldCREATE__SRC__mType,
					creatE__SRC__mType));
	}
	...
	public TClass getCONTEXT__TRG__tClass() {
		if (contexT__TRG__tClass != null && contexT__TRG__tClass.eIsProxy()) {
			...
			if (contexT__TRG__tClass != oldCONTEXT__TRG__tClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANONYMOUS_CLASS_TYPE_INTERFACE_MARKER__CONTEXT_TRG_TCLASS,
	 ...
	 */
	@Override
	public TInterface getCONTEXT__TRG__tParent() {
		if (contexT__TRG__tParent != null && contexT__TRG__tParent.eIsProxy()) {
			...
			contexT__TRG__tParent = (TInterface) eResolveProxy(oldCONTEXT__TRG__tParent);
			if (contexT__TRG__tParent != oldCONTEXT__TRG__tParent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANONYMOUS_CLASS_TYPE_INTERFACE_MARKER__CONTEXT_TRG_TPARENT,
	 ...
	 * @generated
	 */
	public TInterface basicGetCONTEXT__TRG__tParent() {
		return contexT__TRG__tParent;
	}
	 ...
	 */
	@Override
	public void setCONTEXT__TRG__tParent(TInterface newCONTEXT__TRG__tParent) {
		TInterface oldCONTEXT__TRG__tParent = contexT__TRG__tParent;
	...
	public AnonymousClassDeclarationToTClass getCONTEXT__CORR__eAnonymousClassDeclarationToTClass() {
		if (contexT__CORR__eAnonymousClassDeclarationToTClass != null
			...
			if (contexT__CORR__eAnonymousClassDeclarationToTClass != oldCONTEXT__CORR__eAnonymousClassDeclarationToTClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANONYMOUS_CLASS_TYPE_INTERFACE_MARKER__CONTEXT_CORR_EANONYMOUS_CLASS_DECLARATION_TO_TCLASS,
							oldCONTEXT__CORR__eAnonymousClassDeclarationToTClass,
	...
	public TypeToTAbstractType getCONTEXT__CORR__parentToParent() {
		if (contexT__CORR__parentToParent != null && contexT__CORR__parentToParent.eIsProxy()) {
			...
			if (contexT__CORR__parentToParent != oldCONTEXT__CORR__parentToParent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANONYMOUS_CLASS_TYPE_INTERFACE_MARKER__CONTEXT_CORR_PARENT_TO_PARENT,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoTGGPackage.ANONYMOUS_CLASS_TYPE_INTERFACE_MARKER__CONTEXT_SRC_MANONYMOUS:
			if (resolve)
				return getCONTEXT__SRC__mAnonymous();
			return basicGetCONTEXT__SRC__mAnonymous();
		case ModiscoTGGPackage.ANONYMOUS_CLASS_TYPE_INTERFACE_MARKER__CREATE_SRC_MCREATION:
			if (resolve)
				return getCREATE__SRC__mCreation();
			return basicGetCREATE__SRC__mCreation();
		case ModiscoTGGPackage.ANONYMOUS_CLASS_TYPE_INTERFACE_MARKER__CONTEXT_SRC_MPARENT:
			if (resolve)
				return getCONTEXT__SRC__mParent();
			return basicGetCONTEXT__SRC__mParent();
		case ModiscoTGGPackage.ANONYMOUS_CLASS_TYPE_INTERFACE_MARKER__CREATE_SRC_MTYPE:
			if (resolve)
				return getCREATE__SRC__mType();
			return basicGetCREATE__SRC__mType();
		case ModiscoTGGPackage.ANONYMOUS_CLASS_TYPE_INTERFACE_MARKER__CONTEXT_TRG_TCLASS:
			if (resolve)
				return getCONTEXT__TRG__tClass();
			return basicGetCONTEXT__TRG__tClass();
		case ModiscoTGGPackage.ANONYMOUS_CLASS_TYPE_INTERFACE_MARKER__CONTEXT_TRG_TPARENT:
			if (resolve)
				return getCONTEXT__TRG__tParent();
			return basicGetCONTEXT__TRG__tParent();
		case ModiscoTGGPackage.ANONYMOUS_CLASS_TYPE_INTERFACE_MARKER__CONTEXT_CORR_EANONYMOUS_CLASS_DECLARATION_TO_TCLASS:
			if (resolve)
		...
		case ModiscoTGGPackage.ANONYMOUS_CLASS_TYPE_INTERFACE_MARKER__CONTEXT_CORR_PARENT_TO_PARENT:
			if (resolve)
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ModiscoTGGPackage.ANONYMOUS_CLASS_TYPE_INTERFACE_MARKER__CONTEXT_TRG_TCLASS:
			...
			return;
		case ModiscoTGGPackage.ANONYMOUS_CLASS_TYPE_INTERFACE_MARKER__CONTEXT_TRG_TPARENT:
			setCONTEXT__TRG__tParent((TInterface) newValue);
			return;
		case ModiscoTGGPackage.ANONYMOUS_CLASS_TYPE_INTERFACE_MARKER__CONTEXT_CORR_EANONYMOUS_CLASS_DECLARATION_TO_TCLASS:
	...
	public void eUnset(int featureID) {
		...
		case ModiscoTGGPackage.ANONYMOUS_CLASS_TYPE_INTERFACE_MARKER__CONTEXT_TRG_TCLASS:
			...
			return;
		case ModiscoTGGPackage.ANONYMOUS_CLASS_TYPE_INTERFACE_MARKER__CONTEXT_TRG_TPARENT:
			setCONTEXT__TRG__tParent((TInterface) null);
			return;
		case ModiscoTGGPackage.ANONYMOUS_CLASS_TYPE_INTERFACE_MARKER__CONTEXT_CORR_EANONYMOUS_CLASS_DECLARATION_TO_TCLASS:
...
} //AnonymousClassTypeInterface__MarkerImpl
