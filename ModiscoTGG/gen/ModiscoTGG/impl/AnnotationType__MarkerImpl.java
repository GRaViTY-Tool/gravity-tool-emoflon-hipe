...
import ModiscoTGG.AnnotationType__Marker;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Annotation Type Marker</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ModiscoTGG.impl.AnnotationType__MarkerImpl#getCONTEXT__SRC__mPackage <em>CONTEXT SRC mPackage</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationType__MarkerImpl#getCREATE__SRC__mType <em>CREATE SRC mType</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationType__MarkerImpl#getCONTEXT__TRG__pg <em>CONTEXT TRG pg</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationType__MarkerImpl#getCONTEXT__TRG__tPackage <em>CONTEXT TRG tPackage</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationType__MarkerImpl#getCREATE__TRG__tType <em>CREATE TRG tType</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationType__MarkerImpl#getCREATE__CORR__mBodyToTAnnotation <em>CREATE CORR mBody To TAnnotation</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationType__MarkerImpl#getCONTEXT__CORR__mPackageToTPackage <em>CONTEXT CORR mPackage To TPackage</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationType__MarkerImpl#getCREATE__CORR__mTypeToTType <em>CREATE CORR mType To TType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnnotationType__MarkerImpl extends TGGRuleApplicationImpl implements AnnotationType__Marker {
	/**
	 ...
	 * @ordered
	 */
	protected AnnotationTypeDeclaration creatE__SRC__mType;
	 ...
	 * @ordered
	 */
	protected TAnnotationType creatE__TRG__tType;
	 ...
	 * @generated
	 */
	protected AnnotationType__MarkerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModiscoTGGPackage.eINSTANCE.getAnnotationType__Marker();
	}
			...
			if (contexT__SRC__mPackage != oldCONTEXT__SRC__mPackage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CONTEXT_SRC_MPACKAGE, oldCONTEXT__SRC__mPackage,
	 ...
	 */
	@Override
	public AnnotationTypeDeclaration getCREATE__SRC__mType() {
		if (creatE__SRC__mType != null && creatE__SRC__mType.eIsProxy()) {
			...
			creatE__SRC__mType = (AnnotationTypeDeclaration) eResolveProxy(oldCREATE__SRC__mType);
			if (creatE__SRC__mType != oldCREATE__SRC__mType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CREATE_SRC_MTYPE, oldCREATE__SRC__mType,
							creatE__SRC__mType));
			}
		}
	 ...
	 * @generated
	 */
	public AnnotationTypeDeclaration basicGetCREATE__SRC__mType() {
		return creatE__SRC__mType;
	}
	 ...
	 */
	@Override
	public void setCREATE__SRC__mType(AnnotationTypeDeclaration newCREATE__SRC__mType) {
		AnnotationTypeDeclaration oldCREATE__SRC__mType = creatE__SRC__mType;
	...
	public TypeGraph getCONTEXT__TRG__pg() {
		if (contexT__TRG__pg != null && contexT__TRG__pg.eIsProxy()) {
			...
			if (contexT__TRG__pg != oldCONTEXT__TRG__pg) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CONTEXT_TRG_PG, oldCONTEXT__TRG__pg,
							contexT__TRG__pg));
			}
		}
	...
	public void setCONTEXT__TRG__pg(TypeGraph newCONTEXT__TRG__pg) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CONTEXT_TRG_PG, oldCONTEXT__TRG__pg, contexT__TRG__pg));
	}
	...
	public TPackage getCONTEXT__TRG__tPackage() {
		if (contexT__TRG__tPackage != null && contexT__TRG__tPackage.eIsProxy()) {
			...
			if (contexT__TRG__tPackage != oldCONTEXT__TRG__tPackage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CONTEXT_TRG_TPACKAGE, oldCONTEXT__TRG__tPackage,
	 ...
	 */
	@Override
	public TAnnotationType getCREATE__TRG__tType() {
		if (creatE__TRG__tType != null && creatE__TRG__tType.eIsProxy()) {
			...
			creatE__TRG__tType = (TAnnotationType) eResolveProxy(oldCREATE__TRG__tType);
			if (creatE__TRG__tType != oldCREATE__TRG__tType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CREATE_TRG_TTYPE, oldCREATE__TRG__tType,
							creatE__TRG__tType));
			}
		}
	 ...
	 * @generated
	 */
	public TAnnotationType basicGetCREATE__TRG__tType() {
		return creatE__TRG__tType;
	}
	 ...
	 */
	@Override
	public void setCREATE__TRG__tType(TAnnotationType newCREATE__TRG__tType) {
		TAnnotationType oldCREATE__TRG__tType = creatE__TRG__tType;
	...
	public ASTNodeToTAnnotatable getCREATE__CORR__mBodyToTAnnotation() {
		if (creatE__CORR__mBodyToTAnnotation != null && creatE__CORR__mBodyToTAnnotation.eIsProxy()) {
			...
			if (creatE__CORR__mBodyToTAnnotation != oldCREATE__CORR__mBodyToTAnnotation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CREATE_CORR_MBODY_TO_TANNOTATION,
	...
	public PackageToTPackage getCONTEXT__CORR__mPackageToTPackage() {
		if (contexT__CORR__mPackageToTPackage != null && contexT__CORR__mPackageToTPackage.eIsProxy()) {
			...
			if (contexT__CORR__mPackageToTPackage != oldCONTEXT__CORR__mPackageToTPackage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CONTEXT_CORR_MPACKAGE_TO_TPACKAGE,
	...
	public TypeToTAbstractType getCREATE__CORR__mTypeToTType() {
		if (creatE__CORR__mTypeToTType != null && creatE__CORR__mTypeToTType.eIsProxy()) {
			...
			if (creatE__CORR__mTypeToTType != oldCREATE__CORR__mTypeToTType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CREATE_CORR_MTYPE_TO_TTYPE,
	...
	public void setCREATE__CORR__mTypeToTType(TypeToTAbstractType newCREATE__CORR__mTypeToTType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CREATE_CORR_MTYPE_TO_TTYPE, oldCREATE__CORR__mTypeToTType,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CONTEXT_SRC_MPACKAGE:
			if (resolve)
				return getCONTEXT__SRC__mPackage();
			return basicGetCONTEXT__SRC__mPackage();
		case ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CREATE_SRC_MTYPE:
			if (resolve)
				return getCREATE__SRC__mType();
			return basicGetCREATE__SRC__mType();
		case ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CONTEXT_TRG_PG:
			if (resolve)
				return getCONTEXT__TRG__pg();
			return basicGetCONTEXT__TRG__pg();
		case ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CONTEXT_TRG_TPACKAGE:
			if (resolve)
				return getCONTEXT__TRG__tPackage();
			return basicGetCONTEXT__TRG__tPackage();
		case ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CREATE_TRG_TTYPE:
			if (resolve)
				return getCREATE__TRG__tType();
			return basicGetCREATE__TRG__tType();
		case ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CREATE_CORR_MBODY_TO_TANNOTATION:
			if (resolve)
				return getCREATE__CORR__mBodyToTAnnotation();
			return basicGetCREATE__CORR__mBodyToTAnnotation();
		case ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CONTEXT_CORR_MPACKAGE_TO_TPACKAGE:
			if (resolve)
				return getCONTEXT__CORR__mPackageToTPackage();
			return basicGetCONTEXT__CORR__mPackageToTPackage();
		case ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CREATE_CORR_MTYPE_TO_TTYPE:
			if (resolve)
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CONTEXT_SRC_MPACKAGE:
			...
			return;
		case ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CREATE_SRC_MTYPE:
			setCREATE__SRC__mType((AnnotationTypeDeclaration) newValue);
			return;
		case ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CONTEXT_TRG_PG:
		...
		case ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CONTEXT_TRG_TPACKAGE:
			...
			return;
		case ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CREATE_TRG_TTYPE:
			setCREATE__TRG__tType((TAnnotationType) newValue);
			return;
		case ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CREATE_CORR_MBODY_TO_TANNOTATION:
	...
	public void eUnset(int featureID) {
		...
		case ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CONTEXT_SRC_MPACKAGE:
			...
			return;
		case ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CREATE_SRC_MTYPE:
			setCREATE__SRC__mType((AnnotationTypeDeclaration) null);
			return;
		case ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CONTEXT_TRG_PG:
		...
		case ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CONTEXT_TRG_TPACKAGE:
			...
			return;
		case ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CREATE_TRG_TTYPE:
			setCREATE__TRG__tType((TAnnotationType) null);
			return;
		case ModiscoTGGPackage.ANNOTATION_TYPE_MARKER__CREATE_CORR_MBODY_TO_TANNOTATION:
