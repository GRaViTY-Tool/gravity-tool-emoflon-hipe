...
import ModiscoTGG.PrimitiveTypeIsByte__Marker;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Primitive Type Is Byte Marker</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ModiscoTGG.impl.PrimitiveTypeIsByte__MarkerImpl#getCONTEXT__SRC__eModel <em>CONTEXT SRC eModel</em>}</li>
 *   <li>{@link ModiscoTGG.impl.PrimitiveTypeIsByte__MarkerImpl#getCREATE__SRC__ePrimitiveType <em>CREATE SRC ePrimitive Type</em>}</li>
 *   <li>{@link ModiscoTGG.impl.PrimitiveTypeIsByte__MarkerImpl#getCREATE__TRG__tPrimitiveClass <em>CREATE TRG tPrimitive Class</em>}</li>
 *   <li>{@link ModiscoTGG.impl.PrimitiveTypeIsByte__MarkerImpl#getCONTEXT__TRG__typeGraph <em>CONTEXT TRG type Graph</em>}</li>
 *   <li>{@link ModiscoTGG.impl.PrimitiveTypeIsByte__MarkerImpl#getCONTEXT__CORR__eModelToTypeGraph <em>CONTEXT CORR eModel To Type Graph</em>}</li>
 *   <li>{@link ModiscoTGG.impl.PrimitiveTypeIsByte__MarkerImpl#getCREATE__CORR__ePrimitiveTypeToTPrimitiveClass <em>CREATE CORR ePrimitive Type To TPrimitive Class</em>}</li>
 *   <li>{@link ModiscoTGG.impl.PrimitiveTypeIsByte__MarkerImpl#getCREATE__CORR__typeToTAbstractType <em>CREATE CORR type To TAbstract Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrimitiveTypeIsByte__MarkerImpl extends TGGRuleApplicationImpl implements PrimitiveTypeIsByte__Marker {
	/**
	 ...
	 * @ordered
	 */
	protected PrimitiveTypeByte creatE__SRC__ePrimitiveType;
	 ...
	 * @generated
	 */
	protected PrimitiveTypeIsByte__MarkerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModiscoTGGPackage.eINSTANCE.getPrimitiveTypeIsByte__Marker();
	}
			...
			if (contexT__SRC__eModel != oldCONTEXT__SRC__eModel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.PRIMITIVE_TYPE_IS_BYTE_MARKER__CONTEXT_SRC_EMODEL,
	...
	public void setCONTEXT__SRC__eModel(Model newCONTEXT__SRC__eModel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.PRIMITIVE_TYPE_IS_BYTE_MARKER__CONTEXT_SRC_EMODEL, oldCONTEXT__SRC__eModel,
	 ...
	 */
	@Override
	public PrimitiveTypeByte getCREATE__SRC__ePrimitiveType() {
		if (creatE__SRC__ePrimitiveType != null && creatE__SRC__ePrimitiveType.eIsProxy()) {
			...
			creatE__SRC__ePrimitiveType = (PrimitiveTypeByte) eResolveProxy(oldCREATE__SRC__ePrimitiveType);
			if (creatE__SRC__ePrimitiveType != oldCREATE__SRC__ePrimitiveType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.PRIMITIVE_TYPE_IS_BYTE_MARKER__CREATE_SRC_EPRIMITIVE_TYPE,
	 ...
	 * @generated
	 */
	public PrimitiveTypeByte basicGetCREATE__SRC__ePrimitiveType() {
		return creatE__SRC__ePrimitiveType;
	}
	 ...
	 */
	@Override
	public void setCREATE__SRC__ePrimitiveType(PrimitiveTypeByte newCREATE__SRC__ePrimitiveType) {
		PrimitiveTypeByte oldCREATE__SRC__ePrimitiveType = creatE__SRC__ePrimitiveType;
	...
	public TClass getCREATE__TRG__tPrimitiveClass() {
		if (creatE__TRG__tPrimitiveClass != null && creatE__TRG__tPrimitiveClass.eIsProxy()) {
			...
			if (creatE__TRG__tPrimitiveClass != oldCREATE__TRG__tPrimitiveClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.PRIMITIVE_TYPE_IS_BYTE_MARKER__CREATE_TRG_TPRIMITIVE_CLASS,
	...
	public TypeGraph getCONTEXT__TRG__typeGraph() {
		if (contexT__TRG__typeGraph != null && contexT__TRG__typeGraph.eIsProxy()) {
			...
			if (contexT__TRG__typeGraph != oldCONTEXT__TRG__typeGraph) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.PRIMITIVE_TYPE_IS_BYTE_MARKER__CONTEXT_TRG_TYPE_GRAPH,
	...
	public void setCONTEXT__TRG__typeGraph(TypeGraph newCONTEXT__TRG__typeGraph) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.PRIMITIVE_TYPE_IS_BYTE_MARKER__CONTEXT_TRG_TYPE_GRAPH, oldCONTEXT__TRG__typeGraph,
	...
	public ModelToTypeGraph getCONTEXT__CORR__eModelToTypeGraph() {
		if (contexT__CORR__eModelToTypeGraph != null && contexT__CORR__eModelToTypeGraph.eIsProxy()) {
			...
			if (contexT__CORR__eModelToTypeGraph != oldCONTEXT__CORR__eModelToTypeGraph) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.PRIMITIVE_TYPE_IS_BYTE_MARKER__CONTEXT_CORR_EMODEL_TO_TYPE_GRAPH,
	...
	public PrimitiveTypeToTClass getCREATE__CORR__ePrimitiveTypeToTPrimitiveClass() {
		if (creatE__CORR__ePrimitiveTypeToTPrimitiveClass != null
			...
			if (creatE__CORR__ePrimitiveTypeToTPrimitiveClass != oldCREATE__CORR__ePrimitiveTypeToTPrimitiveClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.PRIMITIVE_TYPE_IS_BYTE_MARKER__CREATE_CORR_EPRIMITIVE_TYPE_TO_TPRIMITIVE_CLASS,
							oldCREATE__CORR__ePrimitiveTypeToTPrimitiveClass,
	...
	public TypeToTAbstractType getCREATE__CORR__typeToTAbstractType() {
		if (creatE__CORR__typeToTAbstractType != null && creatE__CORR__typeToTAbstractType.eIsProxy()) {
			...
			if (creatE__CORR__typeToTAbstractType != oldCREATE__CORR__typeToTAbstractType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.PRIMITIVE_TYPE_IS_BYTE_MARKER__CREATE_CORR_TYPE_TO_TABSTRACT_TYPE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoTGGPackage.PRIMITIVE_TYPE_IS_BYTE_MARKER__CONTEXT_SRC_EMODEL:
			if (resolve)
				return getCONTEXT__SRC__eModel();
			return basicGetCONTEXT__SRC__eModel();
		case ModiscoTGGPackage.PRIMITIVE_TYPE_IS_BYTE_MARKER__CREATE_SRC_EPRIMITIVE_TYPE:
			if (resolve)
				return getCREATE__SRC__ePrimitiveType();
			return basicGetCREATE__SRC__ePrimitiveType();
		case ModiscoTGGPackage.PRIMITIVE_TYPE_IS_BYTE_MARKER__CREATE_TRG_TPRIMITIVE_CLASS:
			if (resolve)
				return getCREATE__TRG__tPrimitiveClass();
			return basicGetCREATE__TRG__tPrimitiveClass();
		case ModiscoTGGPackage.PRIMITIVE_TYPE_IS_BYTE_MARKER__CONTEXT_TRG_TYPE_GRAPH:
			if (resolve)
				return getCONTEXT__TRG__typeGraph();
			return basicGetCONTEXT__TRG__typeGraph();
		case ModiscoTGGPackage.PRIMITIVE_TYPE_IS_BYTE_MARKER__CONTEXT_CORR_EMODEL_TO_TYPE_GRAPH:
			if (resolve)
				return getCONTEXT__CORR__eModelToTypeGraph();
			return basicGetCONTEXT__CORR__eModelToTypeGraph();
		case ModiscoTGGPackage.PRIMITIVE_TYPE_IS_BYTE_MARKER__CREATE_CORR_EPRIMITIVE_TYPE_TO_TPRIMITIVE_CLASS:
			if (resolve)
				return getCREATE__CORR__ePrimitiveTypeToTPrimitiveClass();
			return basicGetCREATE__CORR__ePrimitiveTypeToTPrimitiveClass();
		case ModiscoTGGPackage.PRIMITIVE_TYPE_IS_BYTE_MARKER__CREATE_CORR_TYPE_TO_TABSTRACT_TYPE:
			if (resolve)
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ModiscoTGGPackage.PRIMITIVE_TYPE_IS_BYTE_MARKER__CONTEXT_SRC_EMODEL:
			...
			return;
		case ModiscoTGGPackage.PRIMITIVE_TYPE_IS_BYTE_MARKER__CREATE_SRC_EPRIMITIVE_TYPE:
			setCREATE__SRC__ePrimitiveType((PrimitiveTypeByte) newValue);
			return;
		case ModiscoTGGPackage.PRIMITIVE_TYPE_IS_BYTE_MARKER__CREATE_TRG_TPRIMITIVE_CLASS:
	...
	public void eUnset(int featureID) {
		...
		case ModiscoTGGPackage.PRIMITIVE_TYPE_IS_BYTE_MARKER__CONTEXT_SRC_EMODEL:
			...
			return;
		case ModiscoTGGPackage.PRIMITIVE_TYPE_IS_BYTE_MARKER__CREATE_SRC_EPRIMITIVE_TYPE:
			setCREATE__SRC__ePrimitiveType((PrimitiveTypeByte) null);
			return;
		case ModiscoTGGPackage.PRIMITIVE_TYPE_IS_BYTE_MARKER__CREATE_TRG_TPRIMITIVE_CLASS:
...
} //PrimitiveTypeIsByte__MarkerImpl
