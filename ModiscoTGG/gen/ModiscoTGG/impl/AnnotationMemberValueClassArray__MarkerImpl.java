...
import ModiscoTGG.AnnotationMemberValueClassArray__Marker;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Annotation Member Value Class Array Marker</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ModiscoTGG.impl.AnnotationMemberValueClassArray__MarkerImpl#getCONTEXT__SRC__AnnotationValue <em>CONTEXT SRC Annotation Value</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationMemberValueClassArray__MarkerImpl#getCREATE__SRC__mAccess <em>CREATE SRC mAccess</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationMemberValueClassArray__MarkerImpl#getCREATE__SRC__mArray <em>CREATE SRC mArray</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationMemberValueClassArray__MarkerImpl#getCONTEXT__SRC__mType <em>CONTEXT SRC mType</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationMemberValueClassArray__MarkerImpl#getCREATE__SRC__mValue <em>CREATE SRC mValue</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationMemberValueClassArray__MarkerImpl#getCONTEXT__TRG__tAnnotationValue <em>CONTEXT TRG tAnnotation Value</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationMemberValueClassArray__MarkerImpl#getCONTEXT__TRG__tType <em>CONTEXT TRG tType</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationMemberValueClassArray__MarkerImpl#getCREATE__TRG__tValue <em>CREATE TRG tValue</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationMemberValueClassArray__MarkerImpl#getCONTEXT__CORR__AnnotationMemberValuePairToTAnnotationValue <em>CONTEXT CORR Annotation Member Value Pair To TAnnotation Value</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationMemberValueClassArray__MarkerImpl#getCONTEXT__CORR__mTypeToTType <em>CONTEXT CORR mType To TType</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationMemberValueClassArray__MarkerImpl#getCREATE__CORR__mValueToTValue <em>CREATE CORR mValue To TValue</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnnotationMemberValueClassArray__MarkerImpl extends TGGRuleApplicationImpl
		implements AnnotationMemberValueClassArray__Marker {
	/**
	 ...
	 * @generated
	 */
	protected AnnotationMemberValueClassArray__MarkerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModiscoTGGPackage.eINSTANCE.getAnnotationMemberValueClassArray__Marker();
	}
			...
			if (contexT__SRC__AnnotationValue != oldCONTEXT__SRC__AnnotationValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_CLASS_ARRAY_MARKER__CONTEXT_SRC_ANNOTATION_VALUE,
	...
	public TypeAccess getCREATE__SRC__mAccess() {
		if (creatE__SRC__mAccess != null && creatE__SRC__mAccess.eIsProxy()) {
			...
			if (creatE__SRC__mAccess != oldCREATE__SRC__mAccess) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_CLASS_ARRAY_MARKER__CREATE_SRC_MACCESS,
	...
	public ArrayInitializer getCREATE__SRC__mArray() {
		if (creatE__SRC__mArray != null && creatE__SRC__mArray.eIsProxy()) {
			...
			if (creatE__SRC__mArray != oldCREATE__SRC__mArray) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_CLASS_ARRAY_MARKER__CREATE_SRC_MARRAY,
	...
	public Type getCONTEXT__SRC__mType() {
		if (contexT__SRC__mType != null && contexT__SRC__mType.eIsProxy()) {
			...
			if (contexT__SRC__mType != oldCONTEXT__SRC__mType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_CLASS_ARRAY_MARKER__CONTEXT_SRC_MTYPE,
	...
	public TypeLiteral getCREATE__SRC__mValue() {
		if (creatE__SRC__mValue != null && creatE__SRC__mValue.eIsProxy()) {
			...
			if (creatE__SRC__mValue != oldCREATE__SRC__mValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_CLASS_ARRAY_MARKER__CREATE_SRC_MVALUE,
	...
	public TAnnotationValue getCONTEXT__TRG__tAnnotationValue() {
		if (contexT__TRG__tAnnotationValue != null && contexT__TRG__tAnnotationValue.eIsProxy()) {
			...
			if (contexT__TRG__tAnnotationValue != oldCONTEXT__TRG__tAnnotationValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_CLASS_ARRAY_MARKER__CONTEXT_TRG_TANNOTATION_VALUE,
	...
	public TAbstractType getCONTEXT__TRG__tType() {
		if (contexT__TRG__tType != null && contexT__TRG__tType.eIsProxy()) {
			...
			if (contexT__TRG__tType != oldCONTEXT__TRG__tType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_CLASS_ARRAY_MARKER__CONTEXT_TRG_TTYPE,
	...
	public TClassNode getCREATE__TRG__tValue() {
		if (creatE__TRG__tValue != null && creatE__TRG__tValue.eIsProxy()) {
			...
			if (creatE__TRG__tValue != oldCREATE__TRG__tValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_CLASS_ARRAY_MARKER__CREATE_TRG_TVALUE,
	...
	public AnnotationMemberValuePairToTAnnotationValue getCONTEXT__CORR__AnnotationMemberValuePairToTAnnotationValue() {
		if (contexT__CORR__AnnotationMemberValuePairToTAnnotationValue != null
			...
			if (contexT__CORR__AnnotationMemberValuePairToTAnnotationValue != oldCONTEXT__CORR__AnnotationMemberValuePairToTAnnotationValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_CLASS_ARRAY_MARKER__CONTEXT_CORR_ANNOTATION_MEMBER_VALUE_PAIR_TO_TANNOTATION_VALUE,
							oldCONTEXT__CORR__AnnotationMemberValuePairToTAnnotationValue,
	...
	public TypeToTAbstractType getCONTEXT__CORR__mTypeToTType() {
		if (contexT__CORR__mTypeToTType != null && contexT__CORR__mTypeToTType.eIsProxy()) {
			...
			if (contexT__CORR__mTypeToTType != oldCONTEXT__CORR__mTypeToTType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_CLASS_ARRAY_MARKER__CONTEXT_CORR_MTYPE_TO_TTYPE,
	...
	public ClassLiteralToClassNode getCREATE__CORR__mValueToTValue() {
		if (creatE__CORR__mValueToTValue != null && creatE__CORR__mValueToTValue.eIsProxy()) {
			...
			if (creatE__CORR__mValueToTValue != oldCREATE__CORR__mValueToTValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_CLASS_ARRAY_MARKER__CREATE_CORR_MVALUE_TO_TVALUE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_CLASS_ARRAY_MARKER__CONTEXT_SRC_ANNOTATION_VALUE:
			if (resolve)
				return getCONTEXT__SRC__AnnotationValue();
			return basicGetCONTEXT__SRC__AnnotationValue();
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_CLASS_ARRAY_MARKER__CREATE_SRC_MACCESS:
			if (resolve)
				return getCREATE__SRC__mAccess();
			return basicGetCREATE__SRC__mAccess();
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_CLASS_ARRAY_MARKER__CREATE_SRC_MARRAY:
			if (resolve)
				return getCREATE__SRC__mArray();
			return basicGetCREATE__SRC__mArray();
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_CLASS_ARRAY_MARKER__CONTEXT_SRC_MTYPE:
			if (resolve)
				return getCONTEXT__SRC__mType();
			return basicGetCONTEXT__SRC__mType();
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_CLASS_ARRAY_MARKER__CREATE_SRC_MVALUE:
			if (resolve)
				return getCREATE__SRC__mValue();
			return basicGetCREATE__SRC__mValue();
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_CLASS_ARRAY_MARKER__CONTEXT_TRG_TANNOTATION_VALUE:
			if (resolve)
				return getCONTEXT__TRG__tAnnotationValue();
			return basicGetCONTEXT__TRG__tAnnotationValue();
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_CLASS_ARRAY_MARKER__CONTEXT_TRG_TTYPE:
			if (resolve)
				return getCONTEXT__TRG__tType();
			return basicGetCONTEXT__TRG__tType();
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_CLASS_ARRAY_MARKER__CREATE_TRG_TVALUE:
			if (resolve)
				return getCREATE__TRG__tValue();
			return basicGetCREATE__TRG__tValue();
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_CLASS_ARRAY_MARKER__CONTEXT_CORR_ANNOTATION_MEMBER_VALUE_PAIR_TO_TANNOTATION_VALUE:
			if (resolve)
		...
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_CLASS_ARRAY_MARKER__CONTEXT_CORR_MTYPE_TO_TTYPE:
			if (resolve)
				return getCONTEXT__CORR__mTypeToTType();
			return basicGetCONTEXT__CORR__mTypeToTType();
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_CLASS_ARRAY_MARKER__CREATE_CORR_MVALUE_TO_TVALUE:
			if (resolve)
...
} //AnnotationMemberValueClassArray__MarkerImpl
