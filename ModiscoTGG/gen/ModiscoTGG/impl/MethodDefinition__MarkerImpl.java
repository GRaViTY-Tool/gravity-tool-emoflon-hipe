...
import ModiscoTGG.MethodDefinition__Marker;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Method Definition Marker</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ModiscoTGG.impl.MethodDefinition__MarkerImpl#getCREATE__SRC__mDefinition <em>CREATE SRC mDefinition</em>}</li>
 *   <li>{@link ModiscoTGG.impl.MethodDefinition__MarkerImpl#getCONTEXT__SRC__mSignature <em>CONTEXT SRC mSignature</em>}</li>
 *   <li>{@link ModiscoTGG.impl.MethodDefinition__MarkerImpl#getCREATE__TRG__tDefinition <em>CREATE TRG tDefinition</em>}</li>
 *   <li>{@link ModiscoTGG.impl.MethodDefinition__MarkerImpl#getCONTEXT__TRG__tMethodSignature <em>CONTEXT TRG tMethod Signature</em>}</li>
 *   <li>{@link ModiscoTGG.impl.MethodDefinition__MarkerImpl#getCREATE__CORR__mBodyToTAnnotation <em>CREATE CORR mBody To TAnnotation</em>}</li>
 *   <li>{@link ModiscoTGG.impl.MethodDefinition__MarkerImpl#getCREATE__CORR__mDefinitionToTMember <em>CREATE CORR mDefinition To TMember</em>}</li>
 *   <li>{@link ModiscoTGG.impl.MethodDefinition__MarkerImpl#getCREATE__CORR__mFlowElementToTFlowElement <em>CREATE CORR mFlow Element To TFlow Element</em>}</li>
 *   <li>{@link ModiscoTGG.impl.MethodDefinition__MarkerImpl#getCONTEXT__CORR__mSignatureToTMethodSignature <em>CONTEXT CORR mSignature To TMethod Signature</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MethodDefinition__MarkerImpl extends TGGRuleApplicationImpl implements MethodDefinition__Marker {
	/**
	 ...
	 * @ordered
	 */
	protected MMethodDefinition creatE__SRC__mDefinition;
	 ...
	 * @generated
	 */
	protected MethodDefinition__MarkerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModiscoTGGPackage.eINSTANCE.getMethodDefinition__Marker();
	}
	 ...
	 */
	@Override
	public MMethodDefinition getCREATE__SRC__mDefinition() {
		if (creatE__SRC__mDefinition != null && creatE__SRC__mDefinition.eIsProxy()) {
			...
			creatE__SRC__mDefinition = (MMethodDefinition) eResolveProxy(oldCREATE__SRC__mDefinition);
			if (creatE__SRC__mDefinition != oldCREATE__SRC__mDefinition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.METHOD_DEFINITION_MARKER__CREATE_SRC_MDEFINITION,
	 ...
	 * @generated
	 */
	public MMethodDefinition basicGetCREATE__SRC__mDefinition() {
		return creatE__SRC__mDefinition;
	}
	 ...
	 */
	@Override
	public void setCREATE__SRC__mDefinition(MMethodDefinition newCREATE__SRC__mDefinition) {
		MMethodDefinition oldCREATE__SRC__mDefinition = creatE__SRC__mDefinition;
		creatE__SRC__mDefinition = newCREATE__SRC__mDefinition;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.METHOD_DEFINITION_MARKER__CREATE_SRC_MDEFINITION, oldCREATE__SRC__mDefinition,
	...
	public MMethodSignature getCONTEXT__SRC__mSignature() {
		if (contexT__SRC__mSignature != null && contexT__SRC__mSignature.eIsProxy()) {
			...
			if (contexT__SRC__mSignature != oldCONTEXT__SRC__mSignature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.METHOD_DEFINITION_MARKER__CONTEXT_SRC_MSIGNATURE,
	...
	public void setCONTEXT__SRC__mSignature(MMethodSignature newCONTEXT__SRC__mSignature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.METHOD_DEFINITION_MARKER__CONTEXT_SRC_MSIGNATURE, oldCONTEXT__SRC__mSignature,
	...
	public TMethodDefinition getCREATE__TRG__tDefinition() {
		if (creatE__TRG__tDefinition != null && creatE__TRG__tDefinition.eIsProxy()) {
			...
			if (creatE__TRG__tDefinition != oldCREATE__TRG__tDefinition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.METHOD_DEFINITION_MARKER__CREATE_TRG_TDEFINITION,
	...
	public void setCREATE__TRG__tDefinition(TMethodDefinition newCREATE__TRG__tDefinition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.METHOD_DEFINITION_MARKER__CREATE_TRG_TDEFINITION, oldCREATE__TRG__tDefinition,
	...
	public TMethodSignature getCONTEXT__TRG__tMethodSignature() {
		if (contexT__TRG__tMethodSignature != null && contexT__TRG__tMethodSignature.eIsProxy()) {
			...
			if (contexT__TRG__tMethodSignature != oldCONTEXT__TRG__tMethodSignature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.METHOD_DEFINITION_MARKER__CONTEXT_TRG_TMETHOD_SIGNATURE,
	...
	public ASTNodeToTAnnotatable getCREATE__CORR__mBodyToTAnnotation() {
		if (creatE__CORR__mBodyToTAnnotation != null && creatE__CORR__mBodyToTAnnotation.eIsProxy()) {
			...
			if (creatE__CORR__mBodyToTAnnotation != oldCREATE__CORR__mBodyToTAnnotation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.METHOD_DEFINITION_MARKER__CREATE_CORR_MBODY_TO_TANNOTATION,
	...
	public MDefinitionToTMember getCREATE__CORR__mDefinitionToTMember() {
		if (creatE__CORR__mDefinitionToTMember != null && creatE__CORR__mDefinitionToTMember.eIsProxy()) {
			...
			if (creatE__CORR__mDefinitionToTMember != oldCREATE__CORR__mDefinitionToTMember) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.METHOD_DEFINITION_MARKER__CREATE_CORR_MDEFINITION_TO_TMEMBER,
	...
	public MAbstractFlowElementToTAbstractFlowElement getCREATE__CORR__mFlowElementToTFlowElement() {
		if (creatE__CORR__mFlowElementToTFlowElement != null && creatE__CORR__mFlowElementToTFlowElement.eIsProxy()) {
			...
			if (creatE__CORR__mFlowElementToTFlowElement != oldCREATE__CORR__mFlowElementToTFlowElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.METHOD_DEFINITION_MARKER__CREATE_CORR_MFLOW_ELEMENT_TO_TFLOW_ELEMENT,
	...
	public MSignatureToTSignature getCONTEXT__CORR__mSignatureToTMethodSignature() {
		if (contexT__CORR__mSignatureToTMethodSignature != null
			...
			if (contexT__CORR__mSignatureToTMethodSignature != oldCONTEXT__CORR__mSignatureToTMethodSignature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.METHOD_DEFINITION_MARKER__CONTEXT_CORR_MSIGNATURE_TO_TMETHOD_SIGNATURE,
							oldCONTEXT__CORR__mSignatureToTMethodSignature,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoTGGPackage.METHOD_DEFINITION_MARKER__CREATE_SRC_MDEFINITION:
			if (resolve)
				return getCREATE__SRC__mDefinition();
			return basicGetCREATE__SRC__mDefinition();
		case ModiscoTGGPackage.METHOD_DEFINITION_MARKER__CONTEXT_SRC_MSIGNATURE:
			if (resolve)
				return getCONTEXT__SRC__mSignature();
			return basicGetCONTEXT__SRC__mSignature();
		case ModiscoTGGPackage.METHOD_DEFINITION_MARKER__CREATE_TRG_TDEFINITION:
			if (resolve)
				return getCREATE__TRG__tDefinition();
			return basicGetCREATE__TRG__tDefinition();
		case ModiscoTGGPackage.METHOD_DEFINITION_MARKER__CONTEXT_TRG_TMETHOD_SIGNATURE:
			if (resolve)
				return getCONTEXT__TRG__tMethodSignature();
			return basicGetCONTEXT__TRG__tMethodSignature();
		case ModiscoTGGPackage.METHOD_DEFINITION_MARKER__CREATE_CORR_MBODY_TO_TANNOTATION:
			if (resolve)
				return getCREATE__CORR__mBodyToTAnnotation();
			return basicGetCREATE__CORR__mBodyToTAnnotation();
		case ModiscoTGGPackage.METHOD_DEFINITION_MARKER__CREATE_CORR_MDEFINITION_TO_TMEMBER:
			if (resolve)
				return getCREATE__CORR__mDefinitionToTMember();
			return basicGetCREATE__CORR__mDefinitionToTMember();
		case ModiscoTGGPackage.METHOD_DEFINITION_MARKER__CREATE_CORR_MFLOW_ELEMENT_TO_TFLOW_ELEMENT:
			if (resolve)
				return getCREATE__CORR__mFlowElementToTFlowElement();
			return basicGetCREATE__CORR__mFlowElementToTFlowElement();
		case ModiscoTGGPackage.METHOD_DEFINITION_MARKER__CONTEXT_CORR_MSIGNATURE_TO_TMETHOD_SIGNATURE:
			if (resolve)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
		case ModiscoTGGPackage.METHOD_DEFINITION_MARKER__CREATE_SRC_MDEFINITION:
			setCREATE__SRC__mDefinition((MMethodDefinition) newValue);
			return;
		case ModiscoTGGPackage.METHOD_DEFINITION_MARKER__CONTEXT_SRC_MSIGNATURE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
		case ModiscoTGGPackage.METHOD_DEFINITION_MARKER__CREATE_SRC_MDEFINITION:
			setCREATE__SRC__mDefinition((MMethodDefinition) null);
			return;
		case ModiscoTGGPackage.METHOD_DEFINITION_MARKER__CONTEXT_SRC_MSIGNATURE:
