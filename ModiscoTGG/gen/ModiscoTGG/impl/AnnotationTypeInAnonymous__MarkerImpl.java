...
import ModiscoTGG.AnnotationTypeInAnonymous__Marker;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Annotation Type In Anonymous Marker</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ModiscoTGG.impl.AnnotationTypeInAnonymous__MarkerImpl#getCONTEXT__SRC__eAnonymousClassDeclaration <em>CONTEXT SRC eAnonymous Class Declaration</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationTypeInAnonymous__MarkerImpl#getCREATE__SRC__mNestedType <em>CREATE SRC mNested Type</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationTypeInAnonymous__MarkerImpl#getCONTEXT__TRG__pg <em>CONTEXT TRG pg</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationTypeInAnonymous__MarkerImpl#getCONTEXT__TRG__tClass <em>CONTEXT TRG tClass</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationTypeInAnonymous__MarkerImpl#getCREATE__TRG__tNestedType <em>CREATE TRG tNested Type</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationTypeInAnonymous__MarkerImpl#getCONTEXT__CORR__eAnonymousClassDeclarationToTClass <em>CONTEXT CORR eAnonymous Class Declaration To TClass</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationTypeInAnonymous__MarkerImpl#getCREATE__CORR__mNestedTypeToTNestedType <em>CREATE CORR mNested Type To TNested Type</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationTypeInAnonymous__MarkerImpl#getCREATE__CORR__mbodyToTAnnotatable <em>CREATE CORR mbody To TAnnotatable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnnotationTypeInAnonymous__MarkerImpl extends TGGRuleApplicationImpl
		implements AnnotationTypeInAnonymous__Marker {
	/**
	 ...
	 * @ordered
	 */
	protected AnnotationTypeDeclaration creatE__SRC__mNestedType;
	 ...
	 * @generated
	 */
	protected AnnotationTypeInAnonymous__MarkerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModiscoTGGPackage.eINSTANCE.getAnnotationTypeInAnonymous__Marker();
	}
			...
			if (contexT__SRC__eAnonymousClassDeclaration != oldCONTEXT__SRC__eAnonymousClassDeclaration) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_IN_ANONYMOUS_MARKER__CONTEXT_SRC_EANONYMOUS_CLASS_DECLARATION,
	 ...
	 */
	@Override
	public AnnotationTypeDeclaration getCREATE__SRC__mNestedType() {
		if (creatE__SRC__mNestedType != null && creatE__SRC__mNestedType.eIsProxy()) {
			...
			creatE__SRC__mNestedType = (AnnotationTypeDeclaration) eResolveProxy(oldCREATE__SRC__mNestedType);
			if (creatE__SRC__mNestedType != oldCREATE__SRC__mNestedType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_IN_ANONYMOUS_MARKER__CREATE_SRC_MNESTED_TYPE,
	 ...
	 * @generated
	 */
	public AnnotationTypeDeclaration basicGetCREATE__SRC__mNestedType() {
		return creatE__SRC__mNestedType;
	}
	 ...
	 */
	@Override
	public void setCREATE__SRC__mNestedType(AnnotationTypeDeclaration newCREATE__SRC__mNestedType) {
		AnnotationTypeDeclaration oldCREATE__SRC__mNestedType = creatE__SRC__mNestedType;
	...
	public TypeGraph getCONTEXT__TRG__pg() {
		if (contexT__TRG__pg != null && contexT__TRG__pg.eIsProxy()) {
			...
			if (contexT__TRG__pg != oldCONTEXT__TRG__pg) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_IN_ANONYMOUS_MARKER__CONTEXT_TRG_PG, oldCONTEXT__TRG__pg,
							contexT__TRG__pg));
			}
		}
	...
	public TClass getCONTEXT__TRG__tClass() {
		if (contexT__TRG__tClass != null && contexT__TRG__tClass.eIsProxy()) {
			...
			if (contexT__TRG__tClass != oldCONTEXT__TRG__tClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_IN_ANONYMOUS_MARKER__CONTEXT_TRG_TCLASS,
	...
	public void setCONTEXT__TRG__tClass(TClass newCONTEXT__TRG__tClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.ANNOTATION_TYPE_IN_ANONYMOUS_MARKER__CONTEXT_TRG_TCLASS, oldCONTEXT__TRG__tClass,
	...
	public TAnnotationType getCREATE__TRG__tNestedType() {
		if (creatE__TRG__tNestedType != null && creatE__TRG__tNestedType.eIsProxy()) {
			...
			if (creatE__TRG__tNestedType != oldCREATE__TRG__tNestedType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_IN_ANONYMOUS_MARKER__CREATE_TRG_TNESTED_TYPE,
	...
	public AnonymousClassDeclarationToTClass getCONTEXT__CORR__eAnonymousClassDeclarationToTClass() {
		if (contexT__CORR__eAnonymousClassDeclarationToTClass != null
			...
			if (contexT__CORR__eAnonymousClassDeclarationToTClass != oldCONTEXT__CORR__eAnonymousClassDeclarationToTClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_IN_ANONYMOUS_MARKER__CONTEXT_CORR_EANONYMOUS_CLASS_DECLARATION_TO_TCLASS,
							oldCONTEXT__CORR__eAnonymousClassDeclarationToTClass,
	...
	public TypeToTAbstractType getCREATE__CORR__mNestedTypeToTNestedType() {
		if (creatE__CORR__mNestedTypeToTNestedType != null && creatE__CORR__mNestedTypeToTNestedType.eIsProxy()) {
			...
			if (creatE__CORR__mNestedTypeToTNestedType != oldCREATE__CORR__mNestedTypeToTNestedType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_IN_ANONYMOUS_MARKER__CREATE_CORR_MNESTED_TYPE_TO_TNESTED_TYPE,
	...
	public ASTNodeToTAnnotatable getCREATE__CORR__mbodyToTAnnotatable() {
		if (creatE__CORR__mbodyToTAnnotatable != null && creatE__CORR__mbodyToTAnnotatable.eIsProxy()) {
			...
			if (creatE__CORR__mbodyToTAnnotatable != oldCREATE__CORR__mbodyToTAnnotatable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_IN_ANONYMOUS_MARKER__CREATE_CORR_MBODY_TO_TANNOTATABLE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoTGGPackage.ANNOTATION_TYPE_IN_ANONYMOUS_MARKER__CONTEXT_SRC_EANONYMOUS_CLASS_DECLARATION:
			if (resolve)
				return getCONTEXT__SRC__eAnonymousClassDeclaration();
			return basicGetCONTEXT__SRC__eAnonymousClassDeclaration();
		case ModiscoTGGPackage.ANNOTATION_TYPE_IN_ANONYMOUS_MARKER__CREATE_SRC_MNESTED_TYPE:
			if (resolve)
				return getCREATE__SRC__mNestedType();
			return basicGetCREATE__SRC__mNestedType();
		case ModiscoTGGPackage.ANNOTATION_TYPE_IN_ANONYMOUS_MARKER__CONTEXT_TRG_PG:
			if (resolve)
				return getCONTEXT__TRG__pg();
			return basicGetCONTEXT__TRG__pg();
		case ModiscoTGGPackage.ANNOTATION_TYPE_IN_ANONYMOUS_MARKER__CONTEXT_TRG_TCLASS:
			if (resolve)
				return getCONTEXT__TRG__tClass();
			return basicGetCONTEXT__TRG__tClass();
		case ModiscoTGGPackage.ANNOTATION_TYPE_IN_ANONYMOUS_MARKER__CREATE_TRG_TNESTED_TYPE:
			if (resolve)
				return getCREATE__TRG__tNestedType();
			return basicGetCREATE__TRG__tNestedType();
		case ModiscoTGGPackage.ANNOTATION_TYPE_IN_ANONYMOUS_MARKER__CONTEXT_CORR_EANONYMOUS_CLASS_DECLARATION_TO_TCLASS:
			if (resolve)
		...
		case ModiscoTGGPackage.ANNOTATION_TYPE_IN_ANONYMOUS_MARKER__CREATE_CORR_MNESTED_TYPE_TO_TNESTED_TYPE:
			if (resolve)
				return getCREATE__CORR__mNestedTypeToTNestedType();
			return basicGetCREATE__CORR__mNestedTypeToTNestedType();
		case ModiscoTGGPackage.ANNOTATION_TYPE_IN_ANONYMOUS_MARKER__CREATE_CORR_MBODY_TO_TANNOTATABLE:
			if (resolve)
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ModiscoTGGPackage.ANNOTATION_TYPE_IN_ANONYMOUS_MARKER__CONTEXT_SRC_EANONYMOUS_CLASS_DECLARATION:
			...
			return;
		case ModiscoTGGPackage.ANNOTATION_TYPE_IN_ANONYMOUS_MARKER__CREATE_SRC_MNESTED_TYPE:
			setCREATE__SRC__mNestedType((AnnotationTypeDeclaration) newValue);
			return;
		case ModiscoTGGPackage.ANNOTATION_TYPE_IN_ANONYMOUS_MARKER__CONTEXT_TRG_PG:
	...
	public void eUnset(int featureID) {
		...
		case ModiscoTGGPackage.ANNOTATION_TYPE_IN_ANONYMOUS_MARKER__CONTEXT_SRC_EANONYMOUS_CLASS_DECLARATION:
			...
			return;
		case ModiscoTGGPackage.ANNOTATION_TYPE_IN_ANONYMOUS_MARKER__CREATE_SRC_MNESTED_TYPE:
			setCREATE__SRC__mNestedType((AnnotationTypeDeclaration) null);
			return;
		case ModiscoTGGPackage.ANNOTATION_TYPE_IN_ANONYMOUS_MARKER__CONTEXT_TRG_PG:
...
} //AnnotationTypeInAnonymous__MarkerImpl
