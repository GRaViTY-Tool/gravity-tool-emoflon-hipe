...
import ModiscoTGG.ClassInnerAnonClassMember__Marker;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Class Inner Anon Class Member Marker</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ModiscoTGG.impl.ClassInnerAnonClassMember__MarkerImpl#getCONTEXT__SRC__eOuterClass <em>CONTEXT SRC eOuter Class</em>}</li>
 *   <li>{@link ModiscoTGG.impl.ClassInnerAnonClassMember__MarkerImpl#getCONTEXT__SRC__mDefinition <em>CONTEXT SRC mDefinition</em>}</li>
 *   <li>{@link ModiscoTGG.impl.ClassInnerAnonClassMember__MarkerImpl#getCREATE__SRC__mInnerClass <em>CREATE SRC mInner Class</em>}</li>
 *   <li>{@link ModiscoTGG.impl.ClassInnerAnonClassMember__MarkerImpl#getCREATE__TRG__tInnerClass <em>CREATE TRG tInner Class</em>}</li>
 *   <li>{@link ModiscoTGG.impl.ClassInnerAnonClassMember__MarkerImpl#getCREATE__TRG__tInnerPackage <em>CREATE TRG tInner Package</em>}</li>
 *   <li>{@link ModiscoTGG.impl.ClassInnerAnonClassMember__MarkerImpl#getCONTEXT__TRG__tOuterClass <em>CONTEXT TRG tOuter Class</em>}</li>
 *   <li>{@link ModiscoTGG.impl.ClassInnerAnonClassMember__MarkerImpl#getCONTEXT__TRG__tOuterPackage <em>CONTEXT TRG tOuter Package</em>}</li>
 *   <li>{@link ModiscoTGG.impl.ClassInnerAnonClassMember__MarkerImpl#getCONTEXT__TRG__typeGraph <em>CONTEXT TRG type Graph</em>}</li>
 *   <li>{@link ModiscoTGG.impl.ClassInnerAnonClassMember__MarkerImpl#getCONTEXT__CORR__eOuterClassToTOuterClass <em>CONTEXT CORR eOuter Class To TOuter Class</em>}</li>
 *   <li>{@link ModiscoTGG.impl.ClassInnerAnonClassMember__MarkerImpl#getCREATE__CORR__tInnerClassToTInnerClass <em>CREATE CORR tInner Class To TInner Class</em>}</li>
 *   <li>{@link ModiscoTGG.impl.ClassInnerAnonClassMember__MarkerImpl#getCREATE__CORR__tInnerTypeToTInnerAbstractType <em>CREATE CORR tInner Type To TInner Abstract Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClassInnerAnonClassMember__MarkerImpl extends TGGRuleApplicationImpl
		implements ClassInnerAnonClassMember__Marker {
	/**
	 ...
	 * @ordered
	 */
	protected AnonymousClassDeclaration contexT__SRC__eOuterClass;
	 ...
	 * @ordered
	 */
	protected AnonymousClassDeclarationToTClass contexT__CORR__eOuterClassToTOuterClass;
	 ...
	 * @generated
	 */
	protected ClassInnerAnonClassMember__MarkerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModiscoTGGPackage.eINSTANCE.getClassInnerAnonClassMember__Marker();
	}
	 ...
	 */
	@Override
	public AnonymousClassDeclaration getCONTEXT__SRC__eOuterClass() {
		if (contexT__SRC__eOuterClass != null && contexT__SRC__eOuterClass.eIsProxy()) {
			...
			contexT__SRC__eOuterClass = (AnonymousClassDeclaration) eResolveProxy(oldCONTEXT__SRC__eOuterClass);
			if (contexT__SRC__eOuterClass != oldCONTEXT__SRC__eOuterClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CONTEXT_SRC_EOUTER_CLASS,
	 ...
	 * @generated
	 */
	public AnonymousClassDeclaration basicGetCONTEXT__SRC__eOuterClass() {
		return contexT__SRC__eOuterClass;
	}
	 ...
	 */
	@Override
	public void setCONTEXT__SRC__eOuterClass(AnonymousClassDeclaration newCONTEXT__SRC__eOuterClass) {
		AnonymousClassDeclaration oldCONTEXT__SRC__eOuterClass = contexT__SRC__eOuterClass;
	...
	public MAbstractMethodDefinition getCONTEXT__SRC__mDefinition() {
		if (contexT__SRC__mDefinition != null && contexT__SRC__mDefinition.eIsProxy()) {
			...
			if (contexT__SRC__mDefinition != oldCONTEXT__SRC__mDefinition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CONTEXT_SRC_MDEFINITION,
	...
	public MClass getCREATE__SRC__mInnerClass() {
		if (creatE__SRC__mInnerClass != null && creatE__SRC__mInnerClass.eIsProxy()) {
			...
			if (creatE__SRC__mInnerClass != oldCREATE__SRC__mInnerClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CREATE_SRC_MINNER_CLASS,
	...
	public TClass getCREATE__TRG__tInnerClass() {
		if (creatE__TRG__tInnerClass != null && creatE__TRG__tInnerClass.eIsProxy()) {
			...
			if (creatE__TRG__tInnerClass != oldCREATE__TRG__tInnerClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CREATE_TRG_TINNER_CLASS,
	...
	public TPackage getCREATE__TRG__tInnerPackage() {
		if (creatE__TRG__tInnerPackage != null && creatE__TRG__tInnerPackage.eIsProxy()) {
			...
			if (creatE__TRG__tInnerPackage != oldCREATE__TRG__tInnerPackage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CREATE_TRG_TINNER_PACKAGE,
	...
	public TClass getCONTEXT__TRG__tOuterClass() {
		if (contexT__TRG__tOuterClass != null && contexT__TRG__tOuterClass.eIsProxy()) {
			...
			if (contexT__TRG__tOuterClass != oldCONTEXT__TRG__tOuterClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CONTEXT_TRG_TOUTER_CLASS,
	...
	public TPackage getCONTEXT__TRG__tOuterPackage() {
		if (contexT__TRG__tOuterPackage != null && contexT__TRG__tOuterPackage.eIsProxy()) {
			...
			if (contexT__TRG__tOuterPackage != oldCONTEXT__TRG__tOuterPackage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CONTEXT_TRG_TOUTER_PACKAGE,
	...
	public TypeGraph getCONTEXT__TRG__typeGraph() {
		if (contexT__TRG__typeGraph != null && contexT__TRG__typeGraph.eIsProxy()) {
			...
			if (contexT__TRG__typeGraph != oldCONTEXT__TRG__typeGraph) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CONTEXT_TRG_TYPE_GRAPH,
	 ...
	 */
	@Override
	public AnonymousClassDeclarationToTClass getCONTEXT__CORR__eOuterClassToTOuterClass() {
		if (contexT__CORR__eOuterClassToTOuterClass != null && contexT__CORR__eOuterClassToTOuterClass.eIsProxy()) {
			...
			contexT__CORR__eOuterClassToTOuterClass = (AnonymousClassDeclarationToTClass) eResolveProxy(
			...
			if (contexT__CORR__eOuterClassToTOuterClass != oldCONTEXT__CORR__eOuterClassToTOuterClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CONTEXT_CORR_EOUTER_CLASS_TO_TOUTER_CLASS,
	 ...
	 * @generated
	 */
	public AnonymousClassDeclarationToTClass basicGetCONTEXT__CORR__eOuterClassToTOuterClass() {
		return contexT__CORR__eOuterClassToTOuterClass;
	}
	...
	public void setCONTEXT__CORR__eOuterClassToTOuterClass(
			AnonymousClassDeclarationToTClass newCONTEXT__CORR__eOuterClassToTOuterClass) {
		AnonymousClassDeclarationToTClass oldCONTEXT__CORR__eOuterClassToTOuterClass = contexT__CORR__eOuterClassToTOuterClass;
	...
	public ClassDeclarationToTClass getCREATE__CORR__tInnerClassToTInnerClass() {
		if (creatE__CORR__tInnerClassToTInnerClass != null && creatE__CORR__tInnerClassToTInnerClass.eIsProxy()) {
			...
			if (creatE__CORR__tInnerClassToTInnerClass != oldCREATE__CORR__tInnerClassToTInnerClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CREATE_CORR_TINNER_CLASS_TO_TINNER_CLASS,
	...
	public TypeToTAbstractType getCREATE__CORR__tInnerTypeToTInnerAbstractType() {
		if (creatE__CORR__tInnerTypeToTInnerAbstractType != null
			...
			if (creatE__CORR__tInnerTypeToTInnerAbstractType != oldCREATE__CORR__tInnerTypeToTInnerAbstractType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CREATE_CORR_TINNER_TYPE_TO_TINNER_ABSTRACT_TYPE,
							oldCREATE__CORR__tInnerTypeToTInnerAbstractType,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CONTEXT_SRC_EOUTER_CLASS:
			if (resolve)
				return getCONTEXT__SRC__eOuterClass();
			return basicGetCONTEXT__SRC__eOuterClass();
		case ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CONTEXT_SRC_MDEFINITION:
			if (resolve)
				return getCONTEXT__SRC__mDefinition();
			return basicGetCONTEXT__SRC__mDefinition();
		case ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CREATE_SRC_MINNER_CLASS:
			if (resolve)
				return getCREATE__SRC__mInnerClass();
			return basicGetCREATE__SRC__mInnerClass();
		case ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CREATE_TRG_TINNER_CLASS:
			if (resolve)
				return getCREATE__TRG__tInnerClass();
			return basicGetCREATE__TRG__tInnerClass();
		case ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CREATE_TRG_TINNER_PACKAGE:
			if (resolve)
				return getCREATE__TRG__tInnerPackage();
			return basicGetCREATE__TRG__tInnerPackage();
		case ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CONTEXT_TRG_TOUTER_CLASS:
			if (resolve)
				return getCONTEXT__TRG__tOuterClass();
			return basicGetCONTEXT__TRG__tOuterClass();
		case ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CONTEXT_TRG_TOUTER_PACKAGE:
			if (resolve)
				return getCONTEXT__TRG__tOuterPackage();
			return basicGetCONTEXT__TRG__tOuterPackage();
		case ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CONTEXT_TRG_TYPE_GRAPH:
			if (resolve)
				return getCONTEXT__TRG__typeGraph();
			return basicGetCONTEXT__TRG__typeGraph();
		case ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CONTEXT_CORR_EOUTER_CLASS_TO_TOUTER_CLASS:
			if (resolve)
				return getCONTEXT__CORR__eOuterClassToTOuterClass();
			return basicGetCONTEXT__CORR__eOuterClassToTOuterClass();
		case ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CREATE_CORR_TINNER_CLASS_TO_TINNER_CLASS:
			if (resolve)
				return getCREATE__CORR__tInnerClassToTInnerClass();
			return basicGetCREATE__CORR__tInnerClassToTInnerClass();
		case ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CREATE_CORR_TINNER_TYPE_TO_TINNER_ABSTRACT_TYPE:
			if (resolve)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
		case ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CONTEXT_SRC_EOUTER_CLASS:
			setCONTEXT__SRC__eOuterClass((AnonymousClassDeclaration) newValue);
			return;
		case ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CONTEXT_SRC_MDEFINITION:
		...
		case ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CONTEXT_TRG_TYPE_GRAPH:
			...
			return;
		case ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CONTEXT_CORR_EOUTER_CLASS_TO_TOUTER_CLASS:
			setCONTEXT__CORR__eOuterClassToTOuterClass((AnonymousClassDeclarationToTClass) newValue);
			return;
		case ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CREATE_CORR_TINNER_CLASS_TO_TINNER_CLASS:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
		case ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CONTEXT_SRC_EOUTER_CLASS:
			setCONTEXT__SRC__eOuterClass((AnonymousClassDeclaration) null);
			return;
		case ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CONTEXT_SRC_MDEFINITION:
		...
		case ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CONTEXT_TRG_TYPE_GRAPH:
			...
			return;
		case ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CONTEXT_CORR_EOUTER_CLASS_TO_TOUTER_CLASS:
			setCONTEXT__CORR__eOuterClassToTOuterClass((AnonymousClassDeclarationToTClass) null);
			return;
		case ModiscoTGGPackage.CLASS_INNER_ANON_CLASS_MEMBER_MARKER__CREATE_CORR_TINNER_CLASS_TO_TINNER_CLASS:
...
} //ClassInnerAnonClassMember__MarkerImpl
