...
import ModiscoTGG.MemberInEnumVisibility__Marker;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Member In Enum Visibility Marker</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ModiscoTGG.impl.MemberInEnumVisibility__MarkerImpl#getCONTEXT__SRC__mClass <em>CONTEXT SRC mClass</em>}</li>
 *   <li>{@link ModiscoTGG.impl.MemberInEnumVisibility__MarkerImpl#getCONTEXT__SRC__mDefinition <em>CONTEXT SRC mDefinition</em>}</li>
 *   <li>{@link ModiscoTGG.impl.MemberInEnumVisibility__MarkerImpl#getCREATE__SRC__mModifier <em>CREATE SRC mModifier</em>}</li>
 *   <li>{@link ModiscoTGG.impl.MemberInEnumVisibility__MarkerImpl#getCONTEXT__TRG__tClass <em>CONTEXT TRG tClass</em>}</li>
 *   <li>{@link ModiscoTGG.impl.MemberInEnumVisibility__MarkerImpl#getCONTEXT__TRG__tMember <em>CONTEXT TRG tMember</em>}</li>
 *   <li>{@link ModiscoTGG.impl.MemberInEnumVisibility__MarkerImpl#getCREATE__TRG__tModifier <em>CREATE TRG tModifier</em>}</li>
 *   <li>{@link ModiscoTGG.impl.MemberInEnumVisibility__MarkerImpl#getCONTEXT__CORR__defToMember <em>CONTEXT CORR def To Member</em>}</li>
 *   <li>{@link ModiscoTGG.impl.MemberInEnumVisibility__MarkerImpl#getCREATE__CORR__mModifierToTModifier <em>CREATE CORR mModifier To TModifier</em>}</li>
 *   <li>{@link ModiscoTGG.impl.MemberInEnumVisibility__MarkerImpl#getCONTEXT__CORR__mTypeToTType <em>CONTEXT CORR mType To TType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MemberInEnumVisibility__MarkerImpl extends TGGRuleApplicationImpl
		implements MemberInEnumVisibility__Marker {
	/**
	 ...
	 * @ordered
	 */
	protected EnumDeclaration contexT__SRC__mClass;
	 ...
	 * @generated
	 */
	protected MemberInEnumVisibility__MarkerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModiscoTGGPackage.eINSTANCE.getMemberInEnumVisibility__Marker();
	}
	 ...
	 */
	@Override
	public EnumDeclaration getCONTEXT__SRC__mClass() {
		if (contexT__SRC__mClass != null && contexT__SRC__mClass.eIsProxy()) {
			...
			contexT__SRC__mClass = (EnumDeclaration) eResolveProxy(oldCONTEXT__SRC__mClass);
			if (contexT__SRC__mClass != oldCONTEXT__SRC__mClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CONTEXT_SRC_MCLASS,
	 ...
	 * @generated
	 */
	public EnumDeclaration basicGetCONTEXT__SRC__mClass() {
		return contexT__SRC__mClass;
	}
	 ...
	 */
	@Override
	public void setCONTEXT__SRC__mClass(EnumDeclaration newCONTEXT__SRC__mClass) {
		EnumDeclaration oldCONTEXT__SRC__mClass = contexT__SRC__mClass;
		contexT__SRC__mClass = newCONTEXT__SRC__mClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CONTEXT_SRC_MCLASS, oldCONTEXT__SRC__mClass,
	...
	public MDefinition getCONTEXT__SRC__mDefinition() {
		if (contexT__SRC__mDefinition != null && contexT__SRC__mDefinition.eIsProxy()) {
			...
			if (contexT__SRC__mDefinition != oldCONTEXT__SRC__mDefinition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CONTEXT_SRC_MDEFINITION,
	...
	public Modifier getCREATE__SRC__mModifier() {
		if (creatE__SRC__mModifier != null && creatE__SRC__mModifier.eIsProxy()) {
			...
			if (creatE__SRC__mModifier != oldCREATE__SRC__mModifier) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CREATE_SRC_MMODIFIER,
	...
	public void setCREATE__SRC__mModifier(Modifier newCREATE__SRC__mModifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CREATE_SRC_MMODIFIER, oldCREATE__SRC__mModifier,
	...
	public TClass getCONTEXT__TRG__tClass() {
		if (contexT__TRG__tClass != null && contexT__TRG__tClass.eIsProxy()) {
			...
			if (contexT__TRG__tClass != oldCONTEXT__TRG__tClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CONTEXT_TRG_TCLASS,
	...
	public void setCONTEXT__TRG__tClass(TClass newCONTEXT__TRG__tClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CONTEXT_TRG_TCLASS, oldCONTEXT__TRG__tClass,
	...
	public TMember getCONTEXT__TRG__tMember() {
		if (contexT__TRG__tMember != null && contexT__TRG__tMember.eIsProxy()) {
			...
			if (contexT__TRG__tMember != oldCONTEXT__TRG__tMember) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CONTEXT_TRG_TMEMBER,
	...
	public void setCONTEXT__TRG__tMember(TMember newCONTEXT__TRG__tMember) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CONTEXT_TRG_TMEMBER, oldCONTEXT__TRG__tMember,
	...
	public TModifier getCREATE__TRG__tModifier() {
		if (creatE__TRG__tModifier != null && creatE__TRG__tModifier.eIsProxy()) {
			...
			if (creatE__TRG__tModifier != oldCREATE__TRG__tModifier) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CREATE_TRG_TMODIFIER,
	...
	public void setCREATE__TRG__tModifier(TModifier newCREATE__TRG__tModifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CREATE_TRG_TMODIFIER, oldCREATE__TRG__tModifier,
	...
	public MDefinitionToTMember getCONTEXT__CORR__defToMember() {
		if (contexT__CORR__defToMember != null && contexT__CORR__defToMember.eIsProxy()) {
			...
			if (contexT__CORR__defToMember != oldCONTEXT__CORR__defToMember) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CONTEXT_CORR_DEF_TO_MEMBER,
	...
	public MModifierToTModifier getCREATE__CORR__mModifierToTModifier() {
		if (creatE__CORR__mModifierToTModifier != null && creatE__CORR__mModifierToTModifier.eIsProxy()) {
			...
			if (creatE__CORR__mModifierToTModifier != oldCREATE__CORR__mModifierToTModifier) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CREATE_CORR_MMODIFIER_TO_TMODIFIER,
	...
	public TypeToTAbstractType getCONTEXT__CORR__mTypeToTType() {
		if (contexT__CORR__mTypeToTType != null && contexT__CORR__mTypeToTType.eIsProxy()) {
			...
			if (contexT__CORR__mTypeToTType != oldCONTEXT__CORR__mTypeToTType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CONTEXT_CORR_MTYPE_TO_TTYPE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CONTEXT_SRC_MCLASS:
			if (resolve)
				return getCONTEXT__SRC__mClass();
			return basicGetCONTEXT__SRC__mClass();
		case ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CONTEXT_SRC_MDEFINITION:
			if (resolve)
				return getCONTEXT__SRC__mDefinition();
			return basicGetCONTEXT__SRC__mDefinition();
		case ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CREATE_SRC_MMODIFIER:
			if (resolve)
				return getCREATE__SRC__mModifier();
			return basicGetCREATE__SRC__mModifier();
		case ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CONTEXT_TRG_TCLASS:
			if (resolve)
				return getCONTEXT__TRG__tClass();
			return basicGetCONTEXT__TRG__tClass();
		case ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CONTEXT_TRG_TMEMBER:
			if (resolve)
				return getCONTEXT__TRG__tMember();
			return basicGetCONTEXT__TRG__tMember();
		case ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CREATE_TRG_TMODIFIER:
			if (resolve)
				return getCREATE__TRG__tModifier();
			return basicGetCREATE__TRG__tModifier();
		case ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CONTEXT_CORR_DEF_TO_MEMBER:
			if (resolve)
				return getCONTEXT__CORR__defToMember();
			return basicGetCONTEXT__CORR__defToMember();
		case ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CREATE_CORR_MMODIFIER_TO_TMODIFIER:
			if (resolve)
				return getCREATE__CORR__mModifierToTModifier();
			return basicGetCREATE__CORR__mModifierToTModifier();
		case ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CONTEXT_CORR_MTYPE_TO_TTYPE:
			if (resolve)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
		case ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CONTEXT_SRC_MCLASS:
			setCONTEXT__SRC__mClass((EnumDeclaration) newValue);
			return;
		case ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CONTEXT_SRC_MDEFINITION:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
		case ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CONTEXT_SRC_MCLASS:
			setCONTEXT__SRC__mClass((EnumDeclaration) null);
			return;
		case ModiscoTGGPackage.MEMBER_IN_ENUM_VISIBILITY_MARKER__CONTEXT_SRC_MDEFINITION:
...
} //MemberInEnumVisibility__MarkerImpl
