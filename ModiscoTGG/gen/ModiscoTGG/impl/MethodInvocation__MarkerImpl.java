...
import ModiscoTGG.MethodInvocation__Marker;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Method Invocation Marker</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ModiscoTGG.impl.MethodInvocation__MarkerImpl#getCREATE__SRC__invocation <em>CREATE SRC invocation</em>}</li>
 *   <li>{@link ModiscoTGG.impl.MethodInvocation__MarkerImpl#getCONTEXT__SRC__mMember <em>CONTEXT SRC mMember</em>}</li>
 *   <li>{@link ModiscoTGG.impl.MethodInvocation__MarkerImpl#getCONTEXT__SRC__mMethod <em>CONTEXT SRC mMethod</em>}</li>
 *   <li>{@link ModiscoTGG.impl.MethodInvocation__MarkerImpl#getCREATE__TRG__tAccess <em>CREATE TRG tAccess</em>}</li>
 *   <li>{@link ModiscoTGG.impl.MethodInvocation__MarkerImpl#getCONTEXT__TRG__tMember <em>CONTEXT TRG tMember</em>}</li>
 *   <li>{@link ModiscoTGG.impl.MethodInvocation__MarkerImpl#getCONTEXT__TRG__tMethod <em>CONTEXT TRG tMethod</em>}</li>
 *   <li>{@link ModiscoTGG.impl.MethodInvocation__MarkerImpl#getCREATE__CORR__invocationToTAccess <em>CREATE CORR invocation To TAccess</em>}</li>
 *   <li>{@link ModiscoTGG.impl.MethodInvocation__MarkerImpl#getCREATE__CORR__mFlowElementToTFlowElement <em>CREATE CORR mFlow Element To TFlow Element</em>}</li>
 *   <li>{@link ModiscoTGG.impl.MethodInvocation__MarkerImpl#getCONTEXT__CORR__mMemberToTMember <em>CONTEXT CORR mMember To TMember</em>}</li>
 *   <li>{@link ModiscoTGG.impl.MethodInvocation__MarkerImpl#getCONTEXT__CORR__mMethodToTMethod <em>CONTEXT CORR mMethod To TMethod</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MethodInvocation__MarkerImpl extends TGGRuleApplicationImpl implements MethodInvocation__Marker {
	/**
	 ...
	 * @generated
	 */
	protected MethodInvocation__MarkerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModiscoTGGPackage.eINSTANCE.getMethodInvocation__Marker();
	}
			...
			if (creatE__SRC__invocation != oldCREATE__SRC__invocation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.METHOD_INVOCATION_MARKER__CREATE_SRC_INVOCATION,
	...
	public void setCREATE__SRC__invocation(MMethodInvocation newCREATE__SRC__invocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.METHOD_INVOCATION_MARKER__CREATE_SRC_INVOCATION, oldCREATE__SRC__invocation,
	...
	public MDefinition getCONTEXT__SRC__mMember() {
		if (contexT__SRC__mMember != null && contexT__SRC__mMember.eIsProxy()) {
			...
			if (contexT__SRC__mMember != oldCONTEXT__SRC__mMember) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.METHOD_INVOCATION_MARKER__CONTEXT_SRC_MMEMBER, oldCONTEXT__SRC__mMember,
	...
	public MAbstractMethodDefinition getCONTEXT__SRC__mMethod() {
		if (contexT__SRC__mMethod != null && contexT__SRC__mMethod.eIsProxy()) {
			...
			if (contexT__SRC__mMethod != oldCONTEXT__SRC__mMethod) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.METHOD_INVOCATION_MARKER__CONTEXT_SRC_MMETHOD, oldCONTEXT__SRC__mMethod,
	...
	public TCall getCREATE__TRG__tAccess() {
		if (creatE__TRG__tAccess != null && creatE__TRG__tAccess.eIsProxy()) {
			...
			if (creatE__TRG__tAccess != oldCREATE__TRG__tAccess) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.METHOD_INVOCATION_MARKER__CREATE_TRG_TACCESS, oldCREATE__TRG__tAccess,
	...
	public TMember getCONTEXT__TRG__tMember() {
		if (contexT__TRG__tMember != null && contexT__TRG__tMember.eIsProxy()) {
			...
			if (contexT__TRG__tMember != oldCONTEXT__TRG__tMember) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.METHOD_INVOCATION_MARKER__CONTEXT_TRG_TMEMBER, oldCONTEXT__TRG__tMember,
	...
	public TMember getCONTEXT__TRG__tMethod() {
		if (contexT__TRG__tMethod != null && contexT__TRG__tMethod.eIsProxy()) {
			...
			if (contexT__TRG__tMethod != oldCONTEXT__TRG__tMethod) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.METHOD_INVOCATION_MARKER__CONTEXT_TRG_TMETHOD, oldCONTEXT__TRG__tMethod,
	...
	public AbstractMethodInvocationToTAccess getCREATE__CORR__invocationToTAccess() {
		if (creatE__CORR__invocationToTAccess != null && creatE__CORR__invocationToTAccess.eIsProxy()) {
			...
			if (creatE__CORR__invocationToTAccess != oldCREATE__CORR__invocationToTAccess) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.METHOD_INVOCATION_MARKER__CREATE_CORR_INVOCATION_TO_TACCESS,
	...
	public MAbstractFlowElementToTAbstractFlowElement getCREATE__CORR__mFlowElementToTFlowElement() {
		if (creatE__CORR__mFlowElementToTFlowElement != null && creatE__CORR__mFlowElementToTFlowElement.eIsProxy()) {
			...
			if (creatE__CORR__mFlowElementToTFlowElement != oldCREATE__CORR__mFlowElementToTFlowElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.METHOD_INVOCATION_MARKER__CREATE_CORR_MFLOW_ELEMENT_TO_TFLOW_ELEMENT,
	...
	public MDefinitionToTMember getCONTEXT__CORR__mMemberToTMember() {
		if (contexT__CORR__mMemberToTMember != null && contexT__CORR__mMemberToTMember.eIsProxy()) {
			...
			if (contexT__CORR__mMemberToTMember != oldCONTEXT__CORR__mMemberToTMember) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.METHOD_INVOCATION_MARKER__CONTEXT_CORR_MMEMBER_TO_TMEMBER,
	...
	public MDefinitionToTMember getCONTEXT__CORR__mMethodToTMethod() {
		if (contexT__CORR__mMethodToTMethod != null && contexT__CORR__mMethodToTMethod.eIsProxy()) {
			...
			if (contexT__CORR__mMethodToTMethod != oldCONTEXT__CORR__mMethodToTMethod) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.METHOD_INVOCATION_MARKER__CONTEXT_CORR_MMETHOD_TO_TMETHOD,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoTGGPackage.METHOD_INVOCATION_MARKER__CREATE_SRC_INVOCATION:
			if (resolve)
				return getCREATE__SRC__invocation();
			return basicGetCREATE__SRC__invocation();
		case ModiscoTGGPackage.METHOD_INVOCATION_MARKER__CONTEXT_SRC_MMEMBER:
			if (resolve)
				return getCONTEXT__SRC__mMember();
			return basicGetCONTEXT__SRC__mMember();
		case ModiscoTGGPackage.METHOD_INVOCATION_MARKER__CONTEXT_SRC_MMETHOD:
			if (resolve)
				return getCONTEXT__SRC__mMethod();
			return basicGetCONTEXT__SRC__mMethod();
		case ModiscoTGGPackage.METHOD_INVOCATION_MARKER__CREATE_TRG_TACCESS:
			if (resolve)
				return getCREATE__TRG__tAccess();
			return basicGetCREATE__TRG__tAccess();
		case ModiscoTGGPackage.METHOD_INVOCATION_MARKER__CONTEXT_TRG_TMEMBER:
			if (resolve)
				return getCONTEXT__TRG__tMember();
			return basicGetCONTEXT__TRG__tMember();
		case ModiscoTGGPackage.METHOD_INVOCATION_MARKER__CONTEXT_TRG_TMETHOD:
			if (resolve)
				return getCONTEXT__TRG__tMethod();
			return basicGetCONTEXT__TRG__tMethod();
		case ModiscoTGGPackage.METHOD_INVOCATION_MARKER__CREATE_CORR_INVOCATION_TO_TACCESS:
			if (resolve)
				return getCREATE__CORR__invocationToTAccess();
			return basicGetCREATE__CORR__invocationToTAccess();
		case ModiscoTGGPackage.METHOD_INVOCATION_MARKER__CREATE_CORR_MFLOW_ELEMENT_TO_TFLOW_ELEMENT:
			if (resolve)
				return getCREATE__CORR__mFlowElementToTFlowElement();
			return basicGetCREATE__CORR__mFlowElementToTFlowElement();
		case ModiscoTGGPackage.METHOD_INVOCATION_MARKER__CONTEXT_CORR_MMEMBER_TO_TMEMBER:
			if (resolve)
				return getCONTEXT__CORR__mMemberToTMember();
			return basicGetCONTEXT__CORR__mMemberToTMember();
		case ModiscoTGGPackage.METHOD_INVOCATION_MARKER__CONTEXT_CORR_MMETHOD_TO_TMETHOD:
			if (resolve)
