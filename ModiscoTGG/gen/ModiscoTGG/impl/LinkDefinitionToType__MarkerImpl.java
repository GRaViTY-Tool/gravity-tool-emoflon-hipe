...
import ModiscoTGG.LinkDefinitionToType__Marker;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Link Definition To Type Marker</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ModiscoTGG.impl.LinkDefinitionToType__MarkerImpl#getCONTEXT__SRC__mDefinition <em>CONTEXT SRC mDefinition</em>}</li>
 *   <li>{@link ModiscoTGG.impl.LinkDefinitionToType__MarkerImpl#getCONTEXT__SRC__mSignature <em>CONTEXT SRC mSignature</em>}</li>
 *   <li>{@link ModiscoTGG.impl.LinkDefinitionToType__MarkerImpl#getCONTEXT__SRC__mType <em>CONTEXT SRC mType</em>}</li>
 *   <li>{@link ModiscoTGG.impl.LinkDefinitionToType__MarkerImpl#getCONTEXT__TRG__tDefinition <em>CONTEXT TRG tDefinition</em>}</li>
 *   <li>{@link ModiscoTGG.impl.LinkDefinitionToType__MarkerImpl#getCONTEXT__TRG__tSignature <em>CONTEXT TRG tSignature</em>}</li>
 *   <li>{@link ModiscoTGG.impl.LinkDefinitionToType__MarkerImpl#getCONTEXT__TRG__tType <em>CONTEXT TRG tType</em>}</li>
 *   <li>{@link ModiscoTGG.impl.LinkDefinitionToType__MarkerImpl#getCONTEXT__CORR__mDefinitionToTMember <em>CONTEXT CORR mDefinition To TMember</em>}</li>
 *   <li>{@link ModiscoTGG.impl.LinkDefinitionToType__MarkerImpl#getCONTEXT__CORR__mSignatureToTSignature <em>CONTEXT CORR mSignature To TSignature</em>}</li>
 *   <li>{@link ModiscoTGG.impl.LinkDefinitionToType__MarkerImpl#getCONTEXT__CORR__mTypeToTType <em>CONTEXT CORR mType To TType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LinkDefinitionToType__MarkerImpl extends TGGRuleApplicationImpl implements LinkDefinitionToType__Marker {
	/**
	 ...
	 * @generated
	 */
	protected LinkDefinitionToType__MarkerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModiscoTGGPackage.eINSTANCE.getLinkDefinitionToType__Marker();
	}
			...
			if (contexT__SRC__mDefinition != oldCONTEXT__SRC__mDefinition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.LINK_DEFINITION_TO_TYPE_MARKER__CONTEXT_SRC_MDEFINITION,
	...
	public MSignature getCONTEXT__SRC__mSignature() {
		if (contexT__SRC__mSignature != null && contexT__SRC__mSignature.eIsProxy()) {
			...
			if (contexT__SRC__mSignature != oldCONTEXT__SRC__mSignature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.LINK_DEFINITION_TO_TYPE_MARKER__CONTEXT_SRC_MSIGNATURE,
	...
	public AbstractTypeDeclaration getCONTEXT__SRC__mType() {
		if (contexT__SRC__mType != null && contexT__SRC__mType.eIsProxy()) {
			...
			if (contexT__SRC__mType != oldCONTEXT__SRC__mType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.LINK_DEFINITION_TO_TYPE_MARKER__CONTEXT_SRC_MTYPE, oldCONTEXT__SRC__mType,
							contexT__SRC__mType));
			}
		}
	...
	public TMember getCONTEXT__TRG__tDefinition() {
		if (contexT__TRG__tDefinition != null && contexT__TRG__tDefinition.eIsProxy()) {
			...
			if (contexT__TRG__tDefinition != oldCONTEXT__TRG__tDefinition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.LINK_DEFINITION_TO_TYPE_MARKER__CONTEXT_TRG_TDEFINITION,
	...
	public TSignature getCONTEXT__TRG__tSignature() {
		if (contexT__TRG__tSignature != null && contexT__TRG__tSignature.eIsProxy()) {
			...
			if (contexT__TRG__tSignature != oldCONTEXT__TRG__tSignature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.LINK_DEFINITION_TO_TYPE_MARKER__CONTEXT_TRG_TSIGNATURE,
	...
	public TAbstractType getCONTEXT__TRG__tType() {
		if (contexT__TRG__tType != null && contexT__TRG__tType.eIsProxy()) {
			...
			if (contexT__TRG__tType != oldCONTEXT__TRG__tType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.LINK_DEFINITION_TO_TYPE_MARKER__CONTEXT_TRG_TTYPE, oldCONTEXT__TRG__tType,
							contexT__TRG__tType));
			}
		}
	...
	public MDefinitionToTMember getCONTEXT__CORR__mDefinitionToTMember() {
		if (contexT__CORR__mDefinitionToTMember != null && contexT__CORR__mDefinitionToTMember.eIsProxy()) {
			...
			if (contexT__CORR__mDefinitionToTMember != oldCONTEXT__CORR__mDefinitionToTMember) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.LINK_DEFINITION_TO_TYPE_MARKER__CONTEXT_CORR_MDEFINITION_TO_TMEMBER,
	...
	public MSignatureToTSignature getCONTEXT__CORR__mSignatureToTSignature() {
		if (contexT__CORR__mSignatureToTSignature != null && contexT__CORR__mSignatureToTSignature.eIsProxy()) {
			...
			if (contexT__CORR__mSignatureToTSignature != oldCONTEXT__CORR__mSignatureToTSignature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.LINK_DEFINITION_TO_TYPE_MARKER__CONTEXT_CORR_MSIGNATURE_TO_TSIGNATURE,
	...
	public TypeToTAbstractType getCONTEXT__CORR__mTypeToTType() {
		if (contexT__CORR__mTypeToTType != null && contexT__CORR__mTypeToTType.eIsProxy()) {
			...
			if (contexT__CORR__mTypeToTType != oldCONTEXT__CORR__mTypeToTType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.LINK_DEFINITION_TO_TYPE_MARKER__CONTEXT_CORR_MTYPE_TO_TTYPE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoTGGPackage.LINK_DEFINITION_TO_TYPE_MARKER__CONTEXT_SRC_MDEFINITION:
			if (resolve)
				return getCONTEXT__SRC__mDefinition();
			return basicGetCONTEXT__SRC__mDefinition();
		case ModiscoTGGPackage.LINK_DEFINITION_TO_TYPE_MARKER__CONTEXT_SRC_MSIGNATURE:
			if (resolve)
				return getCONTEXT__SRC__mSignature();
			return basicGetCONTEXT__SRC__mSignature();
		case ModiscoTGGPackage.LINK_DEFINITION_TO_TYPE_MARKER__CONTEXT_SRC_MTYPE:
			if (resolve)
				return getCONTEXT__SRC__mType();
			return basicGetCONTEXT__SRC__mType();
		case ModiscoTGGPackage.LINK_DEFINITION_TO_TYPE_MARKER__CONTEXT_TRG_TDEFINITION:
			if (resolve)
				return getCONTEXT__TRG__tDefinition();
			return basicGetCONTEXT__TRG__tDefinition();
		case ModiscoTGGPackage.LINK_DEFINITION_TO_TYPE_MARKER__CONTEXT_TRG_TSIGNATURE:
			if (resolve)
				return getCONTEXT__TRG__tSignature();
			return basicGetCONTEXT__TRG__tSignature();
		case ModiscoTGGPackage.LINK_DEFINITION_TO_TYPE_MARKER__CONTEXT_TRG_TTYPE:
			if (resolve)
				return getCONTEXT__TRG__tType();
			return basicGetCONTEXT__TRG__tType();
		case ModiscoTGGPackage.LINK_DEFINITION_TO_TYPE_MARKER__CONTEXT_CORR_MDEFINITION_TO_TMEMBER:
			if (resolve)
				return getCONTEXT__CORR__mDefinitionToTMember();
			return basicGetCONTEXT__CORR__mDefinitionToTMember();
		case ModiscoTGGPackage.LINK_DEFINITION_TO_TYPE_MARKER__CONTEXT_CORR_MSIGNATURE_TO_TSIGNATURE:
			if (resolve)
				return getCONTEXT__CORR__mSignatureToTSignature();
			return basicGetCONTEXT__CORR__mSignatureToTSignature();
		case ModiscoTGGPackage.LINK_DEFINITION_TO_TYPE_MARKER__CONTEXT_CORR_MTYPE_TO_TTYPE:
			if (resolve)
...
} //LinkDefinitionToType__MarkerImpl
