...
import ModiscoTGG.AnnotationTypeNested__Marker;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Annotation Type Nested Marker</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ModiscoTGG.impl.AnnotationTypeNested__MarkerImpl#getCREATE__SRC__eNestedType <em>CREATE SRC eNested Type</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationTypeNested__MarkerImpl#getCONTEXT__SRC__eOuterType <em>CONTEXT SRC eOuter Type</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationTypeNested__MarkerImpl#getCREATE__TRG__tNestedPackage <em>CREATE TRG tNested Package</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationTypeNested__MarkerImpl#getCREATE__TRG__tNestedType <em>CREATE TRG tNested Type</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationTypeNested__MarkerImpl#getCONTEXT__TRG__tOuterPackage <em>CONTEXT TRG tOuter Package</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationTypeNested__MarkerImpl#getCONTEXT__TRG__tOuterType <em>CONTEXT TRG tOuter Type</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationTypeNested__MarkerImpl#getCONTEXT__TRG__typeGraph <em>CONTEXT TRG type Graph</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationTypeNested__MarkerImpl#getCREATE__CORR__eNestedTypeToTNestedType <em>CREATE CORR eNested Type To TNested Type</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationTypeNested__MarkerImpl#getCONTEXT__CORR__eOuterTypeToTOuterInterface <em>CONTEXT CORR eOuter Type To TOuter Interface</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationTypeNested__MarkerImpl#getCREATE__CORR__mBodyToTAnnotation <em>CREATE CORR mBody To TAnnotation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnnotationTypeNested__MarkerImpl extends TGGRuleApplicationImpl implements AnnotationTypeNested__Marker {
	/**
	 ...
	 * @ordered
	 */
	protected AnnotationTypeDeclaration creatE__SRC__eNestedType;
	 ...
	 * @ordered
	 */
	protected TAnnotationType creatE__TRG__tNestedType;
	 ...
	 * @generated
	 */
	protected AnnotationTypeNested__MarkerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModiscoTGGPackage.eINSTANCE.getAnnotationTypeNested__Marker();
	}
	 ...
	 */
	@Override
	public AnnotationTypeDeclaration getCREATE__SRC__eNestedType() {
		if (creatE__SRC__eNestedType != null && creatE__SRC__eNestedType.eIsProxy()) {
			...
			creatE__SRC__eNestedType = (AnnotationTypeDeclaration) eResolveProxy(oldCREATE__SRC__eNestedType);
			if (creatE__SRC__eNestedType != oldCREATE__SRC__eNestedType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CREATE_SRC_ENESTED_TYPE,
	 ...
	 * @generated
	 */
	public AnnotationTypeDeclaration basicGetCREATE__SRC__eNestedType() {
		return creatE__SRC__eNestedType;
	}
	 ...
	 */
	@Override
	public void setCREATE__SRC__eNestedType(AnnotationTypeDeclaration newCREATE__SRC__eNestedType) {
		AnnotationTypeDeclaration oldCREATE__SRC__eNestedType = creatE__SRC__eNestedType;
	...
	public AbstractTypeDeclaration getCONTEXT__SRC__eOuterType() {
		if (contexT__SRC__eOuterType != null && contexT__SRC__eOuterType.eIsProxy()) {
			...
			if (contexT__SRC__eOuterType != oldCONTEXT__SRC__eOuterType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CONTEXT_SRC_EOUTER_TYPE,
	...
	public TPackage getCREATE__TRG__tNestedPackage() {
		if (creatE__TRG__tNestedPackage != null && creatE__TRG__tNestedPackage.eIsProxy()) {
			...
			if (creatE__TRG__tNestedPackage != oldCREATE__TRG__tNestedPackage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CREATE_TRG_TNESTED_PACKAGE,
	 ...
	 */
	@Override
	public TAnnotationType getCREATE__TRG__tNestedType() {
		if (creatE__TRG__tNestedType != null && creatE__TRG__tNestedType.eIsProxy()) {
			...
			creatE__TRG__tNestedType = (TAnnotationType) eResolveProxy(oldCREATE__TRG__tNestedType);
			if (creatE__TRG__tNestedType != oldCREATE__TRG__tNestedType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CREATE_TRG_TNESTED_TYPE,
	 ...
	 * @generated
	 */
	public TAnnotationType basicGetCREATE__TRG__tNestedType() {
		return creatE__TRG__tNestedType;
	}
	 ...
	 */
	@Override
	public void setCREATE__TRG__tNestedType(TAnnotationType newCREATE__TRG__tNestedType) {
		TAnnotationType oldCREATE__TRG__tNestedType = creatE__TRG__tNestedType;
	...
	public TPackage getCONTEXT__TRG__tOuterPackage() {
		if (contexT__TRG__tOuterPackage != null && contexT__TRG__tOuterPackage.eIsProxy()) {
			...
			if (contexT__TRG__tOuterPackage != oldCONTEXT__TRG__tOuterPackage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CONTEXT_TRG_TOUTER_PACKAGE,
	...
	public TAbstractType getCONTEXT__TRG__tOuterType() {
		if (contexT__TRG__tOuterType != null && contexT__TRG__tOuterType.eIsProxy()) {
			...
			if (contexT__TRG__tOuterType != oldCONTEXT__TRG__tOuterType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CONTEXT_TRG_TOUTER_TYPE,
	...
	public TypeGraph getCONTEXT__TRG__typeGraph() {
		if (contexT__TRG__typeGraph != null && contexT__TRG__typeGraph.eIsProxy()) {
			...
			if (contexT__TRG__typeGraph != oldCONTEXT__TRG__typeGraph) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CONTEXT_TRG_TYPE_GRAPH,
	...
	public void setCONTEXT__TRG__typeGraph(TypeGraph newCONTEXT__TRG__typeGraph) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CONTEXT_TRG_TYPE_GRAPH, oldCONTEXT__TRG__typeGraph,
	...
	public TypeToTAbstractType getCREATE__CORR__eNestedTypeToTNestedType() {
		if (creatE__CORR__eNestedTypeToTNestedType != null && creatE__CORR__eNestedTypeToTNestedType.eIsProxy()) {
			...
			if (creatE__CORR__eNestedTypeToTNestedType != oldCREATE__CORR__eNestedTypeToTNestedType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CREATE_CORR_ENESTED_TYPE_TO_TNESTED_TYPE,
	...
	public TypeToTAbstractType getCONTEXT__CORR__eOuterTypeToTOuterInterface() {
		if (contexT__CORR__eOuterTypeToTOuterInterface != null
			...
			if (contexT__CORR__eOuterTypeToTOuterInterface != oldCONTEXT__CORR__eOuterTypeToTOuterInterface) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CONTEXT_CORR_EOUTER_TYPE_TO_TOUTER_INTERFACE,
	...
	public ASTNodeToTAnnotatable getCREATE__CORR__mBodyToTAnnotation() {
		if (creatE__CORR__mBodyToTAnnotation != null && creatE__CORR__mBodyToTAnnotation.eIsProxy()) {
			...
			if (creatE__CORR__mBodyToTAnnotation != oldCREATE__CORR__mBodyToTAnnotation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CREATE_CORR_MBODY_TO_TANNOTATION,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CREATE_SRC_ENESTED_TYPE:
			if (resolve)
				return getCREATE__SRC__eNestedType();
			return basicGetCREATE__SRC__eNestedType();
		case ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CONTEXT_SRC_EOUTER_TYPE:
			if (resolve)
				return getCONTEXT__SRC__eOuterType();
			return basicGetCONTEXT__SRC__eOuterType();
		case ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CREATE_TRG_TNESTED_PACKAGE:
			if (resolve)
				return getCREATE__TRG__tNestedPackage();
			return basicGetCREATE__TRG__tNestedPackage();
		case ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CREATE_TRG_TNESTED_TYPE:
			if (resolve)
				return getCREATE__TRG__tNestedType();
			return basicGetCREATE__TRG__tNestedType();
		case ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CONTEXT_TRG_TOUTER_PACKAGE:
			if (resolve)
				return getCONTEXT__TRG__tOuterPackage();
			return basicGetCONTEXT__TRG__tOuterPackage();
		case ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CONTEXT_TRG_TOUTER_TYPE:
			if (resolve)
				return getCONTEXT__TRG__tOuterType();
			return basicGetCONTEXT__TRG__tOuterType();
		case ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CONTEXT_TRG_TYPE_GRAPH:
			if (resolve)
				return getCONTEXT__TRG__typeGraph();
			return basicGetCONTEXT__TRG__typeGraph();
		case ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CREATE_CORR_ENESTED_TYPE_TO_TNESTED_TYPE:
			if (resolve)
				return getCREATE__CORR__eNestedTypeToTNestedType();
			return basicGetCREATE__CORR__eNestedTypeToTNestedType();
		case ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CONTEXT_CORR_EOUTER_TYPE_TO_TOUTER_INTERFACE:
			if (resolve)
				return getCONTEXT__CORR__eOuterTypeToTOuterInterface();
			return basicGetCONTEXT__CORR__eOuterTypeToTOuterInterface();
		case ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CREATE_CORR_MBODY_TO_TANNOTATION:
			if (resolve)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
		case ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CREATE_SRC_ENESTED_TYPE:
			setCREATE__SRC__eNestedType((AnnotationTypeDeclaration) newValue);
			return;
		case ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CONTEXT_SRC_EOUTER_TYPE:
		...
		case ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CREATE_TRG_TNESTED_PACKAGE:
			...
			return;
		case ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CREATE_TRG_TNESTED_TYPE:
			setCREATE__TRG__tNestedType((TAnnotationType) newValue);
			return;
		case ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CONTEXT_TRG_TOUTER_PACKAGE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
		case ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CREATE_SRC_ENESTED_TYPE:
			setCREATE__SRC__eNestedType((AnnotationTypeDeclaration) null);
			return;
		case ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CONTEXT_SRC_EOUTER_TYPE:
		...
		case ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CREATE_TRG_TNESTED_PACKAGE:
			...
			return;
		case ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CREATE_TRG_TNESTED_TYPE:
			setCREATE__TRG__tNestedType((TAnnotationType) null);
			return;
		case ModiscoTGGPackage.ANNOTATION_TYPE_NESTED_MARKER__CONTEXT_TRG_TOUTER_PACKAGE:
...
} //AnnotationTypeNested__MarkerImpl
