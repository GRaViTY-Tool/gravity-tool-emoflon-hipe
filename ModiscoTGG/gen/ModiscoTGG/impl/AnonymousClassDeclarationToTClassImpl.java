 ...
 * </p>
 * <ul>
 *   <li>{@link ModiscoTGG.impl.AnonymousClassDeclarationToTClassImpl#getSource <em>Source</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnonymousClassDeclarationToTClassImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnonymousClassDeclarationToTClassImpl extends EObjectImpl implements AnonymousClassDeclarationToTClass {
	/**
	...
	protected EClass eStaticClass() {
		return ModiscoTGGPackage.eINSTANCE.getAnonymousClassDeclarationToTClass();
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANONYMOUS_CLASS_DECLARATION_TO_TCLASS__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public TClass getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANONYMOUS_CLASS_DECLARATION_TO_TCLASS__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoTGGPackage.ANONYMOUS_CLASS_DECLARATION_TO_TCLASS__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case ModiscoTGGPackage.ANONYMOUS_CLASS_DECLARATION_TO_TCLASS__TARGET:
			if (resolve)
				return getTarget();
