...
import ModiscoTGG.AnnotationMemberValueStringArray__Marker;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Annotation Member Value String Array Marker</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ModiscoTGG.impl.AnnotationMemberValueStringArray__MarkerImpl#getCONTEXT__SRC__AnnotationValue <em>CONTEXT SRC Annotation Value</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationMemberValueStringArray__MarkerImpl#getCREATE__SRC__mArray <em>CREATE SRC mArray</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationMemberValueStringArray__MarkerImpl#getCREATE__SRC__mValue <em>CREATE SRC mValue</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationMemberValueStringArray__MarkerImpl#getCONTEXT__TRG__tAnnotationValue <em>CONTEXT TRG tAnnotation Value</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationMemberValueStringArray__MarkerImpl#getCREATE__TRG__tValue <em>CREATE TRG tValue</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationMemberValueStringArray__MarkerImpl#getCONTEXT__CORR__AnnotationMemberValuePairToTAnnotationValue <em>CONTEXT CORR Annotation Member Value Pair To TAnnotation Value</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationMemberValueStringArray__MarkerImpl#getCREATE__CORR__mTypeToTType <em>CREATE CORR mType To TType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnnotationMemberValueStringArray__MarkerImpl extends TGGRuleApplicationImpl
		implements AnnotationMemberValueStringArray__Marker {
	/**
	 ...
	 * @ordered
	 */
	protected StringLiteral creatE__SRC__mValue;
	 ...
	 * @ordered
	 */
	protected TTextNode creatE__TRG__tValue;
	 ...
	 * @ordered
	 */
	protected StringLiteralToTTextNode creatE__CORR__mTypeToTType;
	 ...
	 * @generated
	 */
	protected AnnotationMemberValueStringArray__MarkerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModiscoTGGPackage.eINSTANCE.getAnnotationMemberValueStringArray__Marker();
	}
			...
			if (contexT__SRC__AnnotationValue != oldCONTEXT__SRC__AnnotationValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CONTEXT_SRC_ANNOTATION_VALUE,
	...
	public ArrayInitializer getCREATE__SRC__mArray() {
		if (creatE__SRC__mArray != null && creatE__SRC__mArray.eIsProxy()) {
			...
			if (creatE__SRC__mArray != oldCREATE__SRC__mArray) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CREATE_SRC_MARRAY,
	 ...
	 */
	@Override
	public StringLiteral getCREATE__SRC__mValue() {
		if (creatE__SRC__mValue != null && creatE__SRC__mValue.eIsProxy()) {
			...
			creatE__SRC__mValue = (StringLiteral) eResolveProxy(oldCREATE__SRC__mValue);
			if (creatE__SRC__mValue != oldCREATE__SRC__mValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CREATE_SRC_MVALUE,
	 ...
	 * @generated
	 */
	public StringLiteral basicGetCREATE__SRC__mValue() {
		return creatE__SRC__mValue;
	}
	 ...
	 */
	@Override
	public void setCREATE__SRC__mValue(StringLiteral newCREATE__SRC__mValue) {
		StringLiteral oldCREATE__SRC__mValue = creatE__SRC__mValue;
	...
	public TAnnotationValue getCONTEXT__TRG__tAnnotationValue() {
		if (contexT__TRG__tAnnotationValue != null && contexT__TRG__tAnnotationValue.eIsProxy()) {
			...
			if (contexT__TRG__tAnnotationValue != oldCONTEXT__TRG__tAnnotationValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CONTEXT_TRG_TANNOTATION_VALUE,
	 ...
	 */
	@Override
	public TTextNode getCREATE__TRG__tValue() {
		if (creatE__TRG__tValue != null && creatE__TRG__tValue.eIsProxy()) {
			...
			creatE__TRG__tValue = (TTextNode) eResolveProxy(oldCREATE__TRG__tValue);
			if (creatE__TRG__tValue != oldCREATE__TRG__tValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CREATE_TRG_TVALUE,
	 ...
	 * @generated
	 */
	public TTextNode basicGetCREATE__TRG__tValue() {
		return creatE__TRG__tValue;
	}
	 ...
	 */
	@Override
	public void setCREATE__TRG__tValue(TTextNode newCREATE__TRG__tValue) {
		TTextNode oldCREATE__TRG__tValue = creatE__TRG__tValue;
	...
	public AnnotationMemberValuePairToTAnnotationValue getCONTEXT__CORR__AnnotationMemberValuePairToTAnnotationValue() {
		if (contexT__CORR__AnnotationMemberValuePairToTAnnotationValue != null
			...
			if (contexT__CORR__AnnotationMemberValuePairToTAnnotationValue != oldCONTEXT__CORR__AnnotationMemberValuePairToTAnnotationValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CONTEXT_CORR_ANNOTATION_MEMBER_VALUE_PAIR_TO_TANNOTATION_VALUE,
							oldCONTEXT__CORR__AnnotationMemberValuePairToTAnnotationValue,
	 ...
	 */
	@Override
	public StringLiteralToTTextNode getCREATE__CORR__mTypeToTType() {
		if (creatE__CORR__mTypeToTType != null && creatE__CORR__mTypeToTType.eIsProxy()) {
			...
			creatE__CORR__mTypeToTType = (StringLiteralToTTextNode) eResolveProxy(oldCREATE__CORR__mTypeToTType);
			if (creatE__CORR__mTypeToTType != oldCREATE__CORR__mTypeToTType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CREATE_CORR_MTYPE_TO_TTYPE,
	 ...
	 * @generated
	 */
	public StringLiteralToTTextNode basicGetCREATE__CORR__mTypeToTType() {
		return creatE__CORR__mTypeToTType;
	}
	 ...
	 */
	@Override
	public void setCREATE__CORR__mTypeToTType(StringLiteralToTTextNode newCREATE__CORR__mTypeToTType) {
		StringLiteralToTTextNode oldCREATE__CORR__mTypeToTType = creatE__CORR__mTypeToTType;
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CONTEXT_SRC_ANNOTATION_VALUE:
			if (resolve)
				return getCONTEXT__SRC__AnnotationValue();
			return basicGetCONTEXT__SRC__AnnotationValue();
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CREATE_SRC_MARRAY:
			if (resolve)
				return getCREATE__SRC__mArray();
			return basicGetCREATE__SRC__mArray();
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CREATE_SRC_MVALUE:
			if (resolve)
				return getCREATE__SRC__mValue();
			return basicGetCREATE__SRC__mValue();
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CONTEXT_TRG_TANNOTATION_VALUE:
			if (resolve)
				return getCONTEXT__TRG__tAnnotationValue();
			return basicGetCONTEXT__TRG__tAnnotationValue();
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CREATE_TRG_TVALUE:
			if (resolve)
				return getCREATE__TRG__tValue();
			return basicGetCREATE__TRG__tValue();
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CONTEXT_CORR_ANNOTATION_MEMBER_VALUE_PAIR_TO_TANNOTATION_VALUE:
			if (resolve)
		...
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CREATE_CORR_MTYPE_TO_TTYPE:
			if (resolve)
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CREATE_SRC_MARRAY:
			...
			return;
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CREATE_SRC_MVALUE:
			setCREATE__SRC__mValue((StringLiteral) newValue);
			return;
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CONTEXT_TRG_TANNOTATION_VALUE:
			setCONTEXT__TRG__tAnnotationValue((TAnnotationValue) newValue);
			return;
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CREATE_TRG_TVALUE:
			setCREATE__TRG__tValue((TTextNode) newValue);
			return;
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CONTEXT_CORR_ANNOTATION_MEMBER_VALUE_PAIR_TO_TANNOTATION_VALUE:
			...
			return;
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CREATE_CORR_MTYPE_TO_TTYPE:
			setCREATE__CORR__mTypeToTType((StringLiteralToTTextNode) newValue);
			return;
		}
	...
	public void eUnset(int featureID) {
		...
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CREATE_SRC_MARRAY:
			...
			return;
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CREATE_SRC_MVALUE:
			setCREATE__SRC__mValue((StringLiteral) null);
			return;
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CONTEXT_TRG_TANNOTATION_VALUE:
			setCONTEXT__TRG__tAnnotationValue((TAnnotationValue) null);
			return;
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CREATE_TRG_TVALUE:
			setCREATE__TRG__tValue((TTextNode) null);
			return;
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CONTEXT_CORR_ANNOTATION_MEMBER_VALUE_PAIR_TO_TANNOTATION_VALUE:
			setCONTEXT__CORR__AnnotationMemberValuePairToTAnnotationValue(
			...
			return;
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_STRING_ARRAY_MARKER__CREATE_CORR_MTYPE_TO_TTYPE:
			setCREATE__CORR__mTypeToTType((StringLiteralToTTextNode) null);
			return;
		}
...
} //AnnotationMemberValueStringArray__MarkerImpl
