...
import ModiscoTGG.FieldAccessReadWrite__Marker;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Field Access Read Write Marker</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ModiscoTGG.impl.FieldAccessReadWrite__MarkerImpl#getCREATE__SRC__mAccess <em>CREATE SRC mAccess</em>}</li>
 *   <li>{@link ModiscoTGG.impl.FieldAccessReadWrite__MarkerImpl#getCONTEXT__SRC__mField <em>CONTEXT SRC mField</em>}</li>
 *   <li>{@link ModiscoTGG.impl.FieldAccessReadWrite__MarkerImpl#getCONTEXT__SRC__mMember <em>CONTEXT SRC mMember</em>}</li>
 *   <li>{@link ModiscoTGG.impl.FieldAccessReadWrite__MarkerImpl#getCONTEXT__SRC__mType <em>CONTEXT SRC mType</em>}</li>
 *   <li>{@link ModiscoTGG.impl.FieldAccessReadWrite__MarkerImpl#getCONTEXT__SRC__varDeclFrag <em>CONTEXT SRC var Decl Frag</em>}</li>
 *   <li>{@link ModiscoTGG.impl.FieldAccessReadWrite__MarkerImpl#getCREATE__TRG__tAccess <em>CREATE TRG tAccess</em>}</li>
 *   <li>{@link ModiscoTGG.impl.FieldAccessReadWrite__MarkerImpl#getCONTEXT__TRG__tField <em>CONTEXT TRG tField</em>}</li>
 *   <li>{@link ModiscoTGG.impl.FieldAccessReadWrite__MarkerImpl#getCONTEXT__TRG__tMember <em>CONTEXT TRG tMember</em>}</li>
 *   <li>{@link ModiscoTGG.impl.FieldAccessReadWrite__MarkerImpl#getCONTEXT__TRG__tType <em>CONTEXT TRG tType</em>}</li>
 *   <li>{@link ModiscoTGG.impl.FieldAccessReadWrite__MarkerImpl#getCREATE__CORR__mAccessToTAccess <em>CREATE CORR mAccess To TAccess</em>}</li>
 *   <li>{@link ModiscoTGG.impl.FieldAccessReadWrite__MarkerImpl#getCREATE__CORR__mFlowOwnerToTFlowOwner <em>CREATE CORR mFlow Owner To TFlow Owner</em>}</li>
 *   <li>{@link ModiscoTGG.impl.FieldAccessReadWrite__MarkerImpl#getCONTEXT__CORR__mMemberToTMember <em>CONTEXT CORR mMember To TMember</em>}</li>
 *   <li>{@link ModiscoTGG.impl.FieldAccessReadWrite__MarkerImpl#getCONTEXT__CORR__mMethodToTMethod <em>CONTEXT CORR mMethod To TMethod</em>}</li>
 *   <li>{@link ModiscoTGG.impl.FieldAccessReadWrite__MarkerImpl#getCONTEXT__CORR__mTypeToTType <em>CONTEXT CORR mType To TType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FieldAccessReadWrite__MarkerImpl extends TGGRuleApplicationImpl implements FieldAccessReadWrite__Marker {
	/**
	 ...
	 * @ordered
	 */
	protected TReadWrite creatE__TRG__tAccess;
	 ...
	 * @generated
	 */
	protected FieldAccessReadWrite__MarkerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModiscoTGGPackage.eINSTANCE.getFieldAccessReadWrite__Marker();
	}
			...
			if (creatE__SRC__mAccess != oldCREATE__SRC__mAccess) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CREATE_SRC_MACCESS,
	...
	public void setCREATE__SRC__mAccess(MSingleVariableAccess newCREATE__SRC__mAccess) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CREATE_SRC_MACCESS, oldCREATE__SRC__mAccess,
	...
	public MFieldDefinition getCONTEXT__SRC__mField() {
		if (contexT__SRC__mField != null && contexT__SRC__mField.eIsProxy()) {
			...
			if (contexT__SRC__mField != oldCONTEXT__SRC__mField) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_SRC_MFIELD,
							oldCONTEXT__SRC__mField, contexT__SRC__mField));
			}
		}
	...
	public void setCONTEXT__SRC__mField(MFieldDefinition newCONTEXT__SRC__mField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_SRC_MFIELD, oldCONTEXT__SRC__mField,
	...
	public MDefinition getCONTEXT__SRC__mMember() {
		if (contexT__SRC__mMember != null && contexT__SRC__mMember.eIsProxy()) {
			...
			if (contexT__SRC__mMember != oldCONTEXT__SRC__mMember) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_SRC_MMEMBER,
	...
	public void setCONTEXT__SRC__mMember(MDefinition newCONTEXT__SRC__mMember) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_SRC_MMEMBER, oldCONTEXT__SRC__mMember,
	...
	public AbstractTypeDeclaration getCONTEXT__SRC__mType() {
		if (contexT__SRC__mType != null && contexT__SRC__mType.eIsProxy()) {
			...
			if (contexT__SRC__mType != oldCONTEXT__SRC__mType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_SRC_MTYPE, oldCONTEXT__SRC__mType,
							contexT__SRC__mType));
			}
		}
	...
	public VariableDeclarationFragment getCONTEXT__SRC__varDeclFrag() {
		if (contexT__SRC__varDeclFrag != null && contexT__SRC__varDeclFrag.eIsProxy()) {
			...
			if (contexT__SRC__varDeclFrag != oldCONTEXT__SRC__varDeclFrag) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_SRC_VAR_DECL_FRAG,
	 ...
	 */
	@Override
	public TReadWrite getCREATE__TRG__tAccess() {
		if (creatE__TRG__tAccess != null && creatE__TRG__tAccess.eIsProxy()) {
			...
			creatE__TRG__tAccess = (TReadWrite) eResolveProxy(oldCREATE__TRG__tAccess);
			if (creatE__TRG__tAccess != oldCREATE__TRG__tAccess) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CREATE_TRG_TACCESS,
	 ...
	 * @generated
	 */
	public TReadWrite basicGetCREATE__TRG__tAccess() {
		return creatE__TRG__tAccess;
	}
	 ...
	 */
	@Override
	public void setCREATE__TRG__tAccess(TReadWrite newCREATE__TRG__tAccess) {
		TReadWrite oldCREATE__TRG__tAccess = creatE__TRG__tAccess;
		creatE__TRG__tAccess = newCREATE__TRG__tAccess;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CREATE_TRG_TACCESS, oldCREATE__TRG__tAccess,
	...
	public TFieldDefinition getCONTEXT__TRG__tField() {
		if (contexT__TRG__tField != null && contexT__TRG__tField.eIsProxy()) {
			...
			if (contexT__TRG__tField != oldCONTEXT__TRG__tField) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_TRG_TFIELD,
							oldCONTEXT__TRG__tField, contexT__TRG__tField));
			}
		}
	...
	public void setCONTEXT__TRG__tField(TFieldDefinition newCONTEXT__TRG__tField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_TRG_TFIELD, oldCONTEXT__TRG__tField,
	...
	public TMember getCONTEXT__TRG__tMember() {
		if (contexT__TRG__tMember != null && contexT__TRG__tMember.eIsProxy()) {
			...
			if (contexT__TRG__tMember != oldCONTEXT__TRG__tMember) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_TRG_TMEMBER,
	...
	public void setCONTEXT__TRG__tMember(TMember newCONTEXT__TRG__tMember) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_TRG_TMEMBER, oldCONTEXT__TRG__tMember,
	...
	public TAbstractType getCONTEXT__TRG__tType() {
		if (contexT__TRG__tType != null && contexT__TRG__tType.eIsProxy()) {
			...
			if (contexT__TRG__tType != oldCONTEXT__TRG__tType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_TRG_TTYPE, oldCONTEXT__TRG__tType,
							contexT__TRG__tType));
			}
		}
	...
	public MSingleVariableAccessToTAccess getCREATE__CORR__mAccessToTAccess() {
		if (creatE__CORR__mAccessToTAccess != null && creatE__CORR__mAccessToTAccess.eIsProxy()) {
			...
			if (creatE__CORR__mAccessToTAccess != oldCREATE__CORR__mAccessToTAccess) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CREATE_CORR_MACCESS_TO_TACCESS,
	...
	public MAbstractFlowElementToTAbstractFlowElement getCREATE__CORR__mFlowOwnerToTFlowOwner() {
		if (creatE__CORR__mFlowOwnerToTFlowOwner != null && creatE__CORR__mFlowOwnerToTFlowOwner.eIsProxy()) {
			...
			if (creatE__CORR__mFlowOwnerToTFlowOwner != oldCREATE__CORR__mFlowOwnerToTFlowOwner) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CREATE_CORR_MFLOW_OWNER_TO_TFLOW_OWNER,
	...
	public MDefinitionToTMember getCONTEXT__CORR__mMemberToTMember() {
		if (contexT__CORR__mMemberToTMember != null && contexT__CORR__mMemberToTMember.eIsProxy()) {
			...
			if (contexT__CORR__mMemberToTMember != oldCONTEXT__CORR__mMemberToTMember) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_CORR_MMEMBER_TO_TMEMBER,
	...
	public MDefinitionToTMember getCONTEXT__CORR__mMethodToTMethod() {
		if (contexT__CORR__mMethodToTMethod != null && contexT__CORR__mMethodToTMethod.eIsProxy()) {
			...
			if (contexT__CORR__mMethodToTMethod != oldCONTEXT__CORR__mMethodToTMethod) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_CORR_MMETHOD_TO_TMETHOD,
	...
	public TypeToTAbstractType getCONTEXT__CORR__mTypeToTType() {
		if (contexT__CORR__mTypeToTType != null && contexT__CORR__mTypeToTType.eIsProxy()) {
			...
			if (contexT__CORR__mTypeToTType != oldCONTEXT__CORR__mTypeToTType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_CORR_MTYPE_TO_TTYPE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CREATE_SRC_MACCESS:
			if (resolve)
				return getCREATE__SRC__mAccess();
			return basicGetCREATE__SRC__mAccess();
		case ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_SRC_MFIELD:
			if (resolve)
				return getCONTEXT__SRC__mField();
			return basicGetCONTEXT__SRC__mField();
		case ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_SRC_MMEMBER:
			if (resolve)
				return getCONTEXT__SRC__mMember();
			return basicGetCONTEXT__SRC__mMember();
		case ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_SRC_MTYPE:
			if (resolve)
				return getCONTEXT__SRC__mType();
			return basicGetCONTEXT__SRC__mType();
		case ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_SRC_VAR_DECL_FRAG:
			if (resolve)
				return getCONTEXT__SRC__varDeclFrag();
			return basicGetCONTEXT__SRC__varDeclFrag();
		case ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CREATE_TRG_TACCESS:
			if (resolve)
				return getCREATE__TRG__tAccess();
			return basicGetCREATE__TRG__tAccess();
		case ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_TRG_TFIELD:
			if (resolve)
				return getCONTEXT__TRG__tField();
			return basicGetCONTEXT__TRG__tField();
		case ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_TRG_TMEMBER:
			if (resolve)
				return getCONTEXT__TRG__tMember();
			return basicGetCONTEXT__TRG__tMember();
		case ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_TRG_TTYPE:
			if (resolve)
				return getCONTEXT__TRG__tType();
			return basicGetCONTEXT__TRG__tType();
		case ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CREATE_CORR_MACCESS_TO_TACCESS:
			if (resolve)
				return getCREATE__CORR__mAccessToTAccess();
			return basicGetCREATE__CORR__mAccessToTAccess();
		case ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CREATE_CORR_MFLOW_OWNER_TO_TFLOW_OWNER:
			if (resolve)
				return getCREATE__CORR__mFlowOwnerToTFlowOwner();
			return basicGetCREATE__CORR__mFlowOwnerToTFlowOwner();
		case ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_CORR_MMEMBER_TO_TMEMBER:
			if (resolve)
				return getCONTEXT__CORR__mMemberToTMember();
			return basicGetCONTEXT__CORR__mMemberToTMember();
		case ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_CORR_MMETHOD_TO_TMETHOD:
			if (resolve)
				return getCONTEXT__CORR__mMethodToTMethod();
			return basicGetCONTEXT__CORR__mMethodToTMethod();
		case ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_CORR_MTYPE_TO_TTYPE:
			if (resolve)
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_SRC_VAR_DECL_FRAG:
			...
			return;
		case ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CREATE_TRG_TACCESS:
			setCREATE__TRG__tAccess((TReadWrite) newValue);
			return;
		case ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_TRG_TFIELD:
	...
	public void eUnset(int featureID) {
		...
		case ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_SRC_VAR_DECL_FRAG:
			...
			return;
		case ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CREATE_TRG_TACCESS:
			setCREATE__TRG__tAccess((TReadWrite) null);
			return;
		case ModiscoTGGPackage.FIELD_ACCESS_READ_WRITE_MARKER__CONTEXT_TRG_TFIELD:
...
} //FieldAccessReadWrite__MarkerImpl
