...
import ModiscoTGG.AnnotationMemberValueNumber__Marker;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Annotation Member Value Number Marker</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ModiscoTGG.impl.AnnotationMemberValueNumber__MarkerImpl#getCONTEXT__SRC__AnnotationValue <em>CONTEXT SRC Annotation Value</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationMemberValueNumber__MarkerImpl#getCREATE__SRC__mValue <em>CREATE SRC mValue</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationMemberValueNumber__MarkerImpl#getCONTEXT__TRG__tAnnotationValue <em>CONTEXT TRG tAnnotation Value</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationMemberValueNumber__MarkerImpl#getCREATE__TRG__tValue <em>CREATE TRG tValue</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationMemberValueNumber__MarkerImpl#getCONTEXT__CORR__AnnotationMemberValuePairToTAnnotationValue <em>CONTEXT CORR Annotation Member Value Pair To TAnnotation Value</em>}</li>
 *   <li>{@link ModiscoTGG.impl.AnnotationMemberValueNumber__MarkerImpl#getCREATE__CORR__mTypeToTType <em>CREATE CORR mType To TType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnnotationMemberValueNumber__MarkerImpl extends TGGRuleApplicationImpl
		implements AnnotationMemberValueNumber__Marker {
	/**
	 ...
	 * @generated
	 */
	protected AnnotationMemberValueNumber__MarkerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModiscoTGGPackage.eINSTANCE.getAnnotationMemberValueNumber__Marker();
	}
			...
			if (contexT__SRC__AnnotationValue != oldCONTEXT__SRC__AnnotationValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_NUMBER_MARKER__CONTEXT_SRC_ANNOTATION_VALUE,
	...
	public NumberLiteral getCREATE__SRC__mValue() {
		if (creatE__SRC__mValue != null && creatE__SRC__mValue.eIsProxy()) {
			...
			if (creatE__SRC__mValue != oldCREATE__SRC__mValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_NUMBER_MARKER__CREATE_SRC_MVALUE,
	...
	public void setCREATE__SRC__mValue(NumberLiteral newCREATE__SRC__mValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_NUMBER_MARKER__CREATE_SRC_MVALUE, oldCREATE__SRC__mValue,
					creatE__SRC__mValue));
	}
	...
	public TAnnotationValue getCONTEXT__TRG__tAnnotationValue() {
		if (contexT__TRG__tAnnotationValue != null && contexT__TRG__tAnnotationValue.eIsProxy()) {
			...
			if (contexT__TRG__tAnnotationValue != oldCONTEXT__TRG__tAnnotationValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_NUMBER_MARKER__CONTEXT_TRG_TANNOTATION_VALUE,
	...
	public TNumberNode getCREATE__TRG__tValue() {
		if (creatE__TRG__tValue != null && creatE__TRG__tValue.eIsProxy()) {
			...
			if (creatE__TRG__tValue != oldCREATE__TRG__tValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_NUMBER_MARKER__CREATE_TRG_TVALUE,
	...
	public void setCREATE__TRG__tValue(TNumberNode newCREATE__TRG__tValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_NUMBER_MARKER__CREATE_TRG_TVALUE, oldCREATE__TRG__tValue,
					creatE__TRG__tValue));
	}
	...
	public AnnotationMemberValuePairToTAnnotationValue getCONTEXT__CORR__AnnotationMemberValuePairToTAnnotationValue() {
		if (contexT__CORR__AnnotationMemberValuePairToTAnnotationValue != null
			...
			if (contexT__CORR__AnnotationMemberValuePairToTAnnotationValue != oldCONTEXT__CORR__AnnotationMemberValuePairToTAnnotationValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_NUMBER_MARKER__CONTEXT_CORR_ANNOTATION_MEMBER_VALUE_PAIR_TO_TANNOTATION_VALUE,
							oldCONTEXT__CORR__AnnotationMemberValuePairToTAnnotationValue,
	...
	public NumberLiteralToTNumberNode getCREATE__CORR__mTypeToTType() {
		if (creatE__CORR__mTypeToTType != null && creatE__CORR__mTypeToTType.eIsProxy()) {
			...
			if (creatE__CORR__mTypeToTType != oldCREATE__CORR__mTypeToTType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_NUMBER_MARKER__CREATE_CORR_MTYPE_TO_TTYPE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_NUMBER_MARKER__CONTEXT_SRC_ANNOTATION_VALUE:
			if (resolve)
				return getCONTEXT__SRC__AnnotationValue();
			return basicGetCONTEXT__SRC__AnnotationValue();
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_NUMBER_MARKER__CREATE_SRC_MVALUE:
			if (resolve)
				return getCREATE__SRC__mValue();
			return basicGetCREATE__SRC__mValue();
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_NUMBER_MARKER__CONTEXT_TRG_TANNOTATION_VALUE:
			if (resolve)
				return getCONTEXT__TRG__tAnnotationValue();
			return basicGetCONTEXT__TRG__tAnnotationValue();
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_NUMBER_MARKER__CREATE_TRG_TVALUE:
			if (resolve)
				return getCREATE__TRG__tValue();
			return basicGetCREATE__TRG__tValue();
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_NUMBER_MARKER__CONTEXT_CORR_ANNOTATION_MEMBER_VALUE_PAIR_TO_TANNOTATION_VALUE:
			if (resolve)
		...
		case ModiscoTGGPackage.ANNOTATION_MEMBER_VALUE_NUMBER_MARKER__CREATE_CORR_MTYPE_TO_TTYPE:
			if (resolve)
...
} //AnnotationMemberValueNumber__MarkerImpl
