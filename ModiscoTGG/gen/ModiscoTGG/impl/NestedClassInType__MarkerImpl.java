...
import ModiscoTGG.NestedClassInType__Marker;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Nested Class In Type Marker</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ModiscoTGG.impl.NestedClassInType__MarkerImpl#getCREATE__SRC__eNestedType <em>CREATE SRC eNested Type</em>}</li>
 *   <li>{@link ModiscoTGG.impl.NestedClassInType__MarkerImpl#getCONTEXT__SRC__eOuterType <em>CONTEXT SRC eOuter Type</em>}</li>
 *   <li>{@link ModiscoTGG.impl.NestedClassInType__MarkerImpl#getCREATE__TRG__tNestedPackage <em>CREATE TRG tNested Package</em>}</li>
 *   <li>{@link ModiscoTGG.impl.NestedClassInType__MarkerImpl#getCREATE__TRG__tNestedType <em>CREATE TRG tNested Type</em>}</li>
 *   <li>{@link ModiscoTGG.impl.NestedClassInType__MarkerImpl#getCONTEXT__TRG__tOuterPackage <em>CONTEXT TRG tOuter Package</em>}</li>
 *   <li>{@link ModiscoTGG.impl.NestedClassInType__MarkerImpl#getCONTEXT__TRG__tOuterType <em>CONTEXT TRG tOuter Type</em>}</li>
 *   <li>{@link ModiscoTGG.impl.NestedClassInType__MarkerImpl#getCONTEXT__TRG__typeGraph <em>CONTEXT TRG type Graph</em>}</li>
 *   <li>{@link ModiscoTGG.impl.NestedClassInType__MarkerImpl#getCREATE__CORR__eNestedTypeToTNestedType <em>CREATE CORR eNested Type To TNested Type</em>}</li>
 *   <li>{@link ModiscoTGG.impl.NestedClassInType__MarkerImpl#getCONTEXT__CORR__eOuterTypeToTOuterInterface <em>CONTEXT CORR eOuter Type To TOuter Interface</em>}</li>
 *   <li>{@link ModiscoTGG.impl.NestedClassInType__MarkerImpl#getCREATE__CORR__mBodyToTAnnotation <em>CREATE CORR mBody To TAnnotation</em>}</li>
 *   <li>{@link ModiscoTGG.impl.NestedClassInType__MarkerImpl#getCREATE__CORR__mNestedClassDeclarationToTNestedClass <em>CREATE CORR mNested Class Declaration To TNested Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NestedClassInType__MarkerImpl extends TGGRuleApplicationImpl implements NestedClassInType__Marker {
	/**
	 ...
	 * @ordered
	 */
	protected MClass creatE__SRC__eNestedType;
	...
	/**
	 * The cached value of the '{@link #getCREATE__CORR__mNestedClassDeclarationToTNestedClass() <em>CREATE CORR mNested Class Declaration To TNested Class</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getCREATE__CORR__mNestedClassDeclarationToTNestedClass()
	 * @generated
	 * @ordered
	 */
	protected ClassDeclarationToTClass creatE__CORR__mNestedClassDeclarationToTNestedClass;
	 ...
	 * @generated
	 */
	protected NestedClassInType__MarkerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModiscoTGGPackage.eINSTANCE.getNestedClassInType__Marker();
	}
	 ...
	 */
	@Override
	public MClass getCREATE__SRC__eNestedType() {
		if (creatE__SRC__eNestedType != null && creatE__SRC__eNestedType.eIsProxy()) {
			...
			creatE__SRC__eNestedType = (MClass) eResolveProxy(oldCREATE__SRC__eNestedType);
			if (creatE__SRC__eNestedType != oldCREATE__SRC__eNestedType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CREATE_SRC_ENESTED_TYPE,
	 ...
	 * @generated
	 */
	public MClass basicGetCREATE__SRC__eNestedType() {
		return creatE__SRC__eNestedType;
	}
	 ...
	 */
	@Override
	public void setCREATE__SRC__eNestedType(MClass newCREATE__SRC__eNestedType) {
		MClass oldCREATE__SRC__eNestedType = creatE__SRC__eNestedType;
		creatE__SRC__eNestedType = newCREATE__SRC__eNestedType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CREATE_SRC_ENESTED_TYPE, oldCREATE__SRC__eNestedType,
	...
	public AbstractTypeDeclaration getCONTEXT__SRC__eOuterType() {
		if (contexT__SRC__eOuterType != null && contexT__SRC__eOuterType.eIsProxy()) {
			...
			if (contexT__SRC__eOuterType != oldCONTEXT__SRC__eOuterType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CONTEXT_SRC_EOUTER_TYPE,
	...
	public void setCONTEXT__SRC__eOuterType(AbstractTypeDeclaration newCONTEXT__SRC__eOuterType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CONTEXT_SRC_EOUTER_TYPE, oldCONTEXT__SRC__eOuterType,
	...
	public TPackage getCREATE__TRG__tNestedPackage() {
		if (creatE__TRG__tNestedPackage != null && creatE__TRG__tNestedPackage.eIsProxy()) {
			...
			if (creatE__TRG__tNestedPackage != oldCREATE__TRG__tNestedPackage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CREATE_TRG_TNESTED_PACKAGE,
	...
	public TClass getCREATE__TRG__tNestedType() {
		if (creatE__TRG__tNestedType != null && creatE__TRG__tNestedType.eIsProxy()) {
			...
			if (creatE__TRG__tNestedType != oldCREATE__TRG__tNestedType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CREATE_TRG_TNESTED_TYPE,
	...
	public void setCREATE__TRG__tNestedType(TClass newCREATE__TRG__tNestedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CREATE_TRG_TNESTED_TYPE, oldCREATE__TRG__tNestedType,
	...
	public TPackage getCONTEXT__TRG__tOuterPackage() {
		if (contexT__TRG__tOuterPackage != null && contexT__TRG__tOuterPackage.eIsProxy()) {
			...
			if (contexT__TRG__tOuterPackage != oldCONTEXT__TRG__tOuterPackage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CONTEXT_TRG_TOUTER_PACKAGE,
	...
	public TAbstractType getCONTEXT__TRG__tOuterType() {
		if (contexT__TRG__tOuterType != null && contexT__TRG__tOuterType.eIsProxy()) {
			...
			if (contexT__TRG__tOuterType != oldCONTEXT__TRG__tOuterType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CONTEXT_TRG_TOUTER_TYPE,
	...
	public void setCONTEXT__TRG__tOuterType(TAbstractType newCONTEXT__TRG__tOuterType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CONTEXT_TRG_TOUTER_TYPE, oldCONTEXT__TRG__tOuterType,
	...
	public TypeGraph getCONTEXT__TRG__typeGraph() {
		if (contexT__TRG__typeGraph != null && contexT__TRG__typeGraph.eIsProxy()) {
			...
			if (contexT__TRG__typeGraph != oldCONTEXT__TRG__typeGraph) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CONTEXT_TRG_TYPE_GRAPH,
	...
	public void setCONTEXT__TRG__typeGraph(TypeGraph newCONTEXT__TRG__typeGraph) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CONTEXT_TRG_TYPE_GRAPH, oldCONTEXT__TRG__typeGraph,
	...
	public TypeToTAbstractType getCREATE__CORR__eNestedTypeToTNestedType() {
		if (creatE__CORR__eNestedTypeToTNestedType != null && creatE__CORR__eNestedTypeToTNestedType.eIsProxy()) {
			...
			if (creatE__CORR__eNestedTypeToTNestedType != oldCREATE__CORR__eNestedTypeToTNestedType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CREATE_CORR_ENESTED_TYPE_TO_TNESTED_TYPE,
	...
	public TypeToTAbstractType getCONTEXT__CORR__eOuterTypeToTOuterInterface() {
		if (contexT__CORR__eOuterTypeToTOuterInterface != null
			...
			if (contexT__CORR__eOuterTypeToTOuterInterface != oldCONTEXT__CORR__eOuterTypeToTOuterInterface) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CONTEXT_CORR_EOUTER_TYPE_TO_TOUTER_INTERFACE,
	...
	public ASTNodeToTAnnotatable getCREATE__CORR__mBodyToTAnnotation() {
		if (creatE__CORR__mBodyToTAnnotation != null && creatE__CORR__mBodyToTAnnotation.eIsProxy()) {
			...
			if (creatE__CORR__mBodyToTAnnotation != oldCREATE__CORR__mBodyToTAnnotation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CREATE_CORR_MBODY_TO_TANNOTATION,
	 ...
	 */
	@Override
	public ClassDeclarationToTClass getCREATE__CORR__mNestedClassDeclarationToTNestedClass() {
		if (creatE__CORR__mNestedClassDeclarationToTNestedClass != null
				&& creatE__CORR__mNestedClassDeclarationToTNestedClass.eIsProxy()) {
			InternalEObject oldCREATE__CORR__mNestedClassDeclarationToTNestedClass = (InternalEObject) creatE__CORR__mNestedClassDeclarationToTNestedClass;
			creatE__CORR__mNestedClassDeclarationToTNestedClass = (ClassDeclarationToTClass) eResolveProxy(
					oldCREATE__CORR__mNestedClassDeclarationToTNestedClass);
			if (creatE__CORR__mNestedClassDeclarationToTNestedClass != oldCREATE__CORR__mNestedClassDeclarationToTNestedClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CREATE_CORR_MNESTED_CLASS_DECLARATION_TO_TNESTED_CLASS,
							oldCREATE__CORR__mNestedClassDeclarationToTNestedClass,
							creatE__CORR__mNestedClassDeclarationToTNestedClass));
			}
		}
		return creatE__CORR__mNestedClassDeclarationToTNestedClass;
	}
	 ...
	 * @generated
	 */
	public ClassDeclarationToTClass basicGetCREATE__CORR__mNestedClassDeclarationToTNestedClass() {
		return creatE__CORR__mNestedClassDeclarationToTNestedClass;
	}
	 ...
	 */
	@Override
	public void setCREATE__CORR__mNestedClassDeclarationToTNestedClass(
			ClassDeclarationToTClass newCREATE__CORR__mNestedClassDeclarationToTNestedClass) {
		ClassDeclarationToTClass oldCREATE__CORR__mNestedClassDeclarationToTNestedClass = creatE__CORR__mNestedClassDeclarationToTNestedClass;
		creatE__CORR__mNestedClassDeclarationToTNestedClass = newCREATE__CORR__mNestedClassDeclarationToTNestedClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CREATE_CORR_MNESTED_CLASS_DECLARATION_TO_TNESTED_CLASS,
					oldCREATE__CORR__mNestedClassDeclarationToTNestedClass,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CREATE_SRC_ENESTED_TYPE:
			if (resolve)
				return getCREATE__SRC__eNestedType();
			return basicGetCREATE__SRC__eNestedType();
		case ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CONTEXT_SRC_EOUTER_TYPE:
			if (resolve)
				return getCONTEXT__SRC__eOuterType();
			return basicGetCONTEXT__SRC__eOuterType();
		case ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CREATE_TRG_TNESTED_PACKAGE:
			if (resolve)
				return getCREATE__TRG__tNestedPackage();
			return basicGetCREATE__TRG__tNestedPackage();
		case ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CREATE_TRG_TNESTED_TYPE:
			if (resolve)
				return getCREATE__TRG__tNestedType();
			return basicGetCREATE__TRG__tNestedType();
		case ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CONTEXT_TRG_TOUTER_PACKAGE:
			if (resolve)
				return getCONTEXT__TRG__tOuterPackage();
			return basicGetCONTEXT__TRG__tOuterPackage();
		case ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CONTEXT_TRG_TOUTER_TYPE:
			if (resolve)
				return getCONTEXT__TRG__tOuterType();
			return basicGetCONTEXT__TRG__tOuterType();
		case ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CONTEXT_TRG_TYPE_GRAPH:
			if (resolve)
				return getCONTEXT__TRG__typeGraph();
			return basicGetCONTEXT__TRG__typeGraph();
		case ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CREATE_CORR_ENESTED_TYPE_TO_TNESTED_TYPE:
			if (resolve)
				return getCREATE__CORR__eNestedTypeToTNestedType();
			return basicGetCREATE__CORR__eNestedTypeToTNestedType();
		case ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CONTEXT_CORR_EOUTER_TYPE_TO_TOUTER_INTERFACE:
			if (resolve)
				return getCONTEXT__CORR__eOuterTypeToTOuterInterface();
			return basicGetCONTEXT__CORR__eOuterTypeToTOuterInterface();
		case ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CREATE_CORR_MBODY_TO_TANNOTATION:
			if (resolve)
				return getCREATE__CORR__mBodyToTAnnotation();
			return basicGetCREATE__CORR__mBodyToTAnnotation();
		case ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CREATE_CORR_MNESTED_CLASS_DECLARATION_TO_TNESTED_CLASS:
			if (resolve)
				return getCREATE__CORR__mNestedClassDeclarationToTNestedClass();
			return basicGetCREATE__CORR__mNestedClassDeclarationToTNestedClass();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
		case ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CREATE_SRC_ENESTED_TYPE:
			setCREATE__SRC__eNestedType((MClass) newValue);
			return;
		case ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CONTEXT_SRC_EOUTER_TYPE:
		...
		case ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CREATE_CORR_MBODY_TO_TANNOTATION:
			...
			return;
		case ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CREATE_CORR_MNESTED_CLASS_DECLARATION_TO_TNESTED_CLASS:
			setCREATE__CORR__mNestedClassDeclarationToTNestedClass((ClassDeclarationToTClass) newValue);
			return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
		case ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CREATE_SRC_ENESTED_TYPE:
			setCREATE__SRC__eNestedType((MClass) null);
			return;
		case ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CONTEXT_SRC_EOUTER_TYPE:
		...
		case ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CREATE_CORR_MBODY_TO_TANNOTATION:
			...
			return;
		case ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CREATE_CORR_MNESTED_CLASS_DECLARATION_TO_TNESTED_CLASS:
			setCREATE__CORR__mNestedClassDeclarationToTNestedClass((ClassDeclarationToTClass) null);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case ModiscoTGGPackage.NESTED_CLASS_IN_TYPE_MARKER__CREATE_CORR_MNESTED_CLASS_DECLARATION_TO_TNESTED_CLASS:
			return creatE__CORR__mNestedClassDeclarationToTNestedClass != null;
		}
		return super.eIsSet(featureID);
	}

} //NestedClassInType__MarkerImpl
